...
- Generated: 2026-05-25T20:14:23.124Z
...
Across is a cross-chain bridge protocol that enables fast, low-cost transfers of assets between Ethereum, L2s, and other EVM chains. It uses a hub-and-spoke architecture with liquidity pools and relayers to fulfill user deposit intents across supported networks.
...
- Verified implementations audited: 11/61 (18.0%)
...
- Tier 1 coverage: 18.0% (OpenZeppelin)

### Auditor Coverage

| Auditor | Tier | Contracts Covered | Coverage % | Latest Audit |
|---|---|---:|---:|---|
| OpenZeppelin | Tier 1 | 11 | 18.0% | 2021-12 |
...
| AddressWhitelist | unknown | blast | 2 deployments: ethereum `0xdbf904...0758c7`; blast [`0xd85630...b81b86`](./contracts/blast-81457/0xd85630e361cebbc4c7f13e6eed3587050fb81b86/) | ✅ Audited |
...
|---|---|---|---|---|---|---|---|---|
| [DL audit link](https://www.openzeppelin.com/news/uma-audit-l2-bridges) | OpenZeppelin | Audit | 2021-12 | stale | Direct | n/a | 0 | n/a |
...
| [various incremental pull requests over a longer engagement](https://www.openzeppelin.com/news/uma-continuous-audit) | OpenZeppelin | Audit | 2021-04 | stale | Direct | contract_name | 8 | high |
...
- Match method counts: extraction_exact=52
