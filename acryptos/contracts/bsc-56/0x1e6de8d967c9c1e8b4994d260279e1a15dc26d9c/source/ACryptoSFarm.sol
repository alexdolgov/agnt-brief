...
// File: MasterChef/contracts/ACryptoSFarm.sol
...
contract ACryptoSFarm is OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;
    ...
    function initialize() public initializer {
        ...
        sushi = ERC20Mintable(address(0x4197C6EF3879a08cD51e5560da5064B773aa1d29)); //ACS
        strategist = address(0xB9a81e121d8C9D619682bB9dDB6823439178F2f8); //deployer
        withdrawalFeeAddress = address(0x8650ab7e2C53E705d484c3b98bE14C1Ba1e8D690); //acsACS Strategy
        ...
        boostToken = address(0x7679381507af0c8DE64586A458161aa58D3A4FC3); //acsACS
        ...
        additionalRewards.push(AdditionalReward({
            to: address(0x7679381507af0c8DE64586A458161aa58D3A4FC3), //acsACS Vault
            reward: 3333
        }));
        additionalRewards.push(AdditionalReward({
    ...
    function harvest(address _lpToken) public {
        ...
        if(pending > 0) {
            if(pending < harvestFee) {
                safeSushiTransfer(withdrawalFeeAddress, pending);
            } else {
                safeSushiTransfer(withdrawalFeeAddress, harvestFee);
    ...
    function setWithdrawalFeeAddress(address _withdrawalFeeAddress) external onlyStrategist {
