...
// File: contracts/strategies/StrategyACryptoSCakeTokenToken.sol
...
contract StrategyACryptoSCakeTokenToken {
    ...
    constructor(address _controller, address _want, address _tokenA, address _tokenB, uint256 _cakeChefPid, address[] memory _cakeToTokenAPath) public {
        want = _want;
        tokenA = _tokenA;
        tokenB = _tokenB;
