...
// File: contracts/strategies/StrategyACryptoS0.sol
...
contract StrategyACryptoS0 {
    ...
    constructor(address _controller) public {
        ...
        // TokenConvertor[] storage token = new TokenConvertor[](1);
        // token[0] = TokenConvertor(IUniswapRouter(address(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F)),path);

        // tokenConvertors.push(TokenConvertor({router: IUniswapRouter(address(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F)),path: path}));
    }

    function getName() external pure returns (string memory) {
        return "StrategyACryptoS0";
    }
    ...
    function _convertAllToWant() internal {
      _convertToken(cake,wbnb,pancakeSwapRouter);
      _convertToken(wbnb,want,pancakeSwapRouter);
    }
