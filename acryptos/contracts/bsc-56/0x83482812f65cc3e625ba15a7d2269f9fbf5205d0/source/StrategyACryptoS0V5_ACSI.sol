...
// File: contracts/strategies/StrategyACryptoS0V5_ACSI.sol
...
contract StrategyACryptoS0V5_ACSI {
    ...
    constructor(address _controller) public {
      ...
      tokensToSwap0.push(TokenToSwap({
        ...
        router: address(0x816278BbBCc529f8cdEE8CC72C226fb01def6E6C) //swipe
      }));
      tokensToSwap0.push(TokenToSwap({
    ...
    function getName() external pure returns (string memory) {
        return "StrategyACryptoS0V5_ACSI";
    }
