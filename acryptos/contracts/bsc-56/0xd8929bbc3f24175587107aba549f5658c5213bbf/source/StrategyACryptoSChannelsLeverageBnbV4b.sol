...
// File: MasterChef/contracts/strategies/StrategyACryptoSChannelsLeverageBnbV4b.sol
...
contract StrategyACryptoSChannelsLeverageBnbV4b {
    ...
    function getName() external pure returns (string memory) {
        return "StrategyACryptoSChannelsLeverageBnbV4b";
    }
    ...
    function _rebalance(uint256 withdrawAmount) internal {
        ...
        if (_currentL < _L && _L.sub(_currentL) > targetBorrowLimitHysteresis) {
            ...
            // uint256 _borrowCap = IComptroller(comptroller).borrowCaps(
            //     vToken
            // );
            // if (_borrowCap != 0) {
