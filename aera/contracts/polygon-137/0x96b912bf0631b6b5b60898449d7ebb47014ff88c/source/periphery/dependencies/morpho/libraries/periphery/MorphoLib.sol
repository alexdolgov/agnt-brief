...
library MorphoLib {
    function supplyShares(
        ...
        bytes32[] memory slot =
            _array(MorphoStorageLib.positionSupplySharesSlot(id, user));
    ...
    function totalSupplyAssets(
        ...
        bytes32[] memory slot =
            _array(MorphoStorageLib.marketTotalSupplyAssetsAndSharesSlot(id));
        return uint128(uint256(morpho.extSloads(slot)[0]));
    }
    ...
    function totalBorrowAssets(
        ...
        bytes32[] memory slot =
            _array(MorphoStorageLib.marketTotalBorrowAssetsAndSharesSlot(id));
        return uint128(uint256(morpho.extSloads(slot)[0]));
    }
    ...
    function lastUpdate(
        ...
        bytes32[] memory slot =
            _array(MorphoStorageLib.marketLastUpdateAndFeeSlot(id));
        return uint128(uint256(morpho.extSloads(slot)[0]));
    }
