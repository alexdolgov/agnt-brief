...
library MorphoStorageLib {
    ...
    function positionSupplySharesSlot(
        ...
        return bytes32(
            uint256(
                keccak256(
                    abi.encode(user, keccak256(abi.encode(id, POSITION_SLOT)))
                )
    ...
    function marketTotalSupplyAssetsAndSharesSlot(Id id)
        internal
        pure
        returns (bytes32)
    {
    ...
    function marketTotalBorrowAssetsAndSharesSlot(Id id)
        internal
        pure
        returns (bytes32)
    {
    ...
    function marketLastUpdateAndFeeSlot(Id id)
        internal
        pure
        returns (bytes32)
    {
