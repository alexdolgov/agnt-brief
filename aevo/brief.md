...
- Generated: 2026-05-22T16:38:37.848Z
- Pipeline run: v2-pipeline-2026-05-22-eff36e-2ebb
- Chains: arbitrum, base, ethereum, optimism
- Contract surface: 331 unique implementations (820 raw deployments)
- DeFi Llama TVL: $20,565,266.00
- On-chain TVL (included contracts): $98,470,336.39
- TVL by chain: Ethereum $53,696,595.46 | Arbitrum $25,537,058.85 | Optimism $17,669,989.51 | Base $1,566,692.57
...
- Verified implementations audited: 14/152 (9.2%)
...
- ASD (verified + unaudited TVL): $1,701,984.42
...
|---|---|---:|---:|---|
| Quantstamp | Tier 2 | 7 | 4.6% | 2021-05 |
| Ribbon | Tier 2 | 3 | 2.0% | 2024-01 |
| PeckShield | Tier 2 | 2 | 1.3% | 2022-03 |
| Unknown | Tier 2 | 1 | 0.7% | 2021-07 |
| VAR | Tier 2 | 1 | 0.7% | 2023-10 |
...
| Controller | governance | optimism | 4 deployments: ethereum `0xd8c534...504d2a`; optimism [`0x5e648e...55a6aa`](./contracts/optimism-10/0x5e648e8391b4e7f764b3e79d8a786078c755a6aa/); optimism `0x6dc5f8...6b470c`; arbitrum `0x9cf6f3...a1bc56` | ✅ Audited |
...
| MerkleDistributor | operational_periphery | ethereum | 3 deployments: ethereum [`0x1b6043...ade677`](./contracts/ethereum-1/0x1b604349100a318e369b59a6d6c1b65a31ade677/); ethereum `0x1ea2f2...07cf90`; ethereum `0x7902e4...8cc1bf` | ✅ Audited |
| Migrator | periphery | ethereum | 2 deployments: ethereum [`0x818180...d94830`](./contracts/ethereum-1/0x818180acb9d300ffc023be2300addb6879d94830/); ethereum `0x820670...b7f154` | ✅ Audited |
...
| [VAR_Ribbon_OTC.pdf](https://github.com/ribbon-finance/aevo-audit/blob/master/VAR_Ribbon_OTC.pdf) | VAR | Audit | 2023-03 | stale | Direct | contract_name | 4 | high |
...
| [PeckShield-Audit-Report-RBN-ERC20-v1.0.pdf](https://github.com/ribbon-finance/audit/blob/master/reports/PeckShield-Audit-Report-RBN-ERC20-v1.0.pdf) | PeckShield | Audit | 2021-05 | stale | Direct | contract_name | 6 | high |
...
| [VAR_Ribbon_230604.pdf](https://github.com/aevoxyz/audit/blob/main/VAR_Ribbon_230604.pdf) | Ribbon | Audit | 2023-06 | stale | Direct | contract_name | 3 | high |
...
| ethereum | [`0x0440ae...25c87c`](./contracts/ethereum-1/0x0440ae12f329dbd7306b6d9edbb0e667c225c87c/) | TokenStore | token | $178,786.84 | Verified native implementation with $178,786.84 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,126.25 | Verified native implementation with $5,126.25 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0x5859ad...8120c0`](./contracts/ethereum-1/0x5859adb05988946b9d08dce2e12ae29af58120c0/) | BASPool | core_logic | $1,396.60 | Verified native implementation with $1,396.60 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| optimism | [`0x10bcd3...5755de`](./contracts/optimism-10/0x10bcd35f03c9c9b68305875f52b406188f5755de/) | MessageSearch | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
