# Agentic Audit Brief: Aftermath Finance

⚠️ Lifecycle status: DECLINING - TVL dropped 28.5% over 90 days
...
- Generated: 2026-05-23T15:41:49.792Z
...
- DeFi Llama TVL: $5,463,111.41
- On-chain TVL (included contracts): $1,849,166.97
- TVL by chain: Ethereum $1,690,915.85 | Arbitrum $158,250.42 | Bsc $0.70

## Project Description

Aftermath Finance is a multi-chain DeFi protocol offering yield optimization, liquid staking, DEX aggregation, and derivatives trading. It aggregates liquidity and automates yield strategies across numerous chains, enabling users to earn optimized returns and trade efficiently.

### Architecture

The Aftermath Aggregator family encompasses all identified contracts, with core vaults and pools (e.g., bVault, BAC pools) serving as primary yield-bearing instruments, while governance controllers (FarmV2Controller, FarmV3Controller) and proxies (ArcProxy, BerryMaster) provide shared infrastructure for upgrades and reward distribution. Cross-chain AutoFarm contracts and token bridges (MantaMintableERC20WithBridgeFlag) extend the protocol's reach across multiple chains.
...
- ASD (verified + unaudited TVL): $1,849,166.97
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [declining]. ASD of $1,849,166.97 represents exposure in a protocol with declining activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $298,360.59 | Verified native implementation with $298,360.59 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $67,947.65 | Verified native implementation with $67,947.65 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $50,938.76 | Verified native implementation with $50,938.76 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,928.94 | Verified native implementation with $4,928.94 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,506.14 | Verified native implementation with $4,506.14 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $901.25 | Verified native implementation with $901.25 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $35.58 | Verified native implementation with $35.58 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.75 | Verified native implementation with $31.75 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| bsc | [`0x02360b...23ffcf`](./contracts/bsc-56/0x02360b5e75a84696416f0f446267d5384b23ffcf/) | TokenTimelock | governance | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
