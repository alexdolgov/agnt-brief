...
// ============================================================
// FILE: contracts/core/GToken.sol
// ============================================================
...
contract GToken is ERC20Upgradeable, ERC4626Upgradeable, OwnableUpgradeable, IGToken {
    ...
    function refill(uint256 assets) external {
        ...
        // If asset is not GNS, transfer from `sender` to vault
        if (!isAssetGnsToken) SafeERC20Upgradeable.safeTransferFrom(_assetIERC20(), sender, address(this), assets);
        ...
        // When asset is GNS, mint directly to the vault, otherwise mint to `sender`
        IERC20(gnsToken).mint(isAssetGnsToken ? address(this) : sender, amountGns);
...
// ============================================================
// FILE: contracts/interfaces/IGeneralErrors.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/IGTokenLockedDepositNft.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/IGTokenLockedDepositNftDesign.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/IGTokenOpenPnlFeed.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/mock/IBlockManager_Mock.sol
// ============================================================
...
// ============================================================
// FILE: contracts/libraries/ChainUtils.sol
// ============================================================
...
// ============================================================
// FILE: contracts/libraries/TokenTransferUtils.sol
// ============================================================
