...
contract ksETH is ERC20, Ownable2Step {
    ...
    /// @notice                Deposit `_approvedToken` to receive ksETH
    /// @param _approvedToken  Token to deposit
    /// @param _to             Address to send minted ksETH to
    ...
    /// @notice                         Redeem ksETH to receive `_approvedTokenToReceive`
    ...
    /// @param _ksETHToRedeem           Amount of ksETH to redeem
