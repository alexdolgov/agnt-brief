...
// ============================================================
// FILE: contracts/interfaces/IRedeemOperator.sol
// ============================================================
...
// ============================================================
// FILE: contracts/main/common/Constants.sol
// ============================================================
...
// ============================================================
// FILE: contracts/main/libraries/Errors.sol
// ============================================================
...
// ============================================================
// FILE: contracts/main/libraries/StorageSlot.sol
// ============================================================
...
contract Vault is VaultYieldBasic {
    ...
    uint256 public depositHalted;

    modifier whenDepositNotHalted() {
        require(depositHalted == 0, "Deposit is halted");
        _;
    }
...
// ============================================================
// FILE: contracts/main/vault/StrategyFactory.sol
// ============================================================
...
abstract contract StrategyFactory is OwnableUpgradeable {
    ...
    /**
     * @dev Update the position ratio limits of the strategy.
     * @param _offset The strategy index.
     * @param _newPositionLimit The new limit.
     */
...
// ============================================================
// FILE: contracts/main/vault/VaultYieldBasic.sol
// ============================================================
