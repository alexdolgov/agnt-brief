...
// ============================================================
// FILE: @squadswap/v3-core/contracts/interfaces/ISquadV3Factory.sol
// ============================================================
...
// ============================================================
// FILE: @squadswap/v3-core/contracts/libraries/FixedPoint128.sol
// ============================================================
...
// ============================================================
// FILE: @squadswap/v3-core/contracts/libraries/LiquidityMath.sol
// ============================================================
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0xc43da4ea934a8843dd511f1a48cea8e9fcfff9f1c654d1c06f7a9dd76c9993fa;
...
interface IMasterChefV3 {
    ...
    function getLatestPeriodInfo(address _v3Pool) external view returns (uint256 squadPerSecond, uint256 endTime);
}

// ============================================================
// FILE: contracts/interfaces/ISquadV3LmPool.sol
// ============================================================

// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;

interface ISquadV3LmPool {
...
import '@squadswap/v3-core/contracts/libraries/LiquidityMath.sol';
...
// ============================================================
// FILE: contracts/SquadV3LmPool.sol
// ============================================================
...
// ============================================================
// FILE: contracts/SquadV3LmPoolDeployer.sol
// ============================================================
