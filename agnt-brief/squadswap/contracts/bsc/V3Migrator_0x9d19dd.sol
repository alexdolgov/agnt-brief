// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/ICryptoV3Factory.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/ICryptoV3Pool.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/pool/ICryptoV3PoolActions.sol
// ============================================================
...
interface ICryptoV3PoolActions {
    ...
    /// @dev The caller of this method receives a callback in the form of ICryptoV3MintCallback#CryptoV3MintCallback
    ...
    /// @dev The caller of this method receives a callback in the form of ICryptoV3SwapCallback#CryptoV3SwapCallback
    ...
    /// @dev The caller of this method receives a callback in the form of ICryptoV3FlashCallback#CryptoV3FlashCallback
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/pool/ICryptoV3PoolDerivedState.sol
// ============================================================
...
interface ICryptoV3PoolDerivedState {
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/pool/ICryptoV3PoolEvents.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/pool/ICryptoV3PoolImmutables.sol
// ============================================================
...
interface ICryptoV3PoolImmutables {
    /// @notice The contract that deployed the pool, which must adhere to the ICryptoV3Factory interface
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/pool/ICryptoV3PoolOwnerActions.sol
// ============================================================
...
interface ICryptoV3PoolOwnerActions {
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/interfaces/pool/ICryptoV3PoolState.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoswap2/v3-core/contracts/libraries/LowGasSafeMath.sol
// ============================================================
...
/// @notice Wraps CryptoSwap V3 positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
...
interface IPeripheryImmutableState {
    /// @return Returns the address of the CryptoSwap V3 deployer
    function deployer() external view returns (address);

    /// @return Returns the address of the CryptoSwap V3 factory
    function factory() external view returns (address);
...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from CryptoSwap v2-compatible pairs into CryptoSwap v3 pools
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the CryptoSwap v2-compatible pair
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x4df55b716c4860761850d688a7522eee33a4b056dbe088d6f002a236eb9b6b56;
    ...
    /// @param deployer The CryptoSwap V3 deployer contract address
