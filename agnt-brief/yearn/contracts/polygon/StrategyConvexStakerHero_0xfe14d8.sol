...
// ============================================================
// FILE: lib/tokenized-strategy-periphery/src/Auctions/AuctionFactory.sol
// ============================================================
...
// ============================================================
// FILE: lib/tokenized-strategy-periphery/src/interfaces/TradeFactory/ITradeFactory.sol
// ============================================================
...
// ============================================================
// FILE: lib/tokenized-strategy-periphery/src/swappers/AuctionSwapper.sol
// ============================================================
...
// ============================================================
// FILE: lib/tokenized-strategy-periphery/src/swappers/TradeFactorySwapper.sol
// ============================================================
...
// ============================================================
// FILE: lib/tokenized-strategy-periphery/src/utils/Clonable.sol
// ============================================================
...
// ============================================================
// FILE: src/interfaces/ConvexInterfaces.sol
// ============================================================
...
// ============================================================
// FILE: src/StrategyConvexStakerHero.sol
// ============================================================
...
contract StrategyConvexStakerHero is
    BaseStrategy,
    TradeFactorySwapper,
    AuctionSwapper
{
    ...
    /// @notice This is the multisig we send our keepAURA to
    address public keep = 0x888D768764A2E304215247F0bA3457cCb0f0ab4f;

    /// @notice This is the address for the AURA token
    ERC20 public constant aura =
        ERC20(0x1509706a6c66CA549ff0cB464de88231DDBe213B);
    ...
    function _claimRewards() internal override {
        ...
        // check aura balance, send any to our keep address
        if (keep != address(0)) {
            uint256 auraBalance = aura.balanceOf(address(this));
            if (auraBalance > 0) {
                aura.safeTransfer(keep, auraBalance);
            }
        }
    }
    ...
    function setKeep(address _keep) external onlyManagement {
        keep = _keep;
    }
}
