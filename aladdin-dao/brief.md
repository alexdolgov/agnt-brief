...
⚠️ Lifecycle status: DEAD - TVL dropped 16.0% over 90 days
...
- Generated: 2026-06-20T01:04:37.511Z
- Pipeline run: v2-pipeline-2026-06-19-727228-a815
- Chains: arbitrum, blast, bsc, ethereum, linea, optimism
- Contract surface: 81 unique implementations (269 raw deployments)
- DeFi Llama TVL: $23,208.38
- On-chain TVL (included contracts): $18,986,482.71
- TVL by chain: Ethereum $18,986,482.71

## Project Description

Aladdin DAO is a multi-product DeFi protocol that aggregates yield, provides leveraged exposure, and issues stablecoins. It operates across several product lines including Concentrator (yield optimization), CLever (leveraged yield), f(x) Protocol (decentralized stablecoins), and cross-chain token bridging.

### Architecture

Concentrator and CLever share infrastructure like PlatformFeeDistributor, Vesting, and SmartWalletWhitelist, and both interact with Convex/Curve. f(x) Protocol uses its own set of oracles, gauges, and treasuries but relies on the same multisig governance and token converter contracts. Cross-chain contracts bridge f(x) tokens, while Gateways and Zaps provide user entry points into Concentrator vaults.

## Contract Surface Quality

- Indexed contracts: 1034; live-surface contracts included: 269 (268 live, 1 unknown).
- Excluded by liveness: 553 inactive, 212 singleton, 0 uninitialized.
- Deployment units: 10/87 live.
- Detected codebases: balancer-v2, curve-stableswap, uniswap-v2, uniswap-v3
- Unverified dependencies: 9/296.

## Audit Coverage Summary

- Verified implementations audited: 14/72 (19.4%)
...
- ASD (verified + unaudited TVL): $17,578,200.39
- Latest audit: 2024-08 (aging)
- Staleness: 0 fresh, 2 aging, 18 stale, 0 unknown
- Tier 1 coverage: 2.8% (Trail of Bits)
- Note: This protocol is classified as [dead]. ASD of $17,578,200.39 represents exposure in a protocol with dead activity.

### Auditor Coverage

| Auditor | Tier | Contracts Covered | Coverage % | Latest Audit |
|---|---|---:|---:|---|
| SECBIT | Tier 2 | 13 | 18.1% | 2024-08 |
| Trail of Bits | Tier 1 | 2 | 2.8% | 2024-03 |
| CertiK | Tier 2 | 1 | 1.4% | 2021-10 |
| PeckShield | Tier 2 | 1 | 1.4% | 2022-07 |
...
| AladdinConvexVault | core_logic | ethereum | unit-40816 | [`0xc8ff37...68e0e8`](./contracts/ethereum-1/0xc8ff37f7d057df1bb9ad681b53fa4726f268e0e8/) | ✅ Audited |
| AladdinFXSConvexVault | core_logic | ethereum | unit-40820 | [`0xd6e3bb...bf99e1`](./contracts/ethereum-1/0xd6e3bb7b1d6fa75a71d48cfb10096d59abbf99e1/) | ✅ Audited |
| ALDPlus | unknown | ethereum | n/a | [`0x774e4e...34fbe4`](./contracts/ethereum-1/0x774e4ee61dfcdba5a574c113abb03a0a6634fbe4/) | ✅ Audited |
| CvxCompounder | adapter | ethereum | unit-40809 | [`0xb0903a...8fb777`](./contracts/ethereum-1/0xb0903ab70a7467ee5756074b31ac88aebb8fb777/) | ✅ Audited |
| CvxFxnCompounder | adapter | ethereum | unit-40743 | [`0x00bac6...349545`](./contracts/ethereum-1/0x00bac667a4ccf9089ab1db978238c555c4349545/) | ✅ Audited |
| FxUSD | unknown | ethereum | n/a | [`0x676c35...cecb43`](./contracts/ethereum-1/0x676c359c78f75581ab2da5c353d2577c41cecb43/) | ✅ Audited |
| FxUSDCompounder4626 | adapter | ethereum | unit-40745 | [`0x07d171...945f9a`](./contracts/ethereum-1/0x07d1718ff05a8c53c8f05adaed57c0d672945f9a/) | ✅ Audited |
...
| SdPendleCompounder | adapter | ethereum | unit-40784 | [`0x606462...c7fecf`](./contracts/ethereum-1/0x606462126e4bd5c4d153fe09967e4c46c9c7fecf/) | ✅ Audited |
...
| AaveFundingPool | core_logic | ethereum | unit-40789 (2 proxies) | 2 deployments: ethereum [`0x6ecfa3...0122e8`](./contracts/ethereum-1/0x6ecfa38fee8a5277b91efda204c235814f0122e8/); ethereum `0xab709e...952473` | ⚠️ Unaudited |
...
| GnosisSafe | governance | ethereum | unit-40761 (4 proxies) | 4 deployments: ethereum [`0x26b2ec...e67bbf`](./contracts/ethereum-1/0x26b2ec4e02ebe2f54583af25b647b1d619e67bbf/); ethereum `0xa0fb1b...804e99`; ethereum `0xc40549...afe23f`; ethereum `0xfc0875...9f0c5e` | ⚠️ Unaudited |
...
| SdCrvCompounder | adapter | ethereum | unit-40771 | [`0x43e54c...7b9922`](./contracts/ethereum-1/0x43e54c2e7b3e294de3a155785f52ab49d87b9922/) | ⚠️ Unaudited |
...
| VestingManagerProxy | operational_periphery | ethereum | unit-40750 | [`0x0e4f31...c54ced`](./contracts/ethereum-1/0x0e4f31a2f48418c90f5e9fa84bf761d832c54ced/) | ⚠️ Unaudited |
...
|---|---|---|---|---|---|---|---|---|
| [DL audit link](https://www.aladdin.club/audits/PeckShield-Audit-Report-AladdinDAO2-v1.0.pdf) | PeckShield | Audit | 2021-08 | stale | Direct | contract_name | 0 | n/a |
| [DL audit link](https://skynet.certik.com/projects/aladdindao) | CertiK | Audit | 2021-10 | stale | Direct | contract_name | 1 | medium |
| [f(x) Protocol](https://github.com/trailofbits/publications/blob/master/reviews/2024-03-aladdinfxprotocol-securityreview.pdf) | Trail of Bits | Audit | 2024-03 | stale | Direct | contract_name | 2 | high |
| [AladdinDAO v2](https://github.com/AladdinDAO/aladdin-v2-contracts/blob/main/audit-reports/SECBIT-Audit-Report-AladdinDAO-V2.pdf) | SECBIT | Audit | 2021-12 | stale | Direct | contract_name | 2 | high |
| [Concentrator](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_Concentrator_Report_v1.1.pdf) | SECBIT | Audit | 2022-03 | stale | Direct | contract_name | 1 | high |
| [CLever](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_CLever_Report_v1.1.pdf) | SECBIT | Audit | 2022-04 | stale | Direct | contract_name | 6 | high |
| [f(x) Protocol](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_f(x)_FxUSD_Report_v1.0_20240223.pdf) | SECBIT | Audit | 2024-02 | stale | Direct | contract_name | 2 | high |
| [PeckShield-Audit-Report-AladdinDAOv2-1.0.pdf](https://github.com/AladdinDAO/aladdin-v2-contracts/blob/main/audit-reports/PeckShield-Audit-Report-AladdinDAOv2-1.0.pdf) | PeckShield | Audit | 2021-12 | stale | Direct | contract_name | 0 | n/a |
| [Concentrator (also discovered via alternate URL)](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/PeckShield-Audit-Report-AladdinV3Concentrator-v1.0.pdf) | PeckShield | Audit | 2022-04 | stale | Direct | contract_name | 0 | n/a |
| [SECBIT_f(x)_Shareable_RebalancePool_Report_20240118.pdf](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_f(x)_Shareable_RebalancePool_Report_20240118.pdf) | SECBIT | Audit | 2024-01 | stale | Direct | contract_name | 0 | n/a |
| [#### [arUSD Report]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_Concentrator_arUSD_Report_v1.0_20240618.pdf) | SECBIT | Audit | 2024-06 | stale | Direct | contract_name | 1 | high |
| [#### [aFXN Report]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_Concentrator_aFXN_Report_v1.0_20240726.pdf) | SECBIT | Audit | 2024-07 | aging | Direct | contract_name | 1 | high |
| [[SECBIT]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_Concentrator_asdPENDLE_v1.0_20240813.pdf) | SECBIT | Audit | 2024-08 | aging | Direct | contract_name | 1 | high |
| [[PeckShield]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/PeckShield-Audit-Report-AladdinDAO-Concentrator-v1.0-20220704.pdf) | PeckShield | Audit | 2022-07 | stale | Direct | contract_name | 1 | high |
| [[SECBIT]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_Concentrator_IFO_Report_v1.2_20220701.pdf) | SECBIT | Audit | 2022-07 | stale | Direct | contract_name | 1 | high |
| [[SECBIT]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_AladdinDAO_aFXS_Report.pdf) | SECBIT | Audit | 2022-08 | stale | Direct | contract_name | 1 | high |
| [[SECBIT]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/AladdinETH_Report_v1.0_2022_12_22.pdf) | SECBIT | Audit | 2022-12 | stale | Direct | contract_name | 1 | high |
| [[SECBIT]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_sdCRV_Report_v1.0_20230202.pdf) | SECBIT | Audit | 2023-02 | stale | Direct | contract_name | 0 | n/a |
| [[SECBIT]()](https://github.com/AladdinDAO/aladdin-v3-contracts/blob/main/audit-reports/SECBIT_Aladdin_aCVX_Report_v1.0_20231018.pdf) | SECBIT | Audit | 2023-10 | stale | Direct | contract_name | 1 | high |
| [[SECBIT]()](https://aladdin.club/audits/AladdinDao_V3_Report_Secbit.pdf) | SECBIT | Audit | 2022-03 | stale | Direct | contract_name | 1 | high |
...
|---|---|---|---|---:|---|
| ethereum | [`0xb26c4b...702a8d`](./contracts/ethereum-1/0xb26c4b3ca601136daf98593feaeff9e0ca702a8d/) | ALDToken | token | $2,218,341.70 | Verified native implementation with $2,218,341.70 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0xe93f5d...ee45ed`](./contracts/ethereum-1/0xe93f5dd55ec9bdabbba5ea88e4b4f3c253ee45ed/) | ReservePool | core_logic | $64,295.67 | Verified native implementation with $64,295.67 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0x0e6746...e5521b`](./contracts/ethereum-1/0x0e67460226a71df07115c1f169418dd159e5521b/) | RevenuePool | core_logic | $318.88 | Verified native implementation with $318.88 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0x4ee014...e9580b`](./contracts/ethereum-1/0x4ee014060f4816ad294857d29c22fe62b0e9580b/) | VaultCurveRenWBTC | core_logic | $10.07 | Verified native implementation with $10.07 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xf95420...c05d5b`](./contracts/ethereum-1/0xf954200fd969443b8f853b4083b71cd073c05d5b/) | StakeDAOCompounderBurner | adapter | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0x02d341...1b285c`](./contracts/ethereum-1/0x02d341ccb60faaf662bc0554d13778015d1b285c/) | Vyper_contract | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
- Match method counts: extraction_exact=344
