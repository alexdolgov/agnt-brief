...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IUniswapV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function uniswapV3SwapCallback(
        ...
        IUniswapV3Pool pool = SmartRouterHelper.getPool(factory, tokenIn, tokenOut, fee);
    ...
    )
    {
        ...
        IUniswapV3Pool pool = SmartRouterHelper.getPool(factory, params.tokenIn, params.tokenOut, params.fee);
    ...
    returns (uint256 amountOut)
    {
        ...
        amountOut = IStableSwap(swapContract).calculateSwap(uint8(i), uint8(j), params.amountIn);
    }
