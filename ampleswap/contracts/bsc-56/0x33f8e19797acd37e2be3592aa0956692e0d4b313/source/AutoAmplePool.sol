...
contract AutoAmplePool is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 ampleAtLastUserAction; // keeps track of Ample deposited at the last user action
    ...
    /**
     * @notice Constructor
     * @param _token: Ample token contract
        ...
        nonReentrant("deposit")
    {
        ...
        user.ampleAtLastUserAction = user.shares.mul(balanceOf()).div(
            totalShares
        );
     ...
     */
    function calculateHarvestAmpleRewards() external view returns (uint256) {
     ...
     */
    function calculateTotalPendingAmpleRewards()
        external
        view
        returns (uint256)
    {
