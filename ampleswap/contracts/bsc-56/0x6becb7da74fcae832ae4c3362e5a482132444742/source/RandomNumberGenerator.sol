...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public ampleSwapLottery;
     ...
     * @param _seed: seed provided by the AmpleSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == ampleSwapLottery, "Only AmpleSwapLottery");
    ...
    /**
     * @notice Set the address for the AmpleSwapLottery
     * @param _ampleSwapLottery: address of the AmpleSwap lottery
     */
    function setLotteryAddress(address _ampleSwapLottery) external onlyOwner {
        ampleSwapLottery = _ampleSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAmpleSwapLottery(ampleSwapLottery).viewCurrentLotteryId();
    }
}