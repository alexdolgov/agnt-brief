...
interface IAVotingController {
    ...
    event SetAnzenPerSec(uint256 newAnzenPerSec);

    event BroadcastResults(uint64 indexed chainId, uint128 indexed wTime, uint128 totalAnzenPerSec);
