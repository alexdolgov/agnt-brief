...
// BananaRoll helps your migrate your existing Uniswap LP tokens to ApeSwap LP ones
contract BananaRoll {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'BananaRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'BananaRoll: INSUFFICIENT_B_AMOUNT');
    }
