...
contract StarkParameters is PrimeFieldElement0 {
    ...
    uint256 constant internal PEDERSEN_BUILTIN_ROW_RATIO = 128;
    ...
    uint256 constant internal ECDSA_BUILTIN_ROW_RATIO = 8192;
    uint256 constant internal ECDSA_BUILTIN_REPETITIONS = 1;
    uint256 constant internal BITWISE__RATIO = 256;
    uint256 constant internal BITWISE__ROW_RATIO = 4096;
    uint256 constant internal EC_OP_BUILTIN_RATIO = 256;
    uint256 constant internal EC_OP_BUILTIN_ROW_RATIO = 4096;
