...
contract ArxToken is BEP20 {
    using SafeMath for uint256;
    uint256 public constant maxSupply = 20000000 ether;
...
contract MasterChef is Ownable {
    ...
    /*
      Would like to add, that the team is getting 2 Million tokens, half of which goes to treasury, other half for the team.
      This amount is tracked by the MC, and paid out over 2 years, specifically every week.
    */
    ...
    uint256 public totalAllowedTeamReward = 20000000 * (10 ** 18); // 20 Million
    ...
    function setEmissions(uint256 _mintAmtPerSec) external onlyOwner {
        arxPerSec = _mintAmtPerSec;
    }
