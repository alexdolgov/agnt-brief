...
/// @dev This would be equivalent to Yearn's SingleTokenRewardDistributor.sol (https://etherscan.io/address/0xB226c52EB411326CdB54824a88aBaFDAAfF16D3d)
///     except for bumping the Solidity version from 0.8.22 to 0.8.25
contract SingleTokenRewardDistributor is WeekStart {
    ...
    */
    constructor(
        ...
        WeekStart(IYearnBoostedStaker(_staker)) {
        staker = IYearnBoostedStaker(_staker);
