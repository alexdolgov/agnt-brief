  ...
  UUPSUpgradeable
{
  ...
  mapping(address => bool) public isAllowedToDistribute;

  modifier onlyAllowedToDistribute() {
    require(isAllowedToDistribute[msg.sender], "not allowed");
    _;
  }
  ...
  function setAllowedToDistribute(address distributor, bool allowed) external onlyOwner {
    isAllowedToDistribute[distributor] = allowed;
  }
  ...
  ) external payable onlyAllowedToDistribute {
