...
contract TokenFarmBaseMax is ITokenFarm, Constants, Initializable, ReentrancyGuardUpgradeable {
    ...
    function poolRewarders(bool _isBsmPool, bool _isNlpPool, bool _isLpPool) external view returns (address[] memory rewarders) {
