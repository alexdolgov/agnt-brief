/**
 *Submitted for verification at moonbeam.moonscan.io on 2022-10-15
*/
...
// File contracts/feelessswap/EIP712Base.sol
...
// File contracts/feelessswap/EIP712MetaTransaction.sol
...
// File contracts/feelessswap/IBeamSwapRouter.sol


pragma solidity 0.8.11;

interface IBeamSwapRouter {
...
// File contracts/feelessswap/IToken.sol
...
// File contracts/feelessswap/FeeLessSwap.sol


pragma solidity 0.8.11;
contract FeeLessSwap is Ownable, EIP712MetaTransaction("FeeLessSwap", "2") {
    ...
    IBeamSwapRouter public beamSwapRouter;
    address public feeAddress;
    uint256 public feePercent = 100; //1%

    mapping(address => bool) public tokenWhitelist;

    constructor(address router, address _wglmr) {
        beamSwapRouter = IBeamSwapRouter(router);
        WGLMR = _wglmr;
    }
    ...
    function changeRouter(address newTarget) external onlyOwner {
        ...
        beamSwapRouter = IBeamSwapRouter(newTarget);
    }
    ...
    function swap(bytes calldata swapCallData) external returns (uint256) {
        ...
        sellToken.approve(address(beamSwapRouter), amountIn);

        beamSwapRouter.swapExactTokensForETH(
            amountIn,
            amountOutMin,
            path,
            address(this),
