...
// File: contracts/earnV2/tokensV2/StrategyTokenV2.sol
...
// File: contracts/earnV2/tokensV2/BeltStrategyTokenV2Storage.sol

pragma solidity 0.6.12;


contract BeltStrategyTokenV2Storage {
...
// File: contracts/earnV2/tokensV2/BeltStrategyTokenV2.sol
...
contract AAAA is Initializable, StrategyTokenV2, BeltStrategyTokenV2Storage {
    ...
    function __BeltStrategyTokenV2_init(
        string memory name_,
        string memory symbol_,
        address _token,
        address _strategy
        ...
        __BeltStrategyTokenV2_init_unchained(_strategy);
    }

    function __BeltStrategyTokenV2_init_unchained(address _strategy) internal initializer {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        revert("This token is not transferrable.");
    }
    ...
    function depositBNB(uint256 _minShares) external payable updateDepositTime {
        require(!depositPaused, "deposit paused");
    ...
    function withdrawBNB(uint256 _shares, uint256 _minAmount) external onlyLockUpPeriodSurpassed {
        require(isWBNB, "not bnb");
        uint256 r = _withdraw(_shares, _minAmount);
        _unwrapBNB(r);
