...
// File: contracts\bsc\remedy\BELTTeamAllocationYield.sol
...
contract BELTTeamAllocationYieldStorage {
    ...
    address public halvingPoolAddress;
}
...
contract BELTTeamAllocationYield is Initializable, OwnableUpgradeable, BELTTeamAllocationYieldStorage {
    ...
    function yieldBelt() public {
        ...
        allocationPerBlock = allocationPerBlock.div(2 ** IHalvingPool(halvingPoolAddress).level());
    ...
    function setHalvingPoolAddress(address _address) public onlyOwner {
        halvingPoolAddress = _address;
    }
}