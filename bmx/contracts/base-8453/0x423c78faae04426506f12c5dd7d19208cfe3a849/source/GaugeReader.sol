...
/// @author MorphexBMX
contract GaugeReader is Ownable {
    address public pair;
    ...
    /// @notice Constructor to set initial pair and gauge addresses
    /// wBLT/BMX example:
    /// - Pair: 0xd272920B2b4eBeE362a887451EDBd6d68A76E507
    /// - Gauge: 0x1F7B5E65c09dF12742255BB8Fe26958f4B52F9bb
    constructor(address _pair, address _gauge) {
        pair = _pair;
        gauge = _gauge;
    }
