...
contract TroveManager is LiquityBase, Ownable, CheckContract, ITroveManager {
    ...
    uint public constant REDEMPTION_FEE_FLOOR = (DECIMAL_PRECISION / 1000) * 10; // 1%
    uint public constant MAX_BORROWING_FEE = (DECIMAL_PRECISION / 100) * 10; // 10%
    ...
    function liquidateTroves(uint _n) external override {
        ...
        if (totals.totalCollSurplus > 0) {
            ...
            collSurplusPool.addETH(totals.totalCollSurplus);
        }
    ...
    function _redeemCloseTrove(
        ...
        _contractsCache.collSurplusPool.addETH(_ETH);
    }
