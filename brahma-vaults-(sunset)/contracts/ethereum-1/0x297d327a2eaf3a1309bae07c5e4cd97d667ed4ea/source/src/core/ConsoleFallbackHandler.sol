 ...
 * Refer https://github.com/safe-global/safe-contracts/blob/v1.4.1/contracts/handler/CompatibilityFallbackHandler.sol
 */
contract ConsoleFallbackHandler is AddressProviderService, TokenCallbackHandler, ISignatureValidator {
     ...
     * @dev This is modified from CompatibilityFallbackHandler::isValidSignature(): https://github.com/safe-global/safe-contracts/blob/v1.4.1/contracts/handler/CompatibilityFallbackHandler.sol,
     *  to provide additional policy compliance guarantees during signature validation
