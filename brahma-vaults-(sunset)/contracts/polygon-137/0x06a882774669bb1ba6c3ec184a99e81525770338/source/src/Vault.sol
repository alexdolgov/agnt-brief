...
contract Vault is IVault, ERC4626, ReentrancyGuard {
    ...
    function beforeWithdraw(uint256 assets, uint256 shares) internal override {
        ...
        uint256 yieldExecutorAssetBalance = asset.balanceOf(address(this));
        ...
        uint256 lpAssetReturned = yieldExecutor.withdrawfromExecutor(lpOwed);
    }
    ...
    function setPerformanceFee(uint256 newPerformanceFee) public {
        ...
        uint256 prevFee = performanceFee;
        performanceFee = newPerformanceFee;

        emit UpdatedPerformanceFee(prevFee, performanceFee);
    }
