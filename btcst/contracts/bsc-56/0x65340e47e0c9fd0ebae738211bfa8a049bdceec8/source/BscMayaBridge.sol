// File: 3rdParty/@openzeppelin/contracts-upgradeable/proxy/Initializable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/GSN/ContextUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/utils/PausableUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/utils/EnumerableSetUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/utils/AddressUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/access/AccessControlUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/utils/ReentrancyGuardUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/token/ERC20/IERC20Upgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/math/SafeMathUpgradeable.sol
...
// File: 3rdParty/@openzeppelin/contracts-upgradeable/token/ERC20/SafeERC20Upgradeable.sol
...
// File: contracts-bsc/libraries/OwnableContract.sol
...
// File: contracts-bsc/libraries/UpgradeableBase.sol
...
// File: contracts-bsc/interfaces/IBEP20.sol
...
// File: contracts-bsc/interfaces/IBEP20WithMint.sol
...
// File: contracts-bsc/tau/bridge/maya/MayaBridge.sol
...
contract MayaBridge is UpgradeableBase{
    ...
    //useer=>localToken=>records-index
    ...
    function rollLeaveBack(uint256 index)public onlyBridgeExec{
        ...
        if (IS_SIDE_CHAIN && rec.status==uint256(STATUS.ARRIVED)){
            ...
            IBEP20WithMint(local.localToken).mint(address(this),rec.amount.sub(rec.bridgeFee));
        }   
        //main chain transfer back
        IERC20Upgradeable(local.localToken)
    ...
    function changeOutStatus(uint256 index,uint256 status,uint256 otherSideTxid_)public onlyBridgeExec{
        ...
        if (status == uint256(STATUS.ARRIVED)){
            if (IS_SIDE_CHAIN){
                IBEP20WithMint(local.localToken).burn(rec.amount.sub(rec.bridgeFee));
            }
    ...
    function claimOutBack(address account,uint256 index)public{
        ...
        IERC20Upgradeable(local.localToken).safeTransfer(address(account),remainAmount);
    ...
    function __bridgeOut(LocalRecord memory localSide,
        ...
        IERC20Upgradeable(localSide.localToken)
            .safeTransferFrom(address(localSide.localAddress),address(this),amount_);
        IERC20Upgradeable(localSide.localToken).safeTransfer(address(devAddr),fee);
    ...
    function __bridgeIn(LocalRecord memory localSide,
        ...
        if (IS_SIDE_CHAIN){
            ...
            IBEP20WithMint(localSide.localToken)
...
// File: contracts-bsc/tau/bridge/maya/BscMayaBridge.sol
