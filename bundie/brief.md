...
- Lifecycle: unknown (Tier 0, 69.7% below peak)
- Generated: 2026-06-19T12:41:51.216Z
- Pipeline run: v2-pipeline-2026-06-19-727228-cc10
- Chains: arbitrum, avalanche, base, optimism, scroll
- Contract surface: 76 unique implementations (158 raw deployments)
- DeFi Llama TVL: $54.46
- On-chain TVL (included contracts): n/a
- TVL by chain: n/a

## Project Description

Bundie is a yield aggregator that optimizes user deposits across multiple DeFi protocols. It uses smart accounts and routers to automate yield strategies, managing assets and executing transactions on behalf of users.

### Architecture

The protocol consists of a single product family where AccountManager contracts govern user accounts and RouterManager contracts execute transactions. They share infrastructure through a common deployer and proxy patterns, with Relayer implementations handling cross-chain or off-chain interactions.

## Contract Surface Quality

- Indexed contracts: 166; live-surface contracts included: 158 (158 live, 0 unknown).
...
- Verified implementations audited: 8/10 (80.0%)
...
| FeeManagerFactory | registry | base | n/a | 3 deployments: optimism `0x4add05...cd28fc`; base [`0x47565e...751b0e`](./contracts/base-8453/0x47565e3fcd37a2cee1401adda7c2d05df8751b0e/); arbitrum `0x56c5ff...feb6b4` | ✅ Audited |
...
|---|---|---|---|---|---|---|---|---|
| [DL audit link](https://sherlock-files.ams3.digitaloceanspaces.com/reports/2026.04.09%20-%20Final%20-%20Bundie%20Collaborative%20Audit%20Report%201775738963.pdf) | unknown | Audit | 2026-04 | fresh | Direct | contract_name | 34 | high |
...
|---|---|---|---|---:|---|
| arbitrum | [`0x044272...ef49b1`](./contracts/arbitrum-42161/0x04427241a1d5bff7d9bd2446dfe55a07d6ef49b1/) | MyOVaultComposer | core_logic | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
| base | [`0x007077...33af4f`](./contracts/base-8453/0x007077340cef49d914ae5f799659299f7f33af4f/) | wstUSRComposer | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
