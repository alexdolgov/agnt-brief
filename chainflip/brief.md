...
- Generated: 2026-05-26T18:02:34.357Z
- Pipeline run: v2-pipeline-2026-05-26-695c23-aaf8
- Chains: arbitrum, ethereum
- Contract surface: 14 unique implementations (116 raw deployments)
...
Chainflip is a cross-chain automated market maker (AMM) and lending protocol that enables native asset swaps and liquidity provision across Ethereum and Arbitrum. It uses a vault-based architecture to manage deposits and swaps, with governance and access control managed by KeyManager contracts.
...
|---|---|---:|---:|---|
| Trail of Bits | Tier 1 | 3 | 23.1% | 2023-04 |
