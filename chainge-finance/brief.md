...
- On-chain TVL (included contracts): $1,849,796.46
- TVL by chain: Ethereum $1,691,990.91 | Arbitrum $157,804.86 | Bsc $0.70

## Project Description

Chainge Finance is a multi-chain DeFi protocol offering yield farming, staking, liquidity pools, and cross-chain asset management. It aggregates various farming strategies and vaults to optimize returns for users across numerous blockchains.

### Architecture

The protocol's contracts are unified under a single product family, with core vaults and pools interacting with governance controllers and cross-chain farming adapters. Proxies like ArcProxy and TransparentUpgradeableProxy provide upgradeability, while tokens such as StakedBPT and ArcxTokenV2 represent staked positions and governance rights.
...
- ASD (verified + unaudited TVL): $1,849,796.46
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $299,353.36 | Verified native implementation with $299,353.36 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $67,704.20 | Verified native implementation with $67,704.20 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $50,756.26 | Verified native implementation with $50,756.26 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,490.00 | Verified native implementation with $4,490.00 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $898.02 | Verified native implementation with $898.02 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $35.45 | Verified native implementation with $35.45 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.64 | Verified native implementation with $31.64 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
