# Agentic Audit Brief: COTI Treasury
...
- Generated: 2026-05-23T03:57:20.028Z
...
- DeFi Llama TVL: $10,547,314.32
- On-chain TVL (included contracts): $1,850,731.57
- TVL by chain: Ethereum $1,692,274.12 | Arbitrum $158,456.75 | Bsc $0.70

## Project Description

COTI Treasury is a multi-chain yield aggregation protocol that deploys vaults, staking pools, and liquidity pools to optimize returns on deposited assets. It supports a wide range of chains and integrates with various DeFi primitives to offer automated compounding and reward distribution.

### Architecture

The COTI Treasury family encompasses all contracts, with core vaults and pools relying on governance controllers (FarmV2Controller, FarmV3Controller) and adapters (MarinateAutoCompounder) to manage strategies and rewards. Proxies like ArcProxy and TransparentUpgradeableProxy provide upgradeability for key tokens and gateways, while peripheral contracts handle cross-chain minting and bridging.
...
- ASD (verified + unaudited TVL): $1,850,731.57
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [unknown]. ASD of $1,850,731.57 represents exposure in a protocol with unknown activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $299,561.56 | Verified native implementation with $299,561.56 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,023.28 | Verified native implementation with $51,023.28 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,059.42 | Verified native implementation with $5,059.42 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,513.62 | Verified native implementation with $4,513.62 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.81 | Verified native implementation with $31.81 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
