...
contract esDSQStaking is Ownable {
    ...
    uint256 public constant maxVestingDuration = 365 days;
    ...
    function claim(address _account, address _recipient) external onlyRouter returns (uint256) {
        ...
        require(reward > 0, "esDSQStaking: No valid vested position");
    ...
    function emergencyWithdraw(address _account) external onlyRouter {
        ...
        require(bal > 0, "esDSQStaking: Insufficient balance");
    ...
    function setRouter(address _router) external onlyOwner {
        require(router == address(0), "esDSQStaking: Router is immutable");
