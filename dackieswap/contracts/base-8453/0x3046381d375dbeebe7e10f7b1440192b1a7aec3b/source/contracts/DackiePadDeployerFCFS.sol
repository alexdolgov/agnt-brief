...
import "./DackiePadInitializableFCFS.sol";

/**
 * @title DackiePadDeployer
 */
contract DackiePadDeployerFCFS is Ownable {
    ...
    function createIDO(
        ...
        bytes memory bytecode = type(DackiePadInitializableFCFS).creationCode;
        ...
        DackiePadInitializableFCFS(idoAddress).initialize(
            _raiseToken,
            _offeringToken,
            _startBlock,
            _endBlock,
