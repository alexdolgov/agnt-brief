...
import "./SmartChefByTier.sol";

contract SmartChefFactoryByTier is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(SmartChefByTier).creationCode;
        ...
        SmartChefByTier(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _idackieTier,
            _rewardPerSecond,
