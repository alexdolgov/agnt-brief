...
- Generated: 2026-05-23T22:46:47.993Z
...
- Contract surface: 906 unique implementations (1294 raw deployments)
- DeFi Llama TVL: $4,090,441.00
- On-chain TVL (included contracts): $5,929,680.86
- TVL by chain: Ethereum $5,768,663.05 | Arbitrum $161,017.12 | Bsc $0.70

## Project Description

Dango is a multi-chain DeFi protocol offering a cross-chain bridge for asset transfers and a perpetuals trading platform for leveraged derivatives.

### Architecture

Dango Bridge and Dango Perps share proxy infrastructure (TransparentUpgradeableProxy) and token contracts like L2TBTC, which is used in both families. The bridge facilitates cross-chain movement of assets that can be utilized within the perps ecosystem.

## Audit Coverage Summary

- Verified implementations audited: 0/187 (0.0%)
- Verified + Unaudited implementations: 187
- Verified by bytecode match: 0
- Unverified implementations: 719
- Unique implementations: 906
- Raw deployments: 1294
- Audits discovered: 1
- Scoreable audits (matched contracts): 0
- ASD (verified + unaudited TVL): $5,929,680.86
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 1 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [unknown]. ASD of $5,929,680.86 represents exposure in a protocol with unknown activity.
...
| ProxyAdmin | governance | arbitrum | 3 deployments: ethereum `0x613942...09e601`; ethereum `0x947303...361fe6`; arbitrum [`0x02612d...8a3db3`](./contracts/arbitrum-42161/0x02612d20cc087670a959bb12ca3c5fd56c8a3db3/) | ⚠️ Unaudited |
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $302,925.06 | Verified native implementation with $302,925.06 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,072.01 | Verified native implementation with $52,072.01 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,053.88 | Verified native implementation with $5,053.88 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,606.39 | Verified native implementation with $4,606.39 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $921.30 | Verified native implementation with $921.30 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.37 | Verified native implementation with $36.37 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.46 | Verified native implementation with $32.46 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
