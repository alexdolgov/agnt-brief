...
// ============================================================
// FILE: contracts/tokens/HadronToken.sol
// ============================================================

// Copyright Tether Hadron Limited, 2024. All rights reserved.
    ...
    WithBlockedList
{
    ...
    function destroyBlockedFunds(address _blockedUser) public onlyOwner {
        require(isBlocked[_blockedUser], "Token: user is not blocked");
...
// ============================================================
// FILE: contracts/tokens/WithBlockedList.sol
// ============================================================
...
contract WithBlockedList is OwnableUpgradeable {
    ...
    function addMultipleToBlockedList(
        address[] calldata _users
    ) public onlyOwner {
        for (uint256 i = 0; i < _users.length; i++) _addToBlockedList(_users[i]);
    }

    function removeMultipleFromBlockedList(
        address[] calldata _users
    ) public onlyOwner {
        for (uint256 i = 0; i < _users.length; i++) _removeFromBlockedList(_users[i]);
    }

    function _addToBlockedList(address _user) private {
        isBlocked[_user] = true;
        emit BlockPlaced(_user);
    }

    function _removeFromBlockedList(address _user) private{
