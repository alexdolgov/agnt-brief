...
// ============================================================
// FILE: project:/contracts/irbac.sol
// ============================================================
...
// ============================================================
// FILE: project:/contracts/ITransferProvider.sol
// ============================================================
...
// ============================================================
// FILE: project:/contracts/vnxc.sol
// ============================================================

/**
 * VNX Stablecoin Smart Contract
...
contract VNXCToken is Initializable, OwnableUpgradeable, ERC20PausableUpgradeable, ERC20PermitUpgradeable {
    ...
    event CurrencyNameUpdated(string indexed newCurrencyName);
     ...
     * @param _initTransferProvider Transfer provider address
    ...
    uint8 _minterRoleId, address _rbac,
...
/**
    ...
    /**
     * @dev allows a minter to burn tokens
    ...
    */
     ...
     */
    function updateCurrencyName (string memory _newCurrencyName) public onlyOwner
    {
        currency = _newCurrencyName;
        emit CurrencyNameUpdated(_newCurrencyName);
    }
    ...
    {
        require(_newRbacAddress != address(0), "RBAC address cannot be zero");
