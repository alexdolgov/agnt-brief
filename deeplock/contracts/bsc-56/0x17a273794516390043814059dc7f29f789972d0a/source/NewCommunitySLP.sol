...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1048bDE986E1Cfa5f2ee02934F9E963ffd170C4A;
...
contract NewCommunitySLP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6C2475Fd1637CD6aA775b20e0d33EF22B3C82620;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "New Community SLP";
    string private _symbol = "NSLP";
    ...
    uint256 private numTokensSellToAddToLiquidity = 410000000 * 10**18;
