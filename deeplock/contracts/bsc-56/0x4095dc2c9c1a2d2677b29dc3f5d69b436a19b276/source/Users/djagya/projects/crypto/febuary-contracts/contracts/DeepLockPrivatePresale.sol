...
contract DeepLockPrivatePresale is Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    uint256 public startTime;
    uint256 public saleDuration = 12 hours;

    uint256 public rate;
    uint256 public cap = 80000 ether;
    uint256 public tokensSold;

    uint256 public maxSell = 25 ether;
    uint256 public minSell = 1 ether;
    ...
    function calculatePurchaseAmount(uint purchaseAmountWei) public view returns (uint256) {
        return purchaseAmountWei.mul(rate);
    }
