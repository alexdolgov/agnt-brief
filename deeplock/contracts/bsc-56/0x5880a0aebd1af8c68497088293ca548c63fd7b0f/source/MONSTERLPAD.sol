...
contract MONSTERLPAD is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 100 * 10**6 * 10**9; // Max Transaction: 100 Million 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 200 * 10**6 * 10**9; // Max Wallet: 200 Million 

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "MONSTERLPAD";
    string private _symbol = "MLPAD";
