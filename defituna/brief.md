# Agentic Audit Brief: DefiTuna

⚠️ Lifecycle status: DECLINING - TVL dropped 35.0% over 90 days
...
- Generated: 2026-05-23T23:48:26.295Z
...
- DeFi Llama TVL: $4,057,321.00
- On-chain TVL (included contracts): $1,857,052.94
- TVL by chain: Ethereum $1,695,796.17 | Arbitrum $161,256.08 | Bsc $0.70

## Project Description

DefiTuna is a multi-chain DeFi protocol offering lending, liquidity management, and automated yield farming. It aggregates various pools, vaults, and staking mechanisms to optimize returns for users across numerous blockchains.

### Architecture

The lending family relies on a shared set of governance controllers (FarmV2Controller, FarmV3Controller) and proxy contracts (ArcProxy, BerryMaster, TransparentUpgradeableProxy) to manage upgrades and access control. Multiple pool and vault contracts interact with common token standards (e.g., MantaMintableERC20) and adapters (MarinateAutoCompounder) to facilitate cross-chain yield strategies.
...
- ASD (verified + unaudited TVL): $1,857,052.94
- Latest audit: 2025-09 (fresh)
- Staleness: 3 fresh, 6 aging, 0 stale, 2 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [declining]. ASD of $1,857,052.94 represents exposure in a protocol with declining activity.
...
| [torii-tellor-report-02-2025.pdf](https://github.com/Torii-Security/audits/blob/main/cosmos/torii-tellor-report-02-2025.pdf) | Torii | Audit | 2025 | aging | Direct | n/a | 0 | n/a |
| [pregame-report-final.pdf](https://github.com/Torii-Security/audits/blob/main/solana/pregame-report-final.pdf) | Torii Security | Audit | 2025-04 | aging | Direct | n/a | 0 | n/a |
| [rtr-staking-lottery.pdf](https://github.com/Torii-Security/audits/blob/main/solana/rtr-staking-lottery.pdf) | Torii Security | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
| [torii-follows-report.pdf](https://github.com/Torii-Security/audits/blob/main/solana/torii-follows-report.pdf) | Torii Security | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $303,136.34 | Verified native implementation with $303,136.34 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $69,589.86 | Verified native implementation with $69,589.86 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,169.89 | Verified native implementation with $52,169.89 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,033.51 | Verified native implementation with $5,033.51 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,615.05 | Verified native implementation with $4,615.05 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $923.03 | Verified native implementation with $923.03 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.44 | Verified native implementation with $36.44 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.52 | Verified native implementation with $32.52 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| bsc | [`0x297b04...5a3744`](./contracts/bsc-56/0x297b04683d0d8f230ec03e9f815cd47b065a3744/) | BOGStaking | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
- [2652] OShield-fusionamm-report-23-July-2025.md
- [2653] sec3-fusionamm-report-23-July-2025.pdf
- [2654] torii-defituna-report.pdf
...
- [2658] {% embed url="<>" %}
- [2659] torii-tellor-report-02-2025.pdf
- [2660] pregame-report-final.pdf
- [2661] rtr-staking-lottery.pdf
- [2662] torii-follows-report.pdf
