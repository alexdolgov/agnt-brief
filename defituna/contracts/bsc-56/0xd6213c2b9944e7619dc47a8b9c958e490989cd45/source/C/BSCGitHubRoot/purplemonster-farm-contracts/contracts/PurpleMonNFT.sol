...
contract PurpleMonNFT is ERC721URIStorage, IERC721Enumerable, Ownable
{
      
    uint256 priceDenominator = 100;
    uint256 _commonSupply = 10000;
    uint256 _rareSupply = 4000;
    uint256 _ultraRareSupply = 1250;        
    ...
    constructor(address payable feeAddress)  ERC721("TestPM","TPMNFT") {               
        
        _paymentAddress = feeAddress;
        
        _tokenIdsByRarity[CommonRarity] = 1;
        _tokenIdsByRarity[RareRarity] = 10001;
        _tokenIdsByRarity[UltraRareRarity] = 14001;
        
        _tokenSuppliesByRarity[CommonRarity]  = 10000;
        _tokenSuppliesByRarity[RareRarity]  = 4000;
        _tokenSuppliesByRarity[UltraRareRarity]  = 1250;


        priceListByRarity[CommonRarity] = 1 / 2 * 10 ** 18; // 0.5 BNB
        priceListByRarity[RareRarity] =   1 * 10 ** 18; // 1 BNB
        priceListByRarity[UltraRareRarity] = 2 * 10 ** 18; // 2 BNB
    }
