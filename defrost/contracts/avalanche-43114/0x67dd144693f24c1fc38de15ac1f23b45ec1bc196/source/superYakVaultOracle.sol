...
// File: contracts/interface/IYak.sol
...
// File: contracts/defrostOracle/superYakVaultOracle.sol
...
contract superYakVaultOracle is chainLinkOracle {
    ...
    function getYakPrice(address token)public view returns (bool,uint256){
        uint256 ratio = IYak(address(token)).getDepositTokensForShares(1e18);
