...
// ============================================================
// FILE: lib/openzeppelin-contracts-upgradeable/contracts/math/SafeMathUpgradeable.sol
// ============================================================
...
// ============================================================
// FILE: lib/openzeppelin-contracts-upgradeable/contracts/proxy/Initializable.sol
// ============================================================
...
// ============================================================
// FILE: lib/openzeppelin-contracts-upgradeable/contracts/utils/EnumerableSetUpgradeable.sol
// ============================================================
    ...
    StakedAvaxStorage
{
    ...
    event ProtocolRewardShareUpdated(uint oldProtocolRewardShare, uint newProtocolRewardShare);
    ...
    function accrueRewards() external payable nonReentrant {
        ...
        require(
            protocolRewardShare == 0 || protocolRewardShareRecipient != address(0),
        ...
        totalPooledAvax = totalPooledAvax.add(userRewardAmount);
        ...
        if (protocolRewardAmount > 0) {
            (bool success, ) = protocolRewardShareRecipient.call{ value: protocolRewardAmount}("");
    ...
    /**
     * @notice Set the address where the protocol reward share is sent to
     * @param newProtocolRewardShareRecipient Address of the new protocol reward share recipient
     */
    function setProtocolRewardShareRecipient(address payable newProtocolRewardShareRecipient) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "DEFAULT_ADMIN_ROLE");

        if (newProtocolRewardShareRecipient == address(0)) {
            require(protocolRewardShare == 0, "NON_ZERO_PROTOCOL_REWARD_SHARE");
        }

        emit ProtocolRewardShareRecipientUpdated(protocolRewardShareRecipient, newProtocolRewardShareRecipient);
        protocolRewardShareRecipient = newProtocolRewardShareRecipient;
    }

    /**
     * @notice Set the protocol reward share percentage
     * @param newProtocolRewardShare New protocol reward share percentage
     */
    function setProtocolRewardShare(uint newProtocolRewardShare) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "DEFAULT_ADMIN_ROLE");
        require(newProtocolRewardShare <= 1e18, "PROTOCOL_REWARD_SHARE_TOO_LARGE");

        if (newProtocolRewardShare != 0) {
            require(protocolRewardShareRecipient != address(0), "PROTOCOL_REWARD_SHARE_RECIPIENT_NOT_SET");
        }

        emit ProtocolRewardShareUpdated(protocolRewardShare, newProtocolRewardShare);
