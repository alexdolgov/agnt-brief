...
abstract contract OrderbookStorage is Admin {
    ...
    struct Order {
        ...
        address bToken;
        int256 bAmount;
        int256[] orderParams; // 0:trigerPrice, 1:isAboveTrigerPrice, 2:isIndexPrice, 3:isCloseOnly
    ...
    // Associated TP/SL orders
    // If one is executed or canceled, the other is canceled
    mapping (address => mapping (uint256 => uint256)) public associatedOrder;
