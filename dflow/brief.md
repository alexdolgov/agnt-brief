# Agentic Audit Brief: DFlow

## Project Overview

- Project: DFlow (`dflow`)
- Website: [https://dflow.net/](https://dflow.net/)
- Lifecycle: active (Tier 0, 33.8% below peak)
- Generated: 2026-05-24T20:13:07.028Z
...
- DeFi Llama TVL: $1,605,882.00
- On-chain TVL (included contracts): $1,854,739.17
- TVL by chain: Ethereum $1,694,499.18 | Arbitrum $160,239.29 | Bsc $0.70

## Project Description

DFlow is a multi-chain DeFi aggregator that provides liquidity, yield farming, and staking services. It integrates various protocols and tokens across numerous blockchains to optimize user returns.

### Architecture

The DFlow Aggregator family relies on shared governance controllers (FarmV2Controller, FarmV3Controller) and proxy patterns (ArcProxy, BerryMaster) to manage upgrades and access control. Core vaults and pools interact with various reward and staking contracts, while cross-chain functionality is enabled through bridge-aware tokens and adapters.
...
- ASD (verified + unaudited TVL): $1,854,739.17
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $301,932.45 | Verified native implementation with $301,932.45 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,753.42 | Verified native implementation with $51,753.42 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,940.42 | Verified native implementation with $4,940.42 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,578.21 | Verified native implementation with $4,578.21 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $915.66 | Verified native implementation with $915.66 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.15 | Verified native implementation with $36.15 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.25 | Verified native implementation with $32.25 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
