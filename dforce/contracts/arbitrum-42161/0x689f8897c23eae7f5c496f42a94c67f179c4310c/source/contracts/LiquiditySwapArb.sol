...
import "./price/CurvePriceArb.sol";
import "./order/PulsarLongTermOrders.sol";

/**
 * @title dForce's Liquidity Swap on Arbitrum
 * @author dForce
 */
contract LiquiditySwapArb is
    Initializable,
    Ownable,
    CurvePriceArb,
    PulsarLongTermOrders
{
    ...
    constructor(
        ...
        public
        CurvePriceArb(_curvePool, _chainlinkAggregator)
        PulsarLongTermOrders(_tokenOut, _tokenIn, _pulsarRouter)
        initializer
    {
        __Ownable_init();
