...
interface IiMUSXInterestRateModel {
...
// ============================================================
// FILE: contracts/MiniPool/iMSDMiniPool.sol
// ============================================================
...
contract iMUSX is iMSDMiniPool {
    function initialize(
        address _underlyingToken,
        string memory _name,
        string memory _symbol,
        ...
        super.initialize(
            ...
            _msdController,
            _collateral,
            _originationFeeRecipient,
            _originationFeeRatio
        );
        IiMUSXInterestRateModel(address(_interestRateModel)).enable();
    }

    function _enablesUSX() external onlyOwner {
        IiMUSXInterestRateModel(address(interestRateModel)).enable();
    }
    ...
    function _updateInterest() internal virtual override {
        ...
        if (block.number != accrualBlockNumber) {
            ...
            // Update and get the current borrow interest rate.
            _vars.borrowRate = IiMUSXInterestRateModel(address(interestRateModel)).updateAccrualBorrowRate(
                _vars.currentCash,
                _vars.totalBorrows,
                _vars.totalReserves
            );
    ...
    /**
     * @notice Check whether is a iMUSX contract.
     */
    function isiMUSX() external pure virtual returns (bool) {
        return true;
    }
}
