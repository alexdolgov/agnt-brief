...
contract AlgebraAdapter is IDODOAdapter, IAlgebraSwapCallback, InitializableOwnable {
    ...
    address public immutable _V3_DEPLOYER_;
    ...
    function algebraSwapCallback(
        ...
        // verifyCallback
        address poolAddress = PoolAddress.computeAddress(_V3_DEPLOYER_, PoolAddress.getPoolKey(tokenIn, tokenOut));
