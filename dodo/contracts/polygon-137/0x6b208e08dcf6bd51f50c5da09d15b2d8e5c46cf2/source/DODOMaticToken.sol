...
// File: contracts/DODOToken/DODOMaticToken.sol



/**
 * @title DODO Token Mapped on Matic
 * @author DODO Breeder
 */
contract DODOMaticToken is InitializableOwnable {
    ...
    function redeem(uint256 value, address redeemToEthAccount) external {
        require(balances[msg.sender] >= value, "DODOMaticToken: NOT_ENOUGH");
