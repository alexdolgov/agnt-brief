...
import {ICurvePoolStableSwapNG} from "../interfaces/ICurvePoolStableSwapNG.sol";

/**
 * @title  DexV2AggregatorModuleMk3 (UniV2/SushiV2 + Curve3 direct stable path + Chainlink guard)
...
/**
 * @title  DexV2AggregatorModuleMk3
 ...
 */
contract DexV2AggregatorModuleMk3 is Ownable, ReentrancyGuard {
