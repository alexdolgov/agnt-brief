...
library Errors {
    ...
    error UserMaxOILimited(bytes32 symbol, bool isCrossMargin, bool isLong);
    ...
    // swap
    error RebalanceSwapRequestNotExists();
    error RepeatPrepareRebalanceSwap();
    error RebalanceSwapNotPrepared();
    error SwapLiabilityAccountInvalid();
    error SwapLiabilityAmountInvalid();
    error SwapLiabilityCollateralAmountInvalid();
    error CancelSwapLiabilityCollateralInvalid();
}
