...
- Generated: 2026-05-25T02:26:33.646Z
- Pipeline run: v2-pipeline-2026-05-22-eff36e-2ebb
- Chains: bsc
- Contract surface: 22 unique implementations (130 raw deployments)
- DeFi Llama TVL: $1,266,443.20
- On-chain TVL (included contracts): $59,039.41
- TVL by chain: Bsc $59,039.41

## Project Description

Ellipsis Finance is a decentralized exchange (DEX) on BSC that enables low-slippage stablecoin and pegged-asset swaps. It uses a Curve-like AMM model and includes token locking, fee distribution, and incentive voting mechanisms to align stakeholder interests.
...
- [3133] The Ellipsis codebase is based on code from Curve Finance; [their audits can be found here]().&#x20;
