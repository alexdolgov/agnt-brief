...
contract TvlGuru_v21
{
	...
	*/
	function initialize(address[3] memory uwl, uint8 d) external {
        require(DAO==msg.sender||DAO==address(0),"reinit");
        DAO=msg.sender;
        setUWLD(uwl, d);
    }
	...
	//GLP pools
	//Find USD worth of a GLP token via its vault
