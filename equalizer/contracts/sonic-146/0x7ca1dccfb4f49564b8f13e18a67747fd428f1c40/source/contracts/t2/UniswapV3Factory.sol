...
*/
    ...
    constructor() {
        ...
        enabledTickSpacing[1] = true; emit tickSpacingEnabled(1, true);
        enabledTickSpacing[8] = true; emit tickSpacingEnabled(8, true);
        enabledTickSpacing[64] = true; emit tickSpacingEnabled(64, true);
        //enabledTickSpacing[256] = true; emit tickSpacingEnabled(256, true);
