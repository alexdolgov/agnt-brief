...
// ============================================================
// FILE: @shared/lib-contracts-v0.8/contracts/Dependencies/AddressLib.sol
// ============================================================
...
// ============================================================
// FILE: @shared/lib-contracts-v0.8/contracts/Dependencies/TransferHelper.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Dependencies/EqbConstants.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Dependencies/openzeppelin/contracts/access/AccessControlUpgradeable.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Dependencies/openzeppelin/contracts/utils/introspection/ERC165Upgradeable.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Dependencies/openzeppelin/contracts/utils/PausableUpgradeable.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Dependencies/openzeppelin/contracts/utils/ReentrancyGuardUpgradeable.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IBaseRewardPoolV2.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IDepositTokenV2.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IEqbConfig.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IEqbMinter.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IPendleBooster.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IPendleDepositor.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IPendleProxy.sol
// ============================================================
...
// ============================================================
// FILE: contracts/Interfaces/IXEqbToken.sol
// ============================================================
...
// ============================================================
// FILE: contracts/PendleBoosterBaseUpg.sol
// ============================================================
...
import "./Dependencies/openzeppelin/contracts/access/AccessControlUpgradeable.sol";
import "./Dependencies/openzeppelin/contracts/utils/PausableUpgradeable.sol";
    ...
    PausableUpgradeable
{
    ...
    function pause() external onlyRole(EqbConstants.PAUSER_ROLE) {
        _pause();
    }

    function unpause() external onlyRole(EqbConstants.PAUSER_ROLE) {
        _unpause();
    }
    ...
    function addPoolBeacon(address _market) external whenNotPaused onlyOwner {
    ...
    // shutdown pool
    function shutdownPool(uint256 _pid) public whenNotPaused onlyOwner {
    ...
    function shutdownSystem() external whenNotPaused onlyOwner {
        isShutdown = true;
    ...
    function depositAll(uint256 _pid, bool _stake) external whenNotPaused {
    ...
    function earmarkRewards(uint256 _pid) external whenNotPaused nonReentrant {
        require(!isShutdown, "shutdown");
        PoolInfo memory pool = poolInfo[_pid];
        require(pool.shutdown == false, "pool is closed");
...
// ============================================================
// FILE: contracts/PendleBoosterSidechain.sol
// ============================================================
