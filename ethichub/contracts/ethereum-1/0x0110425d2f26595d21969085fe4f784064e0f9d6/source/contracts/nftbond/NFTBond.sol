...
abstract contract NFTBond is NFT, CollateralizedBondGranter, LockedBondGranter, LiquidityRequester, PausableUpgradeable {
    ...
    event BondIssued(address buyer, address beneficiary, uint256 tokenId, uint256 mintingDate, uint256 maturity, uint256 principal, uint256 interest, string imageCID, string bondTokenURI);
    event BondRedeemed(address redeemer, address beneficiary, uint256 tokenId, uint256 redeemDate, uint256 withdrawn);
