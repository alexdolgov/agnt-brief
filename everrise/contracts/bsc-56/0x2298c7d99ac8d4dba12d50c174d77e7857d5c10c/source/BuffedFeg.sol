...
contract BuffedFeg is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9B6A58ecD9308a613b2971ace77B777A9990e07B); // Marketing Address
        
    address payable public teamAddress =
        payable(0x4aFF6D3AADd4BA0a9aB185b7CDE2A36ddF915E30); // Team Address
    ...
    string private constant _name = "BuffedFeg";
    string private constant _symbol = "BFEG";
