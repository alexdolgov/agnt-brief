...
contract ramx is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "ramx";
    string private constant _symbol = "ramx";
    ...
    address payable constant private _marketingAddress = payable(0x3e764bDCb588b5ff724Fc7aad8B36ef15c484f95);
    address payable constant private _buybackAddress = payable(0x76F148D70bBffEb9625B2358c50A5E72138c3261);
    address payable constant private _projectMaintainence = payable(0x60d3f623b813a6B28bFa023FE807FaAadAD19A5E);
    ...
    address public _oraclePriceFeed = 0xBab20DbCA7b8A89eFA6e563295562724737Bd4A9;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//ramx
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//ramx
