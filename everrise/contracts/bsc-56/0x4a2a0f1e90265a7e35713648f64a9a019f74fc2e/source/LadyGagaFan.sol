...
contract LadyGagaFan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lady Gaga Fan";
    string private constant _symbol = "Lady Gaga Fan";
