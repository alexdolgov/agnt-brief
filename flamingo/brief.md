...
⚠️ Lifecycle status: DEAD - TVL dropped 34.8% over 90 days
...
- Generated: 2026-05-24T13:09:00.891Z
...
- DeFi Llama TVL: $2,268,171.00
- On-chain TVL (included contracts): $1,856,644.75
- TVL by chain: Ethereum $1,695,163.96 | Arbitrum $161,480.09 | Bsc $0.70

## Project Description

Flamingo Finance is a multi-chain DeFi protocol offering yield farming, staking, and liquidity provision. It aggregates various vaults, pools, and reward mechanisms to optimize returns for users across numerous blockchains.

### Architecture

All contracts belong to a single product family, Flamingo Finance, sharing common governance controllers (FarmV2Controller, FarmV3Controller) and reward distribution infrastructure (MasterChef, BerryMaster). Vaults and pools interact with tokens like ArcProxy and BlackPoolToken, while cross-chain deployments are managed via AutoFarmV2_CrossChain and proxies.
...
- ASD (verified + unaudited TVL): $1,856,644.75
- Latest audit: 2020-12 (stale)
- Staleness: 0 fresh, 0 aging, 6 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [dead]. ASD of $1,856,644.75 represents exposure in a protocol with dead activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $302,559.19 | Verified native implementation with $302,559.19 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $69,712.26 | Verified native implementation with $69,712.26 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,261.65 | Verified native implementation with $52,261.65 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,978.46 | Verified native implementation with $4,978.46 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,623.17 | Verified native implementation with $4,623.17 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $924.65 | Verified native implementation with $924.65 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.50 | Verified native implementation with $36.50 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.57 | Verified native implementation with $32.57 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
