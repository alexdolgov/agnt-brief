...
interface ISequencerInterface is IERC1363Receiver {
     ...
     */
    function redelegate(uint256 amount, address srcValidator, address dstValidator) external;
     ...
     */
    function vote(uint64 proposalId, uint32 option, string memory metadata) external;
     ...
     */
    function handleMigration(address owner, uint256 amount, uint256 vestingPeriod, address validator) external;
