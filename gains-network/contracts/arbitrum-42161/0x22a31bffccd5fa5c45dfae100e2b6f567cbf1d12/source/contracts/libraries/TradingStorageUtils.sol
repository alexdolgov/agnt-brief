...
library TradingStorageUtils {
    ...
    function storeTrade(
        ...
        if (_trade.tradeType == ITradingStorage.TradeType.TRADE) TradingCommonUtils.updateOiTrade(_trade, true);
    ...
    function closeTrade(ITradingStorage.Id memory _tradeId) external {
        ...
        if (t.tradeType == ITradingStorage.TradeType.TRADE) TradingCommonUtils.updateOiTrade(t, false);
