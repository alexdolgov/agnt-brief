...
library PriceAggregatorUtils {
    ...
    function getPrice(
        ...
        TradingCommonUtils.updateFeeTierPoints(_collateralIndex, _trader, _pairIndex, 0);
        uint256 linkFeePerNode = getLinkFee(_collateralIndex, _trader, _pairIndex, _positionSizeCollateral) /
            s.oracles.length;
