...
// File: contracts\GFarmPoolV5.sol
...
contract GFarmPoolV5{

    // Constants
    bytes32 public constant MINTER_ROLE = 0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6;
    TokenInterfaceV5 public constant token = TokenInterfaceV5(0x7075cAB6bCCA06613e2d071bd918D1a0241379E2);
    TokenInterfaceV5 public constant quick = TokenInterfaceV5(0xf28164A485B0B2C90639E47b0f377b4a438a16B1);
    LpInterfaceV5 public constant lp = LpInterfaceV5(0x0c7AD41d3E0DBC1CFdcdD717AfB0A72A65cDf069); // GFARM2/DAI
    ...
    function setQuickStakingContract(QuickStakingContractInterfaceV5 _quickStakingContract) external onlyGov{
        require(address(_quickStakingContract) != address(0), "ADDRESS_0");
        require(address(quickStakingContract) == address(0), "ALREADY_SET");
        quickStakingContract = _quickStakingContract;
        emit AddressUpdated("quickStakingContract", address(_quickStakingContract));
    }
