...
// File: contracts\GFarm2Token.sol
    ...
    ContextMixin
{
    ...
    constructor(
        ...
        address trading // trading contract
    ) public ERC20Capped(100000*10**18) ERC20(name_, symbol_) {
        ...
        _setupRole(BURNER_ROLE, trading);
    }
    ...
    // Mint GFARM tokens (GFarmTradingV3 contract)
    function mint(address to, uint amount) external only(MINTER_ROLE){
        _mint(to, amount);
    }

    // Burn GFARM tokens (GFarmTradingV3 contract)
