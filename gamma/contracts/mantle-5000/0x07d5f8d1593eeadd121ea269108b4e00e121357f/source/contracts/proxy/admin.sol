...
contract Admin {
    ...
    /// @param _hypervisor Hypervisor Address
    /// @param newVeNFTTokenId New veNFT TokenId
    function transferVeNFTTokenId(address _hypervisor, uint256 newVeNFTTokenId) external onlyAdmin {
        IHypervisor(_hypervisor).transferVeNFTTokenId(newVeNFTTokenId);
    }
