...
import {UnilaunchVolatilityDynamicFeeLimitOrderHook} from "../LimitOrderBook/hooks/UnilaunchVolatilityDynamicFeeLimitOrderHook.sol";
import {VolatilityOracle} from "../LimitOrderBook/libraries/VolatilityOracle.sol";

contract UnilaunchMultiPositionManager is IMultiPositionManager, ERC20, ReentrancyGuard, Ownable, SafeCallback, Multicall {
    ...
    function _enforceRebalanceParams(IMultiPositionManager.RebalanceParams calldata params, bool isSwap) private view {
        ...
        UnilaunchMultiPositionFactory factoryContract = UnilaunchMultiPositionFactory(unilaunchFactory);
        ...
        if (maxDelta != 0) {
            ...
            VolatilityOracle oracle = UnilaunchVolatilityDynamicFeeLimitOrderHook(hookAddress).volatilityOracle();
