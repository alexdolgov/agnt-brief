...
/**
 * @title UnilaunchLensRatioUtils
 * @notice Library for ratio management and position calculations for UnilaunchSimpleLens
 * @dev Adapted from SimpleLensRatioUtils - removes withdrawal/compound related functions
 */
library UnilaunchLensRatioUtils {
     ...
     * @param manager The UnilaunchMultiPositionManager contract
     ...
     */
    function getAmountsForDeposit(UnilaunchMultiPositionManager manager, bool isToken0, uint256 amount)
        external
        view
        returns (uint256)
    {
     ...
     */
    function calculateWeightsFromPositions(UnilaunchMultiPositionManager manager, uint160 sqrtPriceX96)
        public
        view
     ...
     */
    function getPositionStats(UnilaunchMultiPositionManager manager) external view returns (PositionStats[] memory stats) {
