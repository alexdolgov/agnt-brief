 ...
 */
library LaunchpadRebalanceLogic {
    ...
    function processRebalanceInCallback(
        ...
        ) = abi.decode(params, (IMultiPositionManager.Range[], uint128[], int24, uint256[2][], uint256[2][], IMultiPositionManager.RebalanceParams));
        ...
        IMultiPositionManager.Range[] memory ranges =
            new IMultiPositionManager.Range[](baseLength + 2);
