...
library DepositLogic {
     ...
     * @param directDeposit Whether to directly add liquidity to positions
    ...
    function getDirectDepositAmounts(
        ...
        // Validate inMin array size (always basePositions + 2 limit positions)
        if (inMin.length != s.basePositionsLength + 2) revert InvalidInMinLength();
