...
library SwapQuoteOps {
    ...
    function isBetter(
        ...
        return isBetter(quote1, swapTask, quote2, quote2.gasUsage, gasPriceUnderlying);
    }
    ...
    function trim(SwapQuote[] memory quotes) internal pure returns (SwapQuote[] memory trimmed) {
    ...
    function toRouterResult(SwapQuote memory quote) internal pure returns (RouterResult memory result) {
        if (quote.found) {
