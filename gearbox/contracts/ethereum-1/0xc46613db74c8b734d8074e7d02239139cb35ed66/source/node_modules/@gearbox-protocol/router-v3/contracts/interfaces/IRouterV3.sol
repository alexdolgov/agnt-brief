...
interface IRouterV3 is IGasPricer, IVersion {
    ...
    function findAllSwaps(SwapTask memory swapTask, uint256 slippage) external returns (RouterResult[] memory);
    ...
    /// @param expectedBalances Override for balances on the account
    /// @param leftoverBalances Balances to keep on account after closing
    /// @param connectors Addresses of "connectors" - internidiatery tokens which're used for swap operations
    /// @param slippage Slippage in PERCENTAGE_FORMAT
