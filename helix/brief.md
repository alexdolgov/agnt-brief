...
⚠️ Lifecycle status: DECLINING - TVL dropped 84.7% over 90 days
...
- Generated: 2026-05-29T19:06:25.882Z
...
HelixFactory creates and manages deal tokens (HelixDealTokens) and deal implementations (HelixDealImplementationRepository), while HelixUniqueIdentity provides identity verification and HelixConfig supplies configuration parameters across the protocol.
...
- [9445] 0001-dataset-cache-manifest-and-runtime-adapters.md
- [9446] 0002-metadata-manifest-and-pull-command.md
- [9447] 0003-bun-package-manager-node-runtime.md
