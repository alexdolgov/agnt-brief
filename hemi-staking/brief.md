...
- Generated: 2026-05-26T16:24:47.058Z
- Pipeline run: v2-pipeline-2026-05-26-695c23-aaf8
- Chains: bsc, ethereum, optimism, swellchain
- Contract surface: 141 unique implementations (236 raw deployments)
- DeFi Llama TVL: $36,924,885.97
- On-chain TVL (included contracts): $16,466,868.70
- TVL by chain: Ethereum $16,416,017.69 | Optimism $50,851.02

## Project Description

Hemi Staking is a DeFi protocol that enables users to stake and farm tokens across multiple chains, including Ethereum, Optimism, BSC, and Swellchain. It provides token minting, debt token management, and reward vaults, integrated with cross-chain messaging via LayerZero and Optimism's OP Stack infrastructure.
...
- Verified implementations audited: 1/63 (1.6%)
...
- ASD (verified + unaudited TVL): $16,466,868.70
...
| optimism | [`0x420000...00001a`](./contracts/optimism-10/0x420000000000000000000000000000000000001a/) | L1FeeVault | core_logic | $22,205.00 | Verified native implementation with $22,205.00 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| optimism | [`0x420000...000011`](./contracts/optimism-10/0x4200000000000000000000000000000000000011/) | SequencerFeeVault | core_logic | $17,372.92 | Verified native implementation with $17,372.92 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| optimism | [`0x420000...000019`](./contracts/optimism-10/0x4200000000000000000000000000000000000019/) | BaseFeeVault | core_logic | $10,981.32 | Verified native implementation with $10,981.32 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| optimism | [`0x420000...000017`](./contracts/optimism-10/0x4200000000000000000000000000000000000017/) | OptimismMintableERC721Factory | registry | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
- [3963] Audit_Report_HEMI-VOT_FINAL_21.pdf
