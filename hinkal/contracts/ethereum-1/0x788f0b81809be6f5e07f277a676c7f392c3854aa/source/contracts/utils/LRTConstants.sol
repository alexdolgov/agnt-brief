...
library LRTConstants {
    ...
    bytes32 public constant KELP_ACCOUNTING_ORACLE = keccak256("KELP_ACCOUNTING_ORACLE");
    ...
    function kelpAccountingOracle(ILRTConfig config) internal view returns (address) {
        return config.getContract(KELP_ACCOUNTING_ORACLE);
    }
