...
import "../OFTCoreV2L3USD.sol";
import "./IOFTWithFee.sol";
import "./Fee.sol";
import "@openzeppelin/contracts/utils/introspection/ERC165.sol";

abstract contract BaseOFTWithFeeL3USD is OFTCoreV2L3USD, Fee, ERC165, IOFTWithFee {

    constructor(uint8 _sharedDecimals, address _lzEndpoint) OFTCoreV2L3USD(_sharedDecimals, _lzEndpoint) {
    }
    ...
    ************************************************************************/
    ...
    function _transferFrom(address _from, address _to, uint _amount) internal virtual override (Fee, OFTCoreV2L3USD) returns (uint);
