...
interface ERC20Full is IERC20, IERC20Metadata {}
...
interface ITellerWithMultiAssetSupport {
    ...
    // function assetData(ERC20Full) external view returns
    function assetData(address) external view returns (bool, bool, uint16);
}
