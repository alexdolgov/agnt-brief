...
interface ConduitCaptainInterface {
     ...
     */
    function transferConduitOwnership(address conduit, address newPotentialOwner) external;
     ...
     */
    function getConduitController() external view returns (address conduitController);
}
