...
contract ConduitCaptain is TwoStepOwnable, ConduitCaptainInterface {
     ...
     */
    constructor(address conduitController, address initialOwner, address initialRevoker) {
     ...
     */
    function transferConduitOwnership(address conduit, address newPotentialOwner) external override onlyOwner {
     ...
     */
    function cancelConduitOwnershipTransfer(address conduit) external override onlyOwner {
     ...
     */
    function acceptConduitOwnership(address conduit) external override onlyOwner {
     ...
     */
    function updateChannel(address conduit, address channel, bool isOpen) external override onlyOwner {
     ...
     */
    function getConduitController() external view override returns (address conduitController) {
