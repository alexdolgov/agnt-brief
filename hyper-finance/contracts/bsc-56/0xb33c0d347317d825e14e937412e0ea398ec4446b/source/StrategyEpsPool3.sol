...
contract StrategyEpsPool3 {
    ...
    IPool public pool = IPool(0xcce949De564fE60e7f96C85e55177F8B9E4CF61b);
    uint public poolId = 1;

    address public RewardToken = 0xA7f552078dcC247C2684336020c03648500C6d9F;  // eps

    address public curvePool = 0x160CAed03795365F3A589f10C379FfA7d75d4E76;

    address public want = 0xaF4dE8E872131AE328Ce21D909C74705d3Aaf452;

    address public minter = 0x4076CC26EFeE47825917D0feC3A79d0bB9a6bB5c;
    ...
    function e_getAllUnlocked() external {
        require(msg.sender == governance, "!governance");
        IMinter(minter).withdrawExpiredLocks();
    }
    ...
    function harvest() public onlyBenevolent {
        ...
        uint[3] memory amts = [busdBalance, 0, 0];
        Curve3(curvePool).add_liquidity(amts, 0);
