...
import '@uniswap/v3-core/contracts/interfaces/IHyperswapV3Pool.sol';
import '@uniswap/v3-core/contracts/interfaces/callback/IHyperswapV3SwapCallback.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IHyperswapV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IHyperswapV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IHyperswapV3Pool) {
        return IHyperswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function hyperswapV3SwapCallback(
        ...
        IHyperswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IHyperswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
