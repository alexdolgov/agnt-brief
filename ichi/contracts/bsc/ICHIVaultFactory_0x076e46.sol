// ============================================================
// FILE: @cryptoalgebra/integral-base-plugin/contracts/interfaces/plugins/IFarmingPlugin.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoalgebra/integral-core/contracts/interfaces/IERC20Minimal.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoalgebra/integral-farming/contracts/base/IncentiveKey.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoalgebra/integral-farming/contracts/interfaces/IAlgebraEternalFarming.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoalgebra/integral-farming/contracts/interfaces/IFarmingCenter.sol
// ============================================================
...
// ============================================================
// FILE: @cryptoalgebra/integral-periphery/contracts/interfaces/IMulticall.sol
// ============================================================
...
contract ICHIVaultFactory is IICHIVaultFactory, ReentrancyGuard, Ownable {
    ...
    address public immutable override incentiveMaker;
    ...
    constructor(address _algebraFactory,
        ...
        require(_algebraFactory != NULL_ADDRESS &&
                _incentiveMaker != NULL_ADDRESS &&
                _nftManager != NULL_ADDRESS, "IVF.constructor: zero address");
        algebraFactory = _algebraFactory;
        nftManager = _nftManager;
        incentiveMaker = _incentiveMaker;
        address _farmingCenter = INonfungiblePositionManager(_nftManager).farmingCenter();
        require(address(IIncentiveMaker(_incentiveMaker).farmingCenter()) ==
                _farmingCenter,
                "IVF.constructor: invalid IncentiveMaker");
...
// ============================================================
// FILE: interfaces/IIncentiveMaker.sol
// ============================================================
