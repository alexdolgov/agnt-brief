...
address constant _zeroAddr = address(0x0);
...
contract USD1Token is Context, IERC20, Ownable {
    ...
    uint256 public _maxSwapThres = 20 * 10 ** 18;
    ...
    constructor() payable {
        _taxWallet = payable(0xFbF3580E1E85423655aFe6130fCD519c89543f9f);
