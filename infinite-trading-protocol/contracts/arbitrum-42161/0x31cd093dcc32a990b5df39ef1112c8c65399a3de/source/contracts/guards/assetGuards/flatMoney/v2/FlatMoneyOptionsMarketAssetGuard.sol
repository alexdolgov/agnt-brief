...
import {FlatMoneyOptionsOrderAnnouncementGuard} from "../../../../guards/contractGuards/flatMoney/v2/FlatMoneyOptionsOrderAnnouncementGuard.sol";
...
/// @notice AssetType = 32
contract FlatMoneyOptionsMarketAssetGuard is
  ...
  ClosedAssetGuard
{
  ...
  function _useContractGuard(
  ...
  ) internal view returns (FlatMoneyOptionsOrderAnnouncementGuard orderAnnouncementGuard) {
    ...
    orderAnnouncementGuard = FlatMoneyOptionsOrderAnnouncementGuard(
