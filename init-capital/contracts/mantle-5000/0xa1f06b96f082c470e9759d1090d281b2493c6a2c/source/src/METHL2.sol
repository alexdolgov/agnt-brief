...
import {ERC20PermitUpgradeable, IERC20PermitUpgradeable} from "openzeppelin-upgradeable/token/ERC20/extensions/ERC20PermitUpgradeable.sol";
    ...
    IL2UpgradablePermitERC20
{
        ...
        returns (bool)
    {
        ...
        bytes4 secondSupportedInterface = IL2UpgradablePermitERC20
            .l1Token
            .selector ^
            IL2UpgradablePermitERC20.mint.selector ^
            IL2UpgradablePermitERC20.burn.selector;
        bytes4 thirdSupportedInterface = type(
            AccessControlEnumerableUpgradeable
        ).interfaceId; // AccessControlEnumerableUpgradeable
        return
