...
contract MultichainHub is LzAppSend, ReentrancyGuardUpgradeable {
    ...
    // packet type
    uint16 private constant PT_SEND_AND_CALL = 1;
    uint16 private constant MAINNET_ID = 101;

    IOFT private constant AURA = IOFT(0x1509706a6c66CA549ff0cB464de88231DDBe213B);
    ...
    function initialize(address _multichainReceiver, address _lzEndpoint) external initializer {
        __Ownable_init();
        ...
        returns (uint256 nativeFee, uint256 zroFee)
    {
        ...
        return lzEndpoint.estimateFees(MAINNET_ID, address(this), lzPayload, false, _adapterParams);
    }
    ...
    function _sendAndCall(
        ...
        _checkGasLimit(MAINNET_ID, PT_SEND_AND_CALL, _adapterParams, nativeFee);
        ...
        emit CrossChainDeposit(MAINNET_ID, _user, _amount);
    }
