...
contract TheShreddiesCCTestnet is ERC721AQueryable, Ownable(msg.sender) {
    ...
    IERC20 public jones; // JONES token
    ...
    constructor(string memory _uri, uint256 _startTime, address _jones)
        ERC721A("The Shreddies: Christmas Cards", "TSCC")
    {
        uri = _uri;
