...
import {TickMath} from "src/libraries/pancake/TickMath.sol";
import {FullMath} from "src/libraries/pancake/FullMath.sol";
import {IPancakeV3Pool} from "src/interfaces/pool/pancake/IPancakeV3Pool.sol";
import {ILpFactory} from "src/interfaces/pool/ILpFactory.sol";
...
library PancakeLibrary {
        ...
        returns (IPancakeV3Pool)
    {
        ...
        return IPancakeV3Pool(ILpFactory(factory).getPool(key.token0, key.token1, key.fee));
    }
