...
import {NonblockingLzApp, BytesLib} from "./UpgradeableNonBlockingLzApp.sol";
import {IOFTCoreUpgradeable} from "src/interfaces/IOFTCoreUpgradeable.sol";
import {
    IERC165Upgradeable,
    ERC165Upgradeable
} from "openzeppelin/contracts-upgradeable/utils/introspection/ERC165Upgradeable.sol";

abstract contract UpgradeableOFTCore is NonblockingLzApp, ERC165Upgradeable, IOFTCoreUpgradeable {
    ...
    function __initOFTCore(address _lzEndpoint) internal {
        __initLzApp(_lzEndpoint);
    }
