...
contract ERC20SlashingHandler is Initializable, Ownable, ISlashingHandler {
    ...
    function handleSlashing(IERC20 token, uint256 amount) external {
        ...
        SafeTransferLib.safeTransfer(address(token), Constants.SLASHED_ASSETS_DUMP_ADDRESS, amount);
    }
