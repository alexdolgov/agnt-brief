...
// File: contracts/waultswap/IWaultSwapRouter02.sol

pragma solidity >=0.5.0;

interface IWaultSwapRouter02 {
...
// File: contracts/waultswap/IWexMaster.sol
...
// File: contracts/MasterChefGoblinWault.sol
...
contract MasterChefGoblinWault is Ownable, ReentrancyGuard, Goblin {
    /// @notice Libraries
    ...
    constructor(
        ...
        rewardToken = address(masterChef.wex());
        addStrat = _addStrat;
        liqStrat = _liqStrat;
    ...
    function reinvest() public onlyEOA nonReentrant {
        ...
        masterChef.withdraw(pid, 0, true);
        ...
        masterChef.deposit(pid, lpToken.balanceOf(address(this)), true);
    ...
    function _addShare(uint256 id) internal {
        ...
        if (balance > 0) {
            ...
            masterChef.deposit(pid, balance, true);
    ...
    function _removeShare(uint256 id) internal {
        ...
        if (share > 0) {
            ...
            masterChef.withdraw(pid, balance, true);
