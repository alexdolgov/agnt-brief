...
/**
 * @title ITricootEvents
 * @dev This interface defines events emitted by the Tricoot protocol for various actions such as supply, withdraw, transfer, and more.
 */
interface ITricootEvents {
    // FOUNDATION
     ...
     * @param tricoot The address of the Tricoot market from which dust is rescued
     * @param amount The amount of tokens rescued
     */
    event Dust(address indexed to, address indexed token, address indexed tricoot, uint256 amount);
     ...
     * @param tricoot The address of the Compound V3 Tricoot market
