...
import { ITricootStructs as ICS } from "./ITricootStructs.sol";

interface ITricootFlashLoanPlugin is IERC165 {
     ...
     */
    function  loan(ICS.CallbackData memory data, bytes memory) external payable;
     ...
     * This function standardizes the return data for TricootFoundation to handle.
