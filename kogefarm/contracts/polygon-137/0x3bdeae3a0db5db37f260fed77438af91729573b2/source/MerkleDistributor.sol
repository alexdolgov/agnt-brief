...
contract MerkleDistributor is IMerkleDistributor {
    ...
    uint256 private constant FOUR_WEEKS = 4 weeks;
    ...
    constructor(address token_, bytes32 merkleRoot_, address treasury) public {
        token = token_;
    ...
    function sweepPostDeadline(IERC20 tokenAddr) public {
        ...
        require(
            IERC20(tokenAddr).transfer(_treasury, tokenBalance),
