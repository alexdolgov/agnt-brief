...
- Generated: 2026-05-24T08:01:43.504Z
- Pipeline run: v2-pipeline-2026-05-22-eff36e-2ebb
- Chains: ethereum, linea, mantle, polygon
- Contract surface: 53 unique implementations (210 raw deployments)
- DeFi Llama TVL: $3,079,914.84
- On-chain TVL (included contracts): $3,102,306.93
- TVL by chain: Ethereum $3,044,482.43 | Linea $55,765.24 | Polygon $2,059.26

## Project Description

KUMA Protocol is a decentralized platform for issuing and managing yield-bearing tokens backed by real-world assets (RWAs), specifically sovereign bonds. It provides infrastructure for tokenizing bonds, managing interest rate feeds, and facilitating swaps between bond tokens and stablecoins.
...
- Verified implementations audited: 11/32 (34.4%)
...
- Tier 1 coverage: 34.4% (Code4rena)

### Auditor Coverage

| Auditor | Tier | Contracts Covered | Coverage % | Latest Audit |
|---|---|---:|---:|---|
| Code4rena | Tier 1 | 11 | 34.4% | 2023-02 |
...
| KUMAAccessController | governance | ethereum | 6 deployments: ethereum [`0x5fad6f...1163de`](./contracts/ethereum-1/0x5fad6f80312aee6f19784a7fc359f90d441163de/); polygon `0xfe7261...a42a54`; mantle `0xcdf658...9a3b66`; linea `0x85dd3a...3be78f`; linea `0xad5c32...74ad6b`; linea `0xb9cee0...6a52ae` | ✅ Audited |
...
| [Public Github Repo: <>](https://github.com/code-423n4/2023-02-kuma) | Code4rena | Contest | 2023-02 | stale | Direct | contract_name | 118 | high |
...
- Match method counts: extraction_exact=216
