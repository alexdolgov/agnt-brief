...
- Generated: 2026-05-25T12:11:14.544Z
...
- DeFi Llama TVL: $1,032,039.66
- On-chain TVL (included contracts): $1,508,421.06
- TVL by chain: Ethereum $1,508,421.06

## Project Description

Larix is a multi-chain DeFi protocol offering lending, yield farming, and staking services. It enables users to deposit assets into lending pools, provide liquidity to automated market makers, and stake tokens to earn rewards across numerous blockchain networks.

### Architecture

The Larix family integrates lending pools, yield optimizers, and staking contracts that share common governance controllers (FarmV2Controller, FarmV3Controller) and proxy infrastructure (ArcProxy, TransparentUpgradeableProxy). Tokens like ArcxTokenV2 and StakedBPT flow between staking and farming contracts, while cross-chain AutoFarmV2 variants extend yield strategies across multiple networks.
...
- ASD (verified + unaudited TVL): $1,508,421.06
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [dead]. ASD of $1,508,421.06 represents exposure in a protocol with dead activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $300,951.87 | Verified native implementation with $300,951.87 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
