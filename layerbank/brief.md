...
- Generated: 2026-06-14T05:35:15.331Z
- Pipeline run: v2-pipeline-2026-06-14-ec5560-39b4
- Chains: bsc, linea, manta, mode, scroll
- Contract surface: 91 unique implementations (219 raw deployments)
- DeFi Llama TVL: $20,551,091.87
- On-chain TVL (included contracts): $116,760.74
- TVL by chain: Linea $116,735.52 | Bsc $25.22
...
| Contract Name | Role | Chain | Deployments | Audit Status |
|---|---|---|---|---|
| Core | unknown | linea | 8 deployments: bsc `0x8efdd7...100ffa`; manta `0xb7a23f...748bbf`; mode `0x809808...c1ff50`; linea [`0x009a0b...943833`](./contracts/linea-59144/0x009a0b7c38b542208936f1179151cd08e2943833/); linea `0x43eac5...5de866`; linea `0x850515...0577fb`; linea `0x887d64...fec715`; scroll `0xec53c8...4289aa` | ⚠️ Unaudited |
