# Agentic Audit Brief: Liminal

## Project Overview

- Project: Liminal (`liminal`)
- Website: [https://liminal.money/join/DEFILLAMA](https://liminal.money/join/DEFILLAMA)
- Lifecycle: active (Tier 0, 75.3% below peak)
- Generated: 2026-05-22T14:01:13.488Z
...
- DeFi Llama TVL: $23,057,362.00
- On-chain TVL (included contracts): $1,858,450.31
- TVL by chain: Ethereum $1,696,452.84 | Arbitrum $161,996.78 | Bsc $0.70

## Project Description

Liminal is a multi-chain DeFi protocol offering basis trading and perpetuals. It provides vaults, staking, and liquidity pools to enable yield generation and leveraged trading across numerous blockchains.

### Architecture

The Liminal Perps family relies on a set of core vaults (bVault, CavePool) and liquidity pools (BAC*Pool) for basis trading, while staking contracts (BlackPoolToken, StakedBPT) and governance controllers (FarmV2Controller, FarmV3Controller) manage incentives. Proxies and adapters provide upgradeability and cross-chain bridging, with tokens like L2TBTC and MantaMintableERC20 enabling multi-chain asset representation.
...
- ASD (verified + unaudited TVL): $1,858,450.31
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $303,574.96 | Verified native implementation with $303,574.96 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0x0440ae...25c87c`](./contracts/ethereum-1/0x0440ae12f329dbd7306b6d9edbb0e667c225c87c/) | TokenStore | token | $178,800.06 | Verified native implementation with $178,800.06 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $69,994.56 | Verified native implementation with $69,994.56 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,473.28 | Verified native implementation with $52,473.28 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,208.95 | Verified native implementation with $5,208.95 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,641.89 | Verified native implementation with $4,641.89 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0x5859ad...8120c0`](./contracts/ethereum-1/0x5859adb05988946b9d08dce2e12ae29af58120c0/) | BASPool | core_logic | $1,399.68 | Verified native implementation with $1,399.68 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.71 | Verified native implementation with $32.71 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
