...
- Lifecycle: active (Tier 0, 95.5% below peak)
- Generated: 2026-06-21T18:04:23.456Z
- Pipeline run: v2-pipeline-2026-06-21-727228-48f6
- Chains: arbitrum, avalanche, base, berachain, ethereum, hyperliquid, optimism, scroll, sonic, swellchain
- Contract surface: 51 unique implementations (112 raw deployments)
- DeFi Llama TVL: $217,004,570.00
- On-chain TVL (included contracts): $153,826,088.77
- TVL by chain: Ethereum $153,616,018.31 | Optimism $175,745.69 | Base $34,324.78

## Project Description

Liquity is a decentralized borrowing protocol that allows users to draw interest-free loans against ETH and liquid staking tokens (LSTs) as collateral. Loans are paid out in the stablecoin BOLD, and the system maintains stability through a set of collateral-specific pools and a global stability mechanism. The protocol also includes governance and staking tokens (LQTY, LUSD) for incentivizing participation and managing the system.

### Architecture

Each collateral branch (ETH, rETH, wstETH) operates independently with its own set of core pools and managers, but all branches share the BOLD token as the common debt currency and rely on the CollateralRegistry for cross-branch coordination. The Governance family provides system-wide incentives and control, while Shared contracts offer helper functions used by all branches.

## Contract Surface Quality

- Indexed contracts: 134; live-surface contracts included: 112 (24 live, 88 unknown).
- Excluded by liveness: 19 inactive, 3 singleton, 0 uninitialized.
...
- ASD (verified + unaudited TVL): $31,837,659.65
- Latest audit: 2025-01 (aging)
- Staleness: 0 fresh, 2 aging, 4 stale, 0 unknown
- Tier 1 coverage: 23.3% (Trail of Bits)

### Auditor Coverage

| Auditor | Tier | Contracts Covered | Coverage % | Latest Audit |
|---|---|---:|---:|---|
| Coinspect | Tier 2 | 16 | 37.2% | 2025-01 |
| yAudit | Tier 2 | 16 | 37.2% | 2021-03 |
| Trail of Bits | Tier 1 | 10 | 23.3% | 2021-01 |
...
| GnosisSafeL2 | governance | ethereum | unit-43487 | [`0xdc6f86...f7f690`](./contracts/ethereum-1/0xdc6f869d2d34e4aee3e89a51f2af6d54f0f7f690/) | ⚠️ Unaudited |
...
| Contract Name | Role | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---|---|
| BurnMintERC20 | token | optimism | n/a | 9 deployments: optimism [`0x03569c...81b01d`](./contracts/optimism-10/0x03569cc076654f82679c4ba2124d64774781b01d/); sonic `0xc6e53b...e6ae08`; sonic `0xf05a20...8cb1c9`; hyperliquid `0x84533b...dbb11a`; base [`0x03569c...81b01d`](./contracts/base-8453/0x03569cc076654f82679c4ba2124d64774781b01d/); arbitrum [`0x03569c...81b01d`](./contracts/arbitrum-42161/0x03569cc076654f82679c4ba2124d64774781b01d/); avalanche [`0x03569c...81b01d`](./contracts/avalanche-43114/0x03569cc076654f82679c4ba2124d64774781b01d/); berachain `0xf05a20...8cb1c9`; scroll [`0x03569c...81b01d`](./contracts/scroll-534352/0x03569cc076654f82679c4ba2124d64774781b01d/) | ⚠️ Unaudited (bytecode match) |
...
|---|---|---|---|---|---|---|---|---|
| [Liquity.pdf](https://github.com/trailofbits/publications/blob/master/reviews/Liquity.pdf) | Trail of Bits | Audit | 2021-01 | stale | Direct | contract_name | 31 | high |
| [DL audit link](https://www.coinspect.com/blog/liquity-audit) | unknown | Audit | 2021-03 | stale | Direct | n/a | 0 | n/a |
| [Download Liquity Audit Report](https://www.coinspect.com/doc/Liquity%20%2D%20Smart%20Contract%20Audit%202021%2Epdf) | yAudit | Audit | 2021-03 | stale | Direct | contract_name | 42 | high |
| [Liquity v2 Governance Smart Contract Audit January 20, 2025 Liquity engaged Coinspect to audit Liquity v2 Governance smart contracts, enhancing decentralized governance with modular initiatives and security measures.](https://www.coinspect.com/blog/liquity-v2-governance-smart-contract-audit) | Coinspect | Audit | 2025-01 | aging | Direct | n/a | 0 | n/a |
| [Liquity V2 Smart Contract Audit January 9, 2025 Liquity V2 Smart Contract Audit](https://www.coinspect.com/blog/liquity-v2-bold-smart-contract-audit) | Coinspect | Audit | 2025-01 | aging | Direct | n/a | 0 | n/a |
| [Rendered PDF capture](https://www.coinspect.com/doc/Liquity%20%2D%20Smart%20Contract%20Audit%202021.pdf) | Coinspect | Audit | 2021-03 | stale | Direct | contract_name | 42 | high |
...
|---|---|---|---|---:|---|
| ethereum | [`0x6440f1...beb01d`](./contracts/ethereum-1/0x6440f144b7e50d6a8439336510312d2f54beb01d/) | BoldToken | token | $31,627,589.19 | Verified native implementation with $31,627,589.19 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
- [13391] DL audit link
- [13393] Liquity v2 Governance Smart Contract Audit January 20, 2025 Liquity engaged Coinspect to audit Liquity v2 Governance smart contracts, enhancing decentralized governance with modular initiatives and security measures.
- [13394] Liquity V2 Smart Contract Audit January 9, 2025 Liquity V2 Smart Contract Audit
