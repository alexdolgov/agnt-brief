...
contract AirdropClaimV2Strategic is ReentrancyGuard {
    ...
    function setUserInfo(address _who, address _to, uint256 _amount, uint16 veShare) external onlyMerkle nonReentrant returns(bool status) {
        ...
        uint256 _veAmount = _totalVeAmount / 6;
        ...
        IVotingEscrowV2(ve).createLockFor(_veAmount, 1 * 30 * 86400, _who, false);
        IVotingEscrowV2(ve).createLockFor(_veAmount, 2 * 30 * 86400, _who, false);
        IVotingEscrowV2(ve).createLockFor(_veAmount, 3 * 30 * 86400, _who, false);
        IVotingEscrowV2(ve).createLockFor(_veAmount, 4 * 30 * 86400, _who, false);
        IVotingEscrowV2(ve).createLockFor(_veAmount, 5 * 30 * 86400, _who, false);
