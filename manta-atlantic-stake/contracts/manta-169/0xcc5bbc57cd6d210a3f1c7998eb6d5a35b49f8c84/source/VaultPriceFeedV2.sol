...
import "../oracle/interfaces/IPythWrapper.sol";
...
contract VaultPriceFeedV2 is IVaultPriceFeed {
    ...
    function getLatestPrimaryPrice(
        ...
        IPythWrapper priceFeed = IPythWrapper(priceFeedAddress);

        uint256 price = priceFeed.getMedianPrice();
    ...
    function getPrimaryPrice(
        ...
        uint256 price = 0;
        if (_maximise) {
            price = priceFeed.getMaxPrice();
        } else {
            price = priceFeed.getMinPrice();
        }
