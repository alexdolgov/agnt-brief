...
// ============================================================
// FILE: src/interfaces/external/eigen-layer/IAllocationManager.sol
// ============================================================
...
interface IAllocationManager {
    ...
    function clearDeallocationQueue(address operator, address[] calldata strategies, uint16[] calldata numToClear)
        external;
    ...
    function removeStrategiesFromOperatorSet(address avs, uint32 operatorSetId, address[] calldata strategies)
        external;
    ...
    function getAllocations(address[] memory operators, OperatorSet memory operatorSet, address strategy)
        external
        view
        returns (Allocation[] memory);
    ...
    function getMaxMagnitudes(address[] calldata operators, address strategy) external view returns (uint64[] memory);

    function getMaxMagnitudesAtBlock(address operator, address[] calldata strategies, uint32 blockNumber)
        external
        view
        returns (uint64[] memory);
    ...
    function getAllocatedStake(OperatorSet memory operatorSet, address[] memory operators, address[] memory strategies)
        external
        view
...
// ============================================================
// FILE: src/interfaces/external/eigen-layer/IDelegationManager.sol
// ============================================================
...
// ============================================================
// FILE: src/interfaces/external/eigen-layer/IRewardsCoordinator.sol
// ============================================================
...
// ============================================================
// FILE: src/interfaces/external/eigen-layer/ISignatureUtils.sol
// ============================================================
...
// ============================================================
// FILE: src/interfaces/external/eigen-layer/IStrategy.sol
// ============================================================
...
// ============================================================
// FILE: src/interfaces/external/eigen-layer/IStrategyManager.sol
// ============================================================
...
// ============================================================
// FILE: src/libraries/SlotLibrary.sol
// ============================================================
...
// ============================================================
// FILE: src/permissions/MellowACL.sol
// ============================================================
...
// ============================================================
// FILE: src/permissions/protocols/EigenLayerVerifier.sol
// ============================================================
...
// ============================================================
// FILE: src/permissions/protocols/OwnedCustomVerifier.sol
// ============================================================
