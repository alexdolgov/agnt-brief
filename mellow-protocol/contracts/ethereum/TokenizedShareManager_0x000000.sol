...
// ============================================================
// FILE: src/interfaces/managers/ITokenizedShareManager.sol
// ============================================================
...
// ============================================================
// FILE: src/libraries/ShareManagerFlagLibrary.sol
// ============================================================
...
// ============================================================
// FILE: src/managers/ShareManager.sol
// ============================================================
...
abstract contract ShareManager is IShareManager, ContextUpgradeable {
    ...
    /// @inheritdoc IShareManager
    function lock(address account, uint256 value) external onlyQueue {
        if (value == 0) {
            revert ZeroValue();
        }
    ...
    function _lockShares(address account, uint256 value) internal virtual;
}

// ============================================================
// FILE: src/managers/TokenizedShareManager.sol
// ============================================================
