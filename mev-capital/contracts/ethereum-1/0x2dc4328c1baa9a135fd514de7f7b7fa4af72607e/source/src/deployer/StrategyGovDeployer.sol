...
contract Deployments {
    ...
    address public constant ROLES_MODULE_IMPL = 0x6B440A8b6c08E2710530897B25E98ec2480B5707;
...
contract StrategyGovDeployer is Deployments {
    ...
    function deploySafe(DeploySafeParams calldata params) external {
        ...
        (address rolesModule, address delayModule) = _deployAndSetupModules(
            ownerlessSafe,
            params.governor,
    ...
    function _deployAndSetupModules(
        ...
        _configureModules(ownerlessSafe, rolesModule, delayModule, governor, vaultGovernors);
    }
    ...
    function _setupModulePermissions(
        ...
        _callModuleFunc(
            ownerlessSafe,
            delayModule,
            abi.encodeWithSelector(IDelay.transferOwnership.selector, address(rolesModule))
        );
    ...
    function _setupGovernorPermissions(
        ...
        // Assign roles to vault governors
        for (uint256 i = 0; i < vaultGovernors.length; i++) {
