...
/// @dev Error when vault owner tries to track user initiated/admin initiated withdrawal through emergency tracking
...
/// @dev Error when not enough liquidity in the withdrawal buffer
error NotEnoughLiquidity();

/// @dev Error when withdrawal buffer is not the caller or not set
error NotWithdrawalBuffer();

/// @dev Error when Instant Withdraw Already Enabled
error InstantWithdrawAlreadyEnabled();

/// @dev Error when array lengths do not match
error MismatchedArrayLengths();

/// @dev Error when caller is not the WithdrawalBufferAdmin
error NotWithdrawalBufferAdmin();

/// @dev Error when instant withdrawal is not enabled
error InstantWithdrawNotEnabled();

/// @dev Error when instant withdrawal is paused
error InstantWithdrawPaused();
