...
contract MAGICStrategy is ERC20, Ownable {
  ...
  constructor(
  ) ERC20("MAGIC/USDC ARBI Shares", "MAGIC/USDC-SHARES") {
    depositToken = IPair(0x6478931004Cd7b995957A4e1a5D06f9A8Db0FA04);
    rewardToken = IERC20(0x2c852D3334188BE136bFC540EF2bB8C37b590BAD);
    stakingContract = IMagicLand(0x6b614684742717114200dc9f30cBFdCC00fc73Ec);
    router = IRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);

    address _token0 = IPair(0x6478931004Cd7b995957A4e1a5D06f9A8Db0FA04).token0();
    address _token1 = IPair(0x6478931004Cd7b995957A4e1a5D06f9A8Db0FA04).token1();
  ...
  function checkReward() public view returns (uint) {
    uint pendingReward = stakingContract.pendingMagic(pid, address(this));
  ...
  //    router.swapExactTokensForTokens(amountIn, amountOutToken1, path1, address(this), block.timestamp);
   // }
    ...
    (,,uint liquidity) = router.addLiquidity(
       address(rewardToken), path0[path0.length - 1], amountIn,
      amountOutToken0,
      0, 0,
      address(this),
      block.timestamp
