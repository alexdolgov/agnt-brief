...
- Generated: 2026-05-29T11:08:23.148Z
...
- Verified implementations audited: 11/47 (23.4%)
...
|---|---|---|---|---|
| DepositPool | core_logic | ethereum | 7 deployments: ethereum [`0x3b5198...8cf116`](./contracts/ethereum-1/0x3b51989212bedab926794d6bf8e9e991218cf116/); ethereum `0x47176b...aa4790`; ethereum `0x6cce08...e4750e`; ethereum `0x9380d7...7cb384`; ethereum `0xccc067...d01532`; ethereum `0xdb10da...fbd670`; ethereum `0xde283f...277a42` | ✅ Audited |
| BuildersTreasury | operational_periphery | arbitrum | [`0x232c15...416aa1`](./contracts/arbitrum-42161/0x232c15275affa0ee944f6894d57e013647416aa1/) | ✅ Audited |
| BuildersV2 | unknown | arbitrum | [`0xa86031...c14fe6`](./contracts/arbitrum-42161/0xa8603114c7bce3a622f2d36286b29c6f51c14fe6/) | ✅ Audited |
| BuildersV3 | unknown | arbitrum | [`0xccc067...d01532`](./contracts/arbitrum-42161/0xccc06767533563fbdcff2e1800e4a266fbd01532/) | ✅ Audited |
| ChainLinkDataConsumer | unknown | ethereum | 3 deployments: ethereum [`0x18faef...7513b0`](./contracts/ethereum-1/0x18faef315b40a6d9cf49628f1133b1aa507513b0/); ethereum `0x2265ae...95ed50`; ethereum `0xd18226...3bbc5e` | ✅ Audited |
| Distributor | operational_periphery | ethereum | [`0x5b660a...b45f64`](./contracts/ethereum-1/0x5b660ab78f3ac743953f9e68630a2d66e7b45f64/) | ✅ Audited |
| FeeConfig | governance | ethereum | 4 deployments: ethereum [`0x33e689...1cae83`](./contracts/ethereum-1/0x33e689846b1f143793c9d270a26016615a1cae83/); ethereum `0x55daa9...2613eb`; arbitrum `0x873940...51ff0e`; arbitrum `0xc03d87...7eb895` | ✅ Audited |
| L1SenderV2 | unknown | ethereum | 3 deployments: ethereum [`0x2bc54c...66515a`](./contracts/ethereum-1/0x2bc54ca13a75b24630070e73173cc2f35d66515a/); ethereum `0x2efd44...e5ff84`; ethereum `0x50e80e...467d1f` | ✅ Audited |
| L2TokenReceiverV2 | token | arbitrum | 4 deployments: arbitrum [`0x27353f...2d5ae4`](./contracts/arbitrum-42161/0x27353ffadfd53538e8bdf81be7041c56ce2d5ae4/); arbitrum `0x2e1ff1...0092b7`; arbitrum `0x47176b...aa4790`; arbitrum `0x9eba62...8fc561` | ✅ Audited |
| MOROFT | unknown | arbitrum | 3 deployments: ethereum `0xcbb8f1...9dcec0`; arbitrum [`0x092baa...bcfc86`](./contracts/arbitrum-42161/0x092baadb7def4c3981454dd9c0a0d7ff07bcfc86/); arbitrum `0x3c3a26...55786e` | ✅ Audited |
| RewardPool | core_logic | arbitrum | 4 deployments: ethereum `0xb7994d...d8df87`; ethereum `0xe30279...d88a75`; arbitrum [`0x281bc6...4b6375`](./contracts/arbitrum-42161/0x281bc6f84952abe53f6921dcd76c879d3c4b6375/); arbitrum `0x6ad6ef...830193` | ✅ Audited |
...
|---|---|---|---|---|---|---|---|---|
| [external-prompt-api.md](https://github.com/MorpheusAIs/MySuperAgent/blob/main/app/docs/external-prompt-api.md) | unknown | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
| [google-auth-setup.md](https://github.com/MorpheusAIs/MySuperAgent/blob/main/app/docs/google-auth-setup.md) | unknown | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
| [vercel-analytics-integration.md](https://github.com/MorpheusAIs/MySuperAgent/blob/main/app/docs/vercel-analytics-integration.md) | unknown | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
| [MOROFT.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/MOROFT.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 3 | low |
| [BuilderSubnets.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/builder-protocol/BuilderSubnets.md) | unknown | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
| [BuildersTreasury.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/builder-protocol/BuildersTreasury.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 1 | low |
| [BuildersV2.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/builder-protocol/BuildersV2.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 1 | low |
| [BuildersV3.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/builder-protocol/BuildersV3.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 1 | low |
| [FeeConfig.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/builder-protocol/FeeConfig.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 4 | low |
| [ChainLinkDataConsumer.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/ChainLinkDataConsumer.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 3 | low |
| [DepositPool.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/DepositPool.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 7 | low |
| [DistributionV6.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/DistributionV6.md) | unknown | Audit | n/a | unknown | Direct | n/a | 0 | n/a |
| [Distributor.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/Distributor.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 1 | low |
| [L1SenderV2.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/L1SenderV2.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 3 | low |
| [L2TokenReceiverV2.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/L2TokenReceiverV2.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 4 | low |
| [RewardPool.md](https://github.com/MorpheusAIs/SmartContracts/blob/main/docs/capital-protocol/RewardPool.md) | unknown | Audit | n/a | unknown | Direct | contract_name | 4 | low |
...
- Extraction confidence breakdown: low=11
- Match method counts: extraction_exact=32

Zero-match audit list:

- [5933] external-prompt-api.md
- [5934] google-auth-setup.md
- [5935] vercel-analytics-integration.md
- [5937] BuilderSubnets.md
- [5944] DistributionV6.md
- [5949] 0001-dataset-cache-manifest-and-runtime-adapters.md
- [5950] 0002-metadata-manifest-and-pull-command.md
- [5951] 0003-bun-package-manager-node-runtime.md
