...
contract Account is DegenPoolStorage, IAccount {
    ...
    function withdrawCollateral(
        ...
        {
            uint96 fundingFeeCollateral = uint256(fundingFeeUsd).wdiv(collateralPrice).toUint96();
            require(subAccount.collateral >= fundingFeeCollateral, "FEE"); // remaining collateral can not pay FEE
            subAccount.collateral -= fundingFeeCollateral;
            _collectFeeToMlp(decoded.collateralId, fundingFeeCollateral);
        }
