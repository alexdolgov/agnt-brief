...
contract RewardDistributorV2 is IRewardDistributor, Upgradeable, ReentrancyGuard, Pausable {
    ...
    function initializeV2(
        ...
        _unlockRules.push(UnlockRule({duration: 7 days, penaltyRatio: 50000000}));
        _unlockRules.push(UnlockRule({duration: 14 days, penaltyRatio: 25000000}));
        _unlockRules.push(UnlockRule({duration: 21 days, penaltyRatio: 0}));
    }
