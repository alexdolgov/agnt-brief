...
/**
 * @title Shutdown Redeemer for NFTX V3 vaults
 * @author @apoorvlathey
 *
 * @notice Allows users to exchange their vault tokens for ETH, after the vault shutdown.
 */
contract ShutdownRedeemerV3Upgradeable is PausableUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    INFTXVaultFactoryV3 public immutable V3VaultFactory;
    ...
    constructor(INFTXVaultFactoryV3 V3VaultFactory_) {
        V3VaultFactory = V3VaultFactory_;
    }
    ...
    function redeem(uint256 vaultId, uint256 vTokenAmount) external {
        ...
        address vToken = V3VaultFactory.vault(vaultId);
