...
interface IEconomicsFactory {
    ...
    // function setIntegratorName(uint256 integratorIndex, string calldata name) external;
    ...
    // function returnRelayerData(address relayerAddress) external view returns (RelayerData memory);
}
