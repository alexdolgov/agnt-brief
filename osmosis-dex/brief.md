# Agentic Audit Brief: Osmosis DEX
...
- Generated: 2026-05-22T18:50:40.966Z
...
- DeFi Llama TVL: $18,171,325.69
- On-chain TVL (included contracts): $1,875,045.26
- TVL by chain: Ethereum $1,713,575.02 | Arbitrum $161,469.55 | Bsc $0.70

## Project Description

Osmosis DEX is a decentralized exchange protocol that facilitates token swaps, liquidity provision, and yield farming across multiple blockchain networks. It aggregates various liquidity pools, vaults, and staking mechanisms to enable efficient trading and earning opportunities for users.

### Architecture

The protocol's contracts share common infrastructure through proxy patterns (ArcProxy, TransparentUpgradeableProxy) and governance controllers (FarmV2Controller, FarmV3Controller) that manage multiple farming and staking pools. Liquidity pool tokens like StakedBPT and BlackPoolToken are used across various vaults and reward contracts, while cross-chain farming strategies (AutoFarmV2_CrossChain) integrate with these pools to optimize yields.
...
- ASD (verified + unaudited TVL): $1,875,045.26
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [declining]. ASD of $1,875,045.26 represents exposure in a protocol with declining activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $320,795.41 | Verified native implementation with $320,795.41 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,257.33 | Verified native implementation with $52,257.33 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,126.46 | Verified native implementation with $5,126.46 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,622.79 | Verified native implementation with $4,622.79 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
