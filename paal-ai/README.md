...
This brief describes the observed EVM deployment and audit surface for PAAL AI. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
|---|---|---|---|---|---|---|---|
| unverified unclassified | UnnamedContract<br>`0x4a24d53e6664d79896f49767a652eae6f92544bf` | non_address_book | unknown | unknown | unverified | n/a | `0x28e481358d7b7aeb813fb55e5378f4ef0544c5fd` |

## Audit Inventory

| Audit | Auditor | Audit Type | Date | Freshness | Inheritance | Scope Format | Scope Result | Own Matches | Proxy Refs | Excluded/Context | Unresolved | Extraction Confidence |
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [skynet.certik.com/projects/paal-ai](https://skynet.certik.com/projects/paal-ai) | CertiK | Audit | 2025-05 | aging | Direct | contract_name | no match | 0 | 0 | 0 | 1 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [21358] skynet.certik.com/projects/paal-ai — no match: Only one contract file explicitly listed in the audit report: PaalXSwapContract.sol. The audit date is derived from 'Last Audit was delivered on 5/20/2025'.
...
|---|---|---|---|---|---|
| skynet.certik.com/projects/paal-ai | PaalXSwapContract | unmatched — not counted | — | Listed in Audited Files/SHA256 section | no |
