...
- Generated: 2026-05-24T10:37:30.384Z
...
- DeFi Llama TVL: $2,707,100.00
- On-chain TVL (included contracts): $1,856,894.42
- TVL by chain: Ethereum $1,695,494.96 | Arbitrum $161,398.76 | Bsc $0.70

## Project Description

Pact is a multi-chain DeFi protocol offering automated yield farming, staking, and liquidity pool services. It aggregates user deposits into vaults and farms to optimize returns across various chains and decentralized exchanges.

### Architecture

All contracts belong to a single Pact family, sharing governance controllers (FarmV2Controller, FarmV3Controller) and reward distribution mechanisms (MasterChef, various reward contracts). Vaults and pools interact with external DEX pairs (UniswapV2Pair, PancakePair) to execute yield strategies, while tokens like ArcxTokenV2 and StakedBPT represent user stakes and rewards.
...
- ASD (verified + unaudited TVL): $1,856,894.42
...
|---|---|---|---|---|---|---|---|---|
| [Pact_Fi.pdf](https://github.com/runtimeverification/publications/blob/main/reports/smart-contracts/Pact_Fi.pdf) | unknown | Audit | 2022-01 | stale | Direct | n/a | 0 | n/a |
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $302,900.01 | Verified native implementation with $302,900.01 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $69,667.82 | Verified native implementation with $69,667.82 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,228.34 | Verified native implementation with $52,228.34 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,968.64 | Verified native implementation with $4,968.64 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,620.22 | Verified native implementation with $4,620.22 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $924.06 | Verified native implementation with $924.06 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.48 | Verified native implementation with $36.48 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.55 | Verified native implementation with $32.55 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
