...
contract PadFarmsV2 {
   ...
   modifier hasDripped {
    ...
    mapping(address => uint256) public farmedFuk;
    ...
    constructor(address _vaultAddress, address _fuk, address _acceptedToken) {
        fuk = TOKEN(_fuk);
    ...
    function harvest() hasDripped hasRewards public {
        ...
        fuk.transfer(_farmerAddress, _rewards);
        farmedFuk[_farmerAddress] += _rewards;
