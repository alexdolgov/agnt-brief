...
- Website: [https://phoenix.trade](https://phoenix.trade)
- Lifecycle: unknown (Tier 0, 93.9% below peak)
- Generated: 2026-05-25T04:25:31.251Z
...
- DeFi Llama TVL: $1,177,437.00
- On-chain TVL (included contracts): $1,855,243.60
- TVL by chain: Ethereum $1,695,279.10 | Arbitrum $159,963.81 | Bsc $0.70

## Project Description

Phoenix is a multi-chain DeFi protocol offering derivatives and decentralized exchange services. It provides perpetual futures trading, liquidity pools, yield farming vaults, and staking mechanisms across numerous blockchains.

### Architecture

The Phoenix Perp family integrates core liquidity pools (BAC pools, bVault, CavePool) with yield farming controllers (FarmV2Controller, FarmV3Controller) and staking contracts (MasterChef, BerryMaster). Tokens like ArcProxy and L2TBTC serve as cross-chain assets, while adapters like MarinateAutoCompounder automate compounding across these pools.
...
- ASD (verified + unaudited TVL): $1,855,243.60
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [unknown]. ASD of $1,855,243.60 represents exposure in a protocol with unknown activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $302,732.82 | Verified native implementation with $302,732.82 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $68,883.81 | Verified native implementation with $68,883.81 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,640.58 | Verified native implementation with $51,640.58 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,919.96 | Verified native implementation with $4,919.96 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,568.23 | Verified native implementation with $4,568.23 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.07 | Verified native implementation with $36.07 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.18 | Verified native implementation with $32.18 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
