...
contract Implementations is Setup {
    ...
    IndexInterface immutable public bxdIndex;

    constructor(address _bxdIndex) {
        bxdIndex = IndexInterface(_bxdIndex);
    }

    modifier isMaster() {
        require(msg.sender == bxdIndex.master(), "Implementations: not-master");
        _;
    }
...
contract BxdImplementations is Implementations {
    constructor(address _bxdIndex) public Implementations(_bxdIndex) {}
