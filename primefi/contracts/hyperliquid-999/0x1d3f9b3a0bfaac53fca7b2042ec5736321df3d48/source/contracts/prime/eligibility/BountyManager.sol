...
contract BountyManager is Initializable, OwnableUpgradeable, PausableUpgradeable, RecoverERC20 {
	...
	function initialize(
		...
		require(_hunterShare <= RATIO_DIVISOR && _baseBountyUsdTarget != 0 && _maxBaseBounty != 0, InvalidNumber());
	...
	function _getChefBounty(
		...
		issueBaseBounty = IChefIncentivesController(chef).claimBounty(0, _user, _execute);
		incentivizer = chef;
		return (incentivizer, 0, issueBaseBounty);
	}
