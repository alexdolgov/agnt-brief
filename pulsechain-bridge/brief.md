...
- Generated: 2026-05-29T12:55:55.876Z
...
The PulseChain Bridge is a canonical bridge enabling asset transfers between Ethereum and PulseChain. It uses a set of proxy-based contracts to lock tokens on one chain and mint or release equivalent tokens on the other.

### Architecture

The bridge family relies on EternalStorageProxy to decouple logic from storage, with ForeignOmnibridge handling token mediation, BridgeValidators managing validator signatures, and ForeignAMB providing arbitrary message passing. These contracts share a common deployer and proxy pattern, indicating a unified upgradeable infrastructure.
...
- [5690] 0001-dataset-cache-manifest-and-runtime-adapters.md
- [5691] 0002-metadata-manifest-and-pull-command.md
- [5692] 0003-bun-package-manager-node-runtime.md
