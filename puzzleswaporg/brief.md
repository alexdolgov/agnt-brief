# Agentic Audit Brief: PuzzleSwapOrg
...
- Generated: 2026-05-24T23:32:53.629Z
...
- DeFi Llama TVL: $1,411,524.00
- On-chain TVL (included contracts): $1,854,767.16
- TVL by chain: Ethereum $1,694,896.86 | Arbitrum $159,869.60 | Bsc $0.70

## Project Description

PuzzleSwapOrg is a multi-chain DeFi protocol offering decentralized exchange (DEX) and lending services. It enables users to swap tokens, provide liquidity, stake assets, and access yield farming opportunities across numerous blockchains.

### Architecture

The Puzzle Swap family integrates multiple pool types (e.g., bVault, CavePool, BAC pools) with yield optimizers (AutoFarmV2) and staking/reward contracts (MasterChef, BOGStaking, NyanRewards) to manage liquidity and distribute incentives. Governance controllers (FarmV2Controller, FarmV3Controller) and proxy patterns (ArcProxy, TransparentUpgradeableProxy) provide upgradeability and access control across the ecosystem.
...
- ASD (verified + unaudited TVL): $1,854,767.16
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $302,361.99 | Verified native implementation with $302,361.99 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $68,832.33 | Verified native implementation with $68,832.33 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,601.99 | Verified native implementation with $51,601.99 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,908.55 | Verified native implementation with $4,908.55 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,564.81 | Verified native implementation with $4,564.81 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $912.98 | Verified native implementation with $912.98 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.04 | Verified native implementation with $36.04 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.16 | Verified native implementation with $32.16 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
