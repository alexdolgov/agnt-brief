...
interface IThenaFarmingPluginFactory {
    ...
    /// @notice Sets the address that receives the NFT fees
    /// @param _nftFeeReceiver The address of the NFT fee receiver
    function setTheNftFeeReceiver(address _nftFeeReceiver) external;
