...
interface IAlgebraVault {
    ...
    /// @notice Update theNFT information in the plugin
    /// @dev the function takes the data from the vault factory contract
    function updateTheNFTInfo() external;
    ...
    /// @param theNftAmount0 Amount of token0 sent to theNFT
    /// @param theNftAmount1 Amount of token1 sent to theNFT
    event FeesDistributed(address indexed gauge, uint256 token0Amount, uint256 token1Amount, uint256 theNftAmount0, uint256 theNftAmount1);
