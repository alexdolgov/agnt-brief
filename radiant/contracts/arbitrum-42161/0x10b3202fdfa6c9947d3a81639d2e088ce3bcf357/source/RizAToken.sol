...
// lib/radiant-v2-core/contracts/arbitrum/dependencies/openzeppelin/contracts/Context.sol
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IAaveIncentivesController.sol

interface IAaveIncentivesController_0 {
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/ILendingPoolAddressesProvider.sol
 ...
 * @author Aave
 **/
interface ILendingPoolAddressesProvider_0 {
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IPriceOracle.sol

/************
@title IPriceOracle interface
@notice Interface for the Aave price oracle.*/
interface IPriceOracle_0 {
	/***********
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IScaledBalanceToken.sol

interface IScaledBalanceToken_0 {
	/**
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/LockedBalance.sol
...
// lib/radiant-v2-core/contracts/arbitrum/lending/libraries/aave-upgradeability/VersionedInitializable.sol
 ...
 */
abstract contract VersionedInitializable_0 {
	/**
...
// lib/radiant-v2-core/contracts/arbitrum/lending/libraries/helpers/Errors.sol
...
// lib/radiant-v2-core/contracts/arbitrum/lending/libraries/types/DataTypes.sol
...
// lib/radiant-v2-core/contracts/main/dependencies/openzeppelin/contracts/Context.sol
...
// lib/radiant-v2-core/contracts/main/dependencies/openzeppelin/upgradeability/Proxy.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IAaveIncentivesController.sol

interface IAaveIncentivesController_1 {
	event RewardsAccrued(address indexed user, uint256 amount);
...
// lib/radiant-v2-core/contracts/main/interfaces/ICreditDelegationToken.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/ILendingPoolAddressesProvider.sol
 ...
 * @author Aave
 **/
interface ILendingPoolAddressesProvider_1 {
	event MarketIdSet(string newMarketId);
	event LendingPoolUpdated(address indexed newAddress);
	event ConfigurationAdminUpdated(address indexed newAddress);
	event EmergencyAdminUpdated(address indexed newAddress);
...
// lib/radiant-v2-core/contracts/main/interfaces/ILendingPoolCollateralManager.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/ILeverager.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IPriceOracle.sol

/************
@title IPriceOracle interface
@notice Interface for the Aave price oracle.*/
interface IPriceOracle_1 {
	/***********
    @dev returns the asset price in ETH
     */
	function getAssetPrice(address asset) external view returns (uint256);
...
// lib/radiant-v2-core/contracts/main/interfaces/IPriceOracleGetter.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IReserveInterestRateStrategy.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IScaledBalanceToken.sol

interface IScaledBalanceToken_1 {
	/**
	 * @dev Returns the scaled balance of the user. The scaled balance is the sum of all the
	 * updated stored balance divided by the reserve's liquidity index at the moment of the update
	 * @param user The user whose balance is calculated
...
// lib/radiant-v2-core/contracts/main/lending/libraries/aave-upgradeability/VersionedInitializable.sol
 ...
 * @author Aave, inspired by the OpenZeppelin Initializable contract
 */
abstract contract VersionedInitializable_1 {
	/**
	 * @dev Indicates that the contract has been initialized.
	 */
	uint256 private lastInitializedRevision = 0;
...
// lib/radiant-v2-core/contracts/main/lending/libraries/helpers/Errors.sol
...
// lib/radiant-v2-core/contracts/main/lending/libraries/types/DataTypes.sol
...
// src/interfaces/IAggregatorV2V3.sol
...
// src/interfaces/IPythEvents.sol
...
// src/interfaces/PythStructs.sol
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IFeeDistribution.sol
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IMintableToken.sol
...
// lib/radiant-v2-core/contracts/arbitrum/lending/libraries/math/WadRayMath.sol
...
library WadRayMath_0 {
	...
	function wadMul(uint256 a, uint256 b) internal pure returns (uint256) {
		...
		require(a <= (type(uint256).max - halfWAD) / b, Errors_0.MATH_MULTIPLICATION_OVERFLOW);
	...
	function wadDiv(uint256 a, uint256 b) internal pure returns (uint256) {
		require(b != 0, Errors_0.MATH_DIVISION_BY_ZERO);
		uint256 halfB = b / 2;

		require(a <= (type(uint256).max - halfB) / WAD, Errors_0.MATH_MULTIPLICATION_OVERFLOW);
	...
	function rayMul(uint256 a, uint256 b) internal pure returns (uint256) {
		...
		require(a <= (type(uint256).max - halfRAY) / b, Errors_0.MATH_MULTIPLICATION_OVERFLOW);
	...
	function rayDiv(uint256 a, uint256 b) internal pure returns (uint256) {
		...
		require(a <= (type(uint256).max - halfB) / RAY, Errors_0.MATH_MULTIPLICATION_OVERFLOW);
	...
	function rayToWad(uint256 a) internal pure returns (uint256) {
		...
		require(result >= halfRatio, Errors_0.MATH_ADDITION_OVERFLOW);
	...
	function wadToRay(uint256 a) internal pure returns (uint256) {
		...
		require(result / WAD_RAY_RATIO == a, Errors_0.MATH_MULTIPLICATION_OVERFLOW);
		return result;
	}
}

// lib/radiant-v2-core/contracts/main/lending/libraries/math/PercentageMath.sol
...
library PercentageMath {
	...
	function percentMul(uint256 value, uint256 percentage) internal pure returns (uint256) {
		...
		require(value <= (type(uint256).max - HALF_PERCENT) / percentage, Errors_1.MATH_MULTIPLICATION_OVERFLOW);
	...
	function percentDiv(uint256 value, uint256 percentage) internal pure returns (uint256) {
		require(percentage != 0, Errors_1.MATH_DIVISION_BY_ZERO);
		uint256 halfPercentage = percentage / 2;

		require(value <= (type(uint256).max - halfPercentage) / PERCENTAGE_FACTOR, Errors_1.MATH_MULTIPLICATION_OVERFLOW);

		return (value * PERCENTAGE_FACTOR + halfPercentage) / percentage;
	}
}

// lib/radiant-v2-core/contracts/main/lending/libraries/math/WadRayMath.sol
...
library WadRayMath_1 {
	...
	function wadMul(uint256 a, uint256 b) internal pure returns (uint256) {
		...
		require(a <= (type(uint256).max - halfWAD) / b, Errors_1.MATH_MULTIPLICATION_OVERFLOW);
	 ...
	 **/
	function wadDiv(uint256 a, uint256 b) internal pure returns (uint256) {
		require(b != 0, Errors_1.MATH_DIVISION_BY_ZERO);
		uint256 halfB = b / 2;

		require(a <= (type(uint256).max - halfB) / WAD, Errors_1.MATH_MULTIPLICATION_OVERFLOW);
	...
	function rayMul(uint256 a, uint256 b) internal pure returns (uint256) {
		...
		require(a <= (type(uint256).max - halfRAY) / b, Errors_1.MATH_MULTIPLICATION_OVERFLOW);
	...
	function rayDiv(uint256 a, uint256 b) internal pure returns (uint256) {
		...
		require(a <= (type(uint256).max - halfB) / RAY, Errors_1.MATH_MULTIPLICATION_OVERFLOW);
	...
	function rayToWad(uint256 a) internal pure returns (uint256) {
		uint256 halfRatio = WAD_RAY_RATIO / 2;
		uint256 result = halfRatio + a;
		require(result >= halfRatio, Errors_1.MATH_ADDITION_OVERFLOW);
	...
	function wadToRay(uint256 a) internal pure returns (uint256) {
		uint256 result = a * WAD_RAY_RATIO;
		require(result / WAD_RAY_RATIO == a, Errors_1.MATH_MULTIPLICATION_OVERFLOW);
		return result;
	}
}

// src/interfaces/IOracleRouter.sol
...
// src/interfaces/Riz/IRizLendingPoolAddressesProvider.sol

interface IRizLendingPoolAddressesProvider is ILendingPoolAddressesProvider_1 {
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/ILendingPool.sol

interface ILendingPool_0 {
	/**
	...
	function initialize(ILendingPoolAddressesProvider_0 provider) external;
	 ...
	 **/
	function getConfiguration(address asset) external view returns (DataTypes_0.ReserveConfigurationMap memory);
	 ...
	 **/
	function getUserConfiguration(address user) external view returns (DataTypes_0.UserConfigurationMap memory);
	...
	function getAddressesProvider() external view returns (ILendingPoolAddressesProvider_0);
...
// lib/radiant-v2-core/contracts/main/dependencies/openzeppelin/upgradeability/BaseUpgradeabilityProxy.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/ILendingPool.sol

interface ILendingPool_1 {
	/**
	 * @dev Emitted on deposit()
	 * @param reserve The address of the underlying asset of the reserve
	 * @param user The address initiating the deposit
	...
	function initialize(ILendingPoolAddressesProvider_1 provider) external;
	 ...
	 * @return The configuration of the reserve
	 **/
	function getConfiguration(address asset) external view returns (DataTypes_1.ReserveConfigurationMap memory);
	 ...
	 * @return The configuration of the user
	 **/
	function getUserConfiguration(address user) external view returns (DataTypes_1.UserConfigurationMap memory);
	 ...
	 * @return The state of the reserve
	 **/
	function getReserveData(address asset) external view returns (DataTypes_1.ReserveData memory);
	...
	function getAddressesProvider() external view returns (ILendingPoolAddressesProvider_1);
...
// lib/radiant-v2-core/contracts/main/lending/libraries/configuration/ReserveConfiguration.sol
...
library ReserveConfiguration {
	 ...
	 **/
	function setLtv(DataTypes_1.ReserveConfigurationMap memory self, uint256 ltv) internal pure {
		require(ltv <= MAX_VALID_LTV, Errors_1.RC_INVALID_LTV);
	 ...
	 **/
	function getLtv(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (uint256) {
	 ...
	 **/
	function setLiquidationThreshold(DataTypes_1.ReserveConfigurationMap memory self, uint256 threshold) internal pure {
		require(threshold <= MAX_VALID_LIQUIDATION_THRESHOLD, Errors_1.RC_INVALID_LIQ_THRESHOLD);
	 ...
	 **/
	function getLiquidationThreshold(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (uint256) {
	 ...
	 **/
	function setLiquidationBonus(DataTypes_1.ReserveConfigurationMap memory self, uint256 bonus) internal pure {
		require(bonus <= MAX_VALID_LIQUIDATION_BONUS, Errors_1.RC_INVALID_LIQ_BONUS);
	 ...
	 **/
	function getLiquidationBonus(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (uint256) {
	 ...
	 **/
	function setDecimals(DataTypes_1.ReserveConfigurationMap memory self, uint256 decimals) internal pure {
		require(decimals <= MAX_VALID_DECIMALS, Errors_1.RC_INVALID_DECIMALS);
	 ...
	 **/
	function getDecimals(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (uint256) {
	 ...
	 **/
	function setActive(DataTypes_1.ReserveConfigurationMap memory self, bool active) internal pure {
	 ...
	 **/
	function getActive(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (bool) {
	 ...
	 **/
	function setFrozen(DataTypes_1.ReserveConfigurationMap memory self, bool frozen) internal pure {
	 ...
	 **/
	function getFrozen(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (bool) {
	 ...
	 **/
	function setBorrowingEnabled(DataTypes_1.ReserveConfigurationMap memory self, bool enabled) internal pure {
	 ...
	 **/
	function getBorrowingEnabled(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (bool) {
	 ...
	 **/
	function setStableRateBorrowingEnabled(DataTypes_1.ReserveConfigurationMap memory self, bool enabled) internal pure {
		self.data =
	...
	function getStableRateBorrowingEnabled(
		DataTypes_1.ReserveConfigurationMap storage self
	 ...
	 **/
	function setReserveFactor(DataTypes_1.ReserveConfigurationMap memory self, uint256 reserveFactor) internal pure {
		require(reserveFactor <= MAX_VALID_RESERVE_FACTOR, Errors_1.RC_INVALID_RESERVE_FACTOR);
	 ...
	 **/
	function getReserveFactor(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (uint256) {
	 ...
	 * @custom:borrow-and-supply-caps
	 */
	function setBorrowCap(DataTypes_1.ReserveConfigurationMap memory self, uint256 borrowCap) internal pure {
	 ...
	 * @custom:borrow-and-supply-caps
	 */
	function getBorrowCap(DataTypes_1.ReserveConfigurationMap memory self) internal pure returns (uint256) {
	 ...
	 * @custom:borrow-and-supply-caps
	 */
	function setSupplyCap(DataTypes_1.ReserveConfigurationMap memory self, uint256 supplyCap) internal pure {
	 ...
	 * @custom:borrow-and-supply-caps
	 */
	function getSupplyCap(DataTypes_1.ReserveConfigurationMap memory self) internal pure returns (uint256) {
	 ...
	 **/
	function getFlags(DataTypes_1.ReserveConfigurationMap storage self) internal view returns (bool, bool, bool, bool) {
	...
	function getParamsMemory(
		DataTypes_1.ReserveConfigurationMap memory self
...
// lib/radiant-v2-core/contracts/main/lending/libraries/configuration/UserConfiguration.sol
...
library UserConfiguration {
	 ...
	 **/
	function setBorrowing(DataTypes_1.UserConfigurationMap storage self, uint256 reserveIndex, bool borrowing) internal {
		require(reserveIndex < 128, Errors_1.UL_INVALID_INDEX);
	...
	function setUsingAsCollateral(
		DataTypes_1.UserConfigurationMap storage self,
	...
	function isUsingAsCollateralOrBorrowing(
		DataTypes_1.UserConfigurationMap memory self,
		uint256 reserveIndex
	 ...
	 **/
	function isBorrowingAny(DataTypes_1.UserConfigurationMap memory self) internal pure returns (bool) {
		return self.data & BORROWING_MASK != 0;
	}
	 ...
	 * @return True if the user has been borrowing any reserve, false otherwise
	 **/
	function isEmpty(DataTypes_1.UserConfigurationMap memory self) internal pure returns (bool) {
		return self.data == 0;
	}
}

// lib/radiant-v2-core/contracts/main/lending/libraries/helpers/Helpers.sol
...
library Helpers {
	...
	function getUserCurrentDebt(
		address user,
		DataTypes_1.ReserveData storage reserve
	...
	function getUserCurrentDebtMemory(
		address user,
		DataTypes_1.ReserveData memory reserve
	) internal view returns (uint256, uint256) {
		return (
			IERC20(reserve.stableDebtTokenAddress).balanceOf(user),
			IERC20(reserve.variableDebtTokenAddress).balanceOf(user)
...
interface IPyth is IPythEvents {
    ...
    /// @notice Returns true if the price feed exists (i.e., has been published at least once).
...
// lib/radiant-v2-core/contracts/main/dependencies/openzeppelin/upgradeability/InitializableUpgradeabilityProxy.sol
...
// lib/radiant-v2-core/contracts/main/lending/libraries/aave-upgradeability/BaseImmutableAdminUpgradeabilityProxy.sol
...
// lib/radiant-v2-core/contracts/main/lending/libraries/math/MathUtils.sol

library MathUtils {
	using SafeMath for uint256;
	using WadRayMath_1 for uint256;
	...
	function calculateLinearInterest(uint256 rate, uint40 lastUpdateTimestamp) internal view returns (uint256) {
		...
		return (rate.mul(timeDifference) / SECONDS_PER_YEAR).add(WadRayMath_1.ray());
	}
	...
	function calculateCompoundedInterest(
		...
		return WadRayMath_1.ray().add(ratePerSecond.mul(exp)).add(secondTerm).add(thirdTerm);
	}
...
// src/interfaces/Riz/IRizLendingPool.sol
...
interface IRizLendingPool {
     ...
     *
     */
    function repay(address asset, uint256 amount, DataTypes_1.InterestRateMode rateMode, address onBehalfOf)
        external
        returns (uint256);
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IInitializableAToken.sol
 ...
 * @author Aave
 **/
interface IInitializableAToken_0 {
	/**
	...
	function initialize(
		...
		IAaveIncentivesController_0 incentivesController,
		uint8 aTokenDecimals,
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IMultiFeeDistribution.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IInitializableAToken.sol
 ...
 * @author Aave
 **/
interface IInitializableAToken_1 {
	/**
	 * @dev Emitted when an aToken is initialized
	 * @param underlyingAsset The address of the underlying asset
	 * @param pool The address of the associated lending pool
	...
	function initialize(
		...
		address treasury,
		address underlyingAsset,
		IAaveIncentivesController_1 incentivesController,
		uint8 aTokenDecimals,
		string calldata aTokenName,
		string calldata aTokenSymbol,
		bytes calldata params
...
// lib/radiant-v2-core/contracts/main/interfaces/IInitializableDebtToken.sol
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IMiddleFeeDistribution.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IStableDebtToken.sol
...
interface IStableDebtToken is IInitializableDebtToken {
	 ...
	 **/
	function getIncentivesController() external view returns (IAaveIncentivesController_1);
}

// lib/radiant-v2-core/contracts/main/lending/libraries/aave-upgradeability/InitializableImmutableAdminUpgradeabilityProxy.sol
...
// lib/radiant-v2-core/contracts/main/interfaces/IVariableDebtToken.sol
 ...
 **/
interface IVariableDebtToken is IScaledBalanceToken_1, IInitializableDebtToken {
	/**
...
// lib/radiant-v2-core/contracts/arbitrum/interfaces/IAToken.sol

interface IAToken_0 is IERC20, IScaledBalanceToken_0, IInitializableAToken_0 {
	/**
	 * @dev Emitted after the mint action
	 * @param from The address performing the mint
	 ...
	 * @dev Returns the address of the incentives controller contract
	 **/
	function getIncentivesController() external view returns (IAaveIncentivesController_0);
	 ...
	 **/
	function POOL() external view returns (ILendingPool_0);
}

// lib/radiant-v2-core/contracts/main/interfaces/IAToken.sol

interface IAToken_1 is IERC20, IScaledBalanceToken_1, IInitializableAToken_1 {
	/**
	 * @dev Emitted after the mint action
	 * @param from The address performing the mint
	 * @param value The amount being
	 ...
	 * @dev Returns the address of the lending pool where this aToken is used
	 **/
	function POOL() external view returns (ILendingPool_1);
}

// lib/radiant-v2-core/contracts/arbitrum/lending/tokenization/IncentivizedERC20.sol
 ...
 **/
abstract contract IncentivizedERC20_0 is Context_1, IERC20, IERC20Metadata {
	using SafeMath for uint256;
	 ...
	 **/
	function _getIncentivesController() internal view virtual returns (IAaveIncentivesController_0);
	...
	function getAssetPrice() external view returns (uint256) {
		ILendingPoolAddressesProvider_0 provider = _pool.getAddressesProvider();
		address oracle = provider.getPriceOracle();
		return IPriceOracle_0(oracle).getAssetPrice(_underlyingAsset);
	}
}

// lib/radiant-v2-core/contracts/main/lending/tokenization/IncentivizedERC20.sol
 ...
 * @author Aave, inspired by the Openzeppelin ERC20 implementation
 **/
abstract contract IncentivizedERC20_1 is Context_2, IERC20, IERC20Metadata {
	using SafeMath for uint256;
	 ...
	 * Done this way in order to not break compatibility with previous versions of aTokens/debtTokens
	 **/
	function _getIncentivesController() internal view virtual returns (IAaveIncentivesController_1);
	...
	function getAssetPrice() external view returns (uint256) {
		ILendingPoolAddressesProvider_1 provider = _pool.getAddressesProvider();
		address oracle = provider.getPriceOracle();
		return IPriceOracle_1(oracle).getAssetPrice(_underlyingAsset);
	}
}
...
contract OracleRouter is Ownable, IOracleRouter {
    ...
    function getAssetPrice(address asset) public view override returns (uint256) {
        ...
        if (!success) {
            ...
            if (!feed.isSet) {
                revert Errors_2.NoFallbackFeedSet();
            }
            (success, price) = oracleProviders[feed.oracleProviderType].getPrice(feed);
            // If the price is not available from the fallback feed, revert
            if (!success) {
                revert Errors_2.NoPriceAvailable();
            }
        }
        // Price cannot be 0
        if (price == 0) {
    ...
    function _setAssetSource(
        ...
        if (_oracleType == OracleProviderType.Chainlink) {
            ...
            revert Errors_2.InvalidOracleProviderType();
        }
    ...
    function _getPythPrice(PriceFeedData memory feed) internal view returns (bool, uint256) {
        ...
        if (priceData.expo > 18 || priceData.expo < -18) {
            revert Errors_2.ExponentOutOfRange(priceData.expo);
        }
        if (priceData.price < 0) {
            revert Errors_2.NegativePythPriceValue(priceData.price);
        }
...
// lib/radiant-v2-core/contracts/main/lending/tokenization/base/DebtTokenBase.sol
...
abstract contract DebtTokenBase is
	IncentivizedERC20_1("DEBTTOKEN_IMPL", "DEBTTOKEN_IMPL", 0),
	VersionedInitializable_1,
	ICreditDelegationToken
{
	...
	modifier onlyLendingPool() {
		require(_msgSender() == address(_getLendingPool()), Errors_1.CT_CALLER_MUST_BE_LENDING_POOL);
		_;
	}
	...
	function _decreaseBorrowAllowance(address delegator, address delegatee, uint256 amount) internal {
		uint256 newAllowance = _borrowAllowances[delegator][delegatee].sub(amount, Errors_1.BORROW_ALLOWANCE_NOT_ENOUGH);
	...
	function _getLendingPool() internal view virtual returns (ILendingPool_1);
}

// src/riz-lending/RizLendingPoolAddressesProvider.sol

/**
 * @title RizLendingPoolAddressesProvider contract
 * @author Radiant
 * @custom:security-contact security@radiant.capital
 * @dev Main registry of addresses part of or connected to the protocol, including permissioned roles
 * - Acting also as factory of proxies and admin of those, so with right to change its implementations
...
contract RizLendingPoolAddressesProvider is Initializable, OwnableUpgradeable, IRizLendingPoolAddressesProvider {
    /// @notice the marketId of the lending pool
    string private _marketId;

    /// @notice emitted when a new address is set within the provider
    ...
    function setMarketId(string memory marketId) external onlyOwner {
        if (keccak256(abi.encodePacked(_marketId)) != keccak256(abi.encodePacked(""))) {
            revert Errors_2.MarketIdAlreadySet();
        }
        _setMarketId(marketId);
    }
    ...
    function setBadDebtManager(address _badDebtManager) external onlyOwner {
        if (badDebtManager != _badDebtManager) {
    ...
    function setAddressAsProxy(bytes32 id, address implementationAddress) external onlyOwner {
        if (
            id == LENDING_POOL || id == LENDING_POOL_CONFIGURATOR || id == POOL_ADMIN || id == EMERGENCY_ADMIN
                || id == LENDING_POOL_COLLATERAL_MANAGER || id == PRICE_ORACLE || id == LENDING_RATE_ORACLE
                || id == RIZ_REGISTRY
        ) {
            revert Errors_2.InvalidId(id);
        }
    ...
    function setAddress(bytes32 id, address newAddress) external onlyOwner {
        if (_addresses[id] != newAddress) {
            _addresses[id] = newAddress;
            emit AddressSet(id, newAddress, false);
        }
        if (newAddress == address(0)) {
            revert Errors_2.AddressZero();
        }
        _addresses[id] = newAddress;
        emit AddressSet(id, newAddress, false);
    }
    ...
    function setLendingPoolCollateralManager(address manager) external onlyOwner {
        if (_addresses[LENDING_POOL_COLLATERAL_MANAGER] != manager) {
    ...
    function setRizRegistry(address rizRegistry) external onlyOwner {
        if (_addresses[RIZ_REGISTRY] != rizRegistry) {
    ...
    /**
     * @dev Sets the address of the EmergencyAdmin
     * @param emergencyAdmin The new EmergencyAdmin address
     */
    function setEmergencyAdmin(address emergencyAdmin) external onlyOwner {
        if (_addresses[EMERGENCY_ADMIN] != emergencyAdmin) {
    ...
    /**
     * @dev Sets the address of the liquidation fee receiver
     * @param liquidationFeeTo The new liquidation fee receiver address
     */
    function setLiquidationFeeTo(address liquidationFeeTo) external onlyOwner {
        _liquidationFeeTo = liquidationFeeTo;
        emit LiquidationFeeUpdated(liquidationFeeTo);
    }

    /**
     * @dev Sets the address of the LendingRateOracle
    ...
    function setLendingRateOracle(address lendingRateOracle) external onlyOwner {
        if (_addresses[LENDING_RATE_ORACLE] != lendingRateOracle) {
    ...
    /**
     * @dev Returns the address of the LendingRateOracle
     * @return The LendingRateOracle address
     */
    function getLendingRateOracle() external view returns (address) {
    ...
    /**
     * @dev Returns the address of the PriceOracle
    ...
    /**
     * @dev Returns the address of the liquidation fee receiver
     * @return The liquidation fee receiver address
     */
    function getLiquidationFeeTo() external view returns (address) {
    ...
    /**
     * @dev Returns the address of the EmergencyAdmin
    ...
    function _updateImpl(bytes32 id, address newAddress) internal {
        ...
        bytes memory params = abi.encodeCall(ILendingPool_1.initialize, IRizLendingPoolAddressesProvider(address(this)));
    ...
    /**
     * @dev Internal function to set the market id
     * @param marketId The market id
     */
    function _setMarketId(string memory marketId) internal {
        if (keccak256(abi.encodePacked(_marketId)) != keccak256(abi.encodePacked(marketId))) {
            _marketId = marketId;
...
// lib/radiant-v2-core/contracts/main/lending/tokenization/StableDebtToken.sol
...
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
	...
	IAaveIncentivesController_1 internal _incentivesController;
	...
	function mint(
		...
		require(vars.newStableRate <= type(uint128).max, Errors_1.SDT_STABLE_DEBT_OVERFLOW);
	 ...
	 * @dev Returns the address of the lending pool where this aToken is used
	 **/
	function POOL() public view returns (ILendingPool_1) {
		return _pool;
	}
	 ...
	 * @dev Returns the address of the incentives controller contract
	 **/
	function getIncentivesController() external view override returns (IAaveIncentivesController_1) {
	 ...
	 **/
	function _getIncentivesController() internal view override returns (IAaveIncentivesController_1) {
	 ...
	 * @dev For internal usage in the logic of the parent contracts
	 **/
	function _getLendingPool() internal view override returns (ILendingPool_1) {
		return _pool;
	}
	...
	function _burn(address account, uint256 amount, uint256 oldTotalSupply) internal {
		...
		_balances[account] = oldAccountBalance.sub(amount, Errors_1.SDT_BURN_EXCEEDS_BALANCE);
		if (address(_incentivesController) != address(0)) {
			_incentivesController.handleActionAfter(account, oldAccountBalance, oldTotalSupply);
		}
	}
...
// lib/radiant-v2-core/contracts/main/lending/libraries/logic/ReserveLogic.sol
...
library ReserveLogic {
	...
	using ReserveLogic for DataTypes_1.ReserveData;
	using ReserveConfiguration for DataTypes_1.ReserveConfigurationMap;
	 ...
	 **/
	function getNormalizedIncome(DataTypes_1.ReserveData storage reserve) internal view returns (uint256) {
	 ...
	 **/
	function getNormalizedDebt(DataTypes_1.ReserveData storage reserve) internal view returns (uint256) {
		uint40 timestamp = reserve.lastUpdateTimestamp;
	 ...
	 * @param reserve the reserve object
	 **/
	function updateState(DataTypes_1.ReserveData storage reserve) internal {
	...
	function cumulateToLiquidityIndex(
		...
		uint256 result = amountToLiquidityRatio.add(WadRayMath_1.ray());

		result = result.rayMul(reserve.liquidityIndex);
		require(result <= type(uint128).max, Errors_1.RL_LIQUIDITY_INDEX_OVERFLOW);
	...
	function init(
		...
		require(reserve.aTokenAddress == address(0), Errors_1.RL_RESERVE_ALREADY_INITIALIZED);

		reserve.liquidityIndex = uint128(WadRayMath_1.ray());
		reserve.variableBorrowIndex = uint128(WadRayMath_1.ray());
	...
	function updateInterestRates(
		...
		require(vars.newLiquidityRate <= type(uint128).max, Errors_1.RL_LIQUIDITY_RATE_OVERFLOW);
		require(vars.newStableRate <= type(uint128).max, Errors_1.RL_STABLE_BORROW_RATE_OVERFLOW);
		require(vars.newVariableRate <= type(uint128).max, Errors_1.RL_VARIABLE_BORROW_RATE_OVERFLOW);
	...
	function _mintToTreasury(
		...
		if (vars.amountToMint != 0) {
			IAToken_1(reserve.aTokenAddress).mintToTreasury(vars.amountToMint, newLiquidityIndex);
		}
	}
	...
	function _updateIndexes(
		...
		if (currentLiquidityRate > 0) {
			...
			require(newLiquidityIndex <= type(uint128).max, Errors_1.RL_LIQUIDITY_INDEX_OVERFLOW);
			...
			if (scaledVariableDebt != 0) {
				...
				require(newVariableBorrowIndex <= type(uint128).max, Errors_1.RL_VARIABLE_BORROW_INDEX_OVERFLOW);
...
// lib/radiant-v2-core/contracts/arbitrum/lending/tokenization/AToken.sol
 ...
 * @author Aave
 */
contract AToken is VersionedInitializable_0, IncentivizedERC20_0("ATOKEN_IMPL", "ATOKEN_IMPL", 0), IAToken_0 {
	using WadRayMath_0 for uint256;
	using SafeERC20 for IERC20;
	using SafeMath for uint256;
	...
	uint256 public constant ATOKEN_REVISION = 0x6;
	...
	IAaveIncentivesController_0 internal _incentivesController;
	...
	modifier onlyLendingPool() {
		require(_msgSender() == address(_pool), Errors_0.CT_CALLER_MUST_BE_LENDING_POOL);
		_;
	}

	modifier onlyPoolAdmin() {
		ILendingPoolAddressesProvider_0 lpAddressProvider = ILendingPoolAddressesProvider_0(_pool.getAddressesProvider());
		require(lpAddressProvider.getPoolAdmin() == msg.sender, Errors_0.LP_CALLER_NOT_LENDING_POOL_CONFIGURATOR);
		_;
	}
	...
	function burn(
		...
		require(amountScaled != 0, Errors_0.CT_INVALID_BURN_AMOUNT);
	...
	function mint(address user, uint256 amount, uint256 index) external override onlyLendingPool returns (bool) {
		...
		uint256 amountScaled = amount.rayDiv(index);
		require(amountScaled != 0, Errors_0.CT_INVALID_MINT_AMOUNT);
	 ...
	 **/
	function balanceOf(address user) public view override(IncentivizedERC20_0, IERC20) returns (uint256) {
	 ...
	 **/
	function totalSupply() public view override(IncentivizedERC20_0, IERC20) returns (uint256) {
	 ...
	 * @dev Returns the address of the lending pool where this aToken is used
	 **/
	function POOL() public view returns (ILendingPool_0) {
		return _pool;
	}
	 ...
	 **/
	function _getIncentivesController() internal view override returns (IAaveIncentivesController_0) {
		return _incentivesController;
	}
	 ...
	 * @dev Returns the address of the incentives controller contract
	 **/
	function getIncentivesController() external view override returns (IAaveIncentivesController_0) {
		return _getIncentivesController();
	}
...
// lib/radiant-v2-core/contracts/main/lending/libraries/logic/GenericLogic.sol
...
library GenericLogic {
	...
	using PercentageMath for uint256;
	using ReserveConfiguration for DataTypes_1.ReserveConfigurationMap;
	using UserConfiguration for DataTypes_1.UserConfigurationMap;
	...
	function balanceDecreaseAllowed(
		...
		address user,
		uint256 amount,
		mapping(address => DataTypes_1.ReserveData) storage reservesData,
		DataTypes_1.UserConfigurationMap calldata userConfig,
	...
	function calculateUserAccountData(
		address user,
		mapping(address => DataTypes_1.ReserveData) storage reservesData,
		DataTypes_1.UserConfigurationMap memory userConfig,
		mapping(uint256 => address) storage reserves,
		uint256 reservesCount,
		address oracle
	) internal view returns (uint256, uint256, uint256, uint256, uint256) {
		...
		for (vars.i = 0; vars.i < reservesCount; vars.i++) {
			...
			DataTypes_1.ReserveData storage currentReserve = reservesData[vars.currentReserveAddress];
...
// src/riz-lending/RizLendingPoolStorage.sol
...
contract RizLendingPoolStorage {
    ...
    mapping(address => DataTypes_1.ReserveData) internal _reserves;
    mapping(address => DataTypes_1.UserConfigurationMap) internal _usersConfig;
...
// lib/radiant-v2-core/contracts/main/lending/libraries/logic/ValidationLogic.sol
...
library ValidationLogic {
	 ...
	 * @param amount The amount to be deposited
	 */
	function validateDeposit(DataTypes_1.ReserveData storage reserve, uint256 amount) external view {
		(bool isActive, bool isFrozen, , ) = reserve.configuration.getFlags();

		require(amount != 0, Errors_1.VL_INVALID_AMOUNT);
		require(isActive, Errors_1.VL_NO_ACTIVE_RESERVE);
		require(!isFrozen, Errors_1.VL_RESERVE_FROZEN);
	}
	 ...
	 * @custom:borrow-and-supply-caps
	 */
	function validateSupplyCap(DataTypes_1.ReserveData storage reserve, uint256 amount) external view {
		...
		require(
			...
			supplyCap == 0 ||
				((IScaledBalanceToken_1(reserve.aTokenAddress).scaledTotalSupply()).rayMul(reserve.liquidityIndex) +
					amount) <=
				supplyCap,
			Errors_1.SUPPLY_CAP_EXCEEDED
		);
	}
	...
	function validateWithdraw(
		...
		uint256 userBalance,
		mapping(address => DataTypes_1.ReserveData) storage reservesData,
		DataTypes_1.UserConfigurationMap storage userConfig,
		mapping(uint256 => address) storage reserves,
		uint256 reservesCount,
		address oracle
	) external view {
		require(amount != 0, Errors_1.VL_INVALID_AMOUNT);
		require(amount <= userBalance, Errors_1.VL_NOT_ENOUGH_AVAILABLE_USER_BALANCE);
		...
		require(
			...
			Errors_1.VL_TRANSFER_NOT_ALLOWED
		);
	}
	...
	function validateBorrow(
		...
		require(vars.isActive, Errors_1.VL_NO_ACTIVE_RESERVE);
		require(!vars.isFrozen, Errors_1.VL_RESERVE_FROZEN);
		require(amount != 0, Errors_1.VL_INVALID_AMOUNT);

		require(vars.borrowingEnabled, Errors_1.VL_BORROWING_NOT_ENABLED);

		//validate interest rate mode
		require(
			uint256(DataTypes_1.InterestRateMode.VARIABLE) == interestRateMode ||
				uint256(DataTypes_1.InterestRateMode.STABLE) == interestRateMode,
			Errors_1.VL_INVALID_INTEREST_RATE_MODE_SELECTED
		);
		...
		require(vars.userCollateralBalanceETH > 0, Errors_1.VL_COLLATERAL_BALANCE_IS_0);

		require(
			vars.healthFactor > GenericLogic.HEALTH_FACTOR_LIQUIDATION_THRESHOLD,
			Errors_1.VL_HEALTH_FACTOR_LOWER_THAN_LIQUIDATION_THRESHOLD
		);
		...
		require(
			...
			Errors_1.VL_COLLATERAL_CANNOT_COVER_NEW_BORROW
		);
		...
		if (interestRateMode == uint256(DataTypes_1.InterestRateMode.STABLE)) {
			//check if the borrow mode is stable and if stable rate borrowing is enabled on this reserve

			require(vars.stableRateBorrowingEnabled, Errors_1.VL_STABLE_BORROWING_NOT_ENABLED);

			require(
				!userConfig.isUsingAsCollateral(reserve.id) ||
					reserve.configuration.getLtv() == 0 ||
					amount > IERC20(reserve.aTokenAddress).balanceOf(userAddress),
				Errors_1.VL_COLLATERAL_SAME_AS_BORROWING_CURRENCY
			);
			...
			require(amount <= maxLoanSizeStable, Errors_1.VL_AMOUNT_BIGGER_THAN_MAX_LOAN_SIZE_STABLE);
		}
	}
	 ...
	 * @custom:borrow-and-supply-caps
	 */
	function validateBorrowCap(DataTypes_1.ReserveData storage reserve, uint256 amount) external view {
		...
		if (borrowCap != 0) {
			...
			uint256 variableDebt = (IScaledBalanceToken_1(reserve.variableDebtTokenAddress).scaledTotalSupply()).rayMul(
				reserve.variableBorrowIndex
			);
			...
			require(totalDebt <= borrowCap, Errors_1.BORROW_CAP_EXCEEDED);
		}
	}
	...
	function validateRepay(
		DataTypes_1.ReserveData storage reserve,
		uint256 amountSent,
		DataTypes_1.InterestRateMode rateMode,
		address onBehalfOf,
		uint256 stableDebt,
		...
		require(amountSent > 0, Errors_1.VL_INVALID_AMOUNT);

		require(
			(stableDebt > 0 && DataTypes_1.InterestRateMode(rateMode) == DataTypes_1.InterestRateMode.STABLE) ||
				(variableDebt > 0 && DataTypes_1.InterestRateMode(rateMode) == DataTypes_1.InterestRateMode.VARIABLE),
			Errors_1.VL_NO_DEBT_OF_SELECTED_TYPE
		);

		require(
			amountSent != type(uint256).max || msg.sender == onBehalfOf,
			Errors_1.VL_NO_EXPLICIT_AMOUNT_TO_REPAY_ON_BEHALF
		);
	}
	...
	function validateSwapRateMode(
		...
		uint256 stableDebt,
		uint256 variableDebt,
		DataTypes_1.InterestRateMode currentRateMode
	) external view {
		...
		if (currentRateMode == DataTypes_1.InterestRateMode.STABLE) {
			require(stableDebt > 0, Errors_1.VL_NO_STABLE_RATE_LOAN_IN_RESERVE);
		} else if (currentRateMode == DataTypes_1.InterestRateMode.VARIABLE) {
			require(variableDebt > 0, Errors_1.VL_NO_VARIABLE_RATE_LOAN_IN_RESERVE);
			/**
			 ...
			 **/
			require(stableRateEnabled, Errors_1.VL_STABLE_BORROWING_NOT_ENABLED);
			...
			revert(Errors_1.VL_INVALID_INTEREST_RATE_MODE_SELECTED);
		}
	}
	...
	function validateRebalanceStableBorrowRate(
		...
		require(
			...
			Errors_1.LP_INTEREST_RATE_REBALANCE_CONDITIONS_NOT_MET
		);
	}
	...
	function validateSetUseReserveAsCollateral(
		...
		require(underlyingBalance > 0, Errors_1.VL_UNDERLYING_BALANCE_NOT_GREATER_THAN_0);
		...
		require(
			...
			Errors_1.VL_DEPOSIT_ALREADY_IN_USE
		);
	}
	...
	function validateFlashloan(address[] memory assets, uint256[] memory amounts) internal pure {
		require(assets.length == amounts.length, Errors_1.VL_INCONSISTENT_FLASHLOAN_PARAMS);
	}
	...
	function validateLiquidationCall(
		DataTypes_1.ReserveData storage collateralReserve,
		DataTypes_1.ReserveData storage principalReserve,
		DataTypes_1.UserConfigurationMap storage userConfig,
		...
		if (!collateralReserve.configuration.getActive() || !principalReserve.configuration.getActive()) {
			return (uint256(Errors_1.CollateralManagerErrors.NO_ACTIVE_RESERVE), Errors_1.VL_NO_ACTIVE_RESERVE);
		}

		if (userHealthFactor >= GenericLogic.HEALTH_FACTOR_LIQUIDATION_THRESHOLD) {
			return (
				uint256(Errors_1.CollateralManagerErrors.HEALTH_FACTOR_ABOVE_THRESHOLD),
				Errors_1.LPCM_HEALTH_FACTOR_NOT_BELOW_THRESHOLD
			);
		}
		...
		if (!isCollateralEnabled) {
			return (
				uint256(Errors_1.CollateralManagerErrors.COLLATERAL_CANNOT_BE_LIQUIDATED),
				Errors_1.LPCM_COLLATERAL_CANNOT_BE_LIQUIDATED
			);
		}

		if (userStableDebt == 0 && userVariableDebt == 0) {
			return (
				uint256(Errors_1.CollateralManagerErrors.CURRRENCY_NOT_BORROWED),
				Errors_1.LPCM_SPECIFIED_CURRENCY_NOT_BORROWED_BY_USER
			);
		}

		return (uint256(Errors_1.CollateralManagerErrors.NO_ERROR), Errors_1.LPCM_NO_ERRORS);
	}
	...
	function validateTransfer(
		...
		require(healthFactor >= GenericLogic.HEALTH_FACTOR_LIQUIDATION_THRESHOLD, Errors_1.VL_TRANSFER_NOT_ALLOWED);
	}
}

// src/BadDebtManager.sol
...
contract BadDebtManager is OwnableUpgradeable {
    ...
    modifier onlyLendingPool() {
        if (msg.sender != rizLendingPool) {
            revert Errors_2.InvalidLendingPool();
        }
        _;
    }
    ...
    function setParamsForEmergencyWithdrawals(
        ...
        if (_assets.length == 0) {
            revert Errors_2.InvalidAssetsLength();
        }
        ...
        bool changed = false;
        for (uint256 i = 0; i < _assets.length; ++i) {
            if (tokenPrices[_assets[i]] != _prices[i] || assetRatios[_assets[i]] != _ratios[i]) {
                tokenPrices[_assets[i]] = _prices[i];
                assetRatios[_assets[i]] = _ratios[i];
                changed = true;
            }
        }
        if (slashingRatio != _slashingRatio) {
    ...
    function _snapshot(uint256 _badDebt) internal {
        ...
        for (uint256 i = 0; i < reservesLength; ++i) {
            ...
            DataTypes_1.ReserveData memory currentConfig = pool.getReserveData(reserve);
        ...
        uint256 assetsLiquidityLength = assetsLiquidity.length;
        for (uint256 i = 0; i < assetsLiquidityLength; ++i) {
...
// src/libraries/EmergencyWithdraw.sol
...
library EmergencyWithdraw {
    ...
    function emergencyWithdraw(
        ...
        mapping(address => DataTypes_1.ReserveData) storage reserves
    ) external {
        ...
        if (badDebtManager.hasUserWithdrawn(user)) {
            revert Errors_2.UserAlreadyWithdrawn();
        }
        ...
        if (params.totalUserDepositsUSD < params.totalUserDebtsUSD || params.totalUserDepositsUSD == 0) {
            revert Errors_2.UserAllowanceZero();
        }
    ...
    function _calculateUserDepositsAndDebts(
        ...
        for (uint256 i = 0; i < params.reservesList.length; ++i) {
            ...
            DataTypes_1.ReserveData memory reserve = reserves[reserveAddress];
...
// src/riz-lending/RizLendingPool.sol

/**
 * @title RizLendingPool contract
 * @author Radiant
 * @custom:security-contact security@radiant.capital
 * @dev Main point of interaction with an Radiant protocol's market
 * - Users can:
 *   # Deposit
 *   # Withdraw
 *   # Borrow
 ...
 */
contract RizLendingPool is VersionedInitializable_1, IRizLendingPool, RizLendingPoolStorage {
    using WadRayMath_1 for uint256;
    using PercentageMath for uint256;
    using SafeERC20 for IERC20;
    using ReserveLogic for DataTypes_1.ReserveData;
     ...
     *
     */
    function initialize(IRizLendingPoolAddressesProvider provider) external override initializer {
    ...
    function finalizeTransfer(
        ...
        if (msg.sender != _reserves[asset].aTokenAddress) {
            revert(Errors_2.LP_CALLER_MUST_BE_AN_ATOKEN);
        }
        ...
        if (from != to) {
            if (balanceFromBefore - amount == 0) {
                DataTypes_1.UserConfigurationMap storage fromConfig = _usersConfig[from];
                fromConfig.setUsingAsCollateral(reserveId, false);
                emit ReserveUsedAsCollateralDisabled(asset, from);
            }

            if (balanceToBefore == 0 && amount != 0) {
                DataTypes_1.UserConfigurationMap storage toConfig = _usersConfig[to];
    ...
    function initReserve(
        ...
        if (!Address.isContract(asset)) {
            revert(Errors_2.LP_NOT_CONTRACT);
        }
    ...
    {
        DataTypes_1.ReserveData storage reserve = _reserves[asset];
        ...
        if (IAToken_1(aToken).balanceOf(onBehalfOf) == 0) {
        ...
        IAToken_1(aToken).mint(onBehalfOf, amount, reserve.liquidityIndex);
    ...
    function withdraw(address asset, uint256 amount, address to) external virtual whenNotPaused returns (uint256) {
        ...
        uint256 userBalance = IAToken_1(aToken).balanceOf(msg.sender);
        ...
        IAToken_1(aToken).burn(msg.sender, to, amountToWithdraw, reserve.liquidityIndex);
        ...
        returns (uint256)
    {
        ...
        ValidationLogic.validateRepay(reserve, amount, rateMode, onBehalfOf, stableDebt, variableDebt);

        uint256 paybackAmount = rateMode == DataTypes_1.InterestRateMode.STABLE ? stableDebt : variableDebt;
        ...
        if (rateMode == DataTypes_1.InterestRateMode.STABLE) {
        ...
        IAToken_1(aToken).handleRepayment(msg.sender, paybackAmount);
    ...
    function swapBorrowRateMode(address asset, uint256 rateMode) external virtual whenNotPausedOrShutdown {
        ...
        DataTypes_1.InterestRateMode interestRateMode = DataTypes_1.InterestRateMode(rateMode);
        ...
        if (interestRateMode == DataTypes_1.InterestRateMode.STABLE) {
    ...
    function liquidationCall(
        ...
        if (!success) {
            revert(Errors_2.LP_LIQUIDATION_CALL_FAILED);
        }
    ...
    function _executeBorrow(ExecuteBorrowParams memory vars) internal {
        DataTypes_1.ReserveData storage reserve = _reserves[vars.asset];
        DataTypes_1.UserConfigurationMap storage userConfig = _usersConfig[vars.onBehalfOf];

        address oracle = _addressesProvider.getPriceOracle();

        uint256 amountInUsd = (IPriceOracleGetter(oracle).getAssetPrice(vars.asset) * vars.amount)
        ...
        if (DataTypes_1.InterestRateMode(vars.interestRateMode) == DataTypes_1.InterestRateMode.STABLE) {
        ...
        if (vars.releaseUnderlying) {
            IAToken_1(vars.aTokenAddress).transferUnderlyingTo(vars.user, vars.amount);
        }
        ...
        emit Borrow(
            ...
            vars.amount,
            vars.interestRateMode,
            DataTypes_1.InterestRateMode(vars.interestRateMode) == DataTypes_1.InterestRateMode.STABLE
                ? currentStableRate
                : reserve.currentVariableBorrowRate,
            vars.referralCode
        );
    ...
    function _addReserveToList(address asset) internal {
        ...
        if (reservesCount > _maxNumberOfReserves) {
            revert(Errors_2.LP_NO_MORE_RESERVES_ALLOWED);
        }
    ...
    function _whenNotPaused() internal view {
        if (_paused) {
            revert(Errors_2.LP_IS_PAUSED);
        }
    }

    function _whenNotShutdown() internal view {
        if (_shutdown) {
            revert Errors_2.PoolDisabled();
        }
    }

    function _onlyLendingPoolConfigurator() internal view {
        if (_addressesProvider.getLendingPoolConfigurator() != msg.sender) {
            revert(Errors_2.LP_CALLER_NOT_LENDING_POOL_CONFIGURATOR);
        }
    }
...
// src/tokenization/RizAToken.sol
...
contract RizAToken is AToken {
        ...
        onlyLendingPool
    {
        ...
        if (!RizLendingPool(address(_pool)).isShutdown()) {
            revert Errors_2.PoolNotDisabled();
        }
        uint256 amountScaled = amount.rayDiv(index);
        if (amountScaled == 0) {
            revert(Errors_2.CT_INVALID_BURN_AMOUNT);
        }
