...
/// @title Eligible Deposit Provider Interim
/// @notice This contract is created to provide eligibility data for the users
/// including Riz, and while transitioning from emissions in CIC to the new system with Merkle-Angle.
/// @author Radiant Labs
contract EligibilityDataProviderInterim is OwnableUpgradeable {
	/********************** Common Info ***********************/
