...
library LibDiamond {
    ...
    function initializeDiamond(IRainPool.Params memory params) internal {
        ...
        if (params.numberOfOptions < 2) {
            _revert(IRainPool.MinimumOptionsShouldBeTwo.selector);
        }
        ...
        ds._swapRouter = params.swapRouter;
