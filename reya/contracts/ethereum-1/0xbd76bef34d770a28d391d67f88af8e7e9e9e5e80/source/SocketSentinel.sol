...
contract SocketSentinel is ERC721, Ownable2Step {
    ...
    constructor(address owner_) ERC721("SocketSentinel", "SS") Ownable2Step() {
    ...
    function safeMintBatch(address[] calldata to) external onlyOwner {
    ...
    function updateTokenURI(
        ...
        emit TokenURIUpdated(id, tokenURI_);
    }
