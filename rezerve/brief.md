...
- Generated: 2026-06-17T07:00:49.794Z
- Pipeline run: brief-regen-topo-2026-06-17
- Chains: ethereum, sonic
- Contract surface: 94 unique implementations (346 raw deployments)
- DeFi Llama TVL: $2,453,433.00
...
- Indexed contracts: 499; live-surface contracts included: 346 (346 live, 0 unknown).
- Excluded by liveness: 40 inactive, 113 singleton, 0 uninitialized.
- Deployment units: 2/55 live.
- Detected codebases: curve-stableswap
- Unverified dependencies: 4/136.

## Audit Coverage Summary

- Verified implementations audited: 1/73 (1.4%)
...
| Contract Name | Role | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---|---|
| EVault | core_logic | ethereum | unit-30320 (3 proxies) | 3 deployments: ethereum [`0x303615...d2f3ad`](./contracts/ethereum-1/0x3036155a3ed3e7f6fff1e96e88f1fe51b6d2f3ad/); ethereum `0xbafc1a...547724`; ethereum `0xc42d33...b57e8a` | ⚠️ Unaudited |
...
| AppOracle | operational_periphery | ethereum | n/a | 2 deployments: ethereum [`0x438f98...f69b66`](./contracts/ethereum-1/0x438f98ef0df5520d1f81105f5ceed54919f69b66/); sonic `0x828848...74b5cc` | ⚠️ Unaudited |
...
| BalancerBorrowAndAdd | core_logic | ethereum | unit-30314 | [`0x03a33d...ed5cdc`](./contracts/ethereum-1/0x03a33ded69e1c154267f1e6082804e901ded5cdc/) | ⚠️ Unaudited |
...
| ProxyAdmin | governance | ethereum | n/a | [`0x33812b...e08982`](./contracts/ethereum-1/0x33812b28d85aaaf53e2661694199e512f3e08982/) | ⚠️ Unaudited |
...
| RebaseController | governance | ethereum | n/a | 6 deployments: ethereum [`0x01c8af...948095`](./contracts/ethereum-1/0x01c8afb4dd61821f8ce88b3739493ffde6948095/); ethereum `0x18162c...b49078`; ethereum `0x2aee5c...db66e6`; ethereum `0x92a65e...78b563`; sonic `0x2f567c...a9ac54`; sonic `0xcad00c...101849` | ⚠️ Unaudited |
...
| Staking4626 | unknown | ethereum | n/a | 5 deployments: ethereum [`0x3f76c1...6eb7bc`](./contracts/ethereum-1/0x3f76c1bcfe294004dc05306c6d3e35e7196eb7bc/); ethereum `0x5aac50...dfe3cc`; ethereum `0x6521fa...029f05`; ethereum `0xd6940e...1cfaf5`; sonic `0x73bc78...7cf0e6` | ⚠️ Unaudited |
...
| StakingDistributionLogic | unknown | ethereum | n/a | 2 deployments: ethereum [`0x3e4df7...b6e802`](./contracts/ethereum-1/0x3e4df75d89c21a76718b1613a2967a3cd9b6e802/); sonic `0x8ae837...8d2cb5` | ⚠️ Unaudited |
| TokenList | token | sonic | n/a | 4 deployments: ethereum `0xb68b2b...f67b5c`; sonic [`0x09639d...2fe363`](./contracts/sonic-146/0x09639de0f3b1da19ed12d5dfc9b172dc932fe363/); sonic `0x1e3e7b...5ed9c7`; sonic `0xe8cb54...fd9917` | ⚠️ Unaudited |
...
| YieldLogic | unknown | ethereum | n/a | 2 deployments: ethereum [`0x739f49...dc1b2c`](./contracts/ethereum-1/0x739f4941b06ab58feb2415f6b9d4615308dc1b2c/); sonic `0xc47d50...da2b4b` | ⚠️ Unaudited |
...
|---|---|---|---|---|---|---|---|---|
| [Halborn - 2025](https://github.com/rezervemoney/code/blob/main/audits/2025-06-21-halborn.pdf) | Halborn | Audit | 2025-06 | aging | Direct | contract_name | 8 | high |
...
| ethereum | [`0x438f98...f69b66`](./contracts/ethereum-1/0x438f98ef0df5520d1f81105f5ceed54919f69b66/) | AppOracle | operational_periphery | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0x739f49...dc1b2c`](./contracts/ethereum-1/0x739f4941b06ab58feb2415f6b9d4615308dc1b2c/) | YieldLogic | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
