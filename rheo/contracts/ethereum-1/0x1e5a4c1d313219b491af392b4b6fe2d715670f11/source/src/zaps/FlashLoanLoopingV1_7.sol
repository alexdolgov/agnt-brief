...
contract FlashLoanLoopingV1_7 is Ownable, FlashLoanReceiverBase, DexSwap {
    ...
    function loopPositionWithFlashLoan(
        ...
        LoopParamsV1_7 memory loopParams = LoopParamsV1_7({
    ...
    function executeOperation(
        ...
        LoopParamsV1_7 memory loopParams = abi.decode(params, (LoopParamsV1_7));
        ...
        _settleFlashLoan(assets, amounts, premiums, loopParams.sizeMarket, loopParams.onBehalfOf);
