# Agentic Audit Brief: RobiniaSwap

⚠️ Lifecycle status: UNKNOWN - TVL dropped 14.7% over 90 days

## Project Overview

- Project: RobiniaSwap (`robiniaswap`)
- Lifecycle: unknown (Tier 0, 85.8% below peak)
- Generated: 2026-06-20T00:07:55.102Z
- Pipeline run: v2-pipeline-2026-06-19-727228-a815
- Chains: bsc
- Contract surface: 1 unique implementations (1 raw deployments)
- DeFi Llama TVL: $19,158.19
...
|---|---|---|---|---|---|---|---|---|
| [RobiniaSwap.pdf](https://github.com/TechRate/Smart-Contract-Audits/blob/main/September/RobiniaSwap.pdf) | unknown | Audit | 2021-09 | stale | Direct | n/a | 0 | n/a |
