...
contract LendingPool is BaseLendingPool {
    address public constant SETTLEMENT_ACCOUNT = address(0x87ff94bB7709c70c6B2018FED12E4Ce0ABbf30Ce);
    ...
    function requestRedeem(
        ...
        require(!blacklisted[msg.sender] && !blacklisted[receiverAddr] && !blacklisted[holderAddr], "Address blacklisted");
    ...
    function claim(
        ...
        require(!blacklisted[msg.sender] && !blacklisted[receiverAddr], "Address blacklisted");
    ...
    function processAllClaimsByDate(
        ...
        for (uint256 i; i < receivers.length; i++) {
            recipientAddr = (blacklisted[receivers[i]]) ? SETTLEMENT_ACCOUNT : receivers[i];
