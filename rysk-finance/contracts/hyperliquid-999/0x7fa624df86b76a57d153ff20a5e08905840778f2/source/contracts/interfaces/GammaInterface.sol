...
interface IController {
	...
	function getCurrentPayout(address _otoken, uint256 _amount) external view returns (uint256);
	...
	function setAuthorizedCaller(address _caller, bool _isAuthorized) external;
