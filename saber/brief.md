...
- Project: Saber (`saber`)
- Website: [https://saberdao.io/](https://saberdao.io/)
- Lifecycle: dead (Tier 1, dead)
- Generated: 2026-05-23T20:03:43.921Z
...
- DeFi Llama TVL: $4,694,024.55
- On-chain TVL (included contracts): $1,851,724.16
- TVL by chain: Ethereum $1,692,881.32 | Arbitrum $158,842.15 | Bsc $0.70

## Project Description

Saber is a multi-chain decentralized exchange (DEX) and yield farming protocol that enables users to swap tokens, provide liquidity, and earn rewards across numerous blockchains. It aggregates various liquidity pools, vaults, and staking mechanisms to optimize yield and facilitate cross-chain asset transfers.

### Architecture

All contracts belong to a single product family, sharing common infrastructure such as proxy-based upgradeability (ArcProxy, TransparentUpgradeableProxy) and governance controllers (FarmV2Controller, FarmV3Controller). Liquidity pools (e.g., BAC pools, PancakePairs) feed into vaults (bVault, CavePool) and auto-compounders (AutoFarmV2), while reward tokens (e.g., StakedBPT, ARBIS) are distributed via staking contracts (MasterChef, BerryMaster, NyanRewards) to incentivize user participation across chains.
...
- ASD (verified + unaudited TVL): $1,851,724.16
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [dead]. ASD of $1,851,724.16 represents exposure in a protocol with dead activity.
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $300,314.09 | Verified native implementation with $300,314.09 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,181.14 | Verified native implementation with $51,181.14 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,940.91 | Verified native implementation with $4,940.91 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,527.58 | Verified native implementation with $4,527.58 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $905.53 | Verified native implementation with $905.53 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $35.75 | Verified native implementation with $35.75 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.90 | Verified native implementation with $31.90 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
