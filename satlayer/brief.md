...
- Generated: 2026-05-25T04:43:54.819Z
- Pipeline run: v2-pipeline-2026-05-22-eff36e-2ebb
- Chains: base, berachain, bsc, ethereum
- Contract surface: 342 unique implementations (884 raw deployments)
- DeFi Llama TVL: $1,179,014.15
- On-chain TVL (included contracts): $311,359,441.50
- TVL by chain: Ethereum $249,338,525.81 | Bsc $60,838,498.38 | Berachain $1,182,417.30
...
- Verified implementations audited: 5/140 (3.6%)
...
- ASD (verified + unaudited TVL): $309,092,463.05
- Latest audit: 2025-08 (fresh)
- Staleness: 3 fresh, 8 aging, 0 stale, 1 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [declining]. ASD of $309,092,463.05 represents exposure in a protocol with declining activity.

### Auditor Coverage

| Auditor | Tier | Contracts Covered | Coverage % | Latest Audit |
|---|---|---:|---:|---|
| Zellic | Tier 2 | 3 | 2.1% | 2025-01 |
| unknown | Tier 2 | 2 | 1.4% | 2024-08 |
| Asymptotic | Tier 2 | 1 | 0.7% | n/a |
| Dedaub | Tier 2 | 1 | 0.7% | 2025-08 |
| Zenith | Tier 2 | 1 | 0.7% | 2025-02 |
...
| brVault | core_logic | ethereum | 4 deployments: ethereum [`0x1419b4...0e3386`](./contracts/ethereum-1/0x1419b48e5c1f5ce413cf02d6dcbe1314170e3386/); ethereum `0xc7d81a...8334c7`; berachain `0xd3c8da...b1d58d`; berachain `0xf97750...31ab18` | ⚠️ Unaudited |
| VaultWithoutNative | core_logic | ethereum | 4 deployments: ethereum [`0x047d41...10d6da`](./contracts/ethereum-1/0x047d41f2544b7f63a8e991af2068a363d210d6da/); ethereum `0xcb674f...36ba8c`; berachain `0xa93322...4ffadd`; berachain `0xe0240d...88dea3` | ⚠️ Unaudited |
...
| brBTC | unknown | ethereum | 10 deployments: ethereum [`0x2ec37d...8f6646`](./contracts/ethereum-1/0x2ec37d45fcae65d9787ecf71dc85a444968f6646/); ethereum `0xac6f8c...e9f7f0`; base `0x3376eb...61514a`; base `0x89b2c7...740aeb`; base `0xa16113...2059be`; base `0xd3c8da...b1d58d`; base `0xdfc7d2...2b511e`; base `0xf97750...31ab18`; berachain `0x552b0c...42fa05`; berachain `0x939197...2b593e` | ⚠️ Unaudited |
...
| ProxyAdmin | governance | berachain | 4 deployments: ethereum `0x9f6326...e7f002`; ethereum `0xa2b94c...91945d`; berachain [`0x17c3b6...d551ab`](./contracts/berachain-80094/0x17c3b688badd6dd11244096a9fbc4ae0add551ab/); berachain `0x9203ce...718031` | ⚠️ Unaudited |
| ProxyMock | unknown | ethereum | [`0x72233f...dee7db`](./contracts/ethereum-1/0x72233ff361ebd3e157e3fa5224365137b6dee7db/) | ⚠️ Unaudited |
| PUMP | unknown | ethereum | 4 deployments: ethereum [`0x0ed540...4b079c`](./contracts/ethereum-1/0x0ed540d53b4b49931544a6d8926f3157784b079c/); ethereum `0x5764d4...a93329`; ethereum `0x769225...7575b9`; ethereum `0x9d1301...b8b949` | ⚠️ Unaudited |
| PumpLockMint | unknown | ethereum | 6 deployments: ethereum [`0x77d22a...04eaad`](./contracts/ethereum-1/0x77d22a277b1b29d9b07c207aa1cdfcc38404eaad/); ethereum `0x9152e9...5658b7`; ethereum `0xb37690...748856`; ethereum `0xb713a6...f9d7c8`; ethereum `0xc3c02d...5b23e4`; ethereum `0xeb863b...6a55a9` | ⚠️ Unaudited |
| PumpStaking | unknown | ethereum | 5 deployments: ethereum [`0x1fcca6...404e1e`](./contracts/ethereum-1/0x1fcca65fb6ae3b2758b9b2b394cb227eae404e1e/); ethereum `0x3d9bcc...5e6083`; ethereum `0x9e9dc4...9c4365`; ethereum `0xc0c687...622f88`; ethereum `0xdba4c3...a86bed` | ⚠️ Unaudited |
| PumpToken | token | ethereum | 5 deployments: ethereum [`0x2cd264...d49cfe`](./contracts/ethereum-1/0x2cd2644edab51cb2122f37e03e5f997661d49cfe/); ethereum `0x9f8a4b...23902b`; ethereum `0xe9ebd6...f6235d`; ethereum `0xf469fb...0a012e`; ethereum `0xfa78ea...9b7d02` | ⚠️ Unaudited |
| PumpTokenOFT | token | ethereum | [`0xadc9c9...f4f9a8`](./contracts/ethereum-1/0xadc9c900b05f39f48bb6f402a1bae60929f4f9a8/) | ⚠️ Unaudited |
| PumpTokenOFTAdapter | adapter | ethereum | 2 deployments: ethereum [`0xcb1b27...ef3a52`](./contracts/ethereum-1/0xcb1b273f03c084a906ee64f27beeed7293ef3a52/); ethereum `0xd57aaa...58ea35` | ⚠️ Unaudited |
...
| Sigma | unknown | ethereum | 3 deployments: ethereum [`0x18d0d9...d021b5`](./contracts/ethereum-1/0x18d0d914913ac720a6421cc809f3f44697d021b5/); berachain `0x563a27...731fe5`; berachain `0xb290be...69ec47` | ⚠️ Unaudited |
...
| ThankYouSatoshi | unknown | ethereum | 2 deployments: ethereum [`0xb08fbe...1f061e`](./contracts/ethereum-1/0xb08fbe0e46c284c002d7718b992c7022aa1f061e/); ethereum `0xbfc2d1...93c1ba` | ⚠️ Unaudited |
...
| uniBTC | unknown | ethereum | 9 deployments: ethereum [`0x004e9c...350568`](./contracts/ethereum-1/0x004e9c3ef86bc1ca1f0bb5c7662861ee93350568/); ethereum `0x38a3e2...6234e7`; ethereum `0x3f310c...44c5bd`; ethereum `0x51a7f8...db6c5e`; ethereum `0x780a69...f375c5`; base `0x552b0c...42fa05`; base `0x939197...2b593e`; berachain `0x50fa14...1b8190`; berachain `0xc3827a...db6e90` | ⚠️ Unaudited |
...
| ethereum | [`0x2cd264...d49cfe`](./contracts/ethereum-1/0x2cd2644edab51cb2122f37e03e5f997661d49cfe/) | PumpToken | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0xadc9c9...f4f9a8`](./contracts/ethereum-1/0xadc9c900b05f39f48bb6f402a1bae60929f4f9a8/) | PumpTokenOFT | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
