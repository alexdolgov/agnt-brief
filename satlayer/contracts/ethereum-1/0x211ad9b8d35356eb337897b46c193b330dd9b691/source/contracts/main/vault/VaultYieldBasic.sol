 ...
 */
abstract contract VaultYieldBasic is
    IVault,
    StrategyFactory,
    ERC4626Upgradeable,
    PausableUpgradeable,
    ReentrancyGuardTransientUpgradeable
{
     ...
     * @param _fairExchangePrice The percentage of the rebalancing loss incurred.
     ...
     */
    function optionalRedeem(address _token, uint256 _shares, uint256 _fairExchangePrice, address _receiver, address _owner)
        public
        override
        nonReentrant
        whenNotPaused
    ...
    {   
        ...
        uint256 assets_ = _shares * _fairExchangePrice / PRECISION;
    ...
    function requestRedeem(uint256 _shares, address _token) external virtual nonReentrant whenNotPaused {
        ...
        // IRedeemOperator(vaultParams.redeemOperator).registerWithdrawal(msg.sender, _shares, false);
