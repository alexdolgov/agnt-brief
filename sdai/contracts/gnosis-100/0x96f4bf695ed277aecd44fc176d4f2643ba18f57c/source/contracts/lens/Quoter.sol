...
import 'lib/v3-core/contracts/interfaces/IAgaveswapV3Pool.sol';
import 'lib/v3-core/contracts/interfaces/callback/IAgaveswapV3SwapCallback.sol';
...
contract Quoter is IQuoter, IAgaveswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IAgaveswapV3Pool) {
        return IAgaveswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IAgaveswapV3SwapCallback
