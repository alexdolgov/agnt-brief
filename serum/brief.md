# Agentic Audit Brief: Serum

⚠️ Lifecycle status: DEAD - TVL changed 0.4% over 90 days

## Project Overview

- Project: Serum (`serum`)
- Lifecycle: dead (Tier 0, 99.2% below peak)
- Generated: 2026-05-22T20:27:47.435Z
...
- DeFi Llama TVL: $15,452,624.15
- On-chain TVL (included contracts): $1,851,996.24
- TVL by chain: Ethereum $1,693,574.79 | Arbitrum $158,420.75 | Bsc $0.70

## Project Description

Serum is a multi-chain DeFi protocol offering yield farming, staking, and liquidity pool products. It aggregates various vaults, pools, and reward mechanisms across numerous blockchains to optimize user returns.

### Architecture

The Serum family unifies various yield strategies through shared governance controllers (FarmV2Controller, FarmV3Controller) and proxy-based upgradeability. Core vaults and pools interact with reward distributors and token contracts, while cross-chain deployments reuse patterns like AutoFarmV2_CrossChain and PancakePair to extend functionality across networks.
...
- ASD (verified + unaudited TVL): $1,851,996.24
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [dead]. ASD of $1,851,996.24 represents exposure in a protocol with dead activity.
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $300,913.34 | Verified native implementation with $300,913.34 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $68,040.71 | Verified native implementation with $68,040.71 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,008.53 | Verified native implementation with $51,008.53 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $5,008.31 | Verified native implementation with $5,008.31 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,512.31 | Verified native implementation with $4,512.31 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $902.48 | Verified native implementation with $902.48 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $35.62 | Verified native implementation with $35.62 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.80 | Verified native implementation with $31.80 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
