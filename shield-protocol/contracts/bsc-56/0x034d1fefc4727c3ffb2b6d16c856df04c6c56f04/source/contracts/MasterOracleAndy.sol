...
// File contracts/oracles/MasterOracleAndy.sol

pragma solidity 0.8.4;

contract MasterOracleAndy is Ownable {
    uint256 private constant PRICE_PRECISION = 1e18;

    IPairOracle public oracleXToken;
    IPairOracleAndy public oracleYToken;

    address public xToken;  // AndyX
    address public yToken;  // shield

    constructor(
        address _xToken,
        address _yToken,
        address _oracleXToken,   // andy-andyx
        address _oracleYToken,   // andy-shield
        ...
        oracleYToken = IPairOracleAndy(_oracleYToken);
