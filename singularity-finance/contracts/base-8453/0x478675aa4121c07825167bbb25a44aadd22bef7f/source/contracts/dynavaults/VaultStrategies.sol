...
contract VaultStrategies is VaultTokens {
	...
	/**
	 * @notice Ressurect a strategy, re-enabling it in the vault
	 * @param strategy The address of the strategy to resurrect
	 */
	function resurrectStrategy(address strategy) external {
		VaultStrategiesLib.resurrectStrategy(strategy);
	}
