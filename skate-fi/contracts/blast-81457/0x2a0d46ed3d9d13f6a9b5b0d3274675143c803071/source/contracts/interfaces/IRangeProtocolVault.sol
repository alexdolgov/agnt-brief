...
import {IThrusterMintCallback} from "../thruster/interfaces/callbacks/IThrusterMintCallback.sol";
import {IThrusterSwapCallback} from "../thruster/interfaces/callbacks/IThrusterSwapCallback.sol";
import {IThrusterPool} from "../thruster/interfaces/IThrusterPool.sol";
import {DataTypes} from "../libraries/DataTypes.sol";

interface IRangeProtocolVault is IERC20Upgradeable, IThrusterMintCallback, IThrusterSwapCallback {
    event Minted(
    ...
    function pool() external view returns (IThrusterPool);
    ...
    function setOtherFeeRecipient(address newOtherFeeRecipient) external;
}
