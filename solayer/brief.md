...
- Generated: 2026-05-22T21:48:31.225Z
...
- Contract surface: 935 unique implementations (1319 raw deployments)
- DeFi Llama TVL: $13,479,547.00
- On-chain TVL (included contracts): $1,852,357.36
- TVL by chain: Ethereum $1,693,685.56 | Arbitrum $158,671.11 | Bsc $0.70

## Project Description

Solayer is a multi-chain DeFi protocol offering yield aggregation, staking, and liquidity pool products. It enables users to deposit assets into vaults and pools to earn rewards, and includes a crypto card component for spending.

### Architecture

The Solayer Card family integrates vaults, pools, and staking contracts that share common reward and governance infrastructure. Tokens like ArcProxy and StakedBPT flow between core vaults and supporting staking/reward contracts, while controllers and proxies manage upgrades and cross-chain functionality.
...
- Unverified implementations: 750
- Unique implementations: 935
- Raw deployments: 1319
- Audits discovered: 5
- Scoreable audits (matched contracts): 0
- ASD (verified + unaudited TVL): $1,852,357.36
- Latest audit: 2024-10 (aging)
- Staleness: 0 fresh, 4 aging, 1 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [declining]. ASD of $1,852,357.36 represents exposure in a protocol with declining activity.
...
|---|---|---|---|---|---|---|---|---|
| [1. [OtterSec](): April, 2024 Audit](https://github.com/solayer-labs/token-metadata/blob/07981c9059f64b50132a67c9db57219ed194678d/audit.pdf) | OtterSec | Audit | 2024-04 | stale | Direct | n/a | 0 | n/a |
| [2. [OtterSec](): July, 2024 Audit](https://github.com/solayer-labs/solayer-improvement-proposal/blob/main/audits/restaking/OtterSec-audit-report-restaking-program.pdf) | OtterSec | Audit | 2024-07 | aging | Direct | n/a | 0 | n/a |
| [3. [Halborn - endoAVS](): August, 2024](https://github.com/solayer-labs/solayer-improvement-proposal/blob/main/audits/endoavs/Halborn-audit-report-endoavs-program.pdf) | Halborn | Audit | 2024-08 | aging | Direct | n/a | 0 | n/a |
| [4. [Halborn - pool](): August, 2024](https://github.com/solayer-labs/solayer-improvement-proposal/blob/main/audits/restaking/Halborn-audit-report-restaking-program.pdf) | Halborn | Audit | 2024-08 | aging | Direct | n/a | 0 | n/a |
| [5. [Halborn - sUSD](): October, 2024 (also discovered via alternate URL)](https://github.com/solayer-labs/solayer-improvement-proposal/blob/main/audits/stablecoin/Halborn-audit-report-susd-program.pdf) | Halborn | Audit | 2024-10 | aging | Direct | n/a | 0 | n/a |
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $301,041.84 | Verified native implementation with $301,041.84 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $68,177.50 | Verified native implementation with $68,177.50 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,111.08 | Verified native implementation with $51,111.08 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,990.57 | Verified native implementation with $4,990.57 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,521.39 | Verified native implementation with $4,521.39 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $904.29 | Verified native implementation with $904.29 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $35.70 | Verified native implementation with $35.70 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.86 | Verified native implementation with $31.86 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
- [1995] 1. [OtterSec](): April, 2024 Audit
- [1996] 2. [OtterSec](): July, 2024 Audit
- [1997] 3. [Halborn - endoAVS](): August, 2024
- [1998] 4. [Halborn - pool](): August, 2024
- [1999] 5. [Halborn - sUSD](): October, 2024
