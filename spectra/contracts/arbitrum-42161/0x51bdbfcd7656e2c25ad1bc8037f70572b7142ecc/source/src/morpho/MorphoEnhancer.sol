...
import "../utils/Spectra4626Wrapper.sol";
...
contract EnhancerV2 is Spectra4626Wrapper {
    ...
    /// @dev the contract was upgraded with the addition of AccessManaged inheritance.
    /// This reinitializer has the purpose to initialize AccessManaged.
    function initializeV02(address _initialAuthority) external reinitializer(VERSION) {
