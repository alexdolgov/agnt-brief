...
interface IVoter {
    ...
    event VotingRewardsCreated(
        ...
        address indexed fees,
        address votingRewardsFactory,
        address whitelister
    );
    event WhitelistNFT(address indexed ve, uint256 indexed tokenId, bool indexed _bool, address whitelister);
    ...
    function claimBribes(address[] memory _bribes, address[][] memory _tokens, address _ve, uint256 _tokenId) external;
