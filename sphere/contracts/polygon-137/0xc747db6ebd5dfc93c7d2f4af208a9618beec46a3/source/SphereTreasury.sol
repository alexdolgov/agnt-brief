...
contract SphereTreasury is Ownable {
    ...
    function retrieveMATIC(uint amount) external onlyOwner {
    ...
    function claimMATIC(uint amount, address receiver) external onlyOwner {
