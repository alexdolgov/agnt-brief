# Agentic Audit Brief: Splash Protocol

## Project Overview

- Project: Splash Protocol (`splash-protocol`)
- Website: [https://www.splash.trade](https://www.splash.trade)
- Lifecycle: active (Tier 0, 93.5% below peak)
- Generated: 2026-05-23T18:08:20.316Z
...
- DeFi Llama TVL: $5,192,622.96
- On-chain TVL (included contracts): $1,850,089.15
- TVL by chain: Ethereum $1,692,138.15 | Arbitrum $157,950.31 | Bsc $0.70

## Project Description

Splash Protocol is a multi-chain DeFi platform offering yield farming, staking, and liquidity provision. It aggregates various pools and vaults to optimize returns for users across numerous blockchains.

### Architecture

The protocol's single product family encompasses all contracts, with core vaults and pools relying on governance controllers and auto-compounders for yield optimization. Shared infrastructure includes proxy patterns for upgradeability and cross-chain token bridges.
...
- ASD (verified + unaudited TVL): $1,850,089.15
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $299,600.27 | Verified native implementation with $299,600.27 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $67,783.67 | Verified native implementation with $67,783.67 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $50,815.83 | Verified native implementation with $50,815.83 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,911.57 | Verified native implementation with $4,911.57 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,495.27 | Verified native implementation with $4,495.27 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $899.07 | Verified native implementation with $899.07 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $35.49 | Verified native implementation with $35.49 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $31.68 | Verified native implementation with $31.68 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
