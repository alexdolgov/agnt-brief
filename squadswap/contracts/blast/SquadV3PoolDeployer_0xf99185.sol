...
contract SquadV3Pool is ISquadV3Pool {
    ...
    modifier onlyFactoryOwner() {
        require(msg.sender == ISquadV3Factory(factory).owner());
        _;
    }
    ...
    function initialize(uint160 sqrtPriceX96) external override {
        ...
        IBlastPoints(BLAST_POINTS).configurePointsOperator(ISquadV3Factory(factory).pointsAdmin());
        ...
        slot0 = Slot0({
            ...
            feeProtocol: 524296000, // default value for all pools, 8000:8000, store 2 uint32 inside
            unlocked: true
        });
