// ============================================================
// FILE: @squadswap/v3-lm-pool/contracts/interfaces/ISquadV3LmPool.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/callback/ISquadV3FlashCallback.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/callback/ISquadV3MintCallback.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/callback/ISquadV3SwapCallback.sol
// ============================================================
...
// ============================================================
// FILE: contracts/interfaces/ISquadV3PoolDeployer.sol
// ============================================================

// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;

/// @title An interface for a contract that is capable of deploying SquadSwap V3 Pools
/// @notice A contract that constructs a pool must implement this to pass arguments to the pool
/// @dev This is used to avoid having constructor arguments in the pool contract, which results in the init code hash
/// of the pool being constant allowing the CREATE2 address of the pool to be cheaply computed on-chain
interface ISquadV3PoolDeployer {
...
// ============================================================
// FILE: contracts/interfaces/ISquadV3PoolManager.sol
// ============================================================
...
// ============================================================
// FILE: contracts/SquadV3Pool.sol
// ============================================================
...
import {ISquadV3PoolManagerStates} from './interfaces/ISquadV3PoolManager.sol';
...
contract SquadV3Pool is ISquadV3Pool {
    ...
    /// @inheritdoc ISquadV3PoolImmutables
    uint24 public immutable override defaultFee;
    ...
    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, defaultFee, _tickSpacing) = ISquadV3PoolDeployer(msg.sender).parameters();
    ...
    function fee() public view override returns (uint24) {
        return ISquadV3PoolManagerStates(ISquadV3Factory(factory).poolManager()).getFee(address(this), defaultFee);
    }
...
// ============================================================
// FILE: contracts/SquadV3PoolDeployer.sol
// ============================================================
