 ...
 * @dev Distribution contract for airdrops using Merkle trees
 */
contract AirdropDistributor is IRewardsDistributor, Ownable, Pausable, FeeM {
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    mapping(uint256 epoch => uint256 timestamp) public epochsTimestamps;

    mapping(uint256 epoch => mapping(address account => bool claimed)) public claimedStatus;

    uint256 public constant CLAIM_AVAILABILITY_DELAY = 180 days;
    ...
    function multiClaim(address account, IRewardsDistributor.ClaimParams[] calldata params) external override whenNotPaused {
    ...
    function addEpochRewards(uint256 epoch, bytes32 newMerkleRoot) external onlyOwner {
        ...
        epochsTimestamps[epoch] = block.timestamp;
    ...
    function retrieveUnclaimedReward(
        ...
        uint256 timestamp = epochsTimestamps[epoch];
        if (timestamp + CLAIM_AVAILABILITY_DELAY > block.timestamp) revert Errors.ClaimStillAvailable();
