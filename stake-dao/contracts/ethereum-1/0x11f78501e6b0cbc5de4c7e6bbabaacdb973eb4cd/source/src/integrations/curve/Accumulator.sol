...
import {CurveLocker, CurveProtocol, CurveStrategy} from "@address-book/src/CurveEthereum.sol";
...
contract CurveAccumulator is AccumulatorDelegable, SafeModule {
    ////////////////////////////////////////////////////////////
    /// --- CONSTRUCTOR
    ////////////////////////////////////////////////////////////
        ...
        SafeModule(_gateway)
    {
        ...
        accountant = CurveStrategy.ACCOUNTANT;
    ...
    function _notifyReward(address _tokenReward, uint256 _amount) internal override {
        ...
        if (feeReceiver != address(0) && _tokenReward == token) IFeeReceiver(feeReceiver).split(_tokenReward);
