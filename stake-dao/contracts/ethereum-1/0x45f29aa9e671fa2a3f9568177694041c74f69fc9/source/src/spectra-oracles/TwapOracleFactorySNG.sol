...
import {PriceFeedCurvePTAssetSNG} from "src/spectra-oracles/oracle-instances/stableswap-ng/PriceFeedCurvePTAssetSNG.sol";
import {PriceFeedCurvePTAssetBounded} from "src/spectra-oracles/oracle-instances/stableswap-ng/PriceFeedCurvePTAssetBounded.sol";
...
contract TwapOracleFactorySNG is AccessManagedUpgradeable, ITwapOracleFactory {
    ...
    function initialize(
        ...
        address[ORACLE_TYPE_COUNT] memory _oracleBeaconAddresses
    ...
    function setOracleBeaconAddress(
    ...
    function deployOracle(
        ...
        bytes memory initData = (OracleType.PTUNDHYBRID == _oracleType)
            ? abi.encodeWithSelector(
                PriceFeedCurvePTAssetBounded(address(0)).initialize.selector,
                _pt,
                _pool,
                _impliedRate
            )
