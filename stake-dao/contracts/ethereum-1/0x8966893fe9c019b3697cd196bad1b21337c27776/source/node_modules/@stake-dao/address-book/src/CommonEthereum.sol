...
library Common {
    ...
    /// @notice WBTC18 is a wrapper around WBTC with 18 decimals (vs 8 for WBTC)
    /// @dev Required for gauge rewards to avoid precision loss with 8-decimal tokens
    address internal constant WBTC18 = 0xe065Bc161b90C9C4Bba2de7F1E194b70A3267c47;
    address internal constant ETH_ERC20_PLACEHOLDER = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    // DEPLOYER
    address internal constant CREATE2_FACTORY = CommonUniversal.CREATE2_FACTORY;
    address internal constant CREATE3_FACTORY = CommonUniversal.CREATEX_FACTORY;
    ...
    // Pyth
    address internal constant PYTH_CORE = 0x4305FB66699C3B2702D4d05CF36551390A4c69C6;

    // Enso Router
    address internal constant ENSO = CommonUniversal.ENSO;
}
