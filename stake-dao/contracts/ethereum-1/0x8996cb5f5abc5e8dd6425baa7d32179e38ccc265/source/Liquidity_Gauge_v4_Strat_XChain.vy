# @version 0.3.10
"""
@title Liquidity Gauge v4 Strat XChain
...
@external
def initialize(_staking_token: address, _admin: address, _vault: address, _symbol: String[30]):
    """
    ...
    self.name = concat("Stake DAO ", _symbol, " Gauge")
...
def set_vault(_vault:address):
    ...
    """
    assert msg.sender == self.admin #dev : only admin can call this function 
    self.vault = _vault
