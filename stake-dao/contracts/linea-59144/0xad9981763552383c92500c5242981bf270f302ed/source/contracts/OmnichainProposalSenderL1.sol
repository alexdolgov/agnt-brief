...
contract OmnichainProposalSenderL1 is Ownable, ReentrancyGuard {
    ...
    constructor(ILayerZeroEndpoint _lzEndpoint) Ownable(msg.sender) {
        require(
            ...
            "OmnichainProposalSender: invalid endpoint"
        );
    ...
    function execute(
        ...
        require(
            ...
            "OmnichainProposalSender: destination chain is not a trusted source"
        );
    ...
    function retryExecute(
        ...
        require(
            hash != bytes32(0),
            "OmnichainProposalSender: no stored payload"
        );
