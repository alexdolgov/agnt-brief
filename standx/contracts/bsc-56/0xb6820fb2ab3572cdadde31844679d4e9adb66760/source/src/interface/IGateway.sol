...
import {GatewayLib} from "../gateway/GatewayLib.sol";
...
interface IGateway {
    ...
    event DepositToHighway(address indexed user, IERC20 indexed token, uint256 amount);
    ...
    /// @param targetToken Token to receive
