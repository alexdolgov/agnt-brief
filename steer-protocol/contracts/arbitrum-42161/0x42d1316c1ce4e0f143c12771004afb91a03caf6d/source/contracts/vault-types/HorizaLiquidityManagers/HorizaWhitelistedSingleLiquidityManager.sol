...
import { HorizaBaseLiquidityManager } from "./HorizaBaseLiquidityManager.sol";
...
import { HorizaSinglePositionLiquidityManager } from "./HorizaSinglePositionLiquidityManager.sol";

// SinglePositionLiquidityManager with whitelist-gated deposits
contract HorizaWhitelistedSingleLiquidityManager is HorizaSinglePositionLiquidityManager {
    // Storage
    ...
    ) public virtual override(HorizaBaseLiquidityManager) {
