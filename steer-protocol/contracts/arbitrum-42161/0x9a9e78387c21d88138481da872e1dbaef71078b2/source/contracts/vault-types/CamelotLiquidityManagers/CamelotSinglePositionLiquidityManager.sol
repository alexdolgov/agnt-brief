...
import "./CamelotBaseLiquidityManager.sol";

contract CamelotSinglePositionLiquidityManager is CamelotBaseLiquidityManager {
    ...
    ///      This represents the active position of the vault inside Algebra.
    ...
    function _setBins(
        ...
        if (swapAmount > 0) {
            ...
            require(
                _getBalance1() < (t1ToDeposit * FIVE) / DIVISOR100,
                "swap"
            );
            ...
            // (ensuring that swap amount wasn't too great)
            require(
                _getBalance0() < (t0ToDeposit * FIVE) / DIVISOR100,
                "swap"
            );
        }
    }
