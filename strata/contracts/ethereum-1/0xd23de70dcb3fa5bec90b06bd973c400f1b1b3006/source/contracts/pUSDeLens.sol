...
import { IIntegration } from "./pUSDeLens/Interfaces.sol";

import { PendleIntegration } from "./pUSDeLens/integrations/PendleIntegration.sol";
import { TermmaxIntegration } from "./pUSDeLens/integrations/TermmaxIntegration.sol";
import { EulerIntegration } from "./pUSDeLens/integrations/EulerIntegration.sol";

/**
 * @title Strata pUSDe Contract Helper
 * @author Strata
 */
contract pUSDeLens is OwnableUpgradeable {
    ...
    /**
     * @notice Calculate user's pUSDe balance including holdings from partner's protocols
     * @param owner The address of the account to query
     * @return The amount of pUSDe owned by `owner`
     */
