...
/**
    @title STRDY Token Locker
    @notice STRDY tokens can be locked in this contract to receive "lock weight",
            which is used within `AdminVoting` and `IncentiveVoting` to vote on
            core protocol operations.
 */
contract STRDYLocker is Ownable, SystemStart {
    ...
    ) SystemStart(_startTime) Ownable() {
        lockToken = _token;
