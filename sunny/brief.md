# Agentic Audit Brief: Sunny

⚠️ Lifecycle status: DEAD - TVL changed 4.3% over 90 days

## Project Overview

- Project: Sunny (`sunny`)
- Lifecycle: dead (Tier 0, 99.9% below peak)
- Generated: 2026-05-24T11:17:08.237Z
...
- DeFi Llama TVL: $2,564,119.88
- On-chain TVL (included contracts): $1,857,234.35
- TVL by chain: Ethereum $1,695,712.75 | Arbitrum $161,520.91 | Bsc $0.70

## Project Description

Sunny is a multi-chain yield aggregation protocol that deploys vaults, staking pools, and liquidity pools to optimize returns for users. It supports a wide range of DeFi primitives including stablecoin pools, LP token staking, and cross-chain yield strategies.

### Architecture

The Sunny family encompasses all contracts, with core vaults and pools (e.g., bVault, BAC pools) serving as primary yield-generating mechanisms, while governance controllers (FarmV2Controller, FarmV3Controller) and reward distributors (MasterChef, NyanRewards) manage incentives. Cross-chain strategies are enabled by AutoFarmV2_CrossChain and bridge-related contracts like L2TBTC and MantaMintableERC20WithBridgeFlag, sharing infrastructure across multiple chains.
...
- ASD (verified + unaudited TVL): $1,857,234.35
- Latest audit: n/a (unknown)
- Staleness: 0 fresh, 0 aging, 0 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [dead]. ASD of $1,857,234.35 represents exposure in a protocol with dead activity.
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $303,115.34 | Verified native implementation with $303,115.34 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x47a156...46a49b`](./contracts/arbitrum-42161/0x47a156668f1ecc659efbbf4910508ace1b46a49b/) | MIMETHStrategy2 | core_logic | $69,734.56 | Verified native implementation with $69,734.56 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $52,278.37 | Verified native implementation with $52,278.37 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,971.10 | Verified native implementation with $4,971.10 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,624.65 | Verified native implementation with $4,624.65 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0xaed29d...fd879d`](./contracts/arbitrum-42161/0xaed29d87da3e3294854c8b966b54ccae3bfd879d/) | MIMETHARBISSHARESFarmStrategy | core_logic | $924.95 | Verified native implementation with $924.95 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x9ab60e...37d41c`](./contracts/arbitrum-42161/0x9ab60e8db1ff7d1d18d03e8d821bd440c337d41c/) | HoneyETHLPStrategy | core_logic | $36.51 | Verified native implementation with $36.51 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x5ec477...85a9fc`](./contracts/arbitrum-42161/0x5ec477eda75303450a4185b3557c2c2fbb85a9fc/) | SPELLETHStrategy | core_logic | $32.58 | Verified native implementation with $32.58 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
