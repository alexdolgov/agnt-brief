...
contract HONO is ERC20, Ownable {
    ...
    constructor(address _owner) payable ERC20("HONOLULU", "HONO") {
        uniswapV2Router = IUniswapV2Router02(
            0x4cf76043B3f97ba06917cBd90F9e3A2AAC1B306e
        );
        _approve(address(this), address(uniswapV2Router), type(uint256).max);

        uint256 totalSupply = 8888888888 * 10 ** 8;
        ...
        marketingWallet = 0x1Bf0AcC4A71fB70B31F53F84f3E6E3B278980E3d;
        ...
        _mint(_owner, (totalSupply * 5) / 100);
