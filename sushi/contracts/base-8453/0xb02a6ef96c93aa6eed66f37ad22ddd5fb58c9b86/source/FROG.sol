...
contract FROG is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 88888888888888 * 10 ** _decimals;
    string private constant _name = unicode"FROGFROGFROGFROGFROGFROGFROGFROGx10";
    ...
    function reduceTaxesToFive() external onlyOwner {
        _finalBuyTax = 5;
        _finalSellTax = 5;
    }

    function reduceTaxesToThree() external onlyOwner {
        _finalBuyTax = 3;
        _finalSellTax = 3;
    }
