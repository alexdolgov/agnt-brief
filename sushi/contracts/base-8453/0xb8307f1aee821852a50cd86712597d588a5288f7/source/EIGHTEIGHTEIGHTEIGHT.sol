...
contract EIGHTEIGHTEIGHTEIGHT is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"EIGHTEIGHTEIGHTEIGHT";
    string private constant _symbol = unicode"8888";
