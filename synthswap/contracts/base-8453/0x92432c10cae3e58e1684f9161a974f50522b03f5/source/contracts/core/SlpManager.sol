...
contract SlpManager is ReentrancyGuard, Governable, IGlpManager {
    ...
    function _addLiquidity(
        ...
        require(mintAmount >= _minGlp, "SlpManager: insufficient SLP output");
    ...
    function _removeLiquidity(
        ...
        require(_glpAmount > 0, "SlpManager: invalid _glpAmount");
        require(
