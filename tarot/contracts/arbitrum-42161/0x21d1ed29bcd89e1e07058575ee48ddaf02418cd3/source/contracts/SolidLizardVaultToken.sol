...
import "./interfaces/ISolidLizardRouter.sol";
import "./interfaces/IBaseV1Pair.sol";
import "./interfaces/ISolidLizardPair.sol";
import "./interfaces/ISolidLizardVaultToken.sol";
...
contract SolidLizardVaultToken is ISolidLizardVaultToken, PoolToken {
    ...
    function _initialize(
        ...
        WETH = ISolidLizardRouter(_router).wmatic();
    ...
    function _optimalDepositA(
        ...
        uint256 pairFee = ISolidLizardPair(underlying).swapFee();
        uint256 swapFee = uint256(1000000).div(pairFee);
