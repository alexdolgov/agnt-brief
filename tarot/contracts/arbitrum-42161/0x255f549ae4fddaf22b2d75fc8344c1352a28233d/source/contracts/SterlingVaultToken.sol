...
import "./interfaces/ISterlingPair.sol";
import "./interfaces/ISterlingVaultToken.sol";
...
contract SterlingVaultToken is ISterlingVaultToken, PoolToken {
    ...
    function _optimalDepositA(
        ...
        uint256 pairFee = ISterlingPair(underlying).swapFeeChosen();
