...
contract ApeToken {
    string constant public name = "ArbiApe";
    string constant public symbol = "APE";
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'APE: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'APE: INVALID_SIGNATURE');
