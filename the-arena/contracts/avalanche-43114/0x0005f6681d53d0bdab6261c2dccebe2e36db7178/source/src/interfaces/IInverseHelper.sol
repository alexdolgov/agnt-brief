...
interface IInverseHelper {
    ...
    function getPurchaseAmountAndPriceWithGivenAvax(uint256 _tokenId, uint256 avaxAmount) external view returns (uint256 purchaseAmount, uint256 price);
    ...
    function getPurchaseAmountAndPriceWithGivenAvaxForNewToken(uint256 a, uint256 curveScaler, uint256 creatorFeeBasisPoints, uint256 avaxAmount) external view returns (uint256 purchaseAmount, uint256 price);
    function getAvaxAmountForSell(uint256 tokenId, uint256 sellAmount) external view returns (uint256 avaxAmount);
