...
import "../veTHEAutomation/Gelato/Types.sol";
import {ITaskTreasuryGelato} from "./ITaskTreasuryGelato.sol";
...
interface IGelatoAutomate {
     ...
     *
     * @return ITaskTreasuryGelato TaskTreasury contract interface
     */
    function taskTreasury() external view returns (ITaskTreasuryGelato);
