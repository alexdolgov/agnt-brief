...
⚠️ Lifecycle status: UNKNOWN - TVL dropped 3.4% over 90 days

## Project Overview

- Project: Thesauros (`thesauros`)
- Website: [https://thesauros.io](https://thesauros.io)
- Lifecycle: unknown (Tier 0, 36.4% below peak)
- Generated: 2026-06-21T05:10:10.360Z
- Pipeline run: v2-pipeline-2026-06-21-727228-48f6
- Chains: arbitrum, base
- Contract surface: 25 unique implementations (38 raw deployments)
- DeFi Llama TVL: $50,836.25
- On-chain TVL (included contracts): n/a
- TVL by chain: n/a

## Project Description

Thesauros is a yield optimization protocol that aggregates and rebalances deposits across multiple lending protocols (Aave V3, Compound V3, Morpho, Dolomite) to maximize user returns. It uses provider contracts to interface with each lending platform and rebalancer contracts to shift funds between them based on yield opportunities.

### Architecture

All contracts belong to a single product family where rebalancer contracts orchestrate fund movements between provider contracts. The providers act as adapters to external lending protocols, sharing a common interface for the rebalancer to deposit and withdraw funds.
...
| Rebalancer | adapter | base | unit-41055 | [`0xca6029...f579b8`](./contracts/base-8453/0xca6029f2d5f5d36da047206ae7a254fa80f579b8/) | ⚠️ Unaudited |
