...
import '@throneexchange/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@throneexchange/v3-core/contracts/libraries/SafeCast.sol';
import '@throneexchange/v3-core/contracts/libraries/TickMath.sol';
import '@throneexchange/v3-core/contracts/libraries/TickBitmap.sol';
import '@throneexchange/v3-core/contracts/interfaces/IThroneV3Pool.sol';
import '@throneexchange/v3-core/contracts/interfaces/callback/IThroneV3SwapCallback.sol';
import '@throneexchange/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IThroneV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IThroneV3Pool;
    ...
    */
    ...
    /// @inheritdoc IThroneV3SwapCallback
    function throneV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory path) external view override {
        ...
        IThroneV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IThroneV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
