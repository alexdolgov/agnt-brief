...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x8b2aea2836cd06fd86b0484b1867d4f1c8f66d08de4db412ceb792d3edb7591d;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0x3514a279bc09e9db464fdb8a2b6c0ef8ab51ec3495a22bda3824f4badff737a8;
    ...
    /// @param deployer The ThroneExchange V3 deployer contract address
    ...
    function getPool(address deployer, address tokenA, address tokenB, uint24 fee) public pure returns (IThroneV3Pool) {
        return IThroneV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid ThroneExchange V3 Pool
    /// @param deployer The contract address of the ThroneExchange V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IThroneV3Pool pool) {
    ...
    /// @return pool The V3 pool contract address
    function verifyCallback(address deployer, PoolKey memory poolKey) public view returns (IThroneV3Pool pool) {
        pool = IThroneV3Pool(computeAddress(deployer, poolKey));
