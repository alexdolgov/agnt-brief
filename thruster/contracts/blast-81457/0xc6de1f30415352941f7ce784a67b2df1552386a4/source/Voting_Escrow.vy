...
MAXTIME: constant(uint256) = 1 * 365 * 86400  # 1 years
...
@internal
def _deposit_for(_payer: address, _addr: address, _value: uint256, unlock_time: uint256, locked_balance: LockedBalance, type: int128):
    """
