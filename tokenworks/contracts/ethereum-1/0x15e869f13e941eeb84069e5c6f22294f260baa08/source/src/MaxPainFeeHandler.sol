...
/// @title MaxPainFeeHandler
/// @author TokenWorks (https://token.works/)
contract MaxPainFeeHandler is Ownable, ReentrancyGuard {
    /* ™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™                ™™™™™™™™™™™                ™™™™™™™™™™™ */
    /* ™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™               ™™™™™™™™™™™™               ™™™™™™™™™™  */
    /* ™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™              ™™™™™™™™™™™™™              ™™™™™™™™™™™  */
    /* ™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™™             ™™™™™™™™™™™™™™            ™™™™™™™™™™™   */
    ...
    address public constant MAX_PAIN_ADDRESS = 0xd1169e5349d1cB9941F3DCbA135C8A4b9eACFDDE;
    address public constant PAIN_STRATEGY = 0xDfC3Af477979912EC90b138d3e5552d5304c5663;
    ...
    /// @notice Event emitted when a Max Pain is purchased by the protocol
    event MaxPainProcessed(uint256 cost, uint256 tokenId, address indexed destination);
    ...
    constructor() {
        // Destination is default address(0)
    ...
    /// @notice Updates the destination address for Max Pain NFTs
    ...
    /// @notice Buys a Max Pain from the strategy and sends it to destination, paying a reward to the caller
    /// @param maxPainId The ID of the Max Pain to buy and send to destination
    /// @dev Requires the Max Pain to be for sale to anyone and sufficient fees (price + reward)
    function buyMaxPain(uint256 maxPainId) external nonReentrant returns (uint256) {
        // Get price from strategy contract
        uint256 price = INFTStrategy(PAIN_STRATEGY).nftForSale(maxPainId);
        ...
        // Buy the NFT
        INFTStrategy(PAIN_STRATEGY).sellTargetNFT{value: price}(maxPainId);

        // Make sure we own it
        if (IERC721(MAX_PAIN_ADDRESS).ownerOf(maxPainId) != address(this)) revert NFTNotOwned();

        // Send to destination
        IERC721(MAX_PAIN_ADDRESS).transferFrom(address(this), destination, maxPainId);

        // Send reward to caller
        SafeTransferLib.forceSafeTransferETH(msg.sender, reward);

        emit MaxPainProcessed(price, maxPainId, destination);
