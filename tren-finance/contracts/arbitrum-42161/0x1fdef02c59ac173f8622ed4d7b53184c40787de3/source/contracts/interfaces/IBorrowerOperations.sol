...
interface IBorrowerOperations {
    ...
    /// @dev Error emmitted when leverage rate is invalid.
    error BorrowerOperations__InvalidLeverageRate();

    /// @dev Error emmitted when the loan is not repayable.
    error BorrowerOperations__LoanIsNotRepayable();
    ...
    /**
     * @notice Repays part of debt tokens of specific borrower trenBox by FlashLoan contract.
     * @param _asset The address of collateral asset.
     * @param _borrower The address of borrower which FlashLoan contract will repay the debt.
     * @param _debtTokenAmount The amount of debt token to repay.
     * @param _upperHint Id of previous node for the new insert position.
     * @param _lowerHint Id of next node for the new insert position.
     */
    function repayPartOfDebtTokensWithFlashloan(
        address _asset,
        address _borrower,
        uint256 _debtTokenAmount,
        address _upperHint,
