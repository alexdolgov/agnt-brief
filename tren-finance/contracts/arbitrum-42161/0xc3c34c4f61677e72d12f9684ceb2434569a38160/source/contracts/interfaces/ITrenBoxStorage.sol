...
interface ITrenBoxStorage {
    ...
    /**
     * @dev Thrown when caller is not BorrowerOperations nor SwapManager contract.
     */
    error TrenBoxStorage__BorrowerOperationsOrSwapManagerOnly();

    /**
     * @dev Thrown when caller is not BorrowerOperations nor TrenBoxManagerOperations contract.
     */
    error TrenBoxStorage__BorrowerOperationsOrTrenBoxManagerOperationsOnly();
