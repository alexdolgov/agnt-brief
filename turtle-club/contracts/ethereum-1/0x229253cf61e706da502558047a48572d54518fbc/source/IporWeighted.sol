...
// contracts/algorithm/IporTypes.sol
...
// contracts/integration/aave/IAaveErc20.sol

interface IAaveErc20 {
    function totalSupply() external view returns (uint256);
}

// contracts/integration/aave/IAaveProtocolDataProvider.sol
...
// contracts/integration/aave/IAaveProtocolDataProviderV3.sol
...
// contracts/integration/compound/ICompoundErc20.sol
...
// contracts/integration/compound/ICompoundV3.sol
...
// contracts/interfaces/IIporAlgorithm.sol
...
// contracts/libraries/errors/IporErrors.sol
...
// contracts/libraries/math/IporMath.sol
...
// contracts/security/IporOwnableUpgradeable.sol
...
// contracts/algorithm/IporWeighted.sol
...
contract IporWeighted is IporOwnableUpgradeable, UUPSUpgradeable, IIporAlgorithm {
    ...
    address internal constant _AAVE_PROTOCOL_DATA_PROVIDER_V3 =
    ...
    function _getConnectorList(address asset) private view returns (ConnectorData[] memory) {
        if (asset == _DAI) {
            ...
            connectors[2] = ConnectorData({
                ...
                dataProvider: _AAVE_PROTOCOL_DATA_PROVIDER_V3,
                version: 3,
