...
import {TermFlashDefaultSubmission1Inch} from "./lib/TermFlashDefaultSubmission1Inch.sol";
...
contract TermFlashDefaultLiquidatorFlashSwapAave is IFlashLoanSimpleReceiver {
    ...
    function _oneInchSwap (bytes memory oneInchSwapCalldata, address collateralToken, bool unwrapCollateralToken) internal returns(address, uint256) {
        ...
        address oneInchInputAsset = _oneInchSwapPrep(collateralToken, desc.srcReceiver, unwrapCollateralToken);
    ...
    function _oneInchSwapPrep(address collateralTokenAddr,address srcReceiver, bool unwrapCollateralToken ) internal returns (address) {
