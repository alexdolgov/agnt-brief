...
//Brr Main Token Contract
contract Brr is ERC20, Ownable {
    ...
    constructor() ERC20("Brr", "Brr") {
        ...
        uint256 totalSupply = 1_000_000_000_000 * 1e18; // 1 trillion

        maxTransactionAmount = 10_000_000_000 * 1e18; // 1%   of total supply is maxTransactionAmountTxn
        maxWallet = 50_000_000_000 * 1e18; // 5 % of total supply is  maxWallet
        swapTokensAtAmount = 1_000_000_000 * 1e18; //0.1% of total supply

        marketingWallet = address(0x11E33Ca6042344B274e03D60077Bc809bAbd318E); // set as marketing wallet
        devWallet = address(0x11E33Ca6042344B274e03D60077Bc809bAbd318E); // set as dev wallet
        treasuryWallet = address(0x6bC8F8325d42497b9bE8c376F56DDF0731BBA775);
