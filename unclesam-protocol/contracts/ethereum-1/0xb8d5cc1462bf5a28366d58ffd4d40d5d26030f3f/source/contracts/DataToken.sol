...
/**
 * @title DataToken
 * @notice ERC20 token mining datacenter.
 */
contract DataToken is ERC20, ERC20Burnable, Ownable {
    //---------- Contracts ----------//
    ...
    uint256 public constant sellTax = 6; // 6% tax on sell.
    ...
    mapping(address => bool) private _hasSold; // Contains the addresses they have sold.
    ...
    //---------- Constructor ----------//
    constructor(IRouterV2 _dexRouter) ERC20("Data", "DTA") {
    ...
    //----------- External Functions -----------//
    /**
     * @notice Check if a address has sold.
     * @param account address to check.
     * @return Boolean if has sold or not.
     */
    function hasSold(address account) external view returns (bool) {
        return _hasSold[account];
    }
