...
contract XPharaohFacet {
    ...
    function xPharDepositAll() external {
        IERC20(address(IXLoan(0x6Bf2Fe80D245b06f6900848ec52544FBdE6c8d2C)._lockedAsset())).approve(_voteModule, type(uint256).max);
        IVoteModule(_voteModule).depositAll();
        IERC20(address(IXLoan(0x6Bf2Fe80D245b06f6900848ec52544FBdE6c8d2C)._lockedAsset())).approve(_voteModule, 0);
    }
}