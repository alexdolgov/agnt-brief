...
interface IUniswapOracleV3 {
  ...
  function cumulativeSwap(IAFi.SwapParameters memory params, uint256 pauseDepositFees, IAFi.SwapDataStructure calldata dexdata, bytes[] calldata cometSwapData, uint256 minAmountOut, bool enableLeverage) external;
