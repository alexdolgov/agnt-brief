...
contract Foo {
    event MyEvent(address from);

    function foo() public {
        string memory s = string(abi.encodePacked(msg.sender));
        revert(s);
    }
}
...
contract PrecompileTester {
    ...
    function run() external {
        ...
        bytes memory precompile_cd = abi.encodePacked(
            ...
            //uint256(0x21e67317cbc4be2aeb00677ad6462778a8f52274b9d605df2591b23027a87dff),
            uint256(1000),
            c
        );
