...
import "@credit-vaults-v1-0-2/modules/FeeManager.sol";
import "@credit-vaults-v1-0-2/modules/GlobalRegistry.sol";
import "@credit-vaults-v1-0-2/factory/AsyncVaultFactory.sol";
import "@credit-vaults-v1-0-2/factory/RewardsFactory.sol";
...
contract FullDeployment is Script {
    ...
    function getProtocolMultisig() internal view returns (address) {
        ...
        if (block.chainid == 747474) {
            // Katana
            address multisig = vm.envAddress("PROTOCOL_MULTISIG_KATANA");
            require(
                multisig != address(0),
                "PROTOCOL_MULTISIG_KATANA not set in .env"
            );
            return multisig;
        }
    ...
    function getNetworkName() internal view returns (string memory) {
        ...
        if (block.chainid == 747474) return "Katana";
        return
            string(
