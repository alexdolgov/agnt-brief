...
import {YieldInitParams} from "../interfaces/IAccountableYield.sol";
...
import {AccountableYield} from "../strategies/AccountableYield.sol";
import {IYieldStrategyFactory, YieldFactoryParams} from "../interfaces/IStrategyFactory.sol";

import {Create2} from "@openzeppelin/contracts/utils/Create2.sol";
import {ERC1967Proxy} from "@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";

/// @title YieldStrategyFactory
/// @notice Factory contract for creating and managing yield strategies
contract YieldStrategyFactory is IYieldStrategyFactory, StrategyFactoryBase {
    ...
    /// @inheritdoc IYieldStrategyFactory
        ...
        returns (address strategyProxy, address vault)
    {
        ...
        emit YieldStrategyCreated(strategyProxy, vault, params.investmentManager);
    }
}
