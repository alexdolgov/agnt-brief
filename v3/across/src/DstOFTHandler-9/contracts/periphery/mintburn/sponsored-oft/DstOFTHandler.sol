...
contract DstOFTHandler is ILayerZeroComposer, HyperCoreFlowExecutor {
    ...
    function setAuthorizedPeriphery(uint32 srcEid, address srcPeriphery) external onlyDefaultAdmin {
        bytes32 srcPeripheryBytes32 = srcPeriphery.toBytes32();
        authorizedSrcPeripheryContracts[srcEid] = srcPeripheryBytes32;

        emit SetAuthorizedPeriphery(srcEid, srcPeripheryBytes32);
    }
