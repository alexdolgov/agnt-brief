 ...
 */
contract HyperliquidDepositHandler is AcrossMessageHandler, ReentrancyGuard {
    ...
    function depositToHypercore(address token, uint256 amount, address user) external nonReentrant {
        ...
        HyperCoreLib.transferERC20EVMToCore(token, tokenIndex, user, amount, decimalDiff);
    }
