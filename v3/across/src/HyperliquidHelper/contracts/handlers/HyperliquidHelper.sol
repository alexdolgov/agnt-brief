...
contract HyperliquidHelper is ReentrancyGuard, Ownable {
    ...
    function _depositToHypercore(address token, uint256 evmAmount) internal returns (uint64 amountCoreToReceive) {
        ...
        // We assume this account is already activated and don't have any account activation logic.
        ...
        if (token == USDC_ADDRESS) {
            ...
            (, amountCoreToReceive) = HyperCoreLib.maximumEVMSendAmountToAmounts(evmAmount, decimalDiff);
        } else {
