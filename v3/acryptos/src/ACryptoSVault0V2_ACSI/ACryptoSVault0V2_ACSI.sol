...
// File: contracts/vaults/ACryptoSVault0V2_ACSI.sol
...
//Changes: Default to not keep any minimum in vault. Calls earn() at end of deposit(). Uses modified untransferrable Uniswap governance token as LP token.
//V2 - allow deposit() to specify an address to send the LP token to
...
contract ACryptoSVault0V2_ACSI is acsACSI {
