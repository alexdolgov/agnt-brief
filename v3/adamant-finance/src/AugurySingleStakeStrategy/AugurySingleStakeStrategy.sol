...
contract AugurySingleStakeStrategy is BaseStrategyMasterChef {
    ...
    //address public DIVIDENDS = 0xd5d5eDdC6D634a729EcEf53f710B4a3Cd61bc2B2;
    ...
    //Collect USDC dividends, then convert them to OMEN (no performance fee taken)
    function collectDividends() public onlyOwner {
        IDividends(IAuguryChef(MASTER_CHEF).dividendsContractAddress()).collectDividends();
