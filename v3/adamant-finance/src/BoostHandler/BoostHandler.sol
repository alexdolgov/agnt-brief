...
contract BoostHandler is Ownable, IBoostHandler {
    ...
    //Returns ADDY earning boost based on amount of locked ADDY, boost is divided by 10000
    //_vaultAddress is currently unused, but might be used later
    function getBoost(address _user, address _vaultAddress) external override view returns (uint256) {
        ...
        //Simple if-statement tiering so it's easier for end-users to understand
        //Boost is divided by 10000 when calculating the extra amount
        if(veAddy < 50 * 10**18) {
            return 0;
        }
        if(veAddy < 200 * 10**18) {
        ...
        if(veAddy < 1000 * 10**18) {
            return 3000;
        }
        if(veAddy < 2000 * 10**18) {
            return 4000;
        }
        if(veAddy < 3500 * 10**18) {
            return 5000;
        }
        if(veAddy < 6000 * 10**18) {
            return 6000;
        }
        if(veAddy < 9000 * 10**18) {
            return 7000;
        }
        if(veAddy < 14000 * 10**18) {
            return 8000;
        }
        if(veAddy < 20000 * 10**18) {
            return 9000;
        }
        return 10000;
    }
