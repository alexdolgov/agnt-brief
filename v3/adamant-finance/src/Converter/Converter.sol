...
contract Converter is Ownable {
    ...
    constructor()
        public
    {
        IERC20(dQUICK).approve(dQUICK, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        IERC20(dQUICK).approve(FUND, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        IERC20(QUICK).approve(FUND, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    }
    
    function convertDQuick() public onlyOwner {
        IERCFund(FUND).recover(dQUICK);
        ...
        if (_quick_balance > 0) {
            IERCFund(FUND).depositToFeeDistributor(QUICK, _quick_balance);
        }
    }

    function notifyFeeDistribution(address token) public onlyOwner {
        IERCFund(FUND).notifyFeeDistribution(token);
    }
    ...
    //Return ownership of the fund to me
    function restoreOwnership() public onlyOwner {
