...
contract PolyPupStrategyDeployer is Ownable {
    ...
    address PUP = 0xcFe2cF35D2bDDE84967e67d00aD74237e234CE59;
    address MASTER_CHEF = 0xCc7E7c9FC775D25176e9Bfc5A400EdAc212aa81C;
    ...
    function deploy(address lp, address otherToken, uint256 _poolId) public onlyOwner {
        address strategy = address(new MasterChefStrategy(MASTER_CHEF, lp, otherToken, _poolId, FUND, PUP, QUICKSWAP_ROUTER));
        address jar = address(new GenericVault(IStrategy(strategy), proxy_minter, FUND));
        MasterChefStrategy(strategy).setJar(jar);
