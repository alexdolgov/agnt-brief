...
abstract contract BaseStrategyRewardPairNonReentrant is BaseStrategyStakingRewards {
...
//Strategy for Dfyn's DFYN/ROUTE pool
contract StrategyDfynDual is BaseStrategyRewardPairNonReentrant {

    address constant DFYN = 0xC168E40227E4ebD8C1caE80F7a55a4F0e6D66C97;
    address constant ROUTE = 0x16ECCfDbb4eE1A85A33f3A9B21175Cd7Ae753dB4;
    address constant DFYN_ROUTE_LP = 0xB0dc320ea9eea823a150763AbB4A7bA8286Cd08B;
    address constant DFYN_ROUTE_REWARDS = 0xf997c8e2e7e7387C8fd9120280ad9B3db31A5381;
    address constant ERC_FUND = 0x43c085B5aba4E83a7dd1A478B7458D1d472FF6b4;

    address constant ROUTER = 0xA102072A4C07F06EC3B4900FDC4C7B80b6c57429;

    address[] other_reward_path;
        ...
        )
    {
        ...
        other_reward_path = new address[](2);
        other_reward_path[0] = ROUTE;
        other_reward_path[1] = DFYN;
    }

    //Swap all ROUTE back to DFYN, then 1/2 of DFYN back to route, then add LP, then deposit
    function rebalance() public onlyOwner {
        uint256 _other = IERC20(otherToken).balanceOf(address(this));
        if (_other > 0) {
            _swapUniswapWithPath(other_reward_path, _other);
        }
