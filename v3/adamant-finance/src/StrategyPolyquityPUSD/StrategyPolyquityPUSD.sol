...
contract StrategyPolyquityPUSD is BaseStrategy {

    uint256 public constant keepMax = 10000;

    address public WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address public FRONT_END_TAG = 0x47a7d15B7452820DD7A565ea9C39D8b6cef51ed7;
    ...
    address public PUSD_REWARDS = 0x445098d74B6eB4f3BCF20865989b777ee405a48C;
    ...
    constructor()
        public
        BaseStrategy(PUSD, FUND, PYQ, SUSHI_ROUTER, PUSD_REWARDS)
    {
        reward_a_path = new address[](3);
        reward_a_path[0] = PYQ;
        reward_a_path[1] = USDC;
        reward_a_path[2] = PUSD;
    ...
    function balanceOfPool() public override view returns (uint256) {
        return IPolyquityRewards(rewards).getCompoundedLUSDDeposit(address(this));
    }

    function getHarvestable() external override view returns (uint256) {
        return IPolyquityRewards(rewards).getDepositorLQTYGain(address(this));
    }
    ...
    function deposit() public override {
        ...
        if (_want > 0) {
            ...
            IPolyquityRewards(rewards).provideToSP(_want, FRONT_END_TAG);
        }
    }
    ...
    function _withdrawSome(uint256 _amount)
        ...
        returns (uint256)
    {
        IPolyquityRewards(rewards).withdrawFromSP(_amount);
        return _amount;
    }
    ...
    function _getReward() internal {
        IPolyquityRewards(rewards).withdrawFromSP(0);
    }
    ...
    //Convert any received MATIC to WMATIC
