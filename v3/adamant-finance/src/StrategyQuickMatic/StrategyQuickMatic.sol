...
abstract contract BaseStrategyQuickPair is BaseStrategyStakingRewards {
    ...
    uint256 public constant keepFeeShare = 3000; //30% fee split between token holders
    ...
    function harvest() public override {
        ...
        if (_quick_balance > 0) {
            uint256 feeAmount = _quick_balance.mul(getFee()).div(keepMax);
        ...
        if (quickBalance > 0 && otherBalance > 0) {
            ...
            // Donates DUST
            IERC20(quick).safeTransfer(strategist, IERC20(quick).balanceOf(address(this)));
...
contract StrategyQuickMatic is BaseStrategyQuickPair {
    // Token addresses
    address public QUICK_MATIC_STAKING_REWARDS = 0x760c18f57aDe2Eb793832BF37f1a38EBE5909e7c;
    address public QUICK_MATIC_LP = 0x019ba0325f1988213D448b3472fA1cf8D07618d7;
    address public WMATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;

    constructor()
        public
        BaseStrategyQuickPair(
            QUICK_MATIC_STAKING_REWARDS,
            QUICK_MATIC_LP,
            WMATIC,
            0x25Eb1113Dd5759A40CD874d4fE8e6842eA6A88Be //ERCFund contract
        )
    {}
