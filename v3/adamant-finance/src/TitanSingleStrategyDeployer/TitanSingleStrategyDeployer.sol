...
contract StrategyTitanSingle is BaseStrategyIron {
    ...
    {
        //titan single asset staking uses a different masterchef contract
        masterChef = 0x08b5249F1fee6e4fCf8A7113943ed6796737386E;
        rewards = 0x08b5249F1fee6e4fCf8A7113943ed6796737386E;
    }
...
contract TitanSingleStrategyDeployer is Ownable {
    ...
    function deploy() public onlyOwner {
        address strategy = address(new StrategyTitanSingle(FUND));
        address jar = address(new GenericVault(IStrategy(strategy), proxy_minter, FUND));

        StrategyTitanSingle(strategy).setJar(jar);
