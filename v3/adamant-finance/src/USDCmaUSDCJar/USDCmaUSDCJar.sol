...
contract USDCmaUSDCJar is ERC20, Ownable {
    ...
    constructor(IStrategy _strategy)
        public
        ERC20(
            string(abi.encodePacked("USDC_maUSDC_vault2")),
            string(abi.encodePacked("vUSDC_maUSDC2"))
        )
    {
    ...
    //This does what earn() used to do, functionally the same for the end user since no LP tokens are stored in the contract during normal operation
