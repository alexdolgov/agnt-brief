# Agentic Audit Brief: AFX Bridge
...
- Project: AFX Bridge (`afx-bridge`)
- Website: [https://afx.xyz/](https://afx.xyz/)
- Lifecycle: unknown
...
No contract logic was present for AFX Bridge in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
