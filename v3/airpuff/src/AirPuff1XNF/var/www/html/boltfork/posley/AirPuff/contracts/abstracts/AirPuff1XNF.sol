...
abstract contract AirPuff1XNF is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, ERC20BurnableUpgradeable {
    ...
    function closePosition(uint256 _positionID) external InvalidID(_positionID, msg.sender) whenNotPaused nonReentrant {
        ...
        uint256 amount = _userInfo.deposit;
