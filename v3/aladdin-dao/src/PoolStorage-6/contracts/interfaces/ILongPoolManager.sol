...
interface ILongPoolManager is IPoolManager {
  ...
  /// @param longPool The address of long pool.
  /// @param shortPool The address of short pool.
  /// @param amount The amount of raw collateral token to repay.
  /// @param shortfall The amount of shortfall raw debt token.
  function repay(address longPool, address shortPool, uint256 amount, uint256 shortfall) external;
