...
library SmartRouterHelper {
    ...
    /// @param factory The Alien Base V3 factory contract address
    ...
    function getPool(
        ...
        return IUniswapV3Pool(computeAddress(factory, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid Alien Base V3 Pool
    /// @param factory The contract address of the Alien Base V3 factory
