...
contract LPStaker {
    ...
    IERC20 private constant depositToken = IERC20(0x1c5e351E312C23641275C172D92E8BB19b300734); // HGET/CHR
    IERC20 private constant rewardToken1 = IERC20(0xC7d8D35EBA58a0935ff2D5a33Df105DD9f071731); // HGET
    IERC20 private constant rewardToken2 = IERC20(0xf9CeC8d50f6c8ad3Fb6dcCEC577e05aA32B224FE); // CHR
    ...
    uint128 constant hgetPerLPToken = 327938395852; // Expressed in aomout of HGET per 1 LP token
