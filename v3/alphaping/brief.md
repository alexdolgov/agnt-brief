...
- On-chain TVL (included contracts): $8,184,043.94
- TVL by chain: Ethereum $8,184,043.94
...
- ASD (verified + unaudited TVL): $8,184,043.94
...
|---|---|---|---|---:|---|---|---|---|
| VaultV2 | core_logic | project_anchor | own_supporting | 0 | ethereum | unit-378726 | 2 deployments: ethereum `0x951a9f...b6c0f8`; ethereum `0xf1ca44...76f9a1` | ⚠️ Unaudited |
...
|---|---|---|---|---:|---|
| ethereum | `0x951a9f...b6c0f8` | VaultV2 | core_logic | $5,829,894.77 | Verified native implementation with $5,829,894.77 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
