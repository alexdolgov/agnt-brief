...
import "../../altitude-v2/contracts/interfaces/internal/vault/IVaultCore.sol";
import "../../altitude-v2/contracts/interfaces/external/strategy/lending/Aave/IWETH.sol";
import "../../altitude-v2/contracts/interfaces/internal/strategy/swap/ISwapStrategyConfiguration.sol";
import "../../altitude-v2/contracts/interfaces/internal/strategy/swap/ISwapStrategy.sol";
...
contract UserLiquidationHelper is IReceiver {
    ...
    function receiveData(bytes calldata params, uint256 flashLoanFee) external {
        ...
        console.log( address(swapStrategy), "swapStrategy address");
        console.log(
            supplyBalance,
