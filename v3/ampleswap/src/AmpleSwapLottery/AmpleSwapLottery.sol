...
// File: contracts/interfaces/IAmpleSwapLottery.sol

pragma solidity ^0.8.4;

interface IAmpleSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in AMPLE per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in AMPLE token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInCake: price of a ticket in AMPLE
...
// File: contracts/AmpleSwapLottery.sol

pragma solidity ^0.8.4;
pragma abicoder v2;

/** @title AmpleSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract AmpleSwapLottery is ReentrancyGuard, IAmpleSwapLottery, Ownable {
     ...
     * @param _cakeTokenAddress: address of the AMPLE token
        ...
        nonReentrant
    {
        ...
        // Calculate number of AMPLE to this contract
        ...
        // Transfer AMPLE tokens to this contract
        ...
        nonReentrant
    {
        ...
        // Calculate prizes in AMPLE for each bracket by starting from the highest one
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                // A. No AMPLE to distribute, they are added to the amount to withdraw to treasury address
            } else {
        ...
        // Transfer AMPLE to treasury address
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(cakeToken), "Cannot be AMPLE token");
    ...
    /**
     * @notice Set AMPLE price ticket upper/lower limit
     * @dev Only callable by owner
     * @param _minPriceTicketInCake: minimum price of a ticket in AMPLE
     * @param _maxPriceTicketInCake: maximum price of a ticket in AMPLE
     */
     ...
     * @param _priceTicket price of a ticket (in AMPLE)
