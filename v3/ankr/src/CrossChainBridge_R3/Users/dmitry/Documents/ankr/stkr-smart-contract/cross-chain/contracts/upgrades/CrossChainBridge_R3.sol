...
import "../interfaces/IJokerRace.sol";
...
contract CrossChainBridge_R3 is PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, ICrossChainBridge {
    ...
    function vote(address jr, uint256 proposalId, uint8 support, uint256 totalVotes, uint256 numVotes, bytes32[] calldata proof) external onlyOwner {
