# AnteBalanceHolderPercentageThresholdAbracadabraArbitrumTest — Foundry package
...
```sh
forge build --root "src/AnteBalanceHolderPercentageThresholdAbracadabraArbitrumTest"
```
