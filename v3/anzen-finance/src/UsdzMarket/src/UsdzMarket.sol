...
contract UsdzMarket is AccessControl, ReentrancyGuard {
    ...
    constructor(address _admin, IUSDz _usdz, IERC20 _usdc) {
        USDz = _usdz;
        USDC = _usdc;
    ...
    function fillOffer(uint256 offerId, uint256 usdzAmount) external nonReentrant {
        ...
        require(usdzAmount <= offer.amount, "Amount must be less than offer amount");
