    ...
    fallback() external {
        ...
        assembly {
...

            {
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value1_0*/ mload(0x2d40),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              {
              // range_check_builtin/value3_0 = range_check_builtin__value2_0 * offset_size + column20_row60.
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value2_0*/ mload(0x2d60),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              {
              // range_check_builtin/value4_0 = range_check_builtin__value3_0 * offset_size + column20_row76.
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value3_0*/ mload(0x2d80),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              {
              // range_check_builtin/value5_0 = range_check_builtin__value4_0 * offset_size + column20_row92.
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value4_0*/ mload(0x2da0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              {
              // range_check_builtin/value6_0 = range_check_builtin__value5_0 * offset_size + column20_row108.
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value5_0*/ mload(0x2dc0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              {
              // range_check_builtin/value7_0 = range_check_builtin__value6_0 * offset_size + column20_row124.
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value6_0*/ mload(0x2de0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2960),
                  /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2960),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2960)),
                PRIME)
              ...
              {
              // Constraint expression for cpu/decode/opcode_range_check_input: column19_row1 - (((column0_row0 * offset_size + column20_row4) * offset_size + column20_row8) * offset_size + column20_row0).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/operands/mem_dst_addr: column19_row8 + half_offset_size - (cpu__decode__opcode_range_check__bit_0 * column22_row8 + (1 - cpu__decode__opcode_range_check__bit_0) * column22_row0 + column20_row0).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/operands/mem0_addr: column19_row4 + half_offset_size - (cpu__decode__opcode_range_check__bit_1 * column22_row8 + (1 - cpu__decode__opcode_range_check__bit_1) * column22_row0 + column20_row8).
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_range_check/bit_1*/ mload(0x2b40),
                        /*column22_row8*/ mload(0x2080),
                        PRIME),
                      mulmod(
                        addmod(
                          1,
                          sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_1*/ mload(0x2b40)),
                          PRIME),
                        /*column22_row0*/ mload(0x1f80),
                        PRIME),
                      PRIME),
              ...
              {
              // Constraint expression for cpu/operands/mem1_addr: column19_row12 + half_offset_size - (cpu__decode__opcode_range_check__bit_2 * column19_row0 + cpu__decode__opcode_range_check__bit_4 * column22_row0 + cpu__decode__opcode_range_check__bit_3 * column22_row8 + cpu__decode__flag_op1_base_op0_0 * column19_row5 + column20_row4).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/operands/res: (1 - cpu__decode__opcode_range_check__bit_9) * column22_row12 - (cpu__decode__opcode_range_check__bit_5 * (column19_row5 + column19_row13) + cpu__decode__opcode_range_check__bit_6 * column22_row4 + cpu__decode__flag_res_op1_0 * column19_row13).
              let val := addmod(
                mulmod(
                  addmod(
                    1,
                    sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2a40)),
                    PRIME),
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/tmp0: column22_row2 - cpu__decode__opcode_range_check__bit_9 * column19_row9.
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_negative: (1 - cpu__decode__opcode_range_check__bit_9) * column19_row16 + column22_row2 * (column19_row16 - (column19_row0 + column19_row13)) - (cpu__decode__flag_pc_update_regular_0 * npc_reg_0 + cpu__decode__opcode_range_check__bit_7 * column22_row12 + cpu__decode__opcode_range_check__bit_8 * (column19_row0 + column22_row12)).
              let val := addmod(
                addmod(
                  mulmod(
                    addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_positive: (column22_row10 - cpu__decode__opcode_range_check__bit_9) * (column19_row16 - npc_reg_0).
              let val := mulmod(
                addmod(
                  /*column22_row10*/ mload(0x20c0),
                  sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2a40)),
              ...
              {
              // Constraint expression for cpu/update_registers/update_ap/ap_update: column22_row16 - (column22_row0 + cpu__decode__opcode_range_check__bit_10 * column22_row12 + cpu__decode__opcode_range_check__bit_11 + cpu__decode__opcode_range_check__bit_12 * 2).
              let val := addmod(
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column22_row0*/ mload(0x1f80),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_range_check/bit_10*/ mload(0x2b80),
                          /*column22_row12*/ mload(0x2100),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_11*/ mload(0x2ba0),
                      PRIME),
                    mulmod(/*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x2ae0), 2, PRIME),
                    PRIME)),
                PRIME)
              ...
              {
              // Constraint expression for cpu/update_registers/update_fp/fp_update: column22_row24 - (cpu__decode__fp_update_regular_0 * column22_row8 + cpu__decode__opcode_range_check__bit_13 * column19_row9 + cpu__decode__opcode_range_check__bit_12 * (column22_row0 + 2)).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/call/push_fp: cpu__decode__opcode_range_check__bit_12 * (column19_row9 - column22_row8).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x2ae0),
              ...
              {
              // Constraint expression for cpu/opcodes/call/push_pc: cpu__decode__opcode_range_check__bit_12 * (column19_row5 - (column19_row0 + cpu__decode__opcode_range_check__bit_2 + 1)).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x2ae0),
                addmod(
                  /*column19_row5*/ mload(0x1680),
              ...
              {
              // Constraint expression for cpu/opcodes/call/off0: cpu__decode__opcode_range_check__bit_12 * (column20_row0 - half_offset_size).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x2ae0),
                addmod(
                  /*column20_row0*/ mload(0x1d40),
              ...
              {
              // Constraint expression for cpu/opcodes/call/off1: cpu__decode__opcode_range_check__bit_12 * (column20_row8 - (half_offset_size + 1)).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x2ae0),
                addmod(
                  /*column20_row8*/ mload(0x1de0),
              ...
              {
              // Constraint expression for cpu/opcodes/ret/off0: cpu__decode__opcode_range_check__bit_13 * (column20_row0 + 2 - half_offset_size).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x2b00),
                addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/ret/off2: cpu__decode__opcode_range_check__bit_13 * (column20_row4 + 1 - half_offset_size).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x2b00),
                addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/assert_eq/assert_eq: cpu__decode__opcode_range_check__bit_14 * (column19_row9 - column22_row12).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_14*/ mload(0x2bc0),
                addmod(
                  /*column19_row9*/ mload(0x16c0),
              ...
              {
              // Constraint expression for range_check16/perm/init0: (range_check16/perm/interaction_elm - column21_row1) * column26_inter1_row1 + column20_row0 - range_check16/perm/interaction_elm.
              let val := addmod(
                addmod(
                  mulmod(
                    addmod(
              ...
              {
              // Constraint expression for range_check16/perm/step0: (range_check16/perm/interaction_elm - column21_row3) * column26_inter1_row3 - (range_check16/perm/interaction_elm - column20_row2) * column26_inter1_row1.
              let val := addmod(
                mulmod(
                  addmod(
                    /*range_check16/perm/interaction_elm*/ mload(0x1c0),
              ...
              {
              // Constraint expression for range_check16/perm/last: column26_inter1_row1 - range_check16/perm/public_memory_prod.
              let val := addmod(
                /*column26_inter1_row1*/ mload(0x2900),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check16/diff_0*/ mload(0x2c00),
                  /*intermediate_value/range_check16/diff_0*/ mload(0x2c00),
                  PRIME),
                sub(PRIME, /*intermediate_value/range_check16/diff_0*/ mload(0x2c00)),
                PRIME)
              ...
              {
              // Constraint expression for range_check16/minimum: column21_row1 - range_check_min.
              let val := addmod(
                /*column21_row1*/ mload(0x1f20),
              ...
              {
              // Constraint expression for range_check16/maximum: column21_row1 - range_check_max.
              let val := addmod(
                /*column21_row1*/ mload(0x1f20),
              ...
              {
              // Constraint expression for range_check_builtin/value: range_check_builtin__value7_0 - column19_row107.
              let val := addmod(
                /*intermediate_value/range_check_builtin/value7_0*/ mload(0x2e00),
              ...
              {
              // Constraint expression for range_check_builtin/addr_step: column19_row234 - (column19_row106 + 1).
              let val := addmod(
              ...
              {
              // Constraint expression for range_check_builtin/init_addr: column19_row106 - initial_range_check_addr.
              let val := addmod(
                /*column19_row106*/ mload(0x1840),
                sub(PRIME, /*initial_range_check_addr*/ mload(0x360)),
                PRIME)
              ...
              // Numerator: point - trace_generator^(trace_length - 4096).
              // val *= domains[27].
