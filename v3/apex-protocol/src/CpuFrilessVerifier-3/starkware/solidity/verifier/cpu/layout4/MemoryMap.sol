...
contract MemoryMap {
    ...
    */
    ...
    uint256 constant internal MM_RANGE_CHECK16__PERM__INTERACTION_ELM =    0x149;
    uint256 constant internal MM_RANGE_CHECK16__PERM__PUBLIC_MEMORY_PROD = 0x14a;
    uint256 constant internal MM_RANGE_CHECK_MIN =                         0x14b;
    uint256 constant internal MM_RANGE_CHECK_MAX =                         0x14c;
    ...
    uint256 constant internal MM_INITIAL_RANGE_CHECK_ADDR =                0x156;
