...

            {
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_5*/ mload(0x28e0),
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_6*/ mload(0x2900),
                      PRIME),
                    /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2920),
                    PRIME)),
                PRIME)
              mstore(0x2940, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_7*/ mload(0x2960),
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_8*/ mload(0x2980),
                      PRIME),
                    /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2920),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  addmod(
                    /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x29c0),
                    /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x29e0),
                    PRIME)),
                PRIME)
              mstore(0x2a00, val)
              }
              ...
              let val := addmod(/*column6_row2*/ mload(0x12e0), sub(PRIME, /*column6_row0*/ mload(0x12a0)), PRIME)
              mstore(0x2ac0, val)
              }
              ...
              let val := addmod(/*column7_row6*/ mload(0x13e0), sub(PRIME, /*column7_row2*/ mload(0x1360)), PRIME)
              mstore(0x2ae0, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x2b00)),
                PRIME)
              mstore(0x2b20, val)
              }
              ...
              let val := /*column7_row12*/ mload(0x1480)
              mstore(0x2b40, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value0_0*/ mload(0x2b40),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row44*/ mload(0x1580),
                PRIME)
              mstore(0x2b60, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value1_0*/ mload(0x2b60),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row76*/ mload(0x15e0),
                PRIME)
              mstore(0x2b80, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value2_0*/ mload(0x2b80),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row108*/ mload(0x1640),
                PRIME)
              mstore(0x2ba0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value3_0*/ mload(0x2ba0),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row140*/ mload(0x16a0),
                PRIME)
              mstore(0x2bc0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value4_0*/ mload(0x2bc0),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row172*/ mload(0x1700),
                PRIME)
              mstore(0x2be0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value5_0*/ mload(0x2be0),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row204*/ mload(0x1760),
                PRIME)
              mstore(0x2c00, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value6_0*/ mload(0x2c00),
                  /*offset_size*/ mload(0x140),
                  PRIME),
                /*column7_row236*/ mload(0x17c0),
                PRIME)
              mstore(0x2c20, val)
              }
              ...
              let val := mulmod(/*column8_row1*/ mload(0x1a40), /*column8_row1*/ mload(0x1a40), PRIME)
              mstore(0x2c40, val)
              }
              ...
              let val := addmod(
                /*column8_row59*/ mload(0x1ee0),
                sub(
                  PRIME,
                  addmod(/*column8_row187*/ mload(0x2140), /*column8_row187*/ mload(0x2140), PRIME)),
                PRIME)
              mstore(0x2c60, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x2c60)),
                PRIME)
              mstore(0x2c80, val)
              }
              ...
              let val := addmod(
                /*column8_row9*/ mload(0x1b40),
                sub(
                  PRIME,
                  addmod(/*column8_row73*/ mload(0x1f80), /*column8_row73*/ mload(0x1f80), PRIME)),
                PRIME)
              mstore(0x2ca0, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x2ca0)),
                PRIME)
              mstore(0x2cc0, val)
              }
                  ...
                  addmod(
                    addmod(
                      addmod(
                        addmod(
                          addmod(
                            /*column7_row1*/ mload(0x1340),
                            mulmod(/*column7_row17*/ mload(0x14e0), 2, PRIME),
                            PRIME),
                          mulmod(/*column7_row33*/ mload(0x1560), 4, PRIME),
                          PRIME),
                        mulmod(/*column7_row49*/ mload(0x15a0), 8, PRIME),
                        PRIME),
                      mulmod(/*column7_row65*/ mload(0x15c0), 18446744073709551616, PRIME),
                      PRIME),
                    mulmod(/*column7_row81*/ mload(0x1600), 36893488147419103232, PRIME),
                    PRIME),
                  mulmod(/*column7_row97*/ mload(0x1620), 73786976294838206464, PRIME),
                  PRIME),
                mulmod(/*column7_row113*/ mload(0x1660), 147573952589676412928, PRIME),
                PRIME)
              mstore(0x2ce0, val)
              }
                  ...
                  addmod(
                    addmod(
                      addmod(
                        addmod(
                          addmod(
                            mulmod(/*column7_row129*/ mload(0x1680), 340282366920938463463374607431768211456, PRIME),
                            mulmod(/*column7_row145*/ mload(0x16c0), 680564733841876926926749214863536422912, PRIME),
                            PRIME),
                          mulmod(/*column7_row161*/ mload(0x16e0), 1361129467683753853853498429727072845824, PRIME),
                          PRIME),
                        mulmod(/*column7_row177*/ mload(0x1720), 2722258935367507707706996859454145691648, PRIME),
                        PRIME),
                      mulmod(
                        /*column7_row193*/ mload(0x1740),
                        6277101735386680763835789423207666416102355444464034512896,
                        PRIME),
                      PRIME),
                    mulmod(
                      /*column7_row209*/ mload(0x1780),
                      12554203470773361527671578846415332832204710888928069025792,
                      PRIME),
                    PRIME),
                  mulmod(
                    /*column7_row225*/ mload(0x17a0),
                    25108406941546723055343157692830665664409421777856138051584,
                    PRIME),
                  PRIME),
                mulmod(
                  /*column7_row241*/ mload(0x17e0),
              ...
              let val := mulmod(/*column8_row41*/ mload(0x1dc0), /*column8_row41*/ mload(0x1dc0), PRIME)
              mstore(0x2d20, val)
              }
              ...
              let val := addmod(
                /*column8_row21*/ mload(0x1c60),
                sub(
                  PRIME,
                  addmod(/*column8_row85*/ mload(0x1fe0), /*column8_row85*/ mload(0x1fe0), PRIME)),
                PRIME)
              mstore(0x2d40, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/ec_op/ec_subset_sum/bit_0*/ mload(0x2d40)),
                PRIME)
              mstore(0x2d60, val)
              }
              ...
              let val := mulmod(/*column8_row53*/ mload(0x1e80), /*column8_row29*/ mload(0x1d00), PRIME)
              mstore(0x2d80, val)
              }
              ...
              let val := mulmod(/*column8_row13*/ mload(0x1bc0), /*column8_row61*/ mload(0x1f00), PRIME)
              mstore(0x2da0, val)
              }
              ...
              let val := mulmod(/*column8_row45*/ mload(0x1e00), /*column8_row3*/ mload(0x1a80), PRIME)
              mstore(0x2dc0, val)
              }
              ...
              let val := mulmod(/*column8_row501*/ mload(0x23e0), /*column8_row477*/ mload(0x23a0), PRIME)
              mstore(0x2de0, val)
              }
              ...
              let val := mulmod(/*column8_row461*/ mload(0x2380), /*column8_row509*/ mload(0x2400), PRIME)
              mstore(0x2e00, val)
              }
              ...
              let val := mulmod(/*column8_row493*/ mload(0x23c0), /*column8_row451*/ mload(0x2360), PRIME)
              mstore(0x2e20, val)
              }
              ...
              let val := mulmod(/*column8_row245*/ mload(0x2200), /*column8_row221*/ mload(0x21c0), PRIME)
              mstore(0x2e40, val)
              }
              ...
              let val := mulmod(/*column8_row205*/ mload(0x2180), /*column8_row253*/ mload(0x2220), PRIME)
              mstore(0x2e60, val)
              }
              ...
              let val := mulmod(/*column8_row237*/ mload(0x21e0), /*column8_row195*/ mload(0x2160), PRIME)
              mstore(0x2e80, val)
              }
              ...
              let val := mulmod(/*column7_row3*/ mload(0x1380), /*column7_row7*/ mload(0x1400), PRIME)
              mstore(0x2ea0, val)
              }
              ...
              let val := mulmod(/*column7_row11*/ mload(0x1460), /*column7_row15*/ mload(0x14c0), PRIME)
              mstore(0x2ec0, val)
              }
              ...
              let val := mulmod(/*column7_row19*/ mload(0x1500), /*column7_row23*/ mload(0x1520), PRIME)
              mstore(0x2ee0, val)
              }
              ...
              let val := mulmod(/*column8_row6*/ mload(0x1ae0), /*column8_row14*/ mload(0x1be0), PRIME)
              mstore(0x2f00, val)
              }
              ...
              let val := mulmod(/*column8_row22*/ mload(0x1c80), /*column8_row30*/ mload(0x1d20), PRIME)
              mstore(0x2f20, val)
              }
              ...
              let val := mulmod(/*column8_row38*/ mload(0x1da0), /*column8_row46*/ mload(0x1e20), PRIME)
              mstore(0x2f40, val)
              }
              ...
              let val := mulmod(/*column8_row310*/ mload(0x22a0), /*column8_row318*/ mload(0x22c0), PRIME)
              mstore(0x2f60, val)
              }
              ...
              let val := mulmod(/*column8_row326*/ mload(0x22e0), /*column8_row334*/ mload(0x2300), PRIME)
              mstore(0x2f80, val)
              }
              ...
              let val := mulmod(/*column8_row342*/ mload(0x2320), /*column8_row350*/ mload(0x2340), PRIME)
              mstore(0x2fa0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2840),
                  /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2840),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2840)),
                PRIME)

              // Numerator: point^(trace_length / 16) - trace_generator^(15 * trace_length / 16).
              // val *= domains[4].
              val := mulmod(val, /*domains[4]*/ mload(0x3700), PRIME)
              // Denominator: point^trace_length - 1.
              // val *= denominator_invs[0].
              val := mulmod(val, /*denominator_invs[0]*/ mload(0x3b40), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[1]*/ mload(0x3b60), PRIME)
                      ...
                      addmod(
                        mulmod(
                          addmod(
                            ...
                            /*column7_row4*/ mload(0x13a0),
                            PRIME),
                          /*offset_size*/ mload(0x140),
                          PRIME),
                        /*column7_row8*/ mload(0x1420),
                        PRIME),
                      /*offset_size*/ mload(0x140),
                      PRIME),
                    /*column7_row0*/ mload(0x1320),
                    PRIME)),
                PRIME)
              ...
              val := mulmod(val, /*denominator_invs[2]*/ mload(0x3b80), PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/flag_op1_base_op0_0*/ mload(0x28c0),
                  /*intermediate_value/cpu/decode/flag_op1_base_op0_0*/ mload(0x28c0),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/flag_op1_base_op0_0*/ mload(0x28c0)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/flag_res_op1_0*/ mload(0x2940),
                  /*intermediate_value/cpu/decode/flag_res_op1_0*/ mload(0x2940),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/flag_res_op1_0*/ mload(0x2940)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x29a0),
                  /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x29a0),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x29a0)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/fp_update_regular_0*/ mload(0x2a00),
                  /*intermediate_value/cpu/decode/fp_update_regular_0*/ mload(0x2a00),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/fp_update_regular_0*/ mload(0x2a00)),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_range_check/bit_1*/ mload(0x2a20),
                        /*column8_row8*/ mload(0x1b20),
                        PRIME),
                      mulmod(
                        addmod(
                          1,
                          sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_1*/ mload(0x2a20)),
                          PRIME),
                        /*column8_row0*/ mload(0x1a20),
                        PRIME),
                      PRIME),
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    1,
                    sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2920)),
                    PRIME),
                  /*column8_row12*/ mload(0x1ba0),
                  PRIME),
                sub(
                  PRIME,
                  addmod(
              ...
              // val *= domains[28].
              val := mulmod(val, /*domains[28]*/ mload(0x3a00), PRIME)
              // Denominator: point^(trace_length / 16) - 1.
              // val *= denominator_invs[2].
              val := mulmod(val, /*denominator_invs[2]*/ mload(0x3b80), PRIME)
              ...
              let val := addmod(
                /*column8_row10*/ mload(0x1b60),
                sub(
                  PRIME,
                  mulmod(/*column8_row2*/ mload(0x1a60), /*column8_row12*/ mload(0x1ba0), PRIME)),
                PRIME)
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x29a0),
                        /*intermediate_value/npc_reg_0*/ mload(0x2a40),
                        PRIME),
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_range_check/bit_7*/ mload(0x2960),
                        /*column8_row12*/ mload(0x1ba0),
                    ...
                    mulmod(
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_8*/ mload(0x2980),
                      addmod(/*column5_row0*/ mload(0xae0), /*column8_row12*/ mload(0x1ba0), PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                ...
                addmod(
                  /*column5_row16*/ mload(0xc60),
                  sub(PRIME, /*intermediate_value/npc_reg_0*/ mload(0x2a40)),
                  PRIME),
                PRIME)
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column8_row0*/ mload(0x1a20),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_range_check/bit_10*/ mload(0x2a60),
                          /*column8_row12*/ mload(0x1ba0),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_11*/ mload(0x2a80),
                      PRIME),
                    mulmod(/*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x29c0), 2, PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    ...
                    mulmod(
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x29c0),
                      addmod(/*column8_row0*/ mload(0x1a20), 2, PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x29c0),
                addmod(/*column5_row9*/ mload(0xc00), sub(PRIME, /*column8_row8*/ mload(0x1b20)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x29e0),
                addmod(
                  addmod(/*column7_row0*/ mload(0x1320), 2, PRIME),
                  sub(PRIME, /*half_offset_size*/ mload(0x160)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x29e0),
                addmod(
                  addmod(/*column7_row4*/ mload(0x13a0), 1, PRIME),
                  sub(PRIME, /*half_offset_size*/ mload(0x160)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_14*/ mload(0x2aa0),
                addmod(/*column5_row9*/ mload(0xc00), sub(PRIME, /*column8_row12*/ mload(0x1ba0)), PRIME),
                PRIME)
              ...
              let val := addmod(/*column8_row0*/ mload(0x1a20), sub(PRIME, /*initial_ap*/ mload(0x180)), PRIME)

              // Numerator: 1.
              // val *= 1.
              // Denominator: point - 1.
              // val *= denominator_invs[4].
              val := mulmod(val, /*denominator_invs[4]*/ mload(0x3bc0), PRIME)
              ...
              let val := addmod(/*column8_row8*/ mload(0x1b20), sub(PRIME, /*initial_ap*/ mload(0x180)), PRIME)
              ...
              let val := addmod(/*column8_row0*/ mload(0x1a20), sub(PRIME, /*final_ap*/ mload(0x1c0)), PRIME)

              // Numerator: 1.
              // val *= 1.
              // Denominator: point - trace_generator^(trace_length - 16).
              // val *= denominator_invs[3].
              val := mulmod(val, /*denominator_invs[3]*/ mload(0x3ba0), PRIME)
                    ...
                    mulmod(
                      addmod(
                        ...
                        sub(
                          PRIME,
                          addmod(
                            /*column6_row0*/ mload(0x12a0),
                            mulmod(
                              /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x220),
                              /*column6_row1*/ mload(0x12c0),
                              PRIME),
                            PRIME)),
                        PRIME),
                      /*column9_inter1_row0*/ mload(0x2740),
                      PRIME),
                    /*column5_row0*/ mload(0xae0),
                    PRIME),
                  mulmod(
                ...
                mulmod(
                  addmod(
                    ...
                    sub(
                      PRIME,
                      addmod(
                        /*column6_row2*/ mload(0x12e0),
                        mulmod(
                          /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x220),
                          /*column6_row3*/ mload(0x1300),
                          PRIME),
                        PRIME)),
                    PRIME),
                  /*column9_inter1_row2*/ mload(0x2780),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
              ...
              // val *= domains[30].
              val := mulmod(val, /*domains[30]*/ mload(0x3a40), PRIME)
              // Denominator: point^(trace_length / 2) - 1.
              // val *= denominator_invs[5].
              val := mulmod(val, /*denominator_invs[5]*/ mload(0x3be0), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[6]*/ mload(0x3c00), PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/memory/address_diff_0*/ mload(0x2ac0),
                  /*intermediate_value/memory/address_diff_0*/ mload(0x2ac0),
                  PRIME),
                sub(PRIME, /*intermediate_value/memory/address_diff_0*/ mload(0x2ac0)),
                PRIME)
              ...
              let val := mulmod(
                addmod(/*intermediate_value/memory/address_diff_0*/ mload(0x2ac0), sub(PRIME, 1), PRIME),
                addmod(/*column6_row1*/ mload(0x12c0), sub(PRIME, /*column6_row3*/ mload(0x1300)), PRIME),
                PRIME)
              ...
              let val := addmod(/*column6_row0*/ mload(0x12a0), sub(PRIME, 1), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[7]*/ mload(0x3c20), PRIME)
              ...
              {
              // Constraint expression for range_check16/perm/init0: (range_check16/perm/interaction_elm - column7_row2) * column9_inter1_row1 + column7_row0 - range_check16/perm/interaction_elm.
              let val := addmod(
                addmod(
                  mulmod(
                    addmod(
                      /*range_check16/perm/interaction_elm*/ mload(0x260),
                      sub(PRIME, /*column7_row2*/ mload(0x1360)),
                      PRIME),
                    /*column9_inter1_row1*/ mload(0x2760),
                    PRIME),
                  /*column7_row0*/ mload(0x1320),
                  PRIME),
                sub(PRIME, /*range_check16/perm/interaction_elm*/ mload(0x260)),
                PRIME)
              ...
              {
              // Constraint expression for range_check16/perm/step0: (range_check16/perm/interaction_elm - column7_row6) * column9_inter1_row5 - (range_check16/perm/interaction_elm - column7_row4) * column9_inter1_row1.
              let val := addmod(
                mulmod(
                  addmod(
                    /*range_check16/perm/interaction_elm*/ mload(0x260),
                    sub(PRIME, /*column7_row6*/ mload(0x13e0)),
                    PRIME),
                  /*column9_inter1_row5*/ mload(0x27c0),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    addmod(
                      /*range_check16/perm/interaction_elm*/ mload(0x260),
                      sub(PRIME, /*column7_row4*/ mload(0x13a0)),
                      PRIME),
                    /*column9_inter1_row1*/ mload(0x2760),
                    PRIME)),
                PRIME)
              ...
              // val *= domains[31].
              val := mulmod(val, /*domains[31]*/ mload(0x3a60), PRIME)
              // Denominator: point^(trace_length / 4) - 1.
              // val *= denominator_invs[8].
              val := mulmod(val, /*denominator_invs[8]*/ mload(0x3c40), PRIME)
              ...
              {
              // Constraint expression for range_check16/perm/last: column9_inter1_row1 - range_check16/perm/public_memory_prod.
              let val := addmod(
                /*column9_inter1_row1*/ mload(0x2760),
                sub(PRIME, /*range_check16/perm/public_memory_prod*/ mload(0x280)),
                PRIME)
              ...
              val := mulmod(val, /*denominator_invs[9]*/ mload(0x3c60), PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check16/diff_0*/ mload(0x2ae0),
                  /*intermediate_value/range_check16/diff_0*/ mload(0x2ae0),
                  PRIME),
                sub(PRIME, /*intermediate_value/range_check16/diff_0*/ mload(0x2ae0)),
                PRIME)
              ...
              let val := addmod(/*column7_row2*/ mload(0x1360), sub(PRIME, /*range_check_min*/ mload(0x2a0)), PRIME)
              ...
              let val := addmod(/*column7_row2*/ mload(0x1360), sub(PRIME, /*range_check_max*/ mload(0x2c0)), PRIME)
                ...
                addmod(
                  mulmod(
                    addmod(
                      ...
                      sub(PRIME, /*column7_row5*/ mload(0x13c0)),
                      PRIME),
                    /*column9_inter1_row7*/ mload(0x27e0),
                    PRIME),
                  /*column7_row1*/ mload(0x1340),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    /*diluted_check/permutation/interaction_elm*/ mload(0x2e0),
                    sub(PRIME, /*column7_row13*/ mload(0x14a0)),
                    PRIME),
                  /*column9_inter1_row15*/ mload(0x2820),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    addmod(
                      /*diluted_check/permutation/interaction_elm*/ mload(0x2e0),
                      sub(PRIME, /*column7_row9*/ mload(0x1440)),
                      PRIME),
                    /*column9_inter1_row7*/ mload(0x27e0),
                    PRIME)),
                PRIME)

              // Numerator: point - trace_generator^(trace_length - 8).
              // val *= domains[32].
              val := mulmod(val, /*domains[32]*/ mload(0x3a80), PRIME)
              // Denominator: point^(trace_length / 8) - 1.
              // val *= denominator_invs[7].
              val := mulmod(val, /*denominator_invs[7]*/ mload(0x3c20), PRIME)
              ...
              // Numerator: 1.
              // val *= 1.
              // Denominator: point - trace_generator^(trace_length - 8).
              // val *= denominator_invs[10].
              val := mulmod(val, /*denominator_invs[10]*/ mload(0x3c80), PRIME)
              ...
              let val := addmod(/*column9_inter1_row3*/ mload(0x27a0), sub(PRIME, 1), PRIME)
              ...
              let val := addmod(
                /*column9_inter1_row11*/ mload(0x2800),
                sub(
                  PRIME,
                  addmod(
                    mulmod(
                      /*column9_inter1_row3*/ mload(0x27a0),
                      addmod(
                        1,
                        mulmod(
                          /*diluted_check/interaction_z*/ mload(0x340),
                          addmod(/*column7_row13*/ mload(0x14a0), sub(PRIME, /*column7_row5*/ mload(0x13c0)), PRIME),
                          PRIME),
                        PRIME),
                      PRIME),
                    mulmod(
              ...
              val := mulmod(val, /*denominator_invs[11]*/ mload(0x3ca0), PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x2b00),
                addmod(
                  /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x2b00),
                  sub(PRIME, 1),
                  PRIME),
              ...
              // val *= domains[9].
              val := mulmod(val, /*domains[9]*/ mload(0x37a0), PRIME)
              // Denominator: point^trace_length - 1.
              // val *= denominator_invs[0].
              val := mulmod(val, /*denominator_invs[0]*/ mload(0x3b40), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[13]*/ mload(0x3ce0), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[12]*/ mload(0x3cc0), PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0*/ mload(0x2b20),
              ...
              // val *= domains[12].
              val := mulmod(val, /*domains[12]*/ mload(0x3800), PRIME)
              // Denominator: point^(trace_length / 256) - 1.
              // val *= denominator_invs[11].
              val := mulmod(val, /*denominator_invs[11]*/ mload(0x3ca0), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[14]*/ mload(0x3d00), PRIME)
              ...
              let val := addmod(
                /*column5_row518*/ mload(0xf80),
                sub(PRIME, addmod(/*column5_row134*/ mload(0xd40), 1, PRIME)),
                PRIME)

              // Numerator: point - trace_generator^(trace_length - 512).
              // val *= domains[33].
              val := mulmod(val, /*domains[33]*/ mload(0x3aa0), PRIME)
              // Denominator: point^(trace_length / 512) - 1.
              // val *= denominator_invs[14].
              val := mulmod(val, /*denominator_invs[14]*/ mload(0x3d00), PRIME)
              ...
              let val := addmod(
                /*intermediate_value/range_check_builtin/value7_0*/ mload(0x2c20),
              ...
              let val := addmod(
                /*column5_row326*/ mload(0xe80),
                sub(PRIME, addmod(/*column5_row70*/ mload(0xcc0), 1, PRIME)),
                PRIME)

              // Numerator: point - trace_generator^(trace_length - 256).
              // val *= domains[34].
              val := mulmod(val, /*domains[34]*/ mload(0x3ac0), PRIME)
              // Denominator: point^(trace_length / 256) - 1.
              // val *= denominator_invs[11].
              val := mulmod(val, /*denominator_invs[11]*/ mload(0x3ca0), PRIME)
              ...
              let val := addmod(
                /*column5_row70*/ mload(0xcc0),
                sub(PRIME, /*initial_range_check_addr*/ mload(0x400)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  addmod(
                    addmod(
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x2c40),
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x2c40),
                      PRIME),
                    /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x2c40),
                    PRIME),
                ...
                sub(
                  PRIME,
                  mulmod(
                    addmod(/*column8_row33*/ mload(0x1d40), /*column8_row33*/ mload(0x1d40), PRIME),
                    /*column8_row35*/ mload(0x1d60),
                    PRIME)),
                PRIME)

              // Numerator: point^(trace_length / 16384) - trace_generator^(255 * trace_length / 256).
              // val *= domains[21].
              val := mulmod(val, /*domains[21]*/ mload(0x3920), PRIME)
              // Denominator: point^(trace_length / 64) - 1.
              // val *= denominator_invs[15].
              val := mulmod(val, /*denominator_invs[15]*/ mload(0x3d20), PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row35*/ mload(0x1d60), /*column8_row35*/ mload(0x1d60), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column8_row1*/ mload(0x1a40), /*column8_row1*/ mload(0x1a40), PRIME),
                    /*column8_row65*/ mload(0x1f20),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column8_row33*/ mload(0x1d40), /*column8_row97*/ mload(0x2040), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row35*/ mload(0x1d60),
                    addmod(/*column8_row1*/ mload(0x1a40), sub(PRIME, /*column8_row65*/ mload(0x1f20)), PRIME),
                    PRIME)),
                PRIME)
              ...
              // val *= domains[25].
              val := mulmod(val, /*domains[25]*/ mload(0x39a0), PRIME)
              // Denominator: point^(trace_length / 128) - 1.
              // val *= denominator_invs[17].
              val := mulmod(val, /*denominator_invs[17]*/ mload(0x3d60), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[18]*/ mload(0x3d80), PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row123*/ mload(0x2100),
                    addmod(
                      /*column8_row27*/ mload(0x1ce0),
              ...
              let val := addmod(
                mulmod(/*column8_row123*/ mload(0x2100), /*column8_row123*/ mload(0x2100), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x2c60),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x2c60),
                  addmod(/*column8_row91*/ mload(0x2020), /*column8_row219*/ mload(0x21a0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    ...
                    addmod(
                      /*column8_row27*/ mload(0x1ce0),
                      sub(PRIME, /*column8_row155*/ mload(0x2120)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x2c80),
                addmod(
                  /*column8_row155*/ mload(0x2120),
                  sub(PRIME, /*column8_row27*/ mload(0x1ce0)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x2c80),
                addmod(
                  /*column8_row219*/ mload(0x21a0),
                  sub(PRIME, /*column8_row91*/ mload(0x2020)),
                  PRIME),
                PRIME)
              ...
              val := mulmod(val, /*denominator_invs[16]*/ mload(0x3d40), PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x2ca0),
                  addmod(/*column8_row49*/ mload(0x1e40), sub(PRIME, /*column8_row33*/ mload(0x1d40)), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row19*/ mload(0x1c40),
                    addmod(/*column8_row17*/ mload(0x1c20), sub(PRIME, /*column8_row1*/ mload(0x1a40)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row19*/ mload(0x1c40), /*column8_row19*/ mload(0x1c40), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x2ca0),
                    addmod(
                      addmod(/*column8_row17*/ mload(0x1c20), /*column8_row1*/ mload(0x1a40), PRIME),
                      /*column8_row81*/ mload(0x1fc0),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x2ca0),
                  addmod(/*column8_row49*/ mload(0x1e40), /*column8_row113*/ mload(0x20c0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row19*/ mload(0x1c40),
                    addmod(/*column8_row17*/ mload(0x1c20), sub(PRIME, /*column8_row81*/ mload(0x1fc0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x2cc0),
                addmod(/*column8_row81*/ mload(0x1fc0), sub(PRIME, /*column8_row17*/ mload(0x1c20)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x2cc0),
                addmod(
                  /*column8_row113*/ mload(0x20c0),
                  sub(PRIME, /*column8_row49*/ mload(0x1e40)),
                  PRIME),
                PRIME)
              ...
              val := mulmod(val, /*denominator_invs[21]*/ mload(0x3de0), PRIME)
              ...
              val := mulmod(val, /*denominator_invs[22]*/ mload(0x3e00), PRIME)
              ...
              let val := addmod(
                /*column8_row32731*/ mload(0x26c0),
                sub(
                  PRIME,
                  addmod(
                    /*column8_row16369*/ mload(0x25c0),
                    mulmod(
                      /*column8_row32763*/ mload(0x2720),
                      addmod(
                        /*column8_row32667*/ mload(0x2660),
                        sub(PRIME, /*column8_row16337*/ mload(0x2520)),
                        PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row32763*/ mload(0x2720), /*column8_row32763*/ mload(0x2720), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column8_row32667*/ mload(0x2660), /*column8_row16337*/ mload(0x2520), PRIME),
                    /*column8_row16385*/ mload(0x2600),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column8_row32731*/ mload(0x26c0), /*column8_row16417*/ mload(0x2620), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row32763*/ mload(0x2720),
                    addmod(
                      /*column8_row32667*/ mload(0x2660),
                      sub(PRIME, /*column8_row16385*/ mload(0x2600)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  /*column8_row32753*/ mload(0x2700),
                  /*ecdsa/sig_config.shift_point.y*/ mload(0x460),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row16331*/ mload(0x2500),
                    addmod(
                      /*column8_row32721*/ mload(0x26a0),
                      sub(PRIME, /*ecdsa/sig_config.shift_point.x*/ mload(0x440)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row16331*/ mload(0x2500), /*column8_row16331*/ mload(0x2500), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              let val := addmod(
                mulmod(/*column8_row59*/ mload(0x1ee0), /*column8_row16363*/ mload(0x25a0), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row9*/ mload(0x1b40), /*column8_row16355*/ mload(0x2560), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              let val := addmod(
                /*column8_row32747*/ mload(0x26e0),
                sub(
                  PRIME,
                  mulmod(/*column8_row1*/ mload(0x1a40), /*column8_row1*/ mload(0x1a40), PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row33*/ mload(0x1d40), /*column8_row33*/ mload(0x1d40), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      mulmod(/*column8_row1*/ mload(0x1a40), /*column8_row32747*/ mload(0x26e0), PRIME),
                      mulmod(/*ecdsa/sig_config.alpha*/ mload(0x420), /*column8_row1*/ mload(0x1a40), PRIME),
                      PRIME),
              ...
              let val := addmod(
                /*column5_row16774*/ mload(0x1220),
                sub(PRIME, addmod(/*column5_row390*/ mload(0xee0), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row33158*/ mload(0x1280),
                sub(PRIME, addmod(/*column5_row16774*/ mload(0x1220), 1, PRIME)),
                PRIME)

              // Numerator: point - trace_generator^(trace_length - 32768).
              // val *= domains[35].
              val := mulmod(val, /*domains[35]*/ mload(0x3ae0), PRIME)
              // Denominator: point^(trace_length / 32768) - 1.
              // val *= denominator_invs[21].
              val := mulmod(val, /*denominator_invs[21]*/ mload(0x3de0), PRIME)
              ...
              let val := addmod(
                /*column5_row16775*/ mload(0x1240),
                sub(PRIME, /*column8_row59*/ mload(0x1ee0)),
                PRIME)
              ...
              let val := addmod(/*column5_row391*/ mload(0xf00), sub(PRIME, /*column8_row1*/ mload(0x1a40)), PRIME)
              ...
              let val := addmod(
                /*column5_row454*/ mload(0xf60),
                sub(PRIME, addmod(/*column5_row198*/ mload(0xdc0), 1, PRIME)),
                PRIME)

              // Numerator: point^(trace_length / 1024) - trace_generator^(3 * trace_length / 4).
              // val *= domains[18].
              val := mulmod(val, /*domains[18]*/ mload(0x38c0), PRIME)
              // Denominator: point^(trace_length / 256) - 1.
              // val *= denominator_invs[11].
              val := mulmod(val, /*denominator_invs[11]*/ mload(0x3ca0), PRIME)
              ...
              let val := addmod(
                /*column5_row902*/ mload(0xfc0),
                sub(PRIME, addmod(/*column5_row966*/ mload(0x1000), 1, PRIME)),
                PRIME)
              ...
              val := mulmod(val, /*denominator_invs[23]*/ mload(0x3e20), PRIME)
              ...
              let val := addmod(
                /*column5_row1222*/ mload(0x1040),
                sub(PRIME, addmod(/*column5_row902*/ mload(0xfc0), 1, PRIME)),
                PRIME)

              // Numerator: point - trace_generator^(trace_length - 1024).
              // val *= domains[36].
              val := mulmod(val, /*domains[36]*/ mload(0x3b00), PRIME)
              // Denominator: point^(trace_length / 1024) - 1.
              // val *= denominator_invs[23].
              val := mulmod(val, /*denominator_invs[23]*/ mload(0x3e20), PRIME)
              ...
              let val := addmod(
                addmod(
                  /*intermediate_value/bitwise/sum_var_0_0*/ mload(0x2ce0),
                  /*intermediate_value/bitwise/sum_var_8_0*/ mload(0x2d00),
                  PRIME),
                sub(PRIME, /*column5_row199*/ mload(0xde0)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row903*/ mload(0xfe0),
                sub(
                  PRIME,
                  addmod(/*column5_row711*/ mload(0xfa0), /*column5_row967*/ mload(0x1020), PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column7_row1*/ mload(0x1340), /*column7_row257*/ mload(0x1800), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column7_row769*/ mload(0x1960), /*column7_row513*/ mload(0x18a0), PRIME),
                    /*column7_row513*/ mload(0x18a0),
                    PRIME)),
                PRIME)
              ...
              val := mulmod(val, /*denominator_invs[24]*/ mload(0x3e40), PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(/*column7_row705*/ mload(0x18e0), /*column7_row961*/ mload(0x19a0), PRIME),
                  16,
                  PRIME),
                sub(PRIME, /*column7_row9*/ mload(0x1440)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(/*column7_row721*/ mload(0x1900), /*column7_row977*/ mload(0x19c0), PRIME),
                  16,
                  PRIME),
                sub(PRIME, /*column7_row521*/ mload(0x18c0)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(/*column7_row737*/ mload(0x1920), /*column7_row993*/ mload(0x19e0), PRIME),
                  16,
                  PRIME),
                sub(PRIME, /*column7_row265*/ mload(0x1820)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(/*column7_row753*/ mload(0x1940), /*column7_row1009*/ mload(0x1a00), PRIME),
                  256,
                  PRIME),
                sub(PRIME, /*column7_row777*/ mload(0x1980)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row24966*/ mload(0x1260),
                sub(PRIME, addmod(/*column5_row8582*/ mload(0x1120), 7, PRIME)),
                PRIME)

              // Numerator: point - trace_generator^(trace_length - 16384).
              // val *= domains[37].
              val := mulmod(val, /*domains[37]*/ mload(0x3b20), PRIME)
              // Denominator: point^(trace_length / 16384) - 1.
              // val *= denominator_invs[22].
              val := mulmod(val, /*denominator_invs[22]*/ mload(0x3e00), PRIME)
              ...
              let val := addmod(
                /*column5_row4486*/ mload(0x10a0),
                sub(PRIME, addmod(/*column5_row8582*/ mload(0x1120), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row12678*/ mload(0x11a0),
                sub(PRIME, addmod(/*column5_row4486*/ mload(0x10a0), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row2438*/ mload(0x1060),
                sub(PRIME, addmod(/*column5_row12678*/ mload(0x11a0), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row10630*/ mload(0x1160),
                sub(PRIME, addmod(/*column5_row2438*/ mload(0x1060), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row6534*/ mload(0x10e0),
                sub(PRIME, addmod(/*column5_row10630*/ mload(0x1160), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row14726*/ mload(0x11e0),
                sub(PRIME, addmod(/*column5_row6534*/ mload(0x10e0), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  addmod(
                    addmod(
                      /*intermediate_value/ec_op/doubling_q/x_squared_0*/ mload(0x2d20),
                      /*intermediate_value/ec_op/doubling_q/x_squared_0*/ mload(0x2d20),
                      PRIME),
                    /*intermediate_value/ec_op/doubling_q/x_squared_0*/ mload(0x2d20),
                    PRIME),
                ...
                sub(
                  PRIME,
                  mulmod(
                    addmod(/*column8_row25*/ mload(0x1cc0), /*column8_row25*/ mload(0x1cc0), PRIME),
                    /*column8_row57*/ mload(0x1ec0),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row57*/ mload(0x1ec0), /*column8_row57*/ mload(0x1ec0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column8_row41*/ mload(0x1dc0), /*column8_row41*/ mload(0x1dc0), PRIME),
                    /*column8_row105*/ mload(0x2080),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column8_row25*/ mload(0x1cc0), /*column8_row89*/ mload(0x2000), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row57*/ mload(0x1ec0),
                    addmod(
                      /*column8_row41*/ mload(0x1dc0),
                      sub(PRIME, /*column8_row105*/ mload(0x2080)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row12679*/ mload(0x11c0),
                sub(PRIME, /*column8_row41*/ mload(0x1dc0)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row2439*/ mload(0x1080),
                sub(PRIME, /*column8_row25*/ mload(0x1cc0)),
                PRIME)
              ...
              let val := mulmod(
                /*column8_row16371*/ mload(0x25e0),
                addmod(
                  /*column8_row85*/ mload(0x1fe0),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column8_row12309*/ mload(0x2420),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row16339*/ mload(0x2540),
                    addmod(
                      /*column8_row12309*/ mload(0x2420),
                      sub(
                        PRIME,
                        addmod(/*column8_row12373*/ mload(0x2440), /*column8_row12373*/ mload(0x2440), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column8_row16339*/ mload(0x2540),
                addmod(
                  /*column8_row12373*/ mload(0x2440),
                  sub(PRIME, mulmod(8, /*column8_row12565*/ mload(0x2460), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column8_row16085*/ mload(0x24a0),
                      sub(
                        PRIME,
                        addmod(/*column8_row16149*/ mload(0x24c0), /*column8_row16149*/ mload(0x24c0), PRIME)),
                      PRIME),
                    addmod(
                      /*column8_row12565*/ mload(0x2460),
                      sub(
                        PRIME,
                        addmod(/*column8_row12629*/ mload(0x2480), /*column8_row12629*/ mload(0x2480), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column8_row12629*/ mload(0x2480),
                  sub(PRIME, mulmod(18014398509481984, /*column8_row16085*/ mload(0x24a0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ec_op/ec_subset_sum/bit_0*/ mload(0x2d40),
                addmod(
                  /*intermediate_value/ec_op/ec_subset_sum/bit_0*/ mload(0x2d40),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ec_op/ec_subset_sum/bit_0*/ mload(0x2d40),
                  addmod(/*column8_row37*/ mload(0x1d80), sub(PRIME, /*column8_row25*/ mload(0x1cc0)), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row11*/ mload(0x1b80),
                    addmod(/*column8_row5*/ mload(0x1ac0), sub(PRIME, /*column8_row41*/ mload(0x1dc0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row11*/ mload(0x1b80), /*column8_row11*/ mload(0x1b80), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ec_op/ec_subset_sum/bit_0*/ mload(0x2d40),
                    addmod(
                      addmod(/*column8_row5*/ mload(0x1ac0), /*column8_row41*/ mload(0x1dc0), PRIME),
                      /*column8_row69*/ mload(0x1f40),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ec_op/ec_subset_sum/bit_0*/ mload(0x2d40),
                  addmod(/*column8_row37*/ mload(0x1d80), /*column8_row101*/ mload(0x2060), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row11*/ mload(0x1b80),
                    addmod(/*column8_row5*/ mload(0x1ac0), sub(PRIME, /*column8_row69*/ mload(0x1f40)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ec_op/ec_subset_sum/bit_neg_0*/ mload(0x2d60),
                addmod(/*column8_row69*/ mload(0x1f40), sub(PRIME, /*column8_row5*/ mload(0x1ac0)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ec_op/ec_subset_sum/bit_neg_0*/ mload(0x2d60),
                addmod(
                  /*column8_row101*/ mload(0x2060),
                  sub(PRIME, /*column8_row37*/ mload(0x1d80)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column8_row21*/ mload(0x1c60),
                sub(PRIME, /*column5_row10631*/ mload(0x1180)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row8583*/ mload(0x1140),
                sub(PRIME, /*column8_row5*/ mload(0x1ac0)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row6535*/ mload(0x1100),
                sub(PRIME, /*column8_row16325*/ mload(0x24e0)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row14727*/ mload(0x1200),
                sub(PRIME, /*column8_row16357*/ mload(0x2580)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row294*/ mload(0xe40),
                sub(PRIME, addmod(/*column5_row38*/ mload(0xc80), 3, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row166*/ mload(0xd80),
                sub(PRIME, addmod(/*initial_poseidon_addr*/ mload(0x520), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row422*/ mload(0xf20),
                sub(PRIME, addmod(/*column5_row166*/ mload(0xd80), 3, PRIME)),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(PRIME, addmod(/*initial_poseidon_addr*/ mload(0x520), 2, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column5_row358*/ mload(0xea0),
                sub(PRIME, addmod(/*column5_row102*/ mload(0xd00), 3, PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row53*/ mload(0x1e80), /*column8_row53*/ mload(0x1e80), PRIME),
                sub(PRIME, /*column8_row29*/ mload(0x1d00)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row13*/ mload(0x1bc0), /*column8_row13*/ mload(0x1bc0), PRIME),
                sub(PRIME, /*column8_row61*/ mload(0x1f00)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row45*/ mload(0x1e00), /*column8_row45*/ mload(0x1e00), PRIME),
                sub(PRIME, /*column8_row3*/ mload(0x1a80)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column7_row3*/ mload(0x1380), /*column7_row3*/ mload(0x1380), PRIME),
                sub(PRIME, /*column7_row7*/ mload(0x1400)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column8_row6*/ mload(0x1ae0), /*column8_row6*/ mload(0x1ae0), PRIME),
                sub(PRIME, /*column8_row14*/ mload(0x1be0)),
                PRIME)

              // Numerator: (point^(trace_length / 512) - trace_generator^(11 * trace_length / 16)) * (point^(trace_length / 512) - trace_generator^(23 * trace_length / 32)) * (point^(trace_length / 512) - trace_generator^(3 * trace_length / 4)) * (point^(trace_length / 512) - trace_generator^(25 * trace_length / 32)) * (point^(trace_length / 512) - trace_generator^(13 * trace_length / 16)) * (point^(trace_length / 512) - trace_generator^(27 * trace_length / 32)) * (point^(trace_length / 512) - trace_generator^(7 * trace_length / 8)) * (point^(trace_length / 512) - trace_generator^(29 * trace_length / 32)) * (point^(trace_length / 512) - trace_generator^(15 * trace_length / 16)) * domain14.
              // val *= domains[15].
              val := mulmod(val, /*domains[15]*/ mload(0x3860), PRIME)
              // Denominator: point^(trace_length / 16) - 1.
              // val *= denominator_invs[2].
              val := mulmod(val, /*denominator_invs[2]*/ mload(0x3b80), PRIME)
              ...
              let val := addmod(
                addmod(
                  ...
                  PRIME),
                sub(PRIME, /*column8_row53*/ mload(0x1e80)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  ...
                  PRIME),
                sub(PRIME, /*column8_row45*/ mload(0x1e00)),
                PRIME)
                  ...
                  addmod(
                    addmod(
                      addmod(
                        addmod(
                          addmod(
                            /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_0*/ mload(0x2d80),
                            /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_0*/ mload(0x2d80),
                            PRIME),
                          /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_0*/ mload(0x2d80),
                          PRIME),
                        /*intermediate_value/poseidon/poseidon/full_rounds_state1_cubed_0*/ mload(0x2da0),
                        PRIME),
                      /*intermediate_value/poseidon/poseidon/full_rounds_state2_cubed_0*/ mload(0x2dc0),
                      PRIME),
              ...
              // val *= domains[11].
              val := mulmod(val, /*domains[11]*/ mload(0x37e0), PRIME)
              // Denominator: point^(trace_length / 64) - 1.
              // val *= denominator_invs[15].
              val := mulmod(val, /*denominator_invs[15]*/ mload(0x3d20), PRIME)
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      addmod(
                        addmod(
                          /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_7*/ mload(0x2de0),
                          /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_7*/ mload(0x2de0),
                          PRIME),
                        /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_7*/ mload(0x2de0),
                        PRIME),
                      /*intermediate_value/poseidon/poseidon/full_rounds_state1_cubed_7*/ mload(0x2e00),
                      PRIME),
                    /*intermediate_value/poseidon/poseidon/full_rounds_state2_cubed_7*/ mload(0x2e20),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(/*column7_row491*/ mload(0x1840), sub(PRIME, /*column8_row6*/ mload(0x1ae0)), PRIME)
              ...
              let val := addmod(
                /*column7_row499*/ mload(0x1860),
                sub(PRIME, /*column8_row22*/ mload(0x1c80)),
                PRIME)
              ...
              let val := addmod(
                /*column7_row507*/ mload(0x1880),
                sub(PRIME, /*column8_row38*/ mload(0x1da0)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  addmod(
                    /*column7_row3*/ mload(0x1380),
                    /*intermediate_value/poseidon/poseidon/full_rounds_state2_cubed_3*/ mload(0x2e80),
                    PRIME),
                  /*intermediate_value/poseidon/poseidon/full_rounds_state2_cubed_3*/ mload(0x2e80),
                  PRIME),
                sub(
                  ...
                  addmod(
                    addmod(
                      /*intermediate_value/poseidon/poseidon/full_rounds_state0_cubed_3*/ mload(0x2e40),
                      /*intermediate_value/poseidon/poseidon/full_rounds_state1_cubed_3*/ mload(0x2e60),
                      PRIME),
                    2121140748740143694053732746913428481442990369183417228688865837805149503386,
                    PRIME)),
                PRIME)
                      ...
                      addmod(
                        addmod(
                          ...
                          mulmod(
                            ...
                            PRIME),
                          PRIME),
                        mulmod(4, /*column7_row3*/ mload(0x1380), PRIME),
                        PRIME),
                      mulmod(
                        3618502788666131213697322783095070105623107215331596699973092056135872020479,
                        /*intermediate_value/poseidon/poseidon/partial_rounds_state0_cubed_0*/ mload(0x2ea0),
                        PRIME),
                      PRIME),
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      ...
                      mulmod(
                        3618502788666131213697322783095070105623107215331596699973092056135872020479,
                        /*intermediate_value/poseidon/poseidon/partial_rounds_state0_cubed_1*/ mload(0x2ec0),
                        PRIME),
                      PRIME),
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                          ...
                          addmod(
                            addmod(
                              mulmod(
                                ...
                                /*intermediate_value/poseidon/poseidon/partial_rounds_state0_cubed_0*/ mload(0x2ea0),
                                PRIME),
                              mulmod(4, /*column7_row11*/ mload(0x1460), PRIME),
                              PRIME),
                            mulmod(
                              6,
                              /*intermediate_value/poseidon/poseidon/partial_rounds_state0_cubed_1*/ mload(0x2ec0),
                      ...
                      mulmod(
                        3618502788666131213697322783095070105623107215331596699973092056135872020479,
                        /*intermediate_value/poseidon/poseidon/partial_rounds_state0_cubed_2*/ mload(0x2ee0),
                        PRIME),
                      PRIME),
              ...
              // Numerator: (point^(trace_length / 512) - trace_generator^(61 * trace_length / 64)) * (point^(trace_length / 512) - trace_generator^(63 * trace_length / 64)) * domain14.
              // val *= domains[16].
              val := mulmod(val, /*domains[16]*/ mload(0x3880), PRIME)
              // Denominator: point^(trace_length / 8) - 1.
              // val *= denominator_invs[7].
              val := mulmod(val, /*denominator_invs[7]*/ mload(0x3c20), PRIME)
                        ...
                        addmod(
                          addmod(
                            addmod(
                              mulmod(
                                8,
                                /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_0*/ mload(0x2f00),
                                PRIME),
                              mulmod(4, /*column8_row22*/ mload(0x1c80), PRIME),
                              PRIME),
                            mulmod(
                              6,
                              /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_1*/ mload(0x2f20),
                              PRIME),
                            PRIME),
                          /*column8_row38*/ mload(0x1da0),
                          PRIME),
                        /*column8_row38*/ mload(0x1da0),
                        PRIME),
                      mulmod(
                        3618502788666131213697322783095070105623107215331596699973092056135872020479,
                        /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_2*/ mload(0x2f40),
                        PRIME),
                      PRIME),
              ...
              // Numerator: (point^(trace_length / 512) - trace_generator^(19 * trace_length / 32)) * (point^(trace_length / 512) - trace_generator^(5 * trace_length / 8)) * (point^(trace_length / 512) - trace_generator^(21 * trace_length / 32)) * domain15.
              // val *= domains[17].
              val := mulmod(val, /*domains[17]*/ mload(0x38a0), PRIME)
              // Denominator: point^(trace_length / 16) - 1.
              // val *= denominator_invs[2].
              val := mulmod(val, /*denominator_invs[2]*/ mload(0x3b80), PRIME)
                      ...
                      addmod(
                        addmod(
                          addmod(
                            mulmod(
                              16,
                              /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_19*/ mload(0x2f60),
                              PRIME),
                            mulmod(8, /*column8_row326*/ mload(0x22e0), PRIME),
                            PRIME),
                          mulmod(
                            16,
                            /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_20*/ mload(0x2f80),
                            PRIME),
                          PRIME),
                        mulmod(6, /*column8_row342*/ mload(0x2320), PRIME),
                        PRIME),
                      /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_21*/ mload(0x2fa0),
                      PRIME),
                    560279373700919169769089400651532183647886248799764942664266404650165812023,
                    PRIME)),
                PRIME)
                          ...
                          addmod(
                            addmod(
                              mulmod(
                                ...
                                /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_19*/ mload(0x2f60),
                                PRIME),
                              mulmod(4, /*column8_row326*/ mload(0x22e0), PRIME),
                              PRIME),
                            mulmod(
                              6,
                              /*intermediate_value/poseidon/poseidon/partial_rounds_state1_cubed_20*/ mload(0x2f80),
