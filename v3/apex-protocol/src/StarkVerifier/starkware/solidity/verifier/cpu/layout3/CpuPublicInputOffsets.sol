...
contract CpuPublicInputOffsets is CpuPublicInputOffsetsBase {
    ...
    uint256 internal constant OFFSET_BITWISE_STOP_PTR = 18;
    uint256 internal constant OFFSET_EC_OP_BEGIN_ADDR = 19;
    uint256 internal constant OFFSET_EC_OP_STOP_PTR = 20;
    uint256 internal constant OFFSET_PUBLIC_MEMORY_PADDING_ADDR = 21;
    uint256 internal constant OFFSET_PUBLIC_MEMORY_PADDING_VALUE = 22;
    uint256 internal constant OFFSET_N_PUBLIC_MEMORY_PAGES = 23;
    uint256 internal constant OFFSET_PUBLIC_MEMORY = 24;
