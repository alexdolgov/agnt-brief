...
contract Settlement is ISettlement, OwnablePausable {
     ...
     * @param _restrictedCountries Array of the restricted countries
     */
    constructor(
        address _redemption,
        address _recipient,
    ...
    function redeem(
        ...
        require(
            !restrictedCountries[redeemerCountry],
            "Settlement: redeemer jurisdiction is restricted"
        );
