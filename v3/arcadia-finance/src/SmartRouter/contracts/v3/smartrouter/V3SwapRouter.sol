...
/// @title Alien Base V3 Swap Router
/// @notice Router for stateless execution of swaps against Alien Base V3
abstract contract V3SwapRouter is IV3SwapRouter, PeripheryPaymentsWithFeeExtended, OracleSlippage, ReentrancyGuard {
    ...
    function exactInputInternal(
        ...
        (int256 amount0, int256 amount1) =
            SmartRouterHelper.getPool(factory, tokenIn, tokenOut, fee).swap(
                recipient,
                zeroForOne,
                amountIn.toInt256(),
                sqrtPriceLimitX96 == 0
