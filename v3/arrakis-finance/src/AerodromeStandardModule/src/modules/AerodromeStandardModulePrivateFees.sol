...
import {AerodromeStandardModule} from
    "../abstracts/AerodromeStandardModule.sol";
...
contract AerodromeStandardModulePrivateFees is
    AerodromeStandardModule,
    IArrakisLPModulePrivate
{
    ...
    /// @dev id = keccak256(abi.encode("AerodromeStandardModulePrivateFees"))
    bytes32 public constant id =
        0x76973ad2c6982df5fca8d74710701ca1127a043b761617709bdd6cca093c03e7;
    ...
    constructor(
        address guardian_,
        address factory_
    ) AerodromeStandardModule(guardian_, factory_) {}
