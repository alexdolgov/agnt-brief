...
/// @notice Fork of UnderlyingV3 adapted for Aerodrome CL pools.
/// @dev Aerodrome CL pools differ from standard UniswapV3:
///   - slot0() returns 6 values (no feeProtocol)
///   - ticks() returns 10 values (extra stakedLiquidityNet and rewardGrowthOutsideX128)
library UnderlyingAerodrome {
        ...
        )
    {
        ...
        (uint160 sqrtPriceX96, int24 tick,,,,) =
            IUniswapV3Pool(underlying_.pool).slot0();
    ...
    function _getFeesEarned(
        ...
        // Aerodrome CL: ticks() returns 10 values.
        // feeGrowthOutside0X128 is at position 3 (not 2)
        // feeGrowthOutside1X128 is at position 4 (not 3)
        (
            ,
            ,
            ,
            ...
            ,
            ,
        ) = IUniswapV3Pool(feeInfo_.pool).ticks(
            feeInfo_.lowerTick
        );
        (
            ,
