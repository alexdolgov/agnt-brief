...
contract KashiPair is ERC20, BoringOwnable, IMasterContract {
    ...
    uint8 internal constant ACTION_BENTO_STRATEGY_HARVEST = 25;
    ...
    function cook(
        ...
        for (uint256 i = 0; i < actions.length; i++) {
            ...
            } else if (action == ACTION_BENTO_STRATEGY_HARVEST) {
                (IERC20 token, bool balance, uint256 maxChangeAmount) = abi.decode(datas[i], (IERC20, bool, uint256));
