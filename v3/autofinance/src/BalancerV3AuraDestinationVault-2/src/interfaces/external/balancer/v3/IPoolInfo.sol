...
/**
 * @dev This interface has been modified from the original Balancer interface.
 * ERC20 values returned have been replaced by address to simplify usage in our
 * contracts since we only need addresses in our code.
 */
