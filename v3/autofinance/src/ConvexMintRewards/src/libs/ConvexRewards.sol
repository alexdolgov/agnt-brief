...
contract ConvexMintRewards {
    function getCVXMintAmount(address cvxToken, uint256 crvEarned) external view returns (uint256) {
        return ConvexRewards.getCVXMintAmount(cvxToken, crvEarned);
    }
}
