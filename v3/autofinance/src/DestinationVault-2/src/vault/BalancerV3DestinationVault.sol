...
import { BalancerV3Utils } from "src/vault/libs/BalancerV3Utils.sol";
...
contract BalancerV3DestinationVault is DestinationVault {
        ...
        returns (address[] memory tokens, uint256[] memory balances)
    {
        ...
        balances = BalancerV3Utils.underlyingReserves(_underlying, _isWrappedToken);
    }
    ...
    function _burnUnderlyer(
        ...
        amounts = BalancerV3Adapter.removeLiquidity(
            balancerRouter, _underlying, tokens, minAmounts, underlyerAmount, isBoosted, _isWrappedToken
        );
    }
