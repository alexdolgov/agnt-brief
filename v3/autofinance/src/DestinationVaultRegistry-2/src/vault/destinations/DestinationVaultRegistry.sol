...
contract DestinationVaultRegistry is SystemComponent, IDestinationVaultRegistry, SecurityBase {
    ...
    function verifyIsRegistered(
        ...
        if (!vaults.contains(destinationVault)) revert AutopilotErrors.NotRegistered();
    }
    ...
    function register(
        ...
        AutopilotErrors.verifyNotZero(newDestinationVault, "newDestinationVault");
    ...
    function setVaultFactory(
        ...
        AutopilotErrors.verifyNotZero(newAddress, "newAddress");
        AutopilotErrors.verifySystemsMatch(address(this), newAddress);
