...
contract MevModule is Initializable {
        ...
        authorizedSwap(_authParams)
    {
        ...
        // xram -> ram
        IXRex(XRAM).exit(IERC20(XRAM).balanceOf(address(this)));
        // profit check
        ...
        // bribe
        // TODO: explore best bribe strategy (X33, XRAM, RAM ?)
        // IFeeDistributor(_feeDistToBribe).incentivize(RAM, balanceAfter - balanceBefore);
    }
