...
library Roles {
    ...
    bytes32 public constant GLOBAL_REWARDER_OPERATOR = keccak256("GLOBAL_REWARDER_OPERATOR");
    bytes32 public constant SPECIFIC_REWARDER_OPERATOR = keccak256("SPECIFIC_REWARDER_OPERATOR");
