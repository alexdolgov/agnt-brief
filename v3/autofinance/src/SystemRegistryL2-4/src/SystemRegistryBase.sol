...
abstract contract SystemRegistryBase is ISystemRegistry, Ownable2Step {
    ...
    constructor(
        ...
        AutopilotErrors.verifyNotZero(address(_weth), "_weth");
        weth = IWETH9(_weth);
    }
    ...
    function setAccToke(
        ...
        AutopilotErrors.verifyNotZero(newAccToke, "newAccToke");
    ...
    function setAutopoolRegistry(
        ...
        AutopilotErrors.verifyNotZero(registry, "autoPoolRegistry");
    ...
    function setAutopilotRouter(
        ...
        AutopilotErrors.verifyNotZero(router, "autoPoolRouter");
    ...
    function setDestinationVaultRegistry(
        ...
        AutopilotErrors.verifyNotZero(registry, "destinationVaultRegistry");
    ...
    function setAccessController(
        ...
        AutopilotErrors.verifyNotZero(controller, "accessController");

        if (address(_accessController) != address(0)) {
            revert AutopilotErrors.AlreadySet("accessController");
        }
    ...
    function setDestinationTemplateRegistry(
        ...
        AutopilotErrors.verifyNotZero(registry, "destinationTemplateRegistry");
    ...
    function setStatsCalculatorRegistry(
        ...
        AutopilotErrors.verifyNotZero(registry, "statsCalculatorRegistry");
    ...
    function setRootPriceOracle(
        ...
        AutopilotErrors.verifyNotZero(oracle, "oracle");
    ...
    function setIncentivePricingStats(
        ...
        AutopilotErrors.verifyNotZero(incentivePricingStats, "incentivePricingStats");
    ...
    function setAsyncSwapperRegistry(
        ...
        AutopilotErrors.verifyNotZero(registry, "asyncSwapperRegistry");
    ...
    function setSwapRouter(
        ...
        AutopilotErrors.verifyNotZero(router, "router");
    ...
    function setCurveResolver(
        ...
        AutopilotErrors.verifyNotZero(resolver, "resolver");
    ...
    function addRewardToken(
        ...
        AutopilotErrors.verifyNotZero(rewardToken, "rewardToken");
        bool success = _rewardTokens.add(rewardToken);
        if (!success) {
            revert AutopilotErrors.ItemExists();
        }
    ...
    function setAutopoolFactory(bytes32 vaultType, address factoryAddress) external onlyOwner {
        AutopilotErrors.verifyNotZero(factoryAddress, "factoryAddress");
        AutopilotErrors.verifyNotZero(vaultType, "vaultType");
    ...
    function setSystemSecurity(
        ...
        AutopilotErrors.verifyNotZero(security, "security");
    ...
    function setMessageProxy(
        ...
        AutopilotErrors.verifyNotZero(proxy, "messageProxy");
    ...
    function setReceivingRouter(
        ...
        AutopilotErrors.verifyNotZero(router, "receivingRouter");
    ...
    function setContract(bytes32 contractType, address contractAddress) external onlyOwner {
        AutopilotErrors.verifyNotZero(contractType, "contractType");
        AutopilotErrors.verifyNotZero(contractAddress, "contractAddress");
    ...
    function getUniqueContract(
        ...
        AutopilotErrors.verifyNotZero(ret, "ret");
    ...
    function _verifySystemsAgree(
        ...
        if (success && data.length > 0) {
            ...
            if (depRegistry != address(this)) {
                revert AutopilotErrors.SystemMismatch(address(this), depRegistry);
            }
        } else {
