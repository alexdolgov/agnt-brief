...
import {ICreditEnforcer, ISavingModule} from "./interfaces/IReservoirSwap.sol";
...
import {IMorpho, Market, Position, MarketParams, Id} from "morpho-blue/interfaces/IMorpho.sol";
...
contract ReservoirLooper is IReservoirLooper, AccessControl {
    ...
    function _mintRUSD(
        ...
        srUSD.approve(SAVINGMODULE_ADDRESS, type(uint256).max);
