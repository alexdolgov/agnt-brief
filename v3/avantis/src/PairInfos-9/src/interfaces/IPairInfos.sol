...
interface IPairInfos {
    ...
    struct PairParams {
        ...
        uint __deprecated_rolloverFeePerBlockP; // Deprecated now
    }

    struct PairRolloverParams {
        uint longRolloverFeePerBlockP;
        uint shortRolloverFeePerBlockP;
    }
    ...
    event RolloverFeePerBlockPUpdated(uint pairIndex, uint longFee, uint shortFee);
