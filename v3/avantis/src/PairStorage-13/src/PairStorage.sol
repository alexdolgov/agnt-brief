...
contract PairStorage is Initializable, IPairStorage {
    ...
    function updatePairParams(uint _pairIndex, PairParams calldata _params) external onlyGov{
        ...
        params.minLongBorrowFee              =               _params.minLongBorrowFee;
        params.maxLongBorrowFee              =               _params.maxLongBorrowFee;
    ...
    function updateAdditionalPairParams(uint _pairIndex, AdditionalPairParams calldata _params) external onlyGov{
        ...
        params.minShortBorrowFee = _params.minShortBorrowFee;
        params.maxShortBorrowFee = _params.maxShortBorrowFee;
    ...
    * @return bool allowed or not
     ...
     */
    function minBorrowFee(uint _pairIndex, bool _isBuy) external view override returns(uint){
        return _isBuy ? pairParams[_pairIndex].minLongBorrowFee : addtionalPairParams[_pairIndex].minShortBorrowFee;
    }

    /**
    @notice Gets the minimum roll over per asset. In APR terms with 1e10 precision. 1e8 means 1%
     */
    function maxBorrowFee(uint _pairIndex, bool _isBuy) external view override returns(uint){
        return _isBuy ? pairParams[_pairIndex].maxLongBorrowFee : addtionalPairParams[_pairIndex].maxShortBorrowFee;
    }

    function setBorrowRateCaps(
        uint256 _pairIndex,
        uint256 _minLongBorrowFee,
        uint256 _maxLongBorrowFee,
        uint256 _minShortBorrowFee,
        uint256 _maxShortBorrowFee
    ) external onlyGov {

        require(_minLongBorrowFee <= _maxLongBorrowFee &&
                _minShortBorrowFee <= _maxShortBorrowFee, "INV_FEES");

        pairParams[_pairIndex].minLongBorrowFee = _minLongBorrowFee;
        pairParams[_pairIndex].maxLongBorrowFee = _maxLongBorrowFee;

        addtionalPairParams[_pairIndex].minShortBorrowFee = _minShortBorrowFee;
        addtionalPairParams[_pairIndex].maxShortBorrowFee = _maxShortBorrowFee;

        emit BorrowFeeCapsUpdated(
            _minLongBorrowFee,
            _maxLongBorrowFee,
            _minShortBorrowFee,
            _maxShortBorrowFee
