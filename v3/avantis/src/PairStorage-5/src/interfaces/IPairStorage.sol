...
interface IPairStorage {
    ...
    struct PairParams {
        ...
        uint minLongBorrowFee;
        uint maxLongBorrowFee;
        uint lazerFeedId;
    ...
    struct AdditionalPairParams{
        ...
        uint minShortBorrowFee;
        uint maxShortBorrowFee;
        uint param_15;
        uint param_16;
        uint param_17;
        uint param_18;
    ...
    struct Group {
        string name;
        uint maxOpenInterestP; // In 1e10 Precision, 1e10 = 1%
    ...
    function minBorrowFee(uint _pairIndex, bool _isBuy) external view returns(uint);

    function maxBorrowFee(uint _pairIndex, bool _isBuy) external view returns(uint);
