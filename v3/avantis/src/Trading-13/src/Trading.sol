...
contract Trading is PausableUpgradeable, Delegatable {
    ...
    function openTrade(
        ...
        require(_type != IExecute.OpenLimitOrderType.MARKET_PNL, "PNL_ORDER_TYPE_NOT_ALLOWED"); 
    ...
    function closeTradeMarket(
        ...
        emit MarketOrderInitiated(__msgSender(), _pairIndex, false, orderId, block.timestamp);
    }
    ...
    function _updateTp(uint _pairIndex, uint _index, uint _newTp) internal {
        ...
        storageT.updateTp(__msgSender(), _pairIndex, _index, _newTp);

        emit TpUpdated(__msgSender(), _pairIndex, _index, _newTp, block.timestamp);
    }
