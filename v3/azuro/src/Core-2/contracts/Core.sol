...
contract Core is CoreBase, ICore {
    ...
    ) external override onlyLp forbidden returns (uint256 tokenId) {
     ...
     * @param  caller he address that called the {LP-resolvePayout} function. This parameter is unused.
