    ...
    OwnableUpgradeable
{
    ...
    function withdrawPayout(uint256 azuroBetId) external {
        ...
        emit BettorWin(azuroBet.core, bettor, azuroBetId, payout);
    }
     ...
     */
    function _mint(address to, uint256 id, Bet calldata bet) internal {
