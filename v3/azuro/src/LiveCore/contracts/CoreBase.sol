...
abstract contract CoreBase is OwnableUpgradeable, ICoreBase {
     ...
     * @param data core prematch affiliate params
    ...
    function _calcOdds(
        ...
        return CoreTools.marginAdjustedOdds(odds, condition.margin).toUint64();
    }
