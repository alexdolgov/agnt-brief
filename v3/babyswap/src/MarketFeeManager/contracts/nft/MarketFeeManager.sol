...
contract MarketFeeManager is Ownable, ReentrancyGuard {
    ...
    function dispatch(address _receiver) external onlyOwner {
        IMarketFeeDispatcher dispatcher = dispatchers[_receiver];
    ...
    function dispatchAll() external onlyOwner {
    ...
    function withdraw(address _receiver) external onlyOwnerOrCaller {
        IMarketFeeDispatcher dispatcher = dispatchers[_receiver];
