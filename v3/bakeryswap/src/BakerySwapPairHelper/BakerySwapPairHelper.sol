...
// File: contracts/BakerySwapPairHelper.sol

pragma solidity =0.6.6;


contract BakerySwapPairHelper {
    address public constant BAKERY_SWAP_FACTORY_ADDRESS = 0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7;

    function pairFor(address tokenA, address tokenB) public pure returns (address) {
        return BakerySwapHelper.pairFor(BAKERY_SWAP_FACTORY_ADDRESS, tokenA, tokenB);
    }

    function getPrice(address _baseToken, address _quoteToken) public view returns (uint256) {
        return BakerySwapHelper.getPrice(BAKERY_SWAP_FACTORY_ADDRESS, _baseToken, _quoteToken);
    }
}