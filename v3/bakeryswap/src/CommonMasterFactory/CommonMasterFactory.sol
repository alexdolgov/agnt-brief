...
// File: contracts/CommonMasterFactory.sol
...
contract CommonMasterFactory is Ownable {
    ...
    event CommonMasterCreated(address indexed commonMaster, address indexed logicImplement);
    ...
    function createCommonMaster(
        ...
        TransparentUpgradeableProxy proxyCommonMaster = new TransparentUpgradeableProxy(logicImplement, proxyAdmin, '');
        ICommonMaster commonMaster = ICommonMaster(address(proxyCommonMaster));
        commonMaster.initialize(_token, _startBlock, _tokenPerBlock, _totalToBeMintAmount, owner);
        emit CommonMasterCreated(address(commonMaster), logicImplement);
