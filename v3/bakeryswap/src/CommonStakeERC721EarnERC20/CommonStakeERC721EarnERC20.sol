...
// File: contracts/ICommonStakeERC721EarnERC20.sol
...
// File: contracts/CommonStakeERC721EarnERC20.sol
...
contract CommonStakeERC721EarnERC20 is
    ICommonStakeERC721EarnERC20,
    ERC721Holder,
    AccessControl,
    Initializable,
    Pausable
{
    ...
    function harvest(address _pair) external override {
        PoolInfo storage pool = poolInfoMap[_pair];
    ...
    function stake(address _pair, uint256 _tokenId) public override whenNotPaused {
        PoolInfo storage pool = poolInfoMap[_pair];
        UserInfo storage userInfo = _poolUserInfoMap[_pair][_msgSender()];
        _harvest(_pair, pool, userInfo);
    ...
    function unstake(address _pair, uint256 _tokenId) public override {
    ...
    function emergencyUnstake(address _pair, uint256 _tokenId) public override {
