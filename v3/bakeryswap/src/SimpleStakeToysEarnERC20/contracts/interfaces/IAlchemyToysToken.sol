...
interface IAlchemyToysToken is IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenPairID(uint256 token1Id, uint256 token2Id) external view returns (uint256);
    ...
    /// @return boolean flag whether the token is special
    function getCurrentNumber(uint256 level, uint256 id) external view returns (uint256);
