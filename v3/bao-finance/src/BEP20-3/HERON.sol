...
contract HERON is BEP20, Pausable {
    uint256 public _maxCap = 235000000000000000000000000;
    constructor() public BEP20("HERON", "HERON") {
    }
    function mint(uint256 amount) public onlyOwner {
        require(amount.add(totalSupply()) <= _maxCap, "HERON: MAX_CAP_REACHED");
