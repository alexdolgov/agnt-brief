...
contract IioPool is StakingPool {
    ...
    function rewardDelta3() virtual public view returns (uint amt) {
        ...
        amt = Math.min(rewardsToken3_.allowance(rewardsDistribution, address(this)), rewardsToken.balanceOf(rewardsDistribution)).sub0(rewards3[rewardsToken3_][address(0)]);
