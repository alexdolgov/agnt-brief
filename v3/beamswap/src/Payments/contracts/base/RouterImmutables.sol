...
struct RouterParameters {
    ...
    address nftxZap; //no
    address x2y2; //no
    address foundation; //not found
    address sudoswap; //no
    address nft20Zap; //not found
    address cryptopunks; //no
    address looksRare; //no
    address routerRewardsDistributor; //not found
    address looksRareRewardsDistributor; //no
    address looksRareToken; //no
    address v2Factory;
    address v3Factory;
