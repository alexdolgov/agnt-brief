...
/// @title Router for Beamswap v3 Trades
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, IBeamswapV3SwapCallback {
    ...
    function beamswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
    ...
    /// @notice Performs a Beamswap v3 exact input swap
    ...
    /// @notice Performs a Beamswap v3 exact output swap
    /// @param recipient The recipient of the output tokens
