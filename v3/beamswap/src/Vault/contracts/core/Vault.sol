...
contract Vault is ReentrancyGuard, IVault {
    ...
    uint256 public override maxLeverage = 5 * 10000; // 5x

    uint256 public override liquidationFeeUsd;
    uint256 public override taxBasisPoints = 50; // 0.5%
    uint256 public override stableTaxBasisPoints = 5; // 0.05%
    uint256 public override mintBurnFeeBasisPoints = 25; // 0.25%
    uint256 public override swapFeeBasisPoints = 25; // 0.25%
    uint256 public override stableSwapFeeBasisPoints = 1; // 0.01%
