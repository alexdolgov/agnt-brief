...
// File contracts/vestings/VestingStratInvest.sol


pragma solidity 0.8.11;
contract VestingStratInvest is Ownable {
    ...
    uint256 private constant RELEASEAMOUNT = 45000000 ether;
    ...
    constructor(address _glintTokenAddress, uint256 _startTime) {
        ...
        startTime = _startTime; //tge + 90 days
        END_DAY = _startTime.add(600 days);
