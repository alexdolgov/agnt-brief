...
contract bpJPYRewardPool {
    ...
    IERC20 public bpjpy = IERC20(0xb7A6Be8E3f5e852077699A6D85fd6f9BB96aDA96);
    ...
    uint256[4] public epochBpJPYPerBlock;
    ...
    constructor(address _bpJPY, uint256 _startBlock) public {
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: _lastRewardBlock, accBpJpyPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
