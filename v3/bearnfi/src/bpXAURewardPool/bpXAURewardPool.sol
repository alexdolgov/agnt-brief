...
contract bpXAURewardPool {
    ...
    IERC20 public bpxau = IERC20(0xeaaF11ff129c2e44801CA6C169C32BeE728cFe8e);
    ...
    uint256[4] public epochBpXAUPerBlock;
    ...
    constructor(address _bpXAU, uint256 _startBlock) public {
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: _lastRewardBlock, accBpXauPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
