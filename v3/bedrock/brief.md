...
- Chains: arbitrum, base, berachain, bsc, ethereum, hyperliquid, ink, linea, mantle, mode, optimism, scroll, sei, sonic, unichain
...
- Indexed contracts: 47; live-surface contracts included: 47 (34 live, 13 unknown).
...
- All verified address-book-owned implementations audited (incl. non-live): 2/33
...
|---|---|---:|---:|---|
| PeckShield | Tier 2 | 2 | 6.1% | 2024-12 |
| BlockSec | Tier 2 | 1 | 3.0% | 2024-11 |
...
| brVault | core_logic | project_anchor | own_supporting | 1 | berachain | unit-229254 | `0xf97750...31ab18` | ✅ Audited |

### ⚠️ Verified + Unaudited (31)

| Contract Name | Role | Address-Book Class | Surface | Proxy Deployments | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---:|---|---|---|---|
| brVault | core_logic | project_anchor | own_supporting | 1 | bsc | unit-229244 | `0x1df46e...90ad93` | ⚠️ Unaudited |
...
| VaultWithoutNative | core_logic | project_anchor | own_supporting | 1 | bsc | unit-229246 | `0x84e5c8...c26800` | ⚠️ Unaudited |
| VaultWithoutNative | core_logic | project_anchor | own_supporting | 1 | optimism | unit-229234 | `0xf97750...31ab18` | ⚠️ Unaudited |
...
| brBTC | unknown | project_anchor | own_supporting | 1 | hyperliquid | unit-229266 | `0xdfc7d2...2b511e` | ⚠️ Unaudited |
| brBTC | unknown | project_anchor | own_supporting | 1 | base | unit-229260 | `0x3376eb...61514a` | ⚠️ Unaudited |
...
| Staking | unknown | project_anchor | own_supporting | 1 | ethereum | unit-229233 | `0x4befa2...269e9d` | ⚠️ Unaudited |
...
| uniBTC | unknown | project_anchor | own_supporting | 1 | hyperliquid | unit-229265 | `0xf97750...31ab18` | ⚠️ Unaudited |
| uniBTC | unknown | project_anchor | own_supporting | 1 | mantle | unit-229243 | `0x939197...2b593e` | ⚠️ Unaudited |
| uniBTC | unknown | project_anchor | own_supporting | 1 | base | unit-229258 | `0x939197...2b593e` | ⚠️ Unaudited |
...
| VaultWithoutNative | unknown | project_anchor | own_supporting | 1 | sonic | unit-229239 | `0x20d702...634510` | ⚠️ Unaudited |
| VaultWithoutNative | core_logic | project_anchor | own_supporting | 1 | mantle | unit-229242 | `0xf97750...31ab18` | ⚠️ Unaudited |
| VaultWithoutNative | unknown | project_anchor | own_supporting | 1 | base | unit-229262 | `0x9f283b...dcfefb` | ⚠️ Unaudited |
| VaultWithoutNative | core_logic | project_anchor | own_supporting | 1 | arbitrum | unit-229240 | `0x84e5c8...c26800` | ⚠️ Unaudited |
| VaultWithoutNative | unknown | project_anchor | own_supporting | 1 | berachain | unit-229251 | `0xe0240d...88dea3` | ⚠️ Unaudited |
...
| Contract Name | Role | Address-Book Class | Surface | Proxy Deployments | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---:|---|---|---|---|
| Proxy (impl: 0x93919784c523f39cacaa98ee0a9d96c3f32b593e) | unknown | project_anchor | own_supporting | 1 | unichain | unit-229236 | `0xd3c8da...b1d58d` | ❓ Unverified |
| Proxy (impl: 0xf9775085d726e782e83585033b58606f7731ab18) | proxy | project_anchor | own_supporting | 1 | unichain | unit-229237 | `0xa16113...2059be` | ❓ Unverified |
...
| berachain | `0xe0240d...88dea3` | VaultWithoutNative | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
