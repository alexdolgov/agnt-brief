...
- Coverage of deployed-live implementations: 27/68 (39.7%)
...
- Coverage code basis (deployed vs audited code): 1 code-matched, 0 diverged (deployed code modified beyond the audited fork baseline), 26 match-unverified
...
- Match method counts: contract_name=45, extraction_exact=1
