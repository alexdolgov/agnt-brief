...
// File: contracts/earnV2/strategiesV2/belt/StrategyBeltV2Storage.sol

pragma solidity 0.6.12;

contract StrategyBeltV2Storage {
    address wantAddress;
}
...
// File: contracts/earnV2/strategiesV2/belt/StrategyBeltV2.sol
...
contract StrategyBeltV2 is Initializable, StrategyV2, StrategyBeltV2Storage {
    ...
    function __StrategyBeltV2_init(
        address _wantAddress
    ) public initializer {
        __StrategyV2_init(msg.sender, 0, 100);
        __StrategyBeltV2_init_unchained(
            _wantAddress
        );
    }

    function __StrategyBeltV2_init_unchained(
        address _wantAddress
