...
interface IMultiRewards {
    ...
    /**
     * @notice Sets the Reward gas limit for claims
     * @param _rewardGasLimit The gas limit for reward claims
     */
    function setRewardGasLimit(uint256 _rewardGasLimit) external;
    
    /**
     * @notice Returns the reward gas limit
     * @return The gas limit for reward claims
     */
    function rewardGasLimit() external view returns (uint256);
