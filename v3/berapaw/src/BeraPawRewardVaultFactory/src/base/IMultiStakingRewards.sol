...
interface IMultiStakingRewards {
    /**
    ...
    /**
     * @notice Emitted when an operator is set for a user
     * @param user The address of the user
     * @param operator The address of the operator set for the user
     */
     ...
     * @param amount The amount of tokens to stake
     * @param account The account to stake tokens on behalf of
     * @dev Transfers `amount` of staking tokens from the user to this contract and credits them to `account`
     */
    function stakeOnBehalf(uint256 amount, address account) external;
     ...
     */
    function getReward(address user, address recipient) external;
    ...
    /**
     * @notice Sets the operator for the sender, operator can claim rewards on behalf of sender but not withdraw staked tokens.
