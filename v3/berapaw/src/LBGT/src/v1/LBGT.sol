...
import { ILBGT } from "./interfaces/ILBGT.sol";
import { Constants } from "../Constants.sol";

/**
 * @title LBGT (Liquid BGT)
 * @author BeraPaw
 * @notice ERC20 token representing liquid staked BGT in the BeraPaw protocol
 ...
 */
contract LBGT is ILBGT, ERC20, ERC20Permit, ERC20FlashMint, AccessControl {
    ...
    modifier onlyBeraPawForge() {
        require(_msgSender() == beraPawForge, OnlyBeraPawForge());
        _;
    }
        ...
        ERC20FlashMint()
    {
        ...
        _setRoleAdmin(ROLE_FLASH_MINTER, ROLE_GOD);
