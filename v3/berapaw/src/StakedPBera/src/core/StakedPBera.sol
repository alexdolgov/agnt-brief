...
import { IStakedPBera } from "./interfaces/IStakedPBera.sol";
import { IERC4626 } from "@openzeppelin/contracts/interfaces/IERC4626.sol";
import { Constants } from "../Constants.sol";

contract StakedPBera is
    IStakedPBera,
    ERC4626Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    address public constant PBERA = Constants.PBERA;
    ...
    function initialize(address _owner) public initializer {
        ...
        __ERC4626_init(IERC20(PBERA));
        __ERC20_init("Staked pBERA", "stpBERA");
