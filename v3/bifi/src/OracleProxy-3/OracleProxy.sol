...
contract OracleProxy is IOracleProxy, OracleProxyErrors {
	...
	* @param busdOracle The address of btc's oracle contract
	*/
	constructor (address bnbOracle, address etherOracle, address usdtOracle, address daiOracle, address usdcOracle, address btcOracle, address busdOracle) public
	{
		owner = msg.sender;
    ...
    _setOracleFeed(1, etherOracle, 8, false, 0);
		...
		_setOracleFeed(6, busdOracle, 8, false, 0);
	}
