...
import {IBimTokenManager} from "../interfaces/IBimTokenManager.sol";
import {IBimZapRouter} from "../interfaces/IBimZapRouter.sol";
import {IPermit2} from "../interfaces/IPermit2.sol";
import {BimTokenManager} from "./BimTokenManager.sol";
import {ZapErrors} from "./ZapErrors.sol";

/**
 * @title Zap router for Bim vaults
 * @author kexley, Bim
 * @notice Adaptable router for zapping tokens to and from Bim vaults
    ...
    ReentrancyGuard
{
    ...
    constructor(address _permit2) {
        permit2 = _permit2;
        tokenManager = address(new BimTokenManager());
    }
    ...
    function executeOrder(
        ...
        IBimTokenManager(tokenManager).pullTokens(_order.user, _order.inputs);
