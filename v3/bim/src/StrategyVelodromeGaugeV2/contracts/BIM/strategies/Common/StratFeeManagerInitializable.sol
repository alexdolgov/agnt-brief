...
contract StratFeeManagerInitializable is OwnableUpgradeable, PausableUpgradeable {
    ...
    struct CommonAddresses {
        ...
        address keeper;
        address strategist;
        address bimFeeRecipient;
        address bimFeeConfig;
    }
    ...
    IFeeConfig public bimFeeConfig;
    ...
    function __StratFeeManager_init(CommonAddresses calldata _commonAddresses) internal onlyInitializing {
        ...
        bimFeeRecipient = _commonAddresses.bimFeeRecipient;
        bimFeeConfig = IFeeConfig(_commonAddresses.bimFeeConfig);
        withdrawalFee = 10;
    }
    ...
    function getFees() internal view returns (IFeeConfig.FeeCategory memory) {
        return bimFeeConfig.getFees(address(this));
    }
    ...
    function getStratFeeId() external view returns (uint256) {
        return bimFeeConfig.stratFeeId(address(this));
    }

    function setStratFeeId(uint256 _feeId) external onlyManager {
        bimFeeConfig.setStratFeeId(_feeId);
    ...
    // set new bim fee address to receive bim fees
    ...
    function setBimFeeConfig(address _bimFeeConfig) external onlyOwner {
        bimFeeConfig = IFeeConfig(_bimFeeConfig);
