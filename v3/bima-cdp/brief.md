...
- Deployed-live implementations: 49 of 54 unique (rest dead/inactive/uninitialized)
- All verified address-book-owned implementations audited (incl. non-live): 4/42
...
|---|---|---:|---:|---|
| Cyfrin | Tier 1 | 2 | 4.8% | 2024-09 |
| Spearbit | Tier 1 | 2 | 4.8% | 2025-06 |
| Unknown | Tier 2 | 1 | 2.4% | 2024-09 |
...
| BimaBurner | unknown | project_anchor | own_supporting | 0 | bsc | unit-230364 | `0x93ee18...f80f09` | ⚠️ Unaudited |
...
| StakedUsbd | token | project_anchor | own_supporting | 0 | ethereum | unit-230323 | `0xda44aa...06f92a` | ⚠️ Unaudited |
...
| ethereum | `0xda44aa...06f92a` | StakedUsbd | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
