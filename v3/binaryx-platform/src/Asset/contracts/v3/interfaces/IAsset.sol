...
interface IAsset {
    ...
    event RejectedBulk(address[] users);
    ...
    function rejectSelling(uint256 offset, uint256 skip, bool isMigration) external;
  ...
  function leftToBuy() external view returns (uint256);
}
