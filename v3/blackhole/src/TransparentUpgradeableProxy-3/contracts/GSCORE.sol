...
/// @dev - ASSET balance = real USDC backing on avax (1:1)
...
contract GSCORE is ERC4626Upgradeable, OFTUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // keccak256(abi.encode(uint256(keccak256("scoreplay.storage.v1")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 public constant STORAGE_LOCATION = 0x5d430d31f780719c7cc3d552a5925e763729b995752c7d6c1341c92776b9ae00;
