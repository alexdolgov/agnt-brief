...
contract BlackholePairAPIV2 is Initializable {
    ...
    function checkAvaxRoute(address tokenIn, address tokenOut, address tokenMid) internal returns (bool){
        return tokenIn == 0xb3B3CbEd8243682845C2ff23Ea1FD48e6144E34F || 
        tokenOut == 0xb3B3CbEd8243682845C2ff23Ea1FD48e6144E34F || 
        tokenMid == 0xb3B3CbEd8243682845C2ff23Ea1FD48e6144E34F;
    }
