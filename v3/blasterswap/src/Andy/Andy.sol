...
/**
$ANDY, a comical character inspired by Matt Furie’s Boy’s club and we will be joining $PEPE and $BRETT as $ANDY launches on @Blast_L2
...
contract Andy is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_blackListed[msg.sender], "ERC20: Blacklisted");
