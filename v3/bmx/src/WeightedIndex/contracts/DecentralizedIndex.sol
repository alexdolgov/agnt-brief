  ...
  ERC20Permit
{
  ...
  address constant DAI = 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913;
  IProtocolFeeRouter constant PROTOCOL_FEE_ROUTER =
    IProtocolFeeRouter(0xabCafce2f7b8DB30c5Bb1D20dd6394561baffcDB);
  IRewardsWhitelister constant REWARDS_WHITELIST =
    IRewardsWhitelister(0x0d7a0F0DEBa08C984c6517f5EEC59503fF9BC24e);
