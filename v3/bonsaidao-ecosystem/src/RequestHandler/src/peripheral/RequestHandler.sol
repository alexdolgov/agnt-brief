...
contract RequestHandler is GlobalACL {
    ...
    constructor(Auth _auth, address _aggregateVault, address _storageViewer) GlobalACL(_auth) {
    ...
    function _executeRequest(AggregateVault.OCRequest memory request) external onlySelf {
        ...
        if (!request.isDeposit) {
            ...
            uint256 withdrawFees = aggregateVault.previewWithdrawalFee(underlyingToken, assets, true);
            uint256 assetsSansFees = assets - withdrawFees;
            require(
            ...
            aggregateVault.releaseWithdrawal(underlyingToken, request.account, assetsSansFees, withdrawFees);
        ...
        // deposit
            ...
            uint256 depositFees = aggregateVault.previewDepositFee(underlyingToken, assets, true);
