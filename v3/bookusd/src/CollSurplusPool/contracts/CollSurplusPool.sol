...
import "./Interfaces/IMSSToken.sol";
...
contract CollSurplusPool is Ownable, CheckContract, ICollSurplusPool {
    ...
    event MSSAddressChanged(address _mss);
    ...
    function claimColl(address _account) external override {
        ...
        bool success = mss.transfer(_account, claimableColl);
        require(success, "CollSurplusPool: sending MSS failed");
    }
