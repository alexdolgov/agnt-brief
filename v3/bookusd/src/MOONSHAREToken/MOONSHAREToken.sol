...
// $$/      $$/  $$$$$$/   $$$$$$/  $$/   $$/   $$/     $$/  $$$$$$$/ $$/  $$$$$$$/ 
//
// MoonYield Protocol - MintStakeShare lending protocol
//
// Web: https://moonyield.app
// TG: https://t.me/mintstakeshare
// X: https://x.com/mintstakeshare
//
...
*
* 4) CommunityIssuance is set at deployment
*
...
contract MOONSHAREToken is CheckContract, ILQTYToken {
    using SafeMath for uint256;

    // --- ERC20 Data ---

    string internal constant _NAME = "MoonYield Share";
    string internal constant _SYMBOL = "MOONSHARE";
    ...
    constructor(address _presaleAddress) public {
        operator = msg.sender;
        ...
        uint presaleEntitlement = _1_MILLION.mul(2); 
        _mint(_presaleAddress, presaleEntitlement); // Allocate 2 million for presale
        _mint(msg.sender, presaleEntitlement); // Allocate 2 million for liquidity
    }
    ...
    function setContracts(
        ...
        uint _presaleEntitlement = _1_MILLION.mul(4); // 4 million tokens used for presale + liquidity

        // Allocate the remainder to the deployer: (100 - 2 - 32) million = 64.66 million
        uint multisigEntitlement = _1_MILLION.mul(100).sub(depositorsAndFrontEndsEntitlement).sub(
            _presaleEntitlement
        );
