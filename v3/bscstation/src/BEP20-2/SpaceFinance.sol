...
// SPFtationToken with Governance.
contract SpaceFinance is BEP20('Space Finance Token', 'SPF'), LGEWhitelisted {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "SPF::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SPF::delegateBySig: invalid nonce");
        require(now <= expiry, "SPF::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SPF::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SPFs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SPF::_writeCheckpoint: block number exceeds 32 bits");
