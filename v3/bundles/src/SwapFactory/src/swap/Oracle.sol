...
contract Oracle {
    ...
    /// @param price1Cumulative Price cumulative for the associated Pair's token1
    /// @param blockTimestamp Last block timestamp for the associated Pair
    /// @dev Only usable by the associated Pair
    ...
    /// @param token Price cumulative for the associated Pair's token
