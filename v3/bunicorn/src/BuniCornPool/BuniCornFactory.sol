...
library FeeFomula {
    ...
    /// @dev calculate fee from rFactorInPrecision, see section 3.2 in buniSwap white paper
...
contract BuniCornPool is IBuniCornPool, ERC20Permit, ReentrancyGuard, VolumeTrendRecorder, Pausable {
    ...
    address public author = 0x496Ae7A91995DDf6F642E34deeA37b743a5D9107;
    ...
    function initialize(
        ...
        require(msg.sender == address(factory), "BUNI: FORBIDDEN");
        token0 = _token0;
        token1 = _token1;
        ampBps = _ampBps;
    }
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(balance0 >= data.reserve0 && balance1 >= data.reserve1, "BUNI: UNSYNC_RESERVES");
    ...
    function swap(
        ...
        ReserveData memory newData;
        {
            ...
            require(to != address(_token0) && to != address(_token1), "BUNI: INVALID_TO");
            ...
            if (callbackData.length > 0)
                IBuniCornCallee(to).buniSwapCall(msg.sender, amount0Out, amount1Out, callbackData);
