...
- Outside the address book: 39 discovered implementations excluded (2 third-party/infra; 2 standard proxy/library)
- Proxy deployments represented within implementation groups: 2
- Deployed-live implementations: 12 of 52 unique (rest dead/inactive/uninitialized)
...
|---|---|---:|---:|---|
| Peckshield | Tier 2 | 3 | 27.3% | 2023-02 |
