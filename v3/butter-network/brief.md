...
No contract logic was present for Butter Network in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [Butter Network.pdf](https://github.com/DeHacker-io/audits_public/blob/main/Butter%20Network.pdf) | DeHacker | Audit | 2026-05 | fresh | Direct | contract_name | no match | 0 | 0 | 0 | 11 | high |
| [ButterSwap.pdf](https://github.com/DeHacker-io/audits_public/blob/main/ButterSwap.pdf) | DeHacker | Audit | 2024-02 | stale | Direct | contract_name | no match | 0 | 0 | 0 | 4 | high |
| [Butter Network TON.pdf](https://github.com/DeHacker-io/audits_public/blob/main/Butter%20Network%20TON.pdf) | DeHacker | Audit | 2024-08 | aging | Direct | contract_name | no match | 0 | 0 | 0 | 1 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [21339] Butter Network.pdf — no match: Extracted contract names from findings and scope description. Audit date from cover page.
- [21340] ButterSwap.pdf — no match: Audit scope table lists four contracts: Router.sol, FeeReceiver.sol, ButterRouterV2.sol, SwapAdapter.sol. Date from cover page: Feb 17th, 2024 (interpreted as February 17, 2024).
- [21341] Butter Network TON.pdf — no match: Only one contract file (ton_router.fc) is in scope. Audit date is August 1st, 2024 from cover page.
...
|---|---|---|---|---|---|
| Butter Network.pdf | AuthorityManager | unmatched — not counted | — | Listed in findings GLOBAL-01 and GLOBAL-02 as a central authorization contract. | no |
| Butter Network.pdf | Bridge | unmatched — not counted | — | Listed in findings GLOBAL-01 as a bridge entity. | no |
| Butter Network.pdf | BridgeAndRelay | unmatched — not counted | — | Listed in findings GLOBAL-01 and GLOBAL-04 as a bridge entity. | no |
| Butter Network.pdf | BridgeAbstract | unmatched — not counted | — | Listed in findings GLOBAL-01 and GLOBAL-02 as a bridge entity. | no |
| Butter Network.pdf | OmniServiceProxy | unmatched — not counted | — | Listed in finding GLOBAL-02 as a proxy shell. | no |
| Butter Network.pdf | VaultTokenV3 | unmatched — not counted | — | Listed in findings GLOBAL-02 and GLOBAL-05 as a non-upgradeable contract. | no |
| Butter Network.pdf | FeeService | unmatched — not counted | — | Listed in finding GLOBAL-02 as a non-upgradeable contract. | no |
| Butter Network.pdf | TokenRegisterV3 | unmatched — not counted | — | Listed in finding GLOBAL-02 as an upgradeable implementation contract. | no |
| Butter Network.pdf | ProtocolFee | unmatched — not counted | — | Listed in finding GLOBAL-03 as a contract violating CEI. | no |
| Butter Network.pdf | NearDecoder | unmatched — not counted | — | Listed in finding GLOBAL-04 as a contract with off-by-one error. | no |
| Butter Network.pdf | BaseImplementation | unmatched — not counted | — | Listed in finding GLOBAL-02 as a periphery base contract. | no |
...
- Address-book scope dispositions: 0 own (0 proxy reference(s)), 0 third-party/infra, 0 historical/testnet/deprecated, 0 unclassified context, 1 ambiguous, 15 unmatched
