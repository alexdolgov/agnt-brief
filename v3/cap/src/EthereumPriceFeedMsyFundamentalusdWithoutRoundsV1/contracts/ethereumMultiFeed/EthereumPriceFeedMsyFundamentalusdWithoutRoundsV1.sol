...
contract EthereumPriceFeedMsyFundamentalusdWithoutRoundsV1 is PriceFeedWithoutRoundsForMultiFeedAdapter {
  function description() public view virtual override returns (string memory) {
    return "RedStone Price Feed for MSY_FUNDAMENTAL/USD";
  }

  function getDataFeedId() public view virtual override returns (bytes32) {
    return bytes32("MSY_FUNDAMENTAL/USD");
  }
