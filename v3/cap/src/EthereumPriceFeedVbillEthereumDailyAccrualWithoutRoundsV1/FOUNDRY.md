# EthereumPriceFeedVbillEthereumDailyAccrualWithoutRoundsV1 — Foundry package
...
```sh
forge build --root "src/EthereumPriceFeedVbillEthereumDailyAccrualWithoutRoundsV1"
```
