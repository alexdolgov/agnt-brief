...
contract EthereumPriceFeedVbillEthereumDailyAccrualWithoutRoundsV1 is PriceFeedWithoutRoundsForMultiFeedAdapter {
  function description() public view virtual override returns (string memory) {
    return "RedStone Price Feed for VBILL_ETHEREUM_DAILY_ACCRUAL";
  }

  function getDataFeedId() public view virtual override returns (bytes32) {
    return bytes32("VBILL_ETHEREUM_DAILY_ACCRUAL");
  }
