...
contract UpgradeableIncentiveReceiver is IIncentiveReceiver, UpgradeableOperable {
    ...
    function init(address _governor, address payable _router) external initializer {
    ...
    function swap(OneInchZapLib.SwapParams calldata _swapParams) external onlyOperator {
