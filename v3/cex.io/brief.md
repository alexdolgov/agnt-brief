...
This brief describes the observed EVM deployment and audit surface for CEX.IO. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.

### Architecture

The pinned logic-topography run contains 2 contract row(s) across ethereum. Structural roles: 2 supporting. No upgradeable pattern was identified in these rows.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [pci.pdf](https://static.cex.io/img/legal/pci.pdf) | PCI DSS | Audit | 2026-03 | fresh | Direct | n/a | no match | 0 | 0 | 0 | 0 | low |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [11551] pci.pdf — no match: The document is a PCI DSS compliance certificate, not a smart contract audit report. No smart contracts or audit scope are mentioned.
