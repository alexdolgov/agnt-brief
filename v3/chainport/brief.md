...
- Outside the address book: 11 discovered implementations excluded (0 third-party/infra; 1 standard proxy/library)
- Proxy deployments represented within implementation groups: 1
- Deployed-live implementations: 15 of 26 unique (rest dead/inactive/uninitialized)
