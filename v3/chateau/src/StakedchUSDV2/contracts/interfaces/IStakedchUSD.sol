...
interface IStakedchUSD {
    ...
    error InvalidAmount();
    /// @notice Error emitted when owner attempts to rescue chUSD tokens.
    error InvalidToken();
    ...
    function retrieveTokens(address token, uint256 amount, address to) external;
