...
/// @title USC token contract for L2
contract USCL2 is IOptimismMintableERC20, ERC20, ERC20Permit, Ownable {
  ...
  constructor(address _remoteToken, address _bridge) ERC20("USC", "USC") ERC20Permit("USC") Ownable() {
