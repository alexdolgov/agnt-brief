...
interface IStakingManager {
    /// @notice Error emitted when contract is paused
    error Paused();
    ...
    /// @param isPaused Is contract paused
    ...
    /// @notice Returns is contract paused
    /// @return isPaused Is contract paused
    ...
    function getUserBalanceOnLockingManager(address user, address stakingToken)
        external
        view
    ...
    /// @param isPaused Is contract paused
    /// @dev When contract is paused no staking, unstaking or claiming rewards is possible
