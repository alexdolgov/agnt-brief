...
contract StrategyLista is StrategyBase, ParaSwapCaller {
    using SafeERC20 for IERC20;

    // The address of the token LISTA
    address public constant LISTA = 0xFceB31A79F71AC9CBDCF853519c1b12D379EdC46;

    // The address of the Re7 USD1 Vault
    address public constant MoolahVault = 0x02A5ca3a749855d1002A78813E679584a96646d0;
