...
contract OneInchCallerV6 is Constants {
    ...
    function executeSwap(
        ...
        if (
            ...
            if (_srcToken != BNB || _dstToken == BNB) revert Errors.OneInchNotSupported();
        ...
        if (srcTokenFromCalldata_.get() != _srcToken || _srcToken == BNB) revert Errors.OneInchNotSupported();
