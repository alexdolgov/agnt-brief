...
interface ISatlayerPool {
    ...
    /*//////////////////////////////////////////////////////////////
                            Read Functions
    //////////////////////////////////////////////////////////////*/
    /// @notice Returns the address of the receipt token for a given staking token
    /// @param _token The address of the staking token
    /// @return receiptToken The address of the receipt token
    function tokenMap(address _token) external view returns (address receiptToken);

    /// @notice Returns the deposit cap for a given token
    /// @param _token The address of the token
    /// @return cap The deposit cap for the token
    function caps(address _token) external view returns (uint256 cap);
