...
- Outside the address book: 54 discovered implementations excluded (0 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 20
- Deployed-live implementations: 21 of 83 unique (rest dead/inactive/uninitialized)
