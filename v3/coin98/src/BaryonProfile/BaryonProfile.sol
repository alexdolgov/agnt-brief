...
// File: @baryon/baryon-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/BaryonProfile.sol
...
*/
contract BaryonProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public baryonToken;
    ...
    uint256 public numberBaryonToReactivate;
    uint256 public numberBaryonToRegister;
    uint256 public numberBaryonToUpdate;
    ...
    constructor(
        IBEP20 _baryonToken,
        uint256 _numberBaryonToReactivate,
        uint256 _numberBaryonToRegister,
        uint256 _numberBaryonToUpdate
    ) public {
        baryonToken = _baryonToken;
        numberBaryonToReactivate = _numberBaryonToReactivate;
        numberBaryonToRegister = _numberBaryonToRegister;
        numberBaryonToUpdate = _numberBaryonToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends BARYON to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer BARYON tokens to this contract
        baryonToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberBaryonToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer BARYON token to this address
        baryonToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberBaryonToUpdate
        );
    ...
    /**
     * @dev Claim BARYON to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        baryonToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of BARYON to register
     * Callable only by owner admins.
     */
    function updateNumberBaryon(
        uint256 _newNumberBaryonToReactivate,
        uint256 _newNumberBaryonToRegister,
        uint256 _newnumberBaryonToUpdate
    ) external onlyOwner {
        numberBaryonToReactivate = _newNumberBaryonToReactivate;
        numberBaryonToRegister = _newNumberBaryonToRegister;
        numberBaryonToUpdate = _newnumberBaryonToUpdate;
    }
