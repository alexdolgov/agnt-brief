...
- Outside the address book: 24 discovered implementations excluded (0 third-party/infra; 5 standard proxy/library)
- Proxy deployments represented within implementation groups: 5
- Deployed-live implementations: 5 of 32 unique (rest dead/inactive/uninitialized)
