...
contract SdtFeeCollector is Ownable2Step {
    ...
    uint256 public rootFees = 15_000;
    ...
    constructor(ICvgControlTower _cvgControlTower) {
        ...
        address _treasuryPod = _cvgControlTower.treasuryPod();
        ...
        require(_treasuryPod != address(0), "TRESO_POD_ZERO");
        require(_treasuryDao != address(0), "TRESO_DAO_ZERO");
        sdt = _sdt;

        /// @dev setup initial repartition of fees
        feesRepartition.push(Fees({receiver: _cvgSdtBuffer, feePercentage: 67_000}));
        feesRepartition.push(Fees({receiver: _treasuryPod, feePercentage: 33_000}));
