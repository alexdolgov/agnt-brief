# Agentic Audit Brief: Convergence
...
- Project: Convergence (`convergence`)
- Website: [https://conv.finance/](https://conv.finance/)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for Convergence. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.

### Architecture

The pinned logic-topography run contains 1 contract row(s) across ethereum, moonbeam. Structural roles: 1 supporting. No upgradeable pattern was identified in these rows.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [DL audit link](https://skynet.certik.com/projects/convergencefinance) | CertiK | Audit | n/a | unknown | Direct | n/a | no match | 0 | 0 | 0 | 0 | low |
| [REP-ConvO-2021-06-22.pdf](https://github.com/Convergence-Finance/audit-report/blob/master/REP-ConvO-2021-06-22.pdf) | unknown | Audit | 2021-06 | stale | Direct | contract_name | no match | 0 | 0 | 0 | 1 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [19655] DL audit link — no match: The provided text is a project dashboard page from CertiK Skynet, not an audit report. It contains no scope section, no contract names, and no audit date. The only contract address mentioned (0xc834...aa8b50) is for the token, but it is not listed as an audited contract in a scope table.
- [19656] REP-ConvO-2021-06-22.pdf — no match: Only one contract in scope: FixedSwap.sol. Audit date from delivery date.
...
|---|---|---|---|---|---|
| REP-ConvO-2021-06-22.pdf | FixedSwap | unmatched — not counted | — | listed in scope table with SHA256 checksum | no |
...
- [19655] DL audit link
- [19656] REP-ConvO-2021-06-22.pdf
