...
contract TeamVestingCoreUpgradeable is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function changeReceiver( address _oldAddress, address _newAddress ) external onlyOwner {
        ...
        startVesting[_newAddress] = startVesting[_oldAddress];
        vestingDuration[ _newAddress ] = vestingDuration[ _oldAddress ];


        claimableAmount[ _oldAddress ] = 0;
        claimedAmount[_oldAddress] = 0;
        startVesting[_oldAddress] = 0;
        vestingDuration[ _oldAddress ] = 0;
