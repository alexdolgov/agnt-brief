...
contract CubVenusVault is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        kingdomAddress = _kingdomAddress;
        ...
        transferOwnership(kingdomAddress);
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(kingdomAddress, _wantAmt);
