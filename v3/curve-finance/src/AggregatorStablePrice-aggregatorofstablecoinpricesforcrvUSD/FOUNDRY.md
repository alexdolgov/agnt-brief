# AggregatorStablePrice-aggregatorofstablecoinpricesforcrvUSD — Foundry package
...
```sh
forge build --root "src/AggregatorStablePrice-aggregatorofstablecoinpricesforcrvUSD"
```
