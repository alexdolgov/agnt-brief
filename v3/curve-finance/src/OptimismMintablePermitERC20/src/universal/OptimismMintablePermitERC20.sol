...
///         meant for use on L2.
contract OptimismMintablePermitERC20 is IOptimismMintableERC20, ILegacyMintableERC20, ERC20, ERC20Permit, ISemver {
    ...
    modifier onlyBridge() {
        require(msg.sender == BRIDGE, "OptimismMintablePermitERC20: only bridge can mint and burn");
        _;
    }
    ...
    function supportsInterface(bytes4 _interfaceId) external pure virtual returns (bool) {
        ...
        // Interface corresponding to the updated OptimismMintablePermitERC20 (this contract).
