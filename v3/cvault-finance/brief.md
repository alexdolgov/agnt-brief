...
- Outside the address book: 28 discovered implementations excluded (2 third-party/infra; 3 standard proxy/library)
- Proxy deployments represented within implementation groups: 10
- Deployed-live implementations: 23 of 51 unique (rest dead/inactive/uninitialized)
