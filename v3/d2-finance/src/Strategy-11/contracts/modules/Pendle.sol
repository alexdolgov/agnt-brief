...
interface IPendle_Module {
    function pendle_deposit(address market, address asset, uint256 amount, uint256 minAmountOut) external;
    function pendle_withdraw(address market, address asset, uint256 amount, uint256 minAmountOut) external;
    function pendle_swap(uint256 kind, address market, address asset, uint256 amount, uint256 minAmountOut) external;
    function pendle_claim(address yt, address asset, uint256 minAmountOut) external;
    function pendle_exit(address market, address asset, uint256 minAmountOut) external;
}
...
contract Pendle_Module is IPendle_Module, AccessControl, ReentrancyGuard {
    ...
    function pendle_deposit(address market, address ast, uint256 amount, uint256 minAmountOut) external onlyRole(EXECUTOR_ROLE) nonReentrant {
    ...
    function pendle_withdraw(address market, address ast, uint256 amount, uint256 minAmountOut) external onlyRole(EXECUTOR_ROLE) nonReentrant {
        IPSwapAggregator.SwapData memory swapData = IPSwapAggregator.SwapData({
            swapType: IPSwapAggregator.SwapType.NONE,
            extRouter: address(0),
            extCalldata: "",
    ...
    function pendle_swap(uint256 kind, address market, address asset, uint256 amount, uint256 minAmountOut) external onlyRole(EXECUTOR_ROLE) nonReentrant {
        IPRouter.ApproxParams memory approxParams = IPRouter.ApproxParams({
            guessMin: 0,
            guessMax: type(uint256).max,
            guessOffchain: 0,
    ...
    function pendle_claim(address market, address asset, uint256 minAmountOut) external onlyRole(EXECUTOR_ROLE) nonReentrant {
    ...
    function pendle_exit(address market, address asset, uint256 minAmountOut) external onlyRole(EXECUTOR_ROLE) nonReentrant {
        (, address pt, ) = IPMarket(market).readTokens();
