...
import { IPendle_Module } from "./trader/modules/Pendle.sol";
import { ISilo_Module } from "./trader/modules/Silo.sol";
...
contract Strategy is AccessControl {
    ...
    constructor(address[] memory targets, address[] memory allowedTokens, address[] memory allowedSpenders) {
        ...
        initialize(t, abi.encodeWithSelector(IInch_LimitOrder_Module.init_Inch_LimitOrder.selector, empty, empty));
        t = targets[22];
