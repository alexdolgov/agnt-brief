...
contract GMXV2_Module is IGMXV2_Module, AccessControl, ReentrancyGuard, DSQ_Common_Roles {
    ...
    function gmxv2_deposit(address market, uint256 executionFee, uint256 long, uint256 short, uint256 minOut) external payable onlyRole(EXECUTOR_ROLE) nonReentrant {
