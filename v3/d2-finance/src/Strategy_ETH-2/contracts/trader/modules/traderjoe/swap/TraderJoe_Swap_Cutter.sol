...
abstract contract TraderJoe_Swap_Cutter is DiamondWritableInternal, ERC165Base {
    ...
    function cut_TraderJoe_Swap(address _facet) internal {
        ...
        selectors[selectorIndex++] =
            ITraderJoe_Swap_Module.traderjoe_swapExactTokensForTokensSupportingFeeOnTransferTokens.selector;
        selectors[selectorIndex++] =
            ITraderJoe_Swap_Module.traderjoe_swapExactTokensForNATIVESupportingFeeOnTransferTokens.selector;
        selectors[selectorIndex++] =
            ITraderJoe_Swap_Module.traderjoe_swapExactNATIVEForTokensSupportingFeeOnTransferTokens.selector;
