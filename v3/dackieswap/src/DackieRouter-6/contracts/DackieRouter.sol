...
import "./DackieGasRouter.sol";

contract DackieRouter is IDackieRouter02, DackieGasRouter {
    ...
    constructor(address _factory, address _WETH) public DackieGasRouter(IDackieFactory(_factory).feeToSetter()){
        factory = _factory;
        WETH = _WETH;
        IBlastPoints(BLAST_POINTS).configurePointsOperator(IDackieFactory(_factory).pointsAdmin());
    }
