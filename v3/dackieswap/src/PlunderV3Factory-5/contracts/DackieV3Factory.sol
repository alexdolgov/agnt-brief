...
contract DackieV3Factory is IDackieV3Factory, DackieGas {
    ...
    constructor(address _pointsAdmin) DackieGas(msg.sender) {
    ...
    function setPoolDeployer(address _poolDeployer) external {
        require(msg.sender == owner && poolDeployer == address(0), "INVALID");
    ...
    function claimDeployerGas(address _recipient) external {
        ...
        IDackieV3PoolDeployer(poolDeployer).claimGas(_recipient);
    }
