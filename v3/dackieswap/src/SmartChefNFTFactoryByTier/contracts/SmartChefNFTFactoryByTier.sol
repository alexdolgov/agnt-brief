...
import "./SmartChefNFTByTier.sol";

contract SmartChefNFTFactoryByTier is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(SmartChefNFTByTier).creationCode;
        ...
        SmartChefNFTByTier(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _iDackieTier,
            _rewardPerSecond,
