    ...
    IDeBridgeGate
{
    ...
    */
    function _normalizeTokenAmount(
        ...
        // Take weth's decimals as it is assumed to be equal to native token's decimals
        uint256 decimals = IERC20Metadata(_token == address(0) ? address(weth) : _token).decimals();
