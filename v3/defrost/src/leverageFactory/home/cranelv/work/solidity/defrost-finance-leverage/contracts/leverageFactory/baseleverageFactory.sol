...
interface IAuthorization{
    ...
    function setPoolLimitation(uint256 _assetCeiling,uint256 _assetFloor)external;
...
contract baseleverageFactory is leverageFactoryData,BaseSplitCodeFactory {
    ...
    function setPoolLimitation(address _lendingPool,uint256 _assetCeiling,uint256 _assetFloor)external onlyOrigin{
        IAuthorization(_lendingPool).setPoolLimitation(_assetCeiling,_assetFloor);
    }
