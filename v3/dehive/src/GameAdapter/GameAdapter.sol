...
contract GameAdapter is DexAdapterCore {
    ...
    address public constant DG_OLD = address(0x2a93172c8DCCbfBC60a39d56183B7279a2F647b4);
    ...
    function getUnderlyingAmount(
        ...
        if (_tokenToSwap == DG_OLD || _tokenToReceive == DG_OLD) return 0;
        if (_tokenToSwap == _tokenToReceive) return _amount;
        return _getUnderlyingAmount(_amount, _tokenToSwap, _tokenToReceive);
    }
