...
// Part: BaseImpulseStrategyRwrdTwoSwp
...
// File: ImpulseAlpacaBusd.sol

contract ImpulseAlpacaBusd is BaseImpulseStrategyRwrdTwoSwp {
    using SafeERC20 for IERC20;
    ...
    function initialize(
        ...
        masterChef = IPanCakeMasterChef(address(0x73feaa1eE314F8c655E354234017bE2193C9E24E));
        poolId = 362;
        usdToken = address(0x55d398326f99059fF775485246999027B3197955); // USDT
        super.initialize(
            _wantToken,
            _router,
            _stakingRewards,
    ...
    function _depositLpToken(uint256 _wantAmt) internal override {
        wantToken.safeApprove(address(masterChef), 0);
        wantToken.safeApprove(address(masterChef), _wantAmt);
        masterChef.deposit(poolId, _wantAmt);
    }
