...
// Last deployed from commit: 49f9e73c70d93424ba9343b57fc93ec4a865bb2b;
...
contract BeefyFinanceArbitrumFacet is ReentrancyGuardKeccak, OnlyOwnerOrInsolvent {
    ...
    **/
    function stakeGmxBeefy(uint256 amount) public onlyOwnerOrInsolvent nonReentrant noBorrowInTheSameBlock remainsSolvent {
    ...
    **/
    function _stakeLpBeefy(IBeefyFinance.BeefyStakingDetails memory stakingDetails) private {
        ...
        stakingDetails.amount = Math.min(_getAvailableBalance(tokenManager.tokenAddressToSymbol(stakingDetails.lpTokenAddress)), stakingDetails.amount);
        require(stakingDetails.amount > 0, "Cannot stake 0 tokens/Insufficient balance");
