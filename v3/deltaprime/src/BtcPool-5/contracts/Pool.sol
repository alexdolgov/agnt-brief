...
// Last deployed from commit: 88b2e202fc0c71154e48c46043c5013bf2a473ad;
...
contract Pool is PendingOwnableUpgradeable, ReentrancyGuardUpgradeable, IERC20, ProxyConnector {
    ...
    **/
    ...
    function setDepositAndBorrowRatesToZero() public onlyOwner nonReentrant {
        depositIndex.setRate(0);
        borrowIndex.setRate(0);
    }
