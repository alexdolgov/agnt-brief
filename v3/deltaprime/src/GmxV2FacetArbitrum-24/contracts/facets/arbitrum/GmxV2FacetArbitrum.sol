...
// Last deployed from commit: f570cd1feac2f6bba7a9cb2778425f65154cdac4;
...
contract GmxV2FacetArbitrum is GmxV2Facet {
    ...
    address constant GM_SUI_WETH_USDC = 0x6Ecf2133E2C9751cAAdCb6958b9654baE198a797;
    address constant GM_SEI_WETH_USDC = 0xB489711B1cB86afDA48924730084e23310EB4883;
    ...
    function marketToLongToken(
        ...
        if (market == GM_ETH_WETH_USDC) {
            ...
            return GMX;
        } else if (market == GM_SUI_WETH_USDC) {
            return WETH;
        } else if (market == GM_SEI_WETH_USDC) {
            return WETH;
        } else {
    ...
    // DEPOSIT
    function depositSuiEthUsdcGmxV2(
        bool isLongToken,
        uint256 tokenAmount,
        uint256 minGmAmount,
    ...
    function depositSeiEthUsdcGmxV2(
        bool isLongToken,
        uint256 tokenAmount,
        uint256 minGmAmount,
        uint256 executionFee
    ...
    // WITHDRAW
    function withdrawSuiEthUsdcGmxV2(
        uint256 gmAmount,
    ...
    function withdrawSeiEthUsdcGmxV2(
        uint256 gmAmount,
        uint256 minLongTokenAmount,
        uint256 minShortTokenAmount,
        uint256 executionFee
