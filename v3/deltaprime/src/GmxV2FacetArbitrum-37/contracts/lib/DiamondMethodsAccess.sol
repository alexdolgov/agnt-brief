...
import {DiamondSolvencyMethodsAccess} from "./DiamondSolvencyMethodsAccess.sol";

/**
 * @dev Provides utility methods for accessing Diamond facet functions
 */
contract DiamondMethodsAccess is DiamondSolvencyMethodsAccess {
