...
contract ParaSwapHelper is SolvencyMethods {
    ...
    function checkSlippage(
        ...
        uint256 soldTokenDollarValue = prices[0] * soldAmount / (10**details.soldTokenDecimals);
        uint256 boughtTokenDollarValue = prices[1] * boughtAmount / (10**details.boughtTokenDecimals);
