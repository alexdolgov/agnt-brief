...
// Last deployed from commit: b6c8944c70ec05700296bfc8d2802a0853b9c3b1;
    ...
    function _repayAllDebts() internal {
        ...
        for (uint256 i = 0; i < debtAssets.length; i++) {
            ...
            if (debtAmount > 0) {
                ...
                _decreaseExposure(tokenManager, address(token), debtAmount);
        ...
        for (uint256 i = 0; i < debtAssets.length; i++) {
            ...
            if (debtAmount > 0) {
                ...
                if (repayAmount > 0) {
                    ...
                    _decreaseExposure(tokenManager, address(token), repayAmount);
