...
library DiamondStorageLib {
    ...
    function setGmxPositionBenchmark(address market, uint256 benchmarkValueUsd, uint256 longTokenAmount, uint256 shortTokenAmount, address longToken, address shortToken, uint256 timestamp) internal {
        GmxPositionStorage storage gps = gmxPositionStorage();
        gps.positionBenchmarks[market] = GmxPositionBenchmark({
