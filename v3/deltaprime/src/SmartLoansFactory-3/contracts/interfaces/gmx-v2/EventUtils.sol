...
library EventUtils {
    ...
    function getWithoutRevert(AddressItems memory addresses, string memory key) internal pure returns(bool, address) {
    ...
    function getArray(AddressItems memory addresses, string memory key) internal pure
    ...
    function getArrayWithoutRevert(AddressItems memory addresses, string memory key) internal pure
    ...
    function getWithoutRevert(UintItems memory items, string memory key) internal pure returns(bool, uint256) {
    ...
    function getArray(UintItems memory items, string memory key) internal pure
    ...
    function getArrayWithoutRevert(UintItems memory items, string memory key) internal pure
    ...
    function getWithoutRevert(IntItems memory items, string memory key) internal pure returns(bool, int256) {
        for (uint i = 0; i < items.items.length; i++) {
            if (compareStrings(items.items[i].key, key)) {
                return (true, items.items[i].value);
            }
    ...
    function getArray(IntItems memory items, string memory key) internal pure
    ...
    function getArrayWithoutRevert(IntItems memory items, string memory key) internal pure
    ...
    function getWithoutRevert(BoolItems memory items, string memory key) internal pure returns(bool, bool) {
        for (uint i = 0; i < items.items.length; i++) {
            if (compareStrings(items.items[i].key, key)) {
                return (true, items.items[i].value);
            }
    ...
    function getArray(BoolItems memory items, string memory key) internal pure
    returns(bool[] memory) {
    ...
    function getArrayWithoutRevert(BoolItems memory items, string memory key) internal pure
    ...
    function getWithoutRevert(Bytes32Items memory items, string memory key) internal pure returns(bool, bytes32) {
        for (uint i = 0; i < items.items.length; i++) {
            if (compareStrings(items.items[i].key, key)) {
                return (true, items.items[i].value);
            }
    ...
    function getArray(Bytes32Items memory items, string memory key) internal pure
    ...
    function getArrayWithoutRevert(Bytes32Items memory items, string memory key) internal pure
    ...
    function getWithoutRevert(BytesItems memory items, string memory key) internal pure returns(bool, bytes memory) {
        for (uint i = 0; i < items.items.length; i++) {
            if (compareStrings(items.items[i].key, key)) {
                return (true, items.items[i].value);
            }
    ...
    function getArray(BytesItems memory items, string memory key) internal pure
    ...
    function getArrayWithoutRevert(BytesItems memory items, string memory key) internal pure
    ...
    function getWithoutRevert(StringItems memory items, string memory key) internal pure returns(bool, string memory) {
        for (uint i = 0; i < items.items.length; i++) {
            if (compareStrings(items.items[i].key, key)) {
                return (true, items.items[i].value);
            }
    ...
    function getArray(StringItems memory items, string memory key) internal pure
    ...
    function getArrayWithoutRevert(StringItems memory items, string memory key) internal pure
