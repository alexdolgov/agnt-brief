...
contract TokenManager is OwnableUpgradeable {
    ...
    **/
    ...
    event TieredDebtCoverageSet(LeverageTierLib.LeverageTier indexed tier, address indexed tokenAddress, uint256 indexed debtCoverage, address admin, uint256 timestamp);
}
