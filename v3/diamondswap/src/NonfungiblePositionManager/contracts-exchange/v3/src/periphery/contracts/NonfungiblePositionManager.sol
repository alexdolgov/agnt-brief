...
import "@exchange-v3/core/contracts/libraries/FixedPoint128.sol";
...
/// @title NFT positions
/// @notice Wraps DiamondSwap V3 positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    constructor(address _factory, address _WETH9, address _tokenDescriptor_)
        ERC721Permit("DiamondSwap V3 Positions NFT-V1", "DS-V3-POS", "1")
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IDiamondSwapV3Pool pool = IDiamondSwapV3Pool(PoolAddress.computeAddress(factory, poolKey));
