...
import "@uniswap-libs/contracts/libraries/SafeERC20Namer.sol";
...
contract NonfungibleTokenPositionDescriptor is INonfungibleTokenPositionDescriptor {
    ...
    constructor(address _WETH9, bytes32 _nativeCurrencyLabelBytes) payable {
        WETH9 = _WETH9;
        ...
        returns (string memory)
    {
        ...
        IDiamondSwapV3Pool pool = IDiamondSwapV3Pool(
