...
import "@exchange-v3/core/contracts/libraries/BitMath.sol";
import "@exchange-v3/core/contracts/libraries/FullMath.sol";
import "@openzeppelin-0.7/contracts/utils/Strings.sol";
import "@openzeppelin-0.7/contracts/math/SafeMath.sol";
import "@openzeppelin-0.7/contracts/math/SignedSafeMath.sol";
...
library NFTDescriptor {
    ...
    function generateDescriptionPartOne(
        ...
        return string(
            abi.encodePacked(
                "This NFT represents a liquidity position in a DiamondSwap V3 ",
                quoteTokenSymbol,
                "-",
                baseTokenSymbol,
                " pool. ",
