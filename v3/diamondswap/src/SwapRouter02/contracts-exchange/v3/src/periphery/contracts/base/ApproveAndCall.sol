...
import "@exchange-v3/periphery/contracts/interfaces/INonfungiblePositionManager.sol";

import "../interfaces/IApproveAndCall.sol";
import "./ImmutableState.sol";

/// @title Approve and Call
/// @notice Allows callers to approve the DiamondSwap V3 position manager from this contract,
