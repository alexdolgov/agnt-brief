...
contract UniV4Adapter is IDODOAdapter, IUnlockCallback {
    ...
    function sellBase(address to, address /*pool*/, bytes memory data) external {
        (address tokenIn, address tokenOut, uint24 fee, int24 tickSpacing) = abi.decode(data, (address, address, uint24, int24));
    ...
    function unlockCallback(bytes calldata data) external returns (bytes memory) {
        ...
        (address tokenIn, address tokenOut, uint24 fee, int24 tickSpacing) = abi.decode(poolData, (address, address, uint24, int24));
