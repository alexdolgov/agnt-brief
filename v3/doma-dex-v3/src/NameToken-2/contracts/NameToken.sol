    ...
    IERC2981
{
    ...
    /**
     * @notice Burn multiple tokens without checking expiration status.
     * @dev Only authorized minters can call this function. Deletes domain capabilities
     * and emits NameTokenBurned events for tracking purposes.
    ...
    function bulkBurn(
        ...
        for (uint256 i = 0; i < len; ) {
            ...
            // Additional event is emitted to associate burn with correlation id
    ...
    function _isTokenExpired(uint256 id) private view returns (bool) {
