...
import { IProxyDomaRecordNameTokenOperations } from "./interfaces/IProxyDomaRecordNameTokenOperations.sol";
    ...
    IERC2981
{
     ...
     */
    IProxyDomaRecordNameTokenOperations public proxyDomaRecord;
     ...
     */
    function setProxyDomaRecord(
        IProxyDomaRecordNameTokenOperations proxyDomaRecord_
    ) external onlyOwner {
