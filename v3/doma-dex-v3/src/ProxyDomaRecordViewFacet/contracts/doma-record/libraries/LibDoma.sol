...
import { IProxyDomaRecordCrossChainOperations } from "../../interfaces/IProxyDomaRecordCrossChainOperations.sol";
...
library LibDoma {
    ...
    struct ChainPolicy {
        ...
        bool eoiOnly;
        /**
         * @dev Whether direct ICANN tokenization is disabled on this chain.
         */
        bool directTokenizationDisabled;
        /**
    ...
    function detokenizeIfClaimed(
        ...
        bytes memory detokenizeCalldata = abi.encodeCall(
            IProxyDomaRecordCrossChainOperations.detokenize,
    ...
    function mintOwnershipToken(
        ...
        IProxyDomaRecordCrossChainOperations.OwnershipTokenInfo[]
            memory tokens = new IProxyDomaRecordCrossChainOperations.OwnershipTokenInfo[](1);
        tokens[0] = IProxyDomaRecordCrossChainOperations.OwnershipTokenInfo(
            name.sld,
            name.tld,
