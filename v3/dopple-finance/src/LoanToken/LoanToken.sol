...
contract LoanToken is AdvancedTokenStorage {
    // It is important to maintain the variables order so the delegate calls can access dfiContractAddress and wbaseTokenAddress
    address public dfiContractAddress;
    ...
    constructor(
        address _newOwner,
        address _newTarget,
        address _dfiContractAddress,
        address _wbaseTokenAddress
    ) public {
        transferOwnership(_newOwner);
        _setTarget(_newTarget);
        _setDFiContractAddress(_dfiContractAddress);
    ...
    function _setDFiContractAddress(address _dfiContractAddress) internal {
        require(Address.isContract(_dfiContractAddress), "dfi not a contract");
        dfiContractAddress = _dfiContractAddress;
    }

    function _setWbaseTokenAddress(address _wbaseTokenAddress) internal {
