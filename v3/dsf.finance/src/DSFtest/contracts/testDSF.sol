...
contract DSFtest is ERC20, Pausable, AccessControl {
    ...
    uint256 public constant MIN_LOCK_TIME = 0 days;
    ...
    constructor(address[POOL_ASSETS] memory _tokens) ERC20('DSFLP_test', 'DSFLP_test') {
        tokens = _tokens;
