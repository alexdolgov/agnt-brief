...
contract RewardManager is Ownable, ReentrancyGuard, AccessControl {
     ...
     * @return holdingsUSDT1e18   Array of total holdings in USDT (1e18 precision)
     * @return sharePrice1e18     Array of computed share prices (1e18 precision)
     */
    function getActivePoolsSnapshot()
        ...
        returns (
            ...
            uint256[] memory holdingsUSDT1e18,
            uint256[] memory sharePrice1e18
        ) 
    {
        uint256 n = dsf.poolCount(); 
        ...
        holdingsUSDT1e18 = new uint256[](activeCount);
        sharePrice1e18 = new uint256[](activeCount);
        ...
        for (uint256 i = 0; i < n; i++) {
            ...
            holdingsUSDT1e18[j] = holdings;
            sharePrice1e18[j] = price;
            j++;
        }
    }
