...
- Outside the address book: 51 discovered implementations excluded (0 third-party/infra; 1 standard proxy/library)
- Proxy deployments represented within implementation groups: 4
- Deployed-live implementations: 8 of 59 unique (rest dead/inactive/uninitialized)
