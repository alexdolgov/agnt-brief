...
// File contracts/ElkSeasonNFT.sol
 ...
 */
contract ElkSeasonNFT is Context, AccessControlEnumerable, ReentrancyGuard, ERC721Enumerable, ERC721Burnable,ERC721Pausable {
    ...
    function mint(address to) public virtual nonReentrant() {
        require(hasRole(MINTER_ROLE, _msgSender()), "ElkSeasonNFT: must have minter role to mint");
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ElkSeasonNFT: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ElkSeasonNFT: must have pauser role to unpause");
        _unpause();
    }
