...
/// @title Parent contract for eMetis
/** @notice Combines Openzeppelin's ERC20Permit and ERC20Burnable with Ownable2Step
    Also includes a list of authorized minters */
/// @dev eMetis adheres to EIP-712/EIP-2612 and can use permits
contract ERC20PermitPermissionedMint is ERC20Permit, ERC20Burnable, Ownable2Step {
    // Core
