/**v3.4.0
 *0xa1b88ec609223113e6ed5aa4c75a487fffab54b4
...
contract Minter is Initializable {
    ...
    uint internal constant POOL2_RATE = 10;
    /// @notice max lock period 26 weeeks
    uint internal constant LOCK = 86400 * 7 * 26;

    uint internal constant MAX_TREASURY_RATE = 543;
    ...
    function update_period() external returns (uint) {
        ...
        if (block.timestamp >= _period + WEEK && owner == address(0)) { // only trigger if new week
            ...
            uint _pool2Emissions = (POOL2_RATE * weekly) / PRECISION;
            ...
            price[ _period ] = ITVL(0x7a18D1b46baaBB2D8260D0f8cfBb2292901c2779).
            p_t_coin_usd(0xc825c67cA3a80D487C339A6C16bB84f7DCA16012);
