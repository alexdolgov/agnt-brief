...
import "./I_SteerSmartRewarder_ts.sol";		//		<---- using "TS" version
    ...
    function notifyRewardAmount(IERC20 _tkn, uint _ramt) external checkPaused nonReentrant {
		...
		SteerSmartRewarder.createRewardCampaign(
			ISteerSmartRewarder.RewardCampaignParams({
        		...
        		campaignParamsIPFSHash:
        			"QmXgkvu83PwnxN2gwGFD77PC1ZyekWTBT6mh9tYJrWWzJd"	// 2026-02-01
        			//"QmWsyDNFPNXDDreLMtHjf4bcywKDP5aXJ8aKDxWsj6ccHR"
        			//"QmWc8fHsK24TqmFroPr26YvfvDJLi4WXLqKa4rXFhcT9jp"
			})
		);
