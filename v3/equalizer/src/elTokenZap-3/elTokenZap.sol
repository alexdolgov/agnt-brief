...
contract elTokenZap {
	...
	IERC20 public constant ELT = IERC20(0xdc2dE2f2C0122FF7cb8482DC47DA75a6a5D1A88B); // eliteRingsSCT
	IERC20 public constant SCT = IERC20(0x3bcE5CB273F0F148010BbEa2470e7b5df84C7812); // SCT
	IERC20 public constant STK = IERC20(0x455d5f11Fea33A8fa9D3e285930b478B6bF85265); // stkSCT
	IVotingEscrow public constant VE = IVotingEscrow(0x1Ec2b9a77A7226ACD457954820197F89B3E3a578); // veUSD

	IEliteRingsManager public constant MGR = IEliteRingsManager(0xB82Beb0860BDe0838e7B721d747528F24A258825); // eliteRingsSCT Minter
	IStk_Teller public constant STK_Teller = IStk_Teller(0x31A5A9F60Dc3d62fa5168352CaF0Ee05aA18f5B8);
