...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function tvl() external view returns(uint) {
		return
			...
			* IGuruFarmland(0x5A11968256F7860C9c19513aDf30AD9C8F5F6041).getAssetPrice( 0xd3DCe716f3eF535C5Ff8d041c1A41C3bd89b97aE )  // PriceGuru.getAssetPrice( scUSD )
			///* IGuruFarmland(0x5A11968256F7860C9c19513aDf30AD9C8F5F6041).getAssetPrice( 0x3bce5cb273f0f148010bbea2470e7b5df84c7812 )  // PriceGuru.getAssetPrice( scETH )
			/ 1e18
		;
	}
