    ...
    ReentrancyGuardUpgradeable
{
    ...
    function vestNft(
        ...
        require(IERC721(nftPool).ownerOf(_nftTokenId) == msg.sender, "Vester: invalid nft owner");
    ...
    function unlock(uint256 _vestId) external updateReward {
        ...
        emit VestingPositionUnlocked(vestingPosition.user, _lpAmount, _vestId, vestInNft[_vestId]);
    }
