...
// SPDX-License-Identifier: GPLv2.0-or-later AND GPLv3 AND GPLv3.0 AND MIT
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721EnumerableUpgradeable.sol@v4.8.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721EnumerableUpgradeable.sol@v4.8.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol@v4.8.3
...
// Original license: SPDX_License_Identifier: GPLv3.0
pragma solidity ^0.8.28;

bytes32 constant DEFAULT_ADMIN_ROLE = bytes32(0);
bytes32 constant TREASURY_MANAGER = keccak256('TREASURY_MANAGER');
bytes32 constant BOND_ADMIN = keccak256('BOND_ADMIN');


// File contracts/access/AccessManagedUpgradeable.sol
...
// File contracts/interfaces/IInterestParameters.sol
...
// File contracts/bond/InterestParameters.sol
...
abstract contract InterestParameters is Initializable, IInterestParameters, AccessManagedUpgradeable {
    ...
    external override onlyRole(BOND_ADMIN) {
        _setInterestParameters(_interests, _maturities);
    }
     ...
     */
    function setMaxInterestParams(uint256 value) external override onlyRole(BOND_ADMIN) {
    ...
    function getInterestForMaturity(uint256 maturity) public view override returns (uint256) {
        ...
        uint256 interestsLength = interests.length;
        for (uint256 i = interestsLength - 1; i >= 0; --i) {
    ...
    internal {
        ...
        uint256 interestsLength = interests.length;
        for (uint256 i = 0; i < interestsLength; ++i) {
            if (i != 0) {
...
// File contracts/bond/BondGranter.sol
...
// File contracts/bond/CollateralizedBondGranter.sol
...
abstract contract CollateralizedBondGranter is BondGranter {
     ...
     */
    uint256[23] private __gap; // deployed with 28 store gaps
}


// File contracts/bond/LockedBondGranter.sol
...
// File contracts/libraries/TokenURILib.sol
...
// File contracts/interfaces/IMultiTokenReserve.sol

// Original license: SPDX_License_Identifier: GPLv3.0
pragma solidity ^0.8.28;

interface IMultiTokenReserve {
    ...
    function balance(address _token) external view returns (uint256 amount);
}


// File contracts/borrowing/LiquidityRequester.sol
...
// File contracts/libraries/DecimalStrings.sol

// Original license: SPDX_License_Identifier: GPLv2.0-or-later
pragma solidity ^0.8.28;
...
// File contracts/nftbond/NFTBond.sol
...
abstract contract NFTBond is NFT, CollateralizedBondGranter, LockedBondGranter, LiquidityRequester, PausableUpgradeable {
    ...
    internal initializer {
        ...
        __CollateralizedBondGranter_init(_collateralToken, _collateralReserve, _interests, _maturities);
...
// File contracts/nftbond/ERC20NFTBond_v_2_2.sol
 ...
 * @author Ethichub
 */
contract ERC20NFTBond_v_2_2 is NFTBond {
    using SafeERC20Upgradeable for IERC20Upgradeable;
