...
contract EthosSlash is ITargetStatus, AccessControl, UUPSUpgradeable {
   ...
   * @param slashType Type of penalty (score or financial)
  ...
  function createSlash(
    ...
    _createSlashInternal(subject, amount, comment, metadata, attestationDetails, authorProfileId);
  }
