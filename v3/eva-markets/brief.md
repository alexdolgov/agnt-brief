# Agentic Audit Brief: eva Markets
...
- Project: eva Markets (`eva-markets`)
- Website: [https://www.eva.markets](https://www.eva.markets)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for eva Markets. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
- Confirmed-live implementations: 3 of 3 unique; 0 retained implementation(s) lack confirmed-live status
