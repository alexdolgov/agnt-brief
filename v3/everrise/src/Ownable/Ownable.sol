// EverOwn & SpookyShiba Wrapper contract 
...
contract MyContractOwn is Ownable {
    ...
    string private _name = "SpookyShibaLocker";
    string private _symbol = "SPOOKYLOCKER";

    ISpookyShibaLock public token;

    constructor (address _token) {
        token = ISpookyShibaLock(payable(_token));
    }
