...
contract FiaBTCOFTAdapter is MintBurnOFTAdapter, Fee {
    ...
    /**
     * @notice Override sharedDecimals to match FIABTC's 8 decimals
     * @dev This prevents dust loss during cross-chain transfers
     * @dev By matching local and shared decimals, decimalConversionRate becomes 1
     * @return The shared decimals (8 for BTC-like tokens)
     */
