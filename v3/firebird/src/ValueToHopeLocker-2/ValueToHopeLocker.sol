...
contract ValueToHopeLocker is OwnableUpgradeSafe, ITokenLocker, ContractGuard {
    using SafeMath for uint256;
    ...
    function startReleaseTime() external view override returns (uint256) {
        return _startReleaseTime;
    }

    function endReleaseTime() external view override returns (uint256) {
