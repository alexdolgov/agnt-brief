...
contract Farm is Ownable {
    ...
    function stopFarm() public onlyOwner {
        REWARD_TOKEN.safeTransferFrom(address(this), DAO_MULTISIG, REWARD_TOKEN.balanceOf(address(this)));
        emit FarmStopped();
    }
    ...
    function claimRewards() public returns (uint256) {
        ...
        if (rewards > 0) {
            REWARD_TOKEN.safeTransferFrom(address(this), msg.sender, rewards);
        }
        return rewards;
    }
    ...
    function unstake(uint256 amount) public {
        ...
        claimRewards();
        stakedTokens[msg.sender] -= amount;
        STAKING_TOKEN.safeTransferFrom(address(this), msg.sender, amount);
