...
contract FireVaultFBXV2 is ERC20, ERC20Burnable, ERC20Permit {
    ...
    address public constant EP_CONTRACT_ADDRESS = 0x0F9f54202446a4d8be9b8DFb03dfFA90ED120D01; // <<TESTING to set before deployment>>
    ...
    function claimRewardsAndBalance() public {
        ...
        if (rewards > 0) {
            SAFE_FBX.safeTransfer(DAO_MULTISIG, rewards / 10);  // DAO fee
            uint256 toSpend = rewards * 9 / 10 * totalFBXBalance() / totalAssetsValuation(); // More FBX implies more burn
            if (toSpend > 0) {
