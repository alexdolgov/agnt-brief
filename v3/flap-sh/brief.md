...
- Outside the address book: 44 discovered implementations excluded (1 third-party/infra; 1 standard proxy/library)
- Proxy deployments represented within implementation groups: 1
- Deployed-live implementations: 18 of 63 unique (rest dead/inactive/uninitialized)
