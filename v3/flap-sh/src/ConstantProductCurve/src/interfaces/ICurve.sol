...
interface ICurve {
    ...
    function estimateReserve(uint256 supply) external pure returns (uint256 reserve);
    ...
    function estimateSupply(uint256 reserve) external pure returns (uint256 supply);
