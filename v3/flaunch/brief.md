...
- Lifecycle: unknown
- Generated: 2026-07-03T21:05:52.237Z
...
- Coverage of deployed-live implementations: 0/55 (0.0%)
...
|---|---|---|---|---|---|
| AddressFeeSplitManager | unknown | base | n/a | 8 deployments: base [`0x58e8b9...79a307`](./contracts/base-8453/0x58e8b94affa117c525d040918344b7a0b779a307/); base `0x6baa4e...149f99`; base `0x929d48...a3d90c`; base `0xabde68...78334b`; base `0xc3f4e7...f6faf9`; base `0xe5a5ad...f7f386`; base `0xf6d801...920a7d`; base `0xfab4ba...1e89f3` | ⚠️ Unaudited |
| AnyBidWall | unknown | base | n/a | [`0x2154c6...9240df`](./contracts/base-8453/0x2154c604df568a5285284d1c4918dc98c39240df/) | ⚠️ Unaudited |
| AnyFlaunch | unknown | base | n/a | 4 deployments: base [`0x32e59c...500983`](./contracts/base-8453/0x32e59c950dbbf0123e3a7008dab56480c3500983/); base `0x71001d...e43666`; base `0xc5b2e8...cf95d5`; base `0xf175a3...844c50` | ⚠️ Unaudited |
...
| AnyPositionManager | governance | base | n/a | [`0x8dc3b8...42e5dc`](./contracts/base-8453/0x8dc3b85e1dc1c846ebf3971179a751896842e5dc/) | ⚠️ Unaudited |
...
| BuyBackAndBurnFlay | unknown | base | n/a | 6 deployments: base [`0x2994a2...10413c`](./contracts/base-8453/0x2994a2849666c3487aaef9bb0662f853a710413c/); base `0x558a4d...725192`; base `0x93db9a...b4016f`; base `0xc5ee96...30968a`; base `0xd0bc17...881982`; base `0xe8476a...bf8dd3` | ⚠️ Unaudited |
| BuyBackManager | unknown | base | n/a | [`0x3aaf3b...ba8a3f`](./contracts/base-8453/0x3aaf3b1d8cd5b61c77f99ba7cdf41e9ec0ba8a3f/) | ⚠️ Unaudited |
...
| FairLaunch | unknown | base | n/a | 2 deployments: base [`0x184b9f...b68f92`](./contracts/base-8453/0x184b9f99ff343d982574cfc3bd8bed8634b68f92/); base `0x4dc442...f32640` | ⚠️ Unaudited |
...
| Flaunch | unknown | base | n/a | 5 deployments: base [`0x0cf6bd...3553af`](./contracts/base-8453/0x0cf6bdf0a85a9d6763361037985b76c8893553af/); base `0x516af5...e10109`; base `0x6a53f8...2d9571`; base `0xb4512b...04c18c`; base `0xba303a...f06d73` | ⚠️ Unaudited |
...
| FlaunchPremineZap | unknown | base | n/a | [`0xefa826...c8dffe`](./contracts/base-8453/0xefa8267954b0740dc981a40d8e23d07116c8dffe/) | ⚠️ Unaudited |
| FlaunchZap | adapter | base | n/a | 8 deployments: base [`0x2bc8cb...22dabf`](./contracts/base-8453/0x2bc8cbfe237aeddc7c296436fefe239a0a22dabf/); base `0x8af174...c913ee`; base `0xa9bd94...24c172`; base `0xc3c6dd...126763`; base `0xe52de1...84b510`; base `0xe70c28...318211`; base `0xf9753e...b8b114`; base `0xfa9e85...0a672a` | ⚠️ Unaudited |
...
| IndexerSubscriber | unknown | base | n/a | 3 deployments: base [`0x221a11...c86088`](./contracts/base-8453/0x221a110f421384c2d5f2c56f04b8e97e47c86088/); base `0x7c6088...659663`; base `0xf14d1f...61ef10` | ⚠️ Unaudited |
| MarketCappedPrice | unknown | base | n/a | 2 deployments: base [`0x09a10a...993ee7`](./contracts/base-8453/0x09a10aee38e93e3ed196728adcf1999e38993ee7/); base `0xadfe60...8b0a6c` | ⚠️ Unaudited |
...
| MerkleAirdrop | unknown | base | n/a | [`0x635b4a...59077a`](./contracts/base-8453/0x635b4afcf977ed946bda31fc7e381c970159077a/) | ⚠️ Unaudited |
...
| PositionManager | governance | base | n/a | [`0x23321f...902fdc`](./contracts/base-8453/0x23321f11a6d44fd1ab790044fdfde5758c902fdc/) | ⚠️ Unaudited |
| PreventNoFairLaunch | unknown | base | n/a | [`0x8ecd49...4c9294`](./contracts/base-8453/0x8ecd49f762c82b48db927cb80b5629fb3f4c9294/) | ⚠️ Unaudited |
...
| RevenueManager | governance | base | n/a | 9 deployments: base [`0x1af9b9...e7ee36`](./contracts/base-8453/0x1af9b9f168bfd2046f45e0ce03972864bce7ee36/); base `0x2a1fc8...c679e2`; base `0x33f04d...1b2282`; base `0x4fb9de...c01b8f`; base `0x641d5c...89d72d`; base `0x662a76...4f9950`; base `0x712fa8...02d898`; base `0xb6c0cc...e92b3d`; base `0xc8d4b2...cc1b50` | ⚠️ Unaudited |
| SignedImporter | unknown | base | n/a | [`0x90664e...34e358`](./contracts/base-8453/0x90664e887e4e98cf281f4c244a9957544134e358/) | ⚠️ Unaudited |
| StakingManager | unknown | base | n/a | 8 deployments: base [`0x361a87...24b630`](./contracts/base-8453/0x361a874945c07069beed611f950506a8e324b630/); base `0x3c3bc8...b40bf0`; base `0x540677...a9622d`; base `0xa15f92...fea193`; base `0xb5dd2f...badbea`; base `0xcc920a...1324c2`; base `0xdcb1be...72b5b2`; base `0xec0069...b3125d` | ⚠️ Unaudited |
| StaticFeeCalculator | unknown | base | n/a | [`0x002f0f...6302ec`](./contracts/base-8453/0x002f0f6d57bd3692ee9bb59e82e5433afd6302ec/) | ⚠️ Unaudited |
...
| TokenImporter | unknown | base | n/a | 2 deployments: base [`0x6fb66f...668197`](./contracts/base-8453/0x6fb66f4fc262dc86e12136c481ba7c411e668197/); base `0xb47af9...435842` | ⚠️ Unaudited |
...
| WhitelistFairLaunch | unknown | base | n/a | 4 deployments: base [`0x8ea82b...e226f6`](./contracts/base-8453/0x8ea82b35b890987cd6b55271f593abbc0fe226f6/); base `0x8ecc81...47c7e5`; base `0x9718c9...d7f1d3`; base `0xfbb09a...99462d` | ⚠️ Unaudited |
| WhitelistPoolSwap | unknown | base | n/a | 4 deployments: base [`0x29d66c...4c3837`](./contracts/base-8453/0x29d66cbfa911cc54bc7111ca5ee19d1f2e4c3837/); base `0x6af705...ea94ee`; base `0x862d54...af054a`; base `0xde9cfa...d4534d` | ⚠️ Unaudited |
...
|---|---|---|---|---|---|---|---|---|
| [2024-12_Security_Review_FlayerLabs_Flaunch.pdf](https://1229184497-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FoleIQgpsdD3uHYHcTay2%2Fuploads%2FvGZ6DMH5qc5WmOLDVo1R%2F2024-12_Security_Review_FlayerLabs_Flaunch.pdf) | FlayerLabs | Audit | 2024-12 | aging | Direct | n/a | 0 | n/a |
...
- [20299] 2024-12_Security_Review_FlayerLabs_Flaunch.pdf
- [20300] 2024-12_Security_Review_Extension_FlayerLabs_Flaunch.pdf
- [20301] 2025-03_Security Review_FlayerLabs_Flaunch v1.1 Protocol Upgrade.pdf
