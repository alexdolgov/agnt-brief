...
contract IndexerSubscriber is Ownable {
     ...
     */
    function addVerifiedFlaunch(address _flaunch) public onlyOwner {
     ...
     */
    function removeVerifiedFlaunch(address _flaunch) public onlyOwner {
     ...
     */
    function isVerifiedFlaunch(address _flaunch) public view returns (bool verified_) {
