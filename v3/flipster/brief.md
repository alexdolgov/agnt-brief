...
- Chains: arbitrum, avalanche, base, blast, bsc, celo, ethereum, kaia, optimism, polygon, sonic
...
No contract logic was present for Flipster in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
