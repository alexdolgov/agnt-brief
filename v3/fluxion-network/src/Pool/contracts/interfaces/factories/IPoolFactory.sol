...
interface IPoolFactory {
    ...
    event SetCustomTeamFee(address indexed pool, uint256 fee);
    event SetUpgrader(address upgrader);
    ...
    function setCustomTeamFee(address _pool, uint256 _fee) external;
    ...
    /// @notice Returns team fee for a pool, as custom team fees are possible.
    function getTeamFee(address _pool, bool _stable) external view returns (uint256);
