...
interface IPool {
    ...
    error NotTeam();
    error NotFactory();
    error PoolFeesAlreadySet();

    event Fees(address indexed sender, uint256 amount0ToPoolFees, uint256 amount1ToPoolFees, uint256 amount0ToTeam, uint256 amount1ToTeam);
    ...
    /// @param _poolFees Address of the upgradeable PoolFees contract
