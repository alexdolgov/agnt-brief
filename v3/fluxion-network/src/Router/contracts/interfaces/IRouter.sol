...
interface IRouter {
    ...
    /// @notice Perform chained getAmountIn calculations on any number of pools using binary search
    /// @dev Uses binary search to find the required input amount for a desired output
    /// @param amountOut Desired amount of output token
    /// @param routes Array of trade routes
    /// @return amounts Array of amounts for each step, where amounts[0] is the required input
