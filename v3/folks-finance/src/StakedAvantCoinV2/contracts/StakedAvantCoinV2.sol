...
import "./StakedAvantCoin.sol";
import "./AvantCoinSilo.sol";
import "./interfaces/IStakedAvantCoinCooldown.sol";

contract StakedAvantCoinV2 is IStakedAvantCoinCooldown, StakedAvantCoin {
  using SafeERC20 for IERC20;

  mapping(address => UserCooldown) public cooldowns;

  AvantCoinSilo public immutable silo;
  ...
  /// @notice Constructor for StakedAvantCoinV2 contract.
  ...
  constructor(IERC20 _asset, address initialRewarder, address _owner) StakedAvantCoin(_asset, initialRewarder, _owner) {
    silo = new AvantCoinSilo(address(this), address(_asset));
