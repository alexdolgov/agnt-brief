...
interface IBAMM {
    ...
    function solvent(address user) external view returns (bool);
    ...
    function ltv(Vault memory vault) external view returns (uint256);
    function currentUtilityRate() external view returns (uint256);
