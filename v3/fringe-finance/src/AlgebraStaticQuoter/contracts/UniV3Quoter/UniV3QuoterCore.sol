...
contract UniV3QuoterCore is UniV3likeQuoterCore {
    function getPoolGlobalState(address pool)
        internal
        view
        override
        returns (GlobalState memory gs)
    {
    ...
    function nextInitializedTickWithinOneWord(
        ...
        return
            TickBitmap.nextInitializedTickWithinOneWord(poolAddress, tick, tickSpacing, zeroForOne);
    }
