...
contract ComptrollerV8Storage is ComptrollerV7Storage {
    ...
    // @notice Supply caps enforced by mintAllowed for each cToken address. Defaults to zero which corresponds to unlimited minting.
    ...
    mapping(address => bool) internal bl;
...
contract ComptrollerAllStorage is ComptrollerV8Storage {
}