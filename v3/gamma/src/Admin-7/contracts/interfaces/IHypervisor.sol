...
interface IHypervisor {
  ...
  function incentiveMaker() external view returns (IIncentiveMaker);
  ...
  function updateIncentiveMaker(address _incentiveMaker) external;
  function setNftIds(uint256 _baseNftId, uint256 _limitNftId) external;
  function pause() external;
  function unpause() external;
  function updateIncentiveKey() external;
