...
contract Admin {
    ...
    constructor(address _admin, address _pointsOperator) {
        admin = _admin;
    ...
    function claimYieldAll(address _hypervisor, address _recipient, uint256 _amountWETH, uint256 _amountUSDB) external onlyAdmin {
        IHypervisor(_hypervisor).claimYieldAll(_recipient, _amountWETH, _amountUSDB); 
    }
