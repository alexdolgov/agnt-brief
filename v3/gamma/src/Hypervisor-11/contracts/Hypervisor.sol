...
/// @notice A Uniswap V2-like interface with fungible liquidity to Lynex
...
contract Hypervisor is IAlgebraMintCallback, ERC20Permit, ReentrancyGuard {
   ...
   event Deposit(
    ...
    /// @param _pool Lynex pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Lynex pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Lynex pool
    ...
    /// @notice Callback function of Lynex Pool mint
    ...
    /// @return tick Lynex pool's current price tick
