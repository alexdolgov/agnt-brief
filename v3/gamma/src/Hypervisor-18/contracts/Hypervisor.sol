...
import "./blasterswap/interfaces/callback/IBlasterswapV3MintCallback.sol";
import "./blasterswap/interfaces/IBlasterswapV3Pool.sol";
import "@uniswap/v3-core/contracts/libraries/TickMath.sol";
import "./blasterswap/libraries/FullMath.sol";
import "./blasterswap/libraries/LiquidityAmounts.sol";
...
/// @notice A Blasterswap V2-like interface with fungible liquidity to Blasterswap V3
/// which allows for arbitrary liquidity provision: one-sided, lop-sided, and balanced
contract Hypervisor is IBlasterswapV3MintCallback, ERC20Permit, ReentrancyGuard {
    ...
    IBlasterswapV3Pool public pool;
   ...
   event Deposit(
    ...
    /// @param _pool Blasterswap V3 pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Blasterswap pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Blasterswap pool
    ...
    /// @notice Callback function of BlasterswapV3Pool mint
    ...
    /// @return tick Blasterswap pool's current price tick
