...
/// @notice A V2-like interface with fungible liquidity to FusionX
/// which allows for arbitrary liquidity provision: one-sided, lop-sided, and balanced
contract Hypervisor is IFusionXV3MintCallback, ERC20Permit, ReentrancyGuard {
   ...
   event Deposit(
    ...
    /// @param _pool FusionX V3 pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from FusionX pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from FusionX pool
    ...
    /// @notice Callback function of FusionXV3Pool mint
    ...
    /// @return tick FusionX pool's current price tick
