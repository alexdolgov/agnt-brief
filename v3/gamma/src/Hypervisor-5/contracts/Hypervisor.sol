...
/// @notice A Uniswap V2-like interface with fungible liquidity to Glacier
...
contract Hypervisor is IAlgebraMintCallback, ERC20Permit, ReentrancyGuard {
   ...
   event Deposit(
    ...
    /// @param _pool Glacier pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Glacier pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Glacier pool
    ...
    /// @notice Callback function of Glacier Pool mint
    ...
    /// @return tick Glacier pool's current price tick
