...
contract Hypervisor is IAlgebraMintCallback, ERC20Permit, ReentrancyGuard {
   ...
   event Deposit(
    ...
    /// @param _pool Thena pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Thena pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Thena pool
    ...
    /// @return tick Thena pool's current price tick
