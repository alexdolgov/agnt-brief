...
/// @notice A Uniswap V2-like interface with fungible liquidity to Swapr
...
contract Hypervisor is IAlgebraMintCallback, ERC20Permit, ReentrancyGuard {
   ...
   event Deposit(
    ...
    /// @param _pool Swapr pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Swapr pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Swapr pool
    ...
    /// @notice Callback function of Swapr Pool mint
    ...
    /// @return tick Swapr pool's current price tick
