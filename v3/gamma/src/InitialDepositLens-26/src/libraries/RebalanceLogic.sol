...
library RebalanceLogic {
    ...
    function _executeRebalance(
        ...
        // Process in separate scope to reduce stack
        {
            ...
            _calculateLiquiditiesFromWeights(
                liquidities, weights, baseRanges, available0, available1, sqrtPriceX96, weightsAreProportional
            );
        }
    ...
    function generateRangesAndLiquiditiesWithPoolKey(
        ...
        _calculateLiquiditiesFromWeights(
            liquidities, weights, baseRanges, amount0, amount1, sqrtPriceX96Current, ctx.weightsAreProportional
        );
    }
}
