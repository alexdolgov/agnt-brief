...
library SimpleLensInMin {
    ...
    function calculateInMinArrayFromAmounts(
        ...
        return _calculateInMinArrayFromAmounts(
            lowerTicks, upperTicks, weights, amount0, amount1, sqrtPriceX96, maxSlippage, weightsAreProportional
        );
    }
    ...
    function _getTotalAmountsForRebalance(MultiPositionManager manager)
        private
        view
