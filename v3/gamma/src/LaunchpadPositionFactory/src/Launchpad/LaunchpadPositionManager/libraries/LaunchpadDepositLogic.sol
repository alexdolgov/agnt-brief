...
/**
 * @title LaunchpadDepositLogic
 * @notice Library containing deposit logic for LaunchpadPositionManager (without withdraw/compound functionality)
 */
library LaunchpadDepositLogic {
    ...
    function calculateShares(
        ...
        // Get current pool totals (inline implementation without WithdrawLogic dependency)
        (uint256 pool0, uint256 pool1, , ) = _getTotalAmounts(s, poolManager);
    ...
    function getDirectDepositAmounts(
        ...
        // Get current totals (inline implementation)
        (uint256 total0, uint256 total1, , ) = _getTotalAmounts(s, poolManager);
    ...
    /**
     * @notice Get total amounts including positions and fees (inline implementation without WithdrawLogic)
     * @param s Storage struct
     * @param poolManager Pool manager contract
     * @return total0 Total amount of token0
     * @return total1 Total amount of token1
     * @return totalFee0 Total fees of token0
     * @return totalFee1 Total fees of token1
     */
