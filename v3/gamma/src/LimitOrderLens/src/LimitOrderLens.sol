...
contract LimitOrderLens is Ownable {
    ...
    // Events
    event PoolIdAdded(address indexed poolManager, PoolId indexed poolId, PoolKey key);
    event PoolIdRemoved(address indexed poolManager, PoolId indexed poolId, PoolKey key);
    ...
    function addPoolId(PoolId poolId, PoolKey calldata key) external onlyOwner {
        ...
        emit PoolIdAdded(address(poolManager), poolId, key);
    }
    ...
    function removePoolId(PoolId poolId) external onlyOwner {
        ...
        emit PoolIdRemoved(address(poolManager), poolId, key);
    }
