...
contract LimitOrderManager is ILimitOrderManager, IUnlockCallback, AccessControl, ReentrancyGuard, Pausable {
    ...
    uint24 public maxOrderLimit = 75; 
    ...
    constructor(address _poolManagerAddr, address _treasury) {
...
// =========== Admin Functions ===========
    ...
    function enableHook(address _hook) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender) || msg.sender == poolFactoryAddr, "UnauthorizedAdminOrPoolFactoryNotSet");
    ...
    function setPoolFactory(address _poolFactoryAddr) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(_poolFactoryAddr != address(0), "ZeroAddress");
