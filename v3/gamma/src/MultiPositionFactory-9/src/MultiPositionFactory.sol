...
contract MultiPositionFactory is IMultiPositionFactory, Ownable {
     ...
     * @param aggregator Address of swap aggregator (ODOS, ParaSwap, etc.)
     * @param swapData Encoded swap calldata from aggregator
     * @param minAmountOut Minimum amount expected from swap (slippage protection)
