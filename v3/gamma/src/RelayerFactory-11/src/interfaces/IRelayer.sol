...
interface IRelayer {
    ...
    struct TriggerConfig {
        ...
        uint256 limitMinRatio;       // Minimum limit0Ratio threshold
    ...
    struct StrategyParams {
        ...
        bool useCarpet;                     // Whether to use carpet strategy
    ...
    // Events
    // triggerIndex: 0=baseTickTrigger, 1=baseRatioTrigger, 2=limitTickTrigger, 3=limitRatioTrigger, 4=outOfPositionTrigger
    event AutomatedRebalanceExecuted(uint8 triggerIndex, bool isSwap);
    event AutomatedCompoundExecuted(
        uint256 outOfPositionRatio,
        uint256 outOfPositionRatioThreshold,
        address indexed mpm
    );
    event AutomatedWithdrawalExecuted(
        bool pool0Triggered,
        bool pool1Triggered,
        address indexed mpm
    );
    ...
    // View functions
    function getRebalanceParams() external view returns (
