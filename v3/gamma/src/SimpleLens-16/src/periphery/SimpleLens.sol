...
contract SimpleLens {
        ...
        )
    {
        ...
        SimpleLensInMin.WithdrawPreviewResult memory result = SimpleLensInMin.previewWithdrawCustomInternal(
    ...
    function _generateCompleteSwapPreview(
        ...
        _calculateExpectedTotals(manager, preview);
    }
        ...
        )
    {
        ...
        // Scope 1: Calculate outMin
        {
            ...
            outMin = totalShares > 0
                ? SimpleLensInMin.getOutMinForShares(mpm, totalShares, maxSlippage)
                : new uint256[2][](0);
        }
        ...
        // Scope 2: Simulate deposit and rebalance
        {
            ...
            (inMin, expectedPositions) = SimpleLensLibrary.simulateDepositAndRebalance(
                mpm, currentTotal0 + amount0, currentTotal1 + amount1, rebalanceParams, maxSlippage
            );
        }
    }
}
