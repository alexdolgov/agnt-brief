...
contract SimpleLens {
    ...
    {
        // Validate params
        _validateRebalanceParams(manager, rebalanceParams);
    ...
    function _validateRebalanceParams(MultiPositionManager manager, IMultiPositionManager.RebalanceParams calldata params)
        private
        view
    {
