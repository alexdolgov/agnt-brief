...
contract SuperchainLBPStrategyFactory is ISuperchainLBPStrategyFactory {
        ...
        returns (IDistributionContract distributionContract)
    {
        ...
        // Scoped block to avoid stack too deep
        {
            ...
            bytes32 poolId = orderBookFactory.computePoolIdForVolatility(
                hookOwner,
                currency0,
                currency1,
            ...
            // Deploy hook immediately with pre-computed salt
            // This avoids expensive on-chain HookMiner.find() during migrate()
            orderBookFactory.deployVolatilityHookWithSalt(hookOwner, hookSalt);
