...
interface IMultiPositionFactory {
    ...
    // Strategy limit-position requirement
    function requiresLimitPosition(address strategy) external view returns (bool);
    function setRequiresLimitPosition(address strategy, bool required) external;
    ...
    event RequiresLimitPositionSet(address indexed strategy, bool required);
}
