...
contract TokenLaunchFactoryV3 is AccessControl {
    ...
    uint64 private constant MEDIUM_DURATION_HOURS = 2;
    uint64 private constant LONG_DURATION_HOURS = 4;
    ...
    function _computeAuctionStepCalc(uint64 durationBlocks) internal view returns (AuctionStepCalc memory calc) {
        uint64 mediumDurationThreshold = blocksPerHour * MEDIUM_DURATION_HOURS;
        uint64 longDurationThreshold = blocksPerHour * LONG_DURATION_HOURS;
