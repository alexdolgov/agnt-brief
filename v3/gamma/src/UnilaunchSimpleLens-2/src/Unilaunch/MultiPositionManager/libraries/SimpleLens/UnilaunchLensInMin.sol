...
import {UnilaunchLensRatioUtils} from "./UnilaunchLensRatioUtils.sol";

/**
 * @title UnilaunchLensInMin
 * @notice Library for calculating minimum amounts (slippage protection) for UnilaunchSimpleLens
 * @dev Adapted from SimpleLensInMin - removes withdrawal-related functions
 */
library UnilaunchLensInMin {
    ...
    function _getTotalAmountsForRebalance(UnilaunchMultiPositionManager manager, bool deductFees)
        private
        view
    ...
    function _calculateOutMinForRebalance(UnilaunchMultiPositionManager manager, uint256 maxSlippage)
        private
        view
    ...
    function simulateRebalance(
        ...
        preview.expectedPositions = new UnilaunchLensRatioUtils.PositionStats[](allRanges.length);
