...
- Chains: arbitrum, base, bsc, celo, chain-200, cronos, ethereum, kaia, linea, manta-pacific, mantle, metis, optimism, plasma, scroll, sei
...
No contract logic was present for Gate US in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
...
- [20442] Gate PoR Implementation — no match: The report is a security assessment of a proof-of-reserves implementation (PoRImplementation) but does not list any specific smart contracts, source files, or modules in scope. The repository is mentioned but no contract names are provided.
