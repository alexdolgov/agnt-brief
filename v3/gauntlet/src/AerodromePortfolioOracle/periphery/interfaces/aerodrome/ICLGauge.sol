...
import {IAerodromeNonFungiblePositionManager} from "./IAerodromeNonFungiblePositionManager.sol";
...
interface ICLGauge {
    ...
    function nft() external view returns (IAerodromeNonFungiblePositionManager);
