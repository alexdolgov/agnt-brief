...
interface IPool is IERC20 {
     ...
     */
    function maxDeposit(address receiver) external pure returns (uint256 maxDeposit);
     ...
     */
    function maxWithdraw(address owner) external pure returns (uint256 maxWithdraw);
     ...
     */
    function maxRedeem(address owner) external pure returns (uint256 maxRedeem);
