...
No contract logic was present for Goldsand by InshAllah in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [spearbit.pdf](https://github.com/inshallah-network/goldsand-v1/blob/master/audit/spearbit.pdf) | Spearbit | Audit | 2024-10 | aging | Direct | contract_name | no match | 0 | 0 | 0 | 2 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [13186] spearbit.pdf — no match: The report does not have a dedicated scope section, but the contracts Goldsand and WithdrawalVault are the only contracts mentioned in findings and context.
...
|---|---|---|---|---|---|
| spearbit.pdf | Goldsand | unmatched — not counted | — | listed in scope and findings | no |
| spearbit.pdf | WithdrawalVault | unmatched — not counted | — | listed in scope and findings | no |
