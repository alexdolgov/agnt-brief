...
contract Auction is OwnableUpgradeable, ReentrancyGuard, IERC721Receiver {
    ...
    uint256 constant MINIMUM_GAP = 10 ** 17; // 0.1 BNB TODO: 0.001 Testnet, 0.1 Mainnet
    uint256 constant MINIMUM_BIDDING_AMOUNT = 10 ** 18; // 1 BNB TODO: 0.01 Testnet, 1 Mainnet
