...
contract StrategyAutoLP is Ownable, ReentrancyGuard, Pausable {
    ...
    function _farm() internal returns (uint256){
        ...
        IERC20(pairAddress).safeIncreaseAllowance(autoChef, wantAmt);
    ...
    function wantTokenValue(uint256 wantAmount) public view returns (uint256) {
        ...
        uint256 total0 = wantAmount.mul(reserve0).div(totalSupply);
        uint256 total1 = wantAmount.mul(reserve1).div(totalSupply);
    ...
    //This does not include the PCS APY
