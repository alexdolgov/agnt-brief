...
- Outside the address book: 77 discovered implementations excluded (0 third-party/infra; 11 standard proxy/library)
- Proxy deployments represented within implementation groups: 12
- Deployed-live implementations: 1 of 78 unique (rest dead/inactive/uninitialized)
