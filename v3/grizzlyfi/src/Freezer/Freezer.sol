...
interface IFreezer {
    ...
    event Migrate(address participantAddress, uint256 round, uint256 amount);
    ...
    function getParticipant(
        address participantAddress,
        uint256 round
    ) external view returns (Participant memory participant);
    ...
    function getTimeperiod(
        uint256 index
    ) external view returns (TimePeriod memory timePeriod);
    ...
    function getPendingRewards(
        address freezerAddress,
        uint256 freezingRound
    )
        external
        returns (
...
// File contracts/Interfaces/IFreezerV2.sol

 
pragma solidity ^0.8.4;

interface IFreezerV2 {
    function freeze(address _for, uint256 _amount, address _referral) external;
}
    ...
    IFreezer
{
    ...
    // TODO: Add the Freezer V2 Address!
    address public constant FREEZER_V2 =
        0x770d42578a1B941de7Aef0B057cb8F437f0E3E69;
    uint256 public constant MIGRATE_START = 1678780800;
    ...
    function freeze(
        ...
        require(false, "No freezing allowed");
    ...
    function migrateToV2(
        ...
        require(participant.amount > 0, "No investment found");
        require(MIGRATE_START < block.timestamp, "Migration not started yet");
        ...
        IERC20Upgradeable(address(HoneyToken)).approve(
            FREEZER_V2,
            unfreezeAmount
        );
        IFreezerV2(FREEZER_V2).freeze(msg.sender, unfreezeAmount, address(0));
        emit Migrate(msg.sender, freezingRound, unfreezeAmount);
    }
