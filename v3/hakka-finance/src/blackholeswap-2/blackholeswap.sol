...
contract blackholeswap is ERC20Mintable {
    ...
    IERC20 constant public token0 = ERC20(0x55d398326f99059fF775485246999027B3197955); //USDT
    IERC20 constant public token1 = ERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD
    ...
    constructor() public {
        symbol = "BHS USDT/BUSD";
        name = "BlackHoleSwap USDT/BUSD";
        decimals = 18;
        admin = msg.sender;
        vault = msg.sender;
    }
