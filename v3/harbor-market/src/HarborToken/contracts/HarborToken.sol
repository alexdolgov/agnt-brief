...
contract HarborToken is Initializable, ERC20Upgradeable, ERC20CappedUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address admin) initializer public { 
        __ERC20_init("Harbor Token", "HBR");
        __ERC20Capped_init(MAX_SUPPLY); 
        __AccessControl_init(); 
        __Pausable_init();  
        __ERC20Permit_init("Harbor Token");   
