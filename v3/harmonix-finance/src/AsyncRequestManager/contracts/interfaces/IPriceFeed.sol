...
interface IPriceFeed {
    ...
    // -------------------------------------------------------------------------
    // Write Functions (PRICE_UPDATER_ROLE)
    // -------------------------------------------------------------------------

    /// @notice Set the denomination price for an asset.
    /// @param asset  ERC20 token address.
    /// @param price  Denomination units per 1 full token, 1e18 scale.
    ///               Example: USDC = 1e18, WETH = 2000e18.
