...
interface IFundVault {
    ...
    /// @notice Emitted when capital is allocated to a strategy.
    event Allocated(address indexed asset, address indexed strategy, uint256 amount);

    /// @notice Emitted when capital is deallocated from a strategy.
    event Deallocated(address indexed asset, address indexed strategy, uint256 amount);

    /// @notice Emitted when a strategy is whitelisted for an asset.
