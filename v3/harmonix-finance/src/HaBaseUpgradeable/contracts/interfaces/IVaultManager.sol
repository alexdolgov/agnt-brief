...
interface IVaultManager {
     ...
     * @dev Restricted to `CURATOR_ROLE`. Reads `navDenomination` and `effectiveSupply` stored
     ...
     * @dev Restricted to `CURATOR_ROLE`. Only accrues when the current PPS exceeds the stored
