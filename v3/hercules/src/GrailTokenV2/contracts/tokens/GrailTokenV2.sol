...
import "./interfaces/IGrailTokenV2.sol";
 ...
 */
contract GrailTokenV2 is Ownable, ERC20("Hercules Token", "TORCH"), IGrailTokenV2 {
  using SafeMath for uint256;

  uint256 public constant MAX_EMISSION_RATE = 1 ether;
  uint256 public constant MAX_SUPPLY_LIMIT = 20000000 ether;
  ...
  uint256 public farmingAllocation = 100; // = 100%
