...
abstract contract BorrowModule is CommonModule {
    ...
    function _borrowAmount() public view returns(uint256) {
        return AaveV3BorrowLibrary._borrowAmount(this);
    }

    function _borrowBound(bool isBalance) public view returns (int256) {
        return AaveV3BorrowLibrary._borrowBound(this, isBalance);
    }

    function _supply(uint256 delta) public {
        AaveV3BorrowLibrary._supply(this, delta);
    }

    function _withdraw(uint256 delta) public {
    ...
    function _borrow(uint256 delta) public {
        AaveV3BorrowLibrary._borrow(this, delta);
    }

    function _repay(uint256 delta) public {
