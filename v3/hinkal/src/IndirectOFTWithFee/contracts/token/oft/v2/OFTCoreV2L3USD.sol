...
abstract contract OFTCoreV2L3USD is NonblockingLzApp {
    ...
    ************************************************************************/
    function callOnOFTReceived(uint16 _srcChainId, bytes calldata _srcAddress, uint64 _nonce, bytes32 _from, address _to, uint _amount, bytes calldata _payload, uint _gasForCall) public virtual {
        ...
        // send
        _amount = _transferFromWithChainId(_srcChainId, address(this), _to, _amount);
    ...
    ************************************************************************/
    ...
    function _transferFromWithChainId(uint16 _srcChainId, address _from, address _to, uint _amount) internal virtual returns (uint);
