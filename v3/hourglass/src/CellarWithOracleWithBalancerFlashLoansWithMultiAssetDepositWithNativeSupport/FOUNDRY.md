# CellarWithOracleWithBalancerFlashLoansWithMultiAssetDepositWithNativeSupport — Foundry package
...
```sh
forge build --root "src/CellarWithOracleWithBalancerFlashLoansWithMultiAssetDepositWithNativeSupport"
```
