...
contract gOHMSimpleBondDepository is Policy {
    ...
    event BondCreated( uint deposit, uint indexed payout, uint indexed expires, uint indexed internalPrice );
    ...
    struct Bond {
        ...
        uint pricePaid; // In Internal Price, as no price feed yet. Front end viewing needs to adjust.
    }
