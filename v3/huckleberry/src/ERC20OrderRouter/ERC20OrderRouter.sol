...
// File contracts/interfaces/IPineCore.sol
...
contract ERC20OrderRouter {
    IPineCore public immutable pineCore;
    ...
    constructor(IPineCore _pineCore) {
        pineCore = _pineCore;
    }
    ...
    */
    ...
    function depositToken(
        ...
        bytes32 key =
            pineCore.keyOf(_module, _inputToken, _owner, _witness, _data);

        IERC20(_inputToken).transferFrom(
            msg.sender,
            pineCore.vaultOfOrder(
                _module,
                _inputToken,
                _owner,
                _witness,
