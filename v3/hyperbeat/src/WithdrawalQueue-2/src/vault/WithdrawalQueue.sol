...
contract WithdrawalQueue is Auth {
    ...
    event WithdrawalRequestCreated(bytes32 withdrawalRequestId, address user, uint256 amount, uint256 baseAssetAmount);
        ...
        returns (WithdrawalRequest memory)
    {
        ...
        withdrawalNonce++;
        emit WithdrawalRequestCreated(withdrawalRequestId, _user, _amount, baseAssetAmount);
