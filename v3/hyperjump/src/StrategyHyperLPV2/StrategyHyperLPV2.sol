...
// File: contracts/BIFI/interfaces/hyperjump/IThugswapRouter.sol
...
// File: contracts/BIFI/interfaces/hyperjump/IThugswapPair.sol
...
// File: contracts/BIFI/interfaces/hyperjump/IHyperCity.sol
...
// File: contracts/BIFI/strategies/HyperJump/StrategyHyperLP.sol
...
/**
 * @dev Implementation of a strategy to get yields from farming LP Pools in HyperSwap.
 * 
 * This strat is currently compatible with all LP pools.
 */
contract StrategyHyperLPV2 is Ownable, Pausable {
     ...
     * {hypr} - HyperBurn token, used to send funds to dao.
    ...
    /**
     * @dev Hyper Contracts:
     * {hyperdao} - Reward pool where the strategy fee earnings will go.
     ...
     * {HYPER_FEE} - 1.5% goes to the hyper dao.
    ...
    uint constant public HYPER_FEE    = 875;
     ...
     * @dev Function that puts the funds to work.
     * It gets called whenever someone deposits in the strategy's vault contract.
     * It deposits {lpPair} in the HyperPlanet to farm {ori}
     */
    ...
    function chargeFees() internal {
        uint256 toWbnb = IERC20(alloy).balanceOf(address(this)).mul(4).div(100);
