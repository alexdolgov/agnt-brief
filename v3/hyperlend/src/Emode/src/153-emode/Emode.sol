...
/**
 * @title Update Emode on HyperLend Core market
 * @author HyperLend
 */
contract Emode is AaveV3Payload {
    ...
    {
        IAaveV3ConfigEngine.EModeCategoryUpdate[] memory eModeUpdates = new IAaveV3ConfigEngine.EModeCategoryUpdate[](2);
