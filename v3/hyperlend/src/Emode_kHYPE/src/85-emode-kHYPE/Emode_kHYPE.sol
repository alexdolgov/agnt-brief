...
/**
 * @title Add kHYPE e-mode to HyperLend Core market
 * @author HyperLend
 */
contract Emode_kHYPE is AaveV3Payload {
    ...
    function priceFeedsUpdates() public view override returns (IAaveV3ConfigEngine.PriceFeedUpdate[] memory) {
        ...
        priceFeedsUpdate[0] = IAaveV3ConfigEngine.PriceFeedUpdate({
            asset: kHYPE, 
            priceFeed: 0xEd2c51a7019B67AcAdCd3978b38FB66fA0EC900f //chainlink kHYPE/USD
        });
    ...
    {
        IAaveV3ConfigEngine.AssetEModeUpdate[] memory assetEModeUpdates = new IAaveV3ConfigEngine.AssetEModeUpdate[](2);
