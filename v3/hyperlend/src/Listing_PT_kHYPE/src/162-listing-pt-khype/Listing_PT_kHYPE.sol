...
/**
 * @title Add PT-kHYPE-19MAR2026 to HyperLend Core market
 * @author HyperLend
 */
contract Listing_PT_kHYPE is AaveV3Payload {
    ...
    address public constant PT_kHYPE_19MAR2026 = 0xea84ca9849D9e76a78B91F221F84e9Ca065FC9f5;
    address public constant USR    = 0x0aD339d66BF4AeD5ce31c64Bc37B3244b6394A77;
    address public constant PT_kHYPE_24SEP2026 = 0x50fC4EDC6346F36993Bb30Fe60E932504Ed17391;

    /// @notice PT-kHYPE-24SEP2026 token
    address public constant TOKEN = 0x50fC4EDC6346F36993Bb30Fe60E932504Ed17391;
    /// @notice 0.1 PT-kHYPE-24SEP2026 token
    uint256 public constant SEED_AMOUNT = 1 * 1e18 / 10;
    /// @notice PendlePriceCapAdapter PT-kHYPE-24SEP2026/USD price feed adapter
    address public constant PRICE_FEED = 0x19f83C380F600F162514cCFec9bFebbaB1EA6795;
    ...
    function newListings() public pure override returns (IAaveV3ConfigEngine.Listing[] memory) {
        ...
        listings[0] = IAaveV3ConfigEngine.Listing({
            asset: TOKEN,
            assetSymbol: 'PT-kHYPE-24SEP2026',
        ...
        returns (IAaveV3ConfigEngine.AssetEModeUpdate[] memory)
    {
        ...
        //also add previous PT-kHYPE to make it easlier to roll positions
        assetEModeUpdates[2] = IAaveV3ConfigEngine.AssetEModeUpdate({
            asset: PT_kHYPE_19MAR2026,
            eModeCategory: 6,
            borrowable: EngineFlags.DISABLED,
            collateral: EngineFlags.ENABLED,
            ltvzero: EngineFlags.DISABLED
