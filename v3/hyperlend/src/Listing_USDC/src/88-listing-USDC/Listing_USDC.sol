...
/**
 * @title Add USDC to HyperLend Core market
 * @author HyperLend
 */
contract Listing_USDC is AaveV3Payload {
    ...
    /// @notice USDC token
    address public constant TOKEN = USDC;
    /// @notice 100 USDC token
    uint256 public constant SEED_AMOUNT = 100 * 1e6;
    /// @notice Chainlink USDC/USD price feed adapter
    address public constant PRICE_FEED = 0x4C7B17c8b4F3FF766889Aaf2ac5a6Db565FD61a9;
