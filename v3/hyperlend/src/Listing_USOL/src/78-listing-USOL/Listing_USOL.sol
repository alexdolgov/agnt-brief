...
/**
 * @title Add Unit Solana to HyperLend Core market
 * @author HyperLend
 */
contract Listing_USOL is AaveV3Payload {
    ...
    /// @notice Unit Solana token
    address public constant TOKEN = USOL;
    /// @notice 0.1 USOL token
    uint256 public constant SEED_AMOUNT = 1 * 1e9 / 10;
    /// @notice Chainlink USOL/USD price feed adapter
    address public constant PRICE_FEED = 0xb3D84379b1aaBAf81b294ffDb5E68a31F7f7CCe6;
