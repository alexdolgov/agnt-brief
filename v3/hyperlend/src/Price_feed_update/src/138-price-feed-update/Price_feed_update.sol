 ...
 * @author HyperLend
 */
contract Price_feed_update is AaveV3Payload {
    ...
    function priceFeedsUpdates() public view override returns (IAaveV3ConfigEngine.PriceFeedUpdate[] memory) {
        IAaveV3ConfigEngine.PriceFeedUpdate[] memory priceFeedsUpdate = new IAaveV3ConfigEngine.PriceFeedUpdate[](1);

        priceFeedsUpdate[0] = IAaveV3ConfigEngine.PriceFeedUpdate({
            asset: PT_kHYPE_19MAR2026, 
            priceFeed: 0xB805B04117F9cde6110B9E5Bd1cA79062754770d //Linear discount HYPE/USD redstone
        });
    ...
    {
        IAaveV3ConfigEngine.RateStrategyUpdate[] memory rateStrategies = new IAaveV3ConfigEngine.RateStrategyUpdate[](1);
