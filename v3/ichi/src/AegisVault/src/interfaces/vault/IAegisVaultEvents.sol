...
interface IAegisVaultEvents {
    ...
    /// @notice Emitted when the minimum deposit shares is updated
    /// @param sender The address that updated the minimum deposit shares
    /// @param newMinDepositAegisShares The new minimum deposit shares
    event SetMinDepositAegisShares(address indexed sender, uint256 newMinDepositAegisShares);
