...
- Outside the address book: 39 discovered implementations excluded (1 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 2
- Deployed-live implementations: 22 of 61 unique (rest dead/inactive/uninitialized)
