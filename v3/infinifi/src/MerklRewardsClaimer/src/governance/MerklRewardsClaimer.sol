...
contract MerklRewardsClaimer is CoreControlled {
    ...
    event EnabledRewardsUpdated(uint256 indexed timestamp, address indexed farm, address indexed rewardToken, address rewardContract);
    ...
    function setEnabledRewards(address _farm, address _rewardToken, address _rewardContract) external onlyCoreRole(CoreRoles.PROTOCOL_PARAMETERS) {
