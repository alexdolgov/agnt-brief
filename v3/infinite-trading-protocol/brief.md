...
The pinned logic-topography run contains 1 contract row(s) across base, optimism. Structural roles: 1 infra. No upgradeable pattern was identified in these rows.
...
- UnnamedContract (`0xb5db6e...77cefb`, chain 10)
- UnnamedContract (`0xba8cd8...ee3440`, chain 8453)
- ITP (`0x0a7b75...7bf7a0`, chain 10)
...
|---|---|---|---|---:|---|---|---|---|
| ITP | unknown | project_anchor | own_supporting | 0 | optimism | unit-387416 | `0x0a7b75...7bf7a0` | ⚠️ Unaudited |
...
| Contract Name | Role | Address-Book Class | Surface | Proxy Deployments | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---:|---|---|---|---|
| UnnamedContract | unknown | project_anchor | own_supporting | 0 | optimism | unit-387417 | `0xb5db6e...77cefb` | ❓ Unverified |
| UnnamedContract | unknown | project_anchor | own_supporting | 0 | base | unit-387418 | `0xba8cd8...ee3440` | ❓ Unverified |
...
|---|---|---|---|---:|---|
| optimism | `0x0a7b75...7bf7a0` | ITP | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
