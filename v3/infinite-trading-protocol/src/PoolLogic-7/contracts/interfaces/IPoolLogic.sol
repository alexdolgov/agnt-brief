...
interface IPoolLogic {
  struct ComplexAsset {
    ...
    bytes withdrawData; // shape depends on the asset's complex guard: ComplexAssetSwapData (Aave), DytmWithdrawLib.UnwindPlan (DYTM), or OndoGMTokenAssetGuard.OndoWithdrawData (Ondo GM, type 41)
