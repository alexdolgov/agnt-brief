...
The pinned logic-topography run contains 4 contract row(s) across base, mantle. Structural roles: 2 supporting, 1 core, 1 unclassified. 1 row(s) use upgradeable patterns.
...
| IntxToken | unknown | project_anchor | own_supporting | 1 | mantle | unit-242960 | `0x4b7f28...f5a877` | ⚠️ Unaudited |
...
| mantle | `0x4b7f28...f5a877` | IntxToken | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
