...
contract InterCrone is ERC20Permit, Ownable {

    constructor() ERC20("InterCrone", "ICR") ERC20Permit("InterCrone")
    {

    }

    uint256 constant private _maxTotalSupply = 210000000e18; // 210,000,000 max ircs
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s ) external {
        ...
        require(signatory != address(0), "ICR::delegateBySig: invalid signature");
        require(nonce == _useNonce(signatory), "ICR::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "ICR::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ICR::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ICR::_writeCheckpoint: block number exceeds 32 bits");
