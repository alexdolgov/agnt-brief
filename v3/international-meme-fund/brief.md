...
- Outside the address book: 7 discovered implementations excluded (4 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 0
- Deployed-live implementations: 15 of 27 unique (rest dead/inactive/uninitialized)
- All verified address-book-owned implementations audited (incl. non-live): 4/14
...
|---|---|---:|---:|---|
| Hashlock | Tier 2 | 4 | 28.6% | 2024-06 |
