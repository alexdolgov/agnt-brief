...
contract DollarOracle is Ownable, IOracle {
    ...
    function consult() external view override returns (uint256) {
        ...
        return (_priceBusdUsd * _priceDollarBusd) / PRICE_PRECISION;
    }

    function setOracleBusdUsd(address _oracleBusdUsd) external onlyOwner {
        oracleBusdUsd = _oracleBusdUsd;
    }

    function setOracleDollarBusd(address _oracleDollarBusd) external onlyOwner {
        oracleDollarBusd = _oracleDollarBusd;
    }
}
