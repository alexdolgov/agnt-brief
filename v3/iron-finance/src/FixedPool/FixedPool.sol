...
// File contracts/FixedPool.sol

pragma solidity 0.8.4;

contract FixedPool is Ownable, ReentrancyGuard, Initializable, IPool {
    ...
    function redeem(
        ...
        if (_share_price < 10) {
            _share_price = 10; // to be the same as right after the crash
        }
        ...
        require(
            _collateral_out_min <= _collateral_output_amount && _share_out_min <= _share_output_amount,
            ">slippage"
        );
