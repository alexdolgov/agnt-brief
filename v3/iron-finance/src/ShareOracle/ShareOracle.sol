...
contract ShareOracle is Ownable, IOracle {
    ...
    function consult() external view override returns (uint256) {
        ...
        return (_priceBnbUsd * _priceShareBnb) / PRICE_PRECISION;
    }
    ...
    function setChainlinkBnbUsd(address _chainlinkBnbUsd) external onlyOwner {
        chainlinkBnbUsd = _chainlinkBnbUsd;
    }

    function setOracleShareBnb(address _oracleShareBnb) external onlyOwner {
        oracleShareBnb = _oracleShareBnb;
    }
}
