...
- Outside the address book: 58 discovered implementations excluded (0 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 0
- Deployed-live implementations: 48 of 112 unique (rest dead/inactive/uninitialized)
