...
contract TheSplitoooor {
    ...
    constructor() {}
    IERC20 public immutable backingToken = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    function splitoooorSplit() public {
        uint256 balance = backingToken.balanceOf(address(this));
        //partner1
        ...
        //founder
        sendSplit(0xe411462E9f5B8389857af2B0A97f7A497965dEA2, backingToken.balanceOf(address(this)));
    }
    function sendSplit(address _address, uint256 amount) private {
        backingToken.transfer(_address,amount);
    }
