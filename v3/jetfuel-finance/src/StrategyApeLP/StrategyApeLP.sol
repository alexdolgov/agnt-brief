...
// File: contracts/JETFUEL/strategies/cookie/StrategyApeLP.sol
...
contract StrategyApeLP is Ownable, Pausable {
     ...
     * {fuel} - JetfuelFinance token, used to send funds to the treasury.
    ...
    address public constant output = address(
        0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95
    );
    address public constant fuel = address(
     ...
     */
    address public constant unirouter = address(
        0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F
    );
    address public constant aperouter = address(
        0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607
    );
    address public constant masterchef = address(
     ...
     */
    address public constant rewards = address(
