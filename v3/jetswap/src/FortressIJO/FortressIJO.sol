...
contract FortressIJO is ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function harvest() public nonReentrant {
        ...
        require(liquidityIsCreated, "Please wait till liquidity is created");
    ...
    function setLiquidityIsCreated(bool _liquidityIsCreated)
        public
        onlyAdmin
    {
