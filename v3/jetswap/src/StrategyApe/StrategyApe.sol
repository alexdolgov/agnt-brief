...
// File: contracts/JETFUEL/strategies/banana/StrategyApe.sol
...
contract StrategyApe is Ownable, Pausable {
     ...
     * {fuel} - BeefyFinance token, used to send funds to the JETS contract.
     */
    ...
    constructor(address _vault) public {
        ...
        IERC20(want).safeApprove(aperouter, uint256(-1));
    ...
    function chargeFees() internal {
        ...
        IUniswapRouter(aperouter).swapExactTokensForTokens(
            toWbnb,
            0,
            wantToWbnbRoute,
            address(this),
