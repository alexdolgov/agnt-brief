...
- Project: Jiko (`jiko`)
- Website: [https://app.jiko.finance/](https://app.jiko.finance/)
- Lifecycle: unknown
- Generated: 2026-07-15T18:30:00.000Z
- Pipeline run: brief-generation-scope-prod-20260715-v1
- Chains: berachain, chain-80084
- Contract surface: 2 unique implementations (2 raw deployments)
- Coverage basis: 0/1 confirmed own live verified implementations (0.0%); conservative 0.0% with 0 needs-review implementation(s)
- DeFi Llama TVL: $106,188.21
...
No contract logic was present for Jiko in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [Beraji-KO-Security-Review.pdf](https://github.com/shieldify-security/audits-portfolio/blob/main/reports/Beraji-KO-Security-Review.pdf) | unknown | Audit | 2025-02 | aging | Direct | contract_name | no match | 0 | 0 | 0 | 4 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [13308] Beraji-KO-Security-Review.pdf — no match: Scope section explicitly lists 4 contracts with file paths and SLOC counts.
...
|---|---|---|---|---|---|
| Beraji-KO-Security-Review.pdf | Token | unmatched — not counted | — | listed in scope table | no |
| Beraji-KO-Security-Review.pdf | StakingKo | unmatched — not counted | — | listed in scope table | no |
| Beraji-KO-Security-Review.pdf | NativeFee | unmatched — not counted | — | listed in scope table | no |
| Beraji-KO-Security-Review.pdf | IStakingKo | unmatched — not counted | — | listed in scope table | no |
...
- [13308] Beraji-KO-Security-Review.pdf
