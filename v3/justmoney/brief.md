...
- Project: JustMoney (`justmoney`)
- Website: [https://about.just.money](https://about.just.money)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for JustMoney. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
