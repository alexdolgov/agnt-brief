...
contract Deployments {
    ...
    address public constant ROLES_MODULE_IMPL = 0x14B3bD93d11A1F97c8e11940D02DaF5E52F66c47;
...
contract StrategyGovDeployerPlasma is Deployments {
    event SafesDeployed(
        address strategy, 
        address dao, 
        address proposer, 
    ...
    function deploySafeExceptProposer(DeploySafeParams calldata params) external {
        require(msg.sender == OWNER, "only owner");
