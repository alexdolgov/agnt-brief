...
// File: contracts/StrategyAddBaseTokenOnlyHelioStableLP.sol
...
contract StrategyAddBaseTokenOnlyHelioStableLP is Ownable, ReentrancyGuard, Strategy {
        ...
        nonReentrant
    {
        ...
        uint256[2] memory amounts = [fToken.myBalance(), baseToken.myBalance()];
        router.add_liquidity(amounts, 0);
        uint256 moreLPAmount = lpToken.balanceOf(address(this)).sub(beforeBalance);
        require(moreLPAmount >= minLPAmount, "insufficient LP tokens received");
        SafeToken.safeTransfer(lpToken, msg.sender, lpToken.balanceOf(address(this)));
    }
