...
// File: contracts/KalmarBondingStrategyBUSD.sol
...
contract KalmarBondingStrategyBUSD is ReentrancyGuard, Ownable, Pausable {
    using SafeMath for uint256;
    ...
    address public constant priceFeedBUSD = 0x91285f9808c0F15006cE4bBFf05AE3225cc1751d;
    address public constant kalmbusdLP = 0xb7890ab80570750564a810eF6F214f1893Feb602;
    ...
    function _stakingTokenPrice() internal view returns (uint256) {
      uint256 busdPrice = IPriceFeed(priceFeedBUSD).fetchPrice();
      return busdPrice;
    }
    ...
    function _kalmPrice() internal view returns (uint256) {
        ...
        // amount of
        uint256 busdPERkalm = ((1e18*res1)/Res0)/1e18;
        uint256 kalmPrice = (busdPERkalm*_stakingTokenPrice())/1e18;
    ...
    function _calculateBondPerToken(uint256 _amount) internal view returns (uint256) {
      ...
      uint256 amountBond = buyAmountUsd.mul(1e18).div(_bondPrice());
      return amountBond;
    }
