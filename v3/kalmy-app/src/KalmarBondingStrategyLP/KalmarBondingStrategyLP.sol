...
contract KalmarBondingStrategyLP is ReentrancyGuard, Ownable, Pausable {
    ...
    function _busdPrice() internal view returns (uint256) {
    ...
    function _kalmPrice() internal view returns (uint256) {
        ...
        uint256 kalmPrice = (busdPERkalm*_busdPrice())/1e18;
    ...
    function _getLpPrice() internal view returns(uint256)
    {
      ...
      uint256 totalBusdPrice = (Res1 * _busdPrice());
    ...
    function _calculateBondPerToken(uint256 _amount) internal view returns (uint256) {
      ...
      uint256 buyAmountUsd = _amount.mul(_getLpPrice()).div(1e18);
