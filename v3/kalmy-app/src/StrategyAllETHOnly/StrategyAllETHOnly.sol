...
// File: contracts/StrategyAddETHOnlyWombat.sol
...
contract StrategyAllETHOnly is Ownable, ReentrancyGuard, Strategy {
        ...
        nonReentrant
    {
        ...
        (address fToken, uint256 minLPAmount, address fLpToken) = abi.decode(data, (address, uint256, address));
        ...
        path[0] = weth;
        path[1] = fToken;
        router.swapExactETHForTokens.value(balance)(0, path, address(this), now);
