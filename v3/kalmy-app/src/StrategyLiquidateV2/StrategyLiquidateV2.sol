...
// File: contracts/StrategyLiquidateV2.sol
...
contract StrategyLiquidateV2 is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(IUniswapV2Router02 _router, ISwap _swap) public {
