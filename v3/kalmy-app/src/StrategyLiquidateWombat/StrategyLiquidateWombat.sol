...
contract StrategyLiquidateWombat is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(ISwap _swap, IWombatRouter _wombatRouter) public {
        swap = _swap;
        ...
        nonReentrant
    {
        ...
        (address baseToken, address fToken, uint256 minBaseToken, address lpToken) = abi.decode(data, (address, address, uint256, address));
