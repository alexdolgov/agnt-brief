...
// File: contracts/StrategyWithdrawMinimizeTradingWault.sol
...
contract StrategyWithdrawMinimizeTradingWault is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(IWaultSwapRouter02 _router) public {
