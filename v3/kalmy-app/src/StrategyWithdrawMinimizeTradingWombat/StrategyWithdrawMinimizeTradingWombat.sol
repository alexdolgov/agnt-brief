...
// File: contracts/StrategyWithdrawMinimizeTradingWombat.sol
...
contract StrategyWithdrawMinimizeTradingWombat is Ownable, ReentrancyGuard, Strategy {
    ...
    function execute(address user, uint256 debt, bytes calldata data) external payable nonReentrant {
        ...
        (address baseToken, address fToken, uint256 minFToken, address lpToken) = abi.decode(data, (address, address, uint256, address));
