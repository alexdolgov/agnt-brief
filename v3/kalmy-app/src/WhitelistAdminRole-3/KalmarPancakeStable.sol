...
// File: contracts/interfaces/IPanckeStable.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.5.17;

interface IPanckeStable {
...
// File: contracts/routes/KalmarPancakeStable.sol
...
contract KalmarPancakeStable is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    IPanckeStable public constant pancakePool = IPanckeStable(0x49079D07ef47449aF808A4f36c2a8dEC975594eC);
    IERC20 public constant hay = IERC20(0x0782b6d8c4551B9760e74c0545a9bCD90bdc41E5); // 0
        ...
        returns(uint256 _destAmount)
    {
        ...
        _src.safeApprove(address(pancakePool), _srcAmount);
        pancakePool.exchange(i, j, _srcAmount, 0);
        ...
        returns(uint256 _destAmount)
    {
        ...
        return pancakePool.get_dy(i, j, _srcAmount);
    }
