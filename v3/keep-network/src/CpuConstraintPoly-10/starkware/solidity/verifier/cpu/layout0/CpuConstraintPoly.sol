    ...
    fallback() external {
        ...
        assembly {
...

            {
              ...
              {
              // Constraint expression for cpu/operands/res: (1 - cpu__decode__opcode_range_check__bit_9) * column21_row12 - (cpu__decode__opcode_range_check__bit_5 * (column19_row5 + column19_row13) + cpu__decode__opcode_range_check__bit_6 * column21_row4 + cpu__decode__flag_res_op1_0 * column19_row13).
              let val := addmod(
                mulmod(
                  addmod(
                    1,
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/tmp0: column21_row2 - cpu__decode__opcode_range_check__bit_9 * column19_row9.
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_positive: (column21_row10 - cpu__decode__opcode_range_check__bit_9) * (column19_row16 - npc_reg_0).
              let val := mulmod(
                addmod(
                  /*column21_row10*/ mload(0x1800),
                  sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x1e20)),
              ...
              {
              // Constraint expression for cpu/update_registers/update_ap/ap_update: column21_row16 - (column21_row0 + cpu__decode__opcode_range_check__bit_10 * column21_row12 + cpu__decode__opcode_range_check__bit_11 + cpu__decode__opcode_range_check__bit_12 * 2).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_fp/fp_update: column21_row24 - (cpu__decode__fp_update_regular_0 * column21_row8 + cpu__decode__opcode_range_check__bit_13 * column19_row9 + cpu__decode__opcode_range_check__bit_12 * (column21_row0 + 2)).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/call/push_fp: cpu__decode__opcode_range_check__bit_12 * (column19_row9 - column21_row8).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x1ec0),
              ...
              {
              // Constraint expression for cpu/opcodes/call/off0: cpu__decode__opcode_range_check__bit_12 * (column0_row0 - half_offset_size).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x1ec0),
              ...
              {
              // Constraint expression for cpu/opcodes/call/off1: cpu__decode__opcode_range_check__bit_12 * (column0_row8 - (half_offset_size + 1)).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x1ec0),
                addmod(
                  /*column0_row8*/ mload(0x480),
              ...
              {
              // Constraint expression for cpu/opcodes/ret/off0: cpu__decode__opcode_range_check__bit_13 * (column0_row0 + 2 - half_offset_size).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x1ee0),
                addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/ret/off2: cpu__decode__opcode_range_check__bit_13 * (column0_row4 + 1 - half_offset_size).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_13*/ mload(0x1ee0),
                addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/assert_eq/assert_eq: cpu__decode__opcode_range_check__bit_14 * (column19_row9 - column21_row12).
              let val := mulmod(
              ...
              {
              // Constraint expression for range_check16/perm/init0: (range_check16/perm/interaction_elm - column2_row0) * column23_inter1_row0 + column0_row0 - range_check16/perm/interaction_elm.
              let val := addmod(
                addmod(
                  mulmod(
                    addmod(
              ...
              {
              // Constraint expression for range_check16/perm/step0: (range_check16/perm/interaction_elm - column2_row1) * column23_inter1_row1 - (range_check16/perm/interaction_elm - column0_row1) * column23_inter1_row0.
              let val := addmod(
                mulmod(
                  addmod(
                    /*range_check16/perm/interaction_elm*/ mload(0x1c0),
              ...
              {
              // Constraint expression for range_check16/perm/last: column23_inter1_row0 - range_check16/perm/public_memory_prod.
              let val := addmod(
                /*column23_inter1_row0*/ mload(0x1cc0),
              ...
              {
              // Constraint expression for range_check16/minimum: column2_row0 - range_check_min.
              let val := addmod(/*column2_row0*/ mload(0x7a0), sub(PRIME, /*range_check_min*/ mload(0x200)), PRIME)
              ...
              {
              // Constraint expression for range_check16/maximum: column2_row0 - range_check_max.
              let val := addmod(/*column2_row0*/ mload(0x7a0), sub(PRIME, /*range_check_max*/ mload(0x220)), PRIME)
              ...
              {
              // Constraint expression for range_check_builtin/value: range_check_builtin__value7_0 - column19_row103.
              let val := addmod(
                /*intermediate_value/range_check_builtin/value7_0*/ mload(0x21e0),
              ...
              {
              // Constraint expression for range_check_builtin/addr_step: column19_row230 - (column19_row102 + 1).
              let val := addmod(
              ...
              {
              // Constraint expression for range_check_builtin/init_addr: column19_row102 - initial_range_check_addr.
              let val := addmod(
