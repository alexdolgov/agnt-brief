    ...
    fallback() external {
        ...
        assembly {
...

            {
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value2_0*/ mload(0x2820),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value3_0*/ mload(0x2840),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value4_0*/ mload(0x2860),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value5_0*/ mload(0x2880),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check_builtin/value6_0*/ mload(0x28a0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2420),
                  /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2420),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_0*/ mload(0x2420)),
                PRIME)
              ...
              {
              // Constraint expression for cpu/operands/mem_dst_addr: column17_row8 + half_offset_size - (cpu__decode__opcode_range_check__bit_0 * column19_row11 + (1 - cpu__decode__opcode_range_check__bit_0) * column19_row3 + column19_row0).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/operands/mem0_addr: column17_row4 + half_offset_size - (cpu__decode__opcode_range_check__bit_1 * column19_row11 + (1 - cpu__decode__opcode_range_check__bit_1) * column19_row3 + column19_row8).
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_range_check/bit_1*/ mload(0x2600),
                        /*column19_row11*/ mload(0x18a0),
                        PRIME),
                      mulmod(
                        addmod(
                          1,
                          sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_1*/ mload(0x2600)),
                          PRIME),
                        /*column19_row3*/ mload(0x17c0),
                        PRIME),
                      PRIME),
              ...
              {
              // Constraint expression for cpu/operands/mem1_addr: column17_row12 + half_offset_size - (cpu__decode__opcode_range_check__bit_2 * column17_row0 + cpu__decode__opcode_range_check__bit_4 * column19_row3 + cpu__decode__opcode_range_check__bit_3 * column19_row11 + cpu__decode__flag_op1_base_op0_0 * column17_row5 + column19_row4).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/operands/res: (1 - cpu__decode__opcode_range_check__bit_9) * column19_row15 - (cpu__decode__opcode_range_check__bit_5 * (column17_row5 + column17_row13) + cpu__decode__opcode_range_check__bit_6 * column19_row7 + cpu__decode__flag_res_op1_0 * column17_row13).
              let val := addmod(
                mulmod(
                  addmod(
                    1,
                    sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2500)),
                    PRIME),
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/tmp0: column20_row0 - cpu__decode__opcode_range_check__bit_9 * column17_row9.
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_negative: (1 - cpu__decode__opcode_range_check__bit_9) * column17_row16 + column20_row0 * (column17_row16 - (column17_row0 + column17_row13)) - (cpu__decode__flag_pc_update_regular_0 * npc_reg_0 + cpu__decode__opcode_range_check__bit_7 * column19_row15 + cpu__decode__opcode_range_check__bit_8 * (column17_row0 + column19_row15)).
              let val := addmod(
                addmod(
                  mulmod(
                    addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_positive: (column20_row8 - cpu__decode__opcode_range_check__bit_9) * (column17_row16 - npc_reg_0).
              let val := mulmod(
                addmod(
                  /*column20_row8*/ mload(0x1ec0),
                  sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x2500)),
              ...
              {
              // Constraint expression for cpu/update_registers/update_ap/ap_update: column19_row19 - (column19_row3 + cpu__decode__opcode_range_check__bit_10 * column19_row15 + cpu__decode__opcode_range_check__bit_11 + cpu__decode__opcode_range_check__bit_12 * 2).
              let val := addmod(
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column19_row3*/ mload(0x17c0),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_range_check/bit_10*/ mload(0x2640),
                          /*column19_row15*/ mload(0x1900),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_11*/ mload(0x2660),
                      PRIME),
                    mulmod(/*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x25a0), 2, PRIME),
                    PRIME)),
                PRIME)
              ...
              {
              // Constraint expression for cpu/update_registers/update_fp/fp_update: column19_row27 - (cpu__decode__fp_update_regular_0 * column19_row11 + cpu__decode__opcode_range_check__bit_13 * column17_row9 + cpu__decode__opcode_range_check__bit_12 * (column19_row3 + 2)).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/call/push_fp: cpu__decode__opcode_range_check__bit_12 * (column17_row9 - column19_row11).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x25a0),
                addmod(
                  /*column17_row9*/ mload(0x1280),
              ...
              {
              // Constraint expression for cpu/opcodes/assert_eq/assert_eq: cpu__decode__opcode_range_check__bit_14 * (column17_row9 - column19_row15).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_14*/ mload(0x2680),
                addmod(
                  /*column17_row9*/ mload(0x1280),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check16/diff_0*/ mload(0x26c0),
                  /*intermediate_value/range_check16/diff_0*/ mload(0x26c0),
                  PRIME),
                sub(PRIME, /*intermediate_value/range_check16/diff_0*/ mload(0x26c0)),
                PRIME)
              ...
              let val := addmod(
                /*intermediate_value/range_check_builtin/value7_0*/ mload(0x28c0),
