    ...
    fallback() external {
        ...
        assembly {
...

            {
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_negative: (1 - cpu__decode__opcode_range_check__bit_9) * column5_row16 + column7_row3 * (column5_row16 - (column5_row0 + column5_row13)) - (cpu__decode__flag_pc_update_regular_0 * npc_reg_0 + cpu__decode__opcode_range_check__bit_7 * column7_row13 + cpu__decode__opcode_range_check__bit_8 * (column5_row0 + column7_row13)).
              let val := addmod(
                addmod(
                  mulmod(
                    addmod(
              ...
              {
              // Constraint expression for cpu/update_registers/update_pc/pc_cond_positive: (column7_row11 - cpu__decode__opcode_range_check__bit_9) * (column5_row16 - npc_reg_0).
              let val := mulmod(
                addmod(
                  /*column7_row11*/ mload(0xda0),
                  sub(PRIME, /*intermediate_value/cpu/decode/opcode_range_check/bit_9*/ mload(0x1500)),
              ...
              {
              // Constraint expression for cpu/update_registers/update_ap/ap_update: column7_row17 - (column7_row1 + cpu__decode__opcode_range_check__bit_10 * column7_row13 + cpu__decode__opcode_range_check__bit_11 + cpu__decode__opcode_range_check__bit_12 * 2).
              let val := addmod(
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column7_row1*/ mload(0xc80),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_range_check/bit_10*/ mload(0x1640),
                          /*column7_row13*/ mload(0xde0),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_range_check/bit_11*/ mload(0x1660),
                      PRIME),
                    mulmod(/*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x15a0), 2, PRIME),
                    PRIME)),
                PRIME)
              ...
              {
              // Constraint expression for cpu/update_registers/update_fp/fp_update: column7_row25 - (cpu__decode__fp_update_regular_0 * column7_row9 + cpu__decode__opcode_range_check__bit_13 * column5_row9 + cpu__decode__opcode_range_check__bit_12 * (column7_row1 + 2)).
              let val := addmod(
              ...
              {
              // Constraint expression for cpu/opcodes/call/push_fp: cpu__decode__opcode_range_check__bit_12 * (column5_row9 - column7_row9).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_12*/ mload(0x15a0),
              ...
              {
              // Constraint expression for cpu/opcodes/assert_eq/assert_eq: cpu__decode__opcode_range_check__bit_14 * (column5_row9 - column7_row13).
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_range_check/bit_14*/ mload(0x1680),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/range_check16/diff_0*/ mload(0x16c0),
                  /*intermediate_value/range_check16/diff_0*/ mload(0x16c0),
                  PRIME),
                sub(PRIME, /*intermediate_value/range_check16/diff_0*/ mload(0x16c0)),
                PRIME)
              ...
              let val := addmod(/*column7_row2*/ mload(0xca0), sub(PRIME, /*range_check_min*/ mload(0x200)), PRIME)
              ...
              let val := addmod(/*column7_row2*/ mload(0xca0), sub(PRIME, /*range_check_max*/ mload(0x220)), PRIME)
              ...
              let val := addmod(
                /*intermediate_value/range_check_builtin/value7_0*/ mload(0x1800),
