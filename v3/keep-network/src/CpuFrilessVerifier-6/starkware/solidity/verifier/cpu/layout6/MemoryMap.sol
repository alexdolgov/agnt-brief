...
contract MemoryMap {
    ...
    */
    ...
    uint256 constant internal MM_RANGE_CHECK16__PERM__INTERACTION_ELM =    0x150;
    uint256 constant internal MM_RANGE_CHECK16__PERM__PUBLIC_MEMORY_PROD = 0x151;
    uint256 constant internal MM_RANGE_CHECK_MIN =                         0x152;
    uint256 constant internal MM_RANGE_CHECK_MAX =                         0x153;
    ...
    uint256 constant internal MM_INITIAL_RANGE_CHECK_ADDR =                0x15d;
    ...
    uint256 constant internal MM_OODS_VALUES =                             0x170; // uint256[271]
    uint256 constant internal MM_CONSTRAINT_POLY_ARGS_END =                0x27f;
    uint256 constant internal MM_COMPOSITION_OODS_VALUES =                 0x27f; // uint256[2]
    uint256 constant internal MM_OODS_EVAL_POINTS =                        0x281; // uint256[48]
    uint256 constant internal MM_OODS_ALPHA =                              0x2b1;
    uint256 constant internal MM_TRACE_QUERY_RESPONSES =                   0x2b2; // uint256[480]
    uint256 constant internal MM_COMPOSITION_QUERY_RESPONSES =             0x492; // uint256[96]
    uint256 constant internal MM_LOG_N_STEPS =                             0x4f2;
    uint256 constant internal MM_N_PUBLIC_MEM_ENTRIES =                    0x4f3;
    uint256 constant internal MM_N_PUBLIC_MEM_PAGES =                      0x4f4;
    uint256 constant internal MM_CONTEXT_SIZE =                            0x4f5;
}
