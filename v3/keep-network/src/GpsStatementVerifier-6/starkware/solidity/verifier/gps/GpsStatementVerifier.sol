...
import "starkware/solidity/verifier/cpu/CairoBootloaderProgram.sol";
import "starkware/solidity/verifier/cpu/CairoVerifierContract.sol";
import "starkware/solidity/verifier/cpu/MemoryPageFactRegistry.sol";
import "starkware/solidity/interfaces/Identity.sol";
import "starkware/solidity/verifier/PrimeFieldElement0.sol";
import "starkware/solidity/verifier/gps/GpsOutputParser.sol";
    ...
    PrimeFieldElement0
{
    ...
    */
    ...
    function identify() external pure override returns (string memory) {
        return "StarkWare_GpsStatementVerifier_2025_12";
    }
