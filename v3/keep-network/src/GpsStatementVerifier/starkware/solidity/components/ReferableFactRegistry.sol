...
contract ReferableFactRegistry is FactRegistry {
    ...
    constructor(address refFactRegistry, uint256 referralDurationSeconds) public {
        ...
        if (refFactRegistry != address(0)) {
            setReferenceFactRegistry(refFactRegistry, referralDurationSeconds);
        }
    }

    function setReferenceFactRegistry(address refFactRegistry, uint256 referralDurationSeconds)
        internal
    {
