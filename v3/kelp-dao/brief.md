...
- Outside the address book: 0 discovered implementations excluded (19 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 0
- Deployed-live implementations: 31 of 73 unique (rest dead/inactive/uninitialized)
