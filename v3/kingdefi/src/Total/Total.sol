...
interface Tvl {
  ...
  function krwValue (  ) external view returns ( uint256 );
  function prezzoBNBBUSD (  ) external view returns ( uint256 );
  function prezzoLpToken (  ) external view returns ( uint256 );
...
contract Total{
    ...
    Tvl totalTT = Tvl(address(0xd4cB175a40A4E97228e314c86BAbA1Dce5A724C6));
    ...
    function TotalTvl() view public returns (uint256) {
        uint256 tt;
