...
contract SKlay is KIP13, IKIP7 {
    string public constant version = "0723";
    ...
    // ------ TOKEN INFO ------
    string private constant _name = "sKlay";
    string private constant _symbol = "SKLAY";
    ...
    function nextOwner(address _newOwner) public onlyOwner {
        newOwner = _newOwner;
    }

    function changeOwner() public onlyNewOwner {
        _owner = newOwner;
        newOwner = address(0);
    }
