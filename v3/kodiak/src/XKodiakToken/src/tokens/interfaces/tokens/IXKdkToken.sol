...
interface IXKdkToken is IERC20 {
    ...
    function isTransferWhitelistedFrom(address account) external view returns (bool);
    function isTransferWhitelistedTo(address account) external view returns (bool);
    ...
    function updateTransferWhitelistFrom(address account, bool value) external;
    function updateTransferWhitelistTo(address account, bool value) external;
}