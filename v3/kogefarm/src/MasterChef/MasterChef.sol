...
// File contracts/interfaces/IMasterChefFund.sol
...
contract MasterChef is Ownable {
    ...
    constructor(
        ...
        masterChefFund = _masterChefFund;
    }
    ...
    function setMasterChefFund(address _masterChefFund) external onlyOwner {
        require(_masterChefFund != address(0), "Invalid zero address");
        masterChefFund = _masterChefFund;
    }
    ...
    function safeRewardTransfer(address _to, uint256 _amount) internal {
        IMasterChefFund(masterChefFund).transferTo(_to, _amount);
    }
