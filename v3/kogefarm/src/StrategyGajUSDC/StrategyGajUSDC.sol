...
abstract contract StrategyGajBase is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_gajBalance > harvestCutoff){
            if (_gajBalance > 0) {
                _swapUniswapWithPath(usdc_gaj_path, _gajBalance.div(2));
            }
            ...
            if (_want > 0) {
                ...
                // DZ Change: Added if performanceFee>0 condition
                if (performanceFee>0) {
...
contract StrategyGajUSDC is StrategyGajBase {
    ...
    address public Gaj_USDC_LP = 0x99dADf889520b9cEBD9959d3ca1866DC2517Ea1d;
