...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x13748d548D95D78a3c83fe3F32604B4796CFfa23;
    ...
    // Not relevant for Koge but might be relevant for other implementations
    ...
    function set_harvestCutoff(uint256 newCutoff) external onlyOwner() {
        require(newCutoff <= 10**18, "New cutoff must be less than 1 Koge");
...
contract StrategySingle is StrategyFarmSingle {
    ...
    address public Want_Token = 0x13748d548D95D78a3c83fe3F32604B4796CFfa23;
