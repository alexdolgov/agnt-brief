...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x6bb45cEAC714c52342Ef73ec663479da35934bf7;
    ...
    address public constant target = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;

    address[] public bone_target_path;
    ...
    {
        bone_target_path = new address[](3);
        bone_target_path[0] = bone;
        bone_target_path[1] = matic;
        bone_target_path[2] = target;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            if (rewardToken != want) {
                _swapUniswapWithPath(bone_target_path, _harvestBalance);
            }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public Bone_MASTER_CHEF = 0x9DcB2D5e7b5212fAF98e4a152827fd76bD55f68b;
