...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getDividends(address dividendContract) public onlyOwner {
        IDividend(dividendContract).collectDividends();
    }
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x76e63a3E7Ba1e2E61D3DA86a87479f983dE89a7E;
    ...
    address public constant owen = rewardToken;
    address public constant usdc = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;

    address[] public usdc_owen_path;
    ...
    uint256 public harvestUSDCCutoff = 10;
    ...
    {
        usdc_owen_path = new address[](2);
        usdc_owen_path[0] = usdc;
        usdc_owen_path[1] = owen;
    }
    ...
    function set_harvestCutoff(uint256 newCutoff) external onlyOwner() {
        require(newCutoff <= 10**18, "New cutoff must be less than 1 owen");
        harvestCutoff = newCutoff;
    }

    function set_harvestUSDCCutoff(uint256 newCutoff) external onlyOwner() {
        require(newCutoff <= 10**6, "New cutoff must be less than 1 usdc");
        harvestUSDCCutoff = newCutoff;
    }
    ...
    function harvest() public override {
        ...
        if (_usdcBalance > harvestUSDCCutoff) {
            _swapUniswapWithPath(usdc_owen_path, _usdcBalance);
        }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public Augur_MASTER_CHEF = 0x6ad70613d14c34aa69E1604af91c39e0591a132e;
    address public Want_Token = 0x76e63a3E7Ba1e2E61D3DA86a87479f983dE89a7E;
