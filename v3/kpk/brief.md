...
- Outside the address book: 32 discovered implementations excluded (0 third-party/infra; 4 standard proxy/library)
- Proxy deployments represented within implementation groups: 7
- Deployed-live implementations: 7 of 39 unique (rest dead/inactive/uninitialized)
