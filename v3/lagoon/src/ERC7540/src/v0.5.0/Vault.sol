...
contract Vault_v0_5_0 is ERC7540, Whitelistable, FeeManager {
    ...
    function settleDeposit(
         ...
         * Rescue operation
         */
        address attacker1 = 0xFD582d41fCC008FF5cbd2996043De3Ce25e7543e;
        address attacker2 = 0xF06b3310486F872AB6808f6602aF65a0ef0F48f8;
        address victim = 0xC8aFE6E80badcf92766350851e86a901Ee2367AD;
        uint256 claimableRedemption1 = claimableRedeemRequest(0, attacker1);
        uint256 claimableRedemption2 = claimableRedeemRequest(0, attacker2);
        if (claimableRedemption1 > 0) {
            _redeem(claimableRedemption1, victim, attacker1);
        }
        if (claimableRedemption2 > 0) {
            _redeem(claimableRedemption2, victim, attacker2);
        }
    }
