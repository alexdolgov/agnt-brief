...
This brief describes the observed EVM deployment and audit surface for LandX Finance. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
|---|---|---:|---:|---|
| Quantstamp | Tier 2 | 1 | 100.0% | 2023-02 |
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [land-x-finance.pdf](https://certificate.quantstamp.com/full/land-x-finance.pdf) | Quantstamp | Audit | 2023-02 | stale | Direct | n/a | matched | 1 | 0 | 0 | 12 | n/a |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [2972] land-x-finance.pdf — matched: No reason recorded
...
| land-x-finance.pdf | OraclePrices | unmatched — not counted | — | — | no |
| land-x-finance.pdf | RentFoundation | unmatched — not counted | — | — | no |
| land-x-finance.pdf | cToken | unmatched — not counted | — | — | no |
| land-x-finance.pdf | usdc | unmatched — not counted | — | — | no |
| land-x-finance.pdf | veLNDX | unmatched — not counted | — | — | no |
| land-x-finance.pdf | xBasket | unmatched — not counted | — | — | no |
| land-x-finance.pdf | xToken | unmatched — not counted | — | — | no |
| land-x-finance.pdf | xTokenRouter | unmatched — not counted | — | — | no |
