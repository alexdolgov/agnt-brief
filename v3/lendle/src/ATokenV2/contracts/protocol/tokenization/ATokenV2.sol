  ...
  IAToken
{
  ...
  function mintToTreasury(uint256 amount, uint256 index) external override onlyLendingPool {
    ...
    if (treasury != address(0) && secondTreasury != address(0)) {
      // 50% of the interest is sent to the treasury
      uint256 amountTreasury = _amount.rayDiv(10).rayMul(5);
      // 50% of the interest is sent to the protocol revenue treasury
