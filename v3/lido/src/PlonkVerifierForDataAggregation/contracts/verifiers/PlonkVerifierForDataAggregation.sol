...
contract PlonkVerifierForDataAggregation {
  ...
  uint256 private constant VK_QL_COM_X = 6071571457349249003420910199254964260893262676919602655650916988112621733915;
  uint256 private constant VK_QL_COM_Y = 12021764680362148009901072802139342582429276044253130738565784469309924741251;
  ...
  uint256 private constant VK_QK_COM_X = 19578678961095215792051543326752670219540665265902730294527559551667224365996;
  uint256 private constant VK_QK_COM_Y = 9159267038139312552654502046559147957719441662677131346863515727263335888744;
  ...
  function Verify(bytes calldata proof, uint256[] calldata public_inputs) public view returns (bool success) {
    assembly {
      ...
      /// @param x x coordinate of a point on Bn254(?_p)
      /// @param y y coordinate of a point on Bn254(?_p)
      /// @param mPtr free memory
      ...
      /// @param src pointer to a point on Bn254(?_p)
      /// @param s scalar
      /// @param mPtr free memory
      ...
      /// @parma dst pointer storing the result
      /// @param src pointer to a point on Bn254(?_p) on calldata
      /// @param s scalar
      /// @param mPtr free memory
