...
contract WithdrawalFinalizer {
  ...
  IL1Bridge constant ERC20_BRIDGE = IL1Bridge(0x41527B2d03844dB6b0945f25702cB958b6d55989);
  ...
  function finalizeWithdrawals(RequestFinalizeWithdrawal[] calldata requests) external returns (Result[] memory) {
