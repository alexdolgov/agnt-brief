...
- Outside the address book: 30 discovered implementations excluded (0 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 1
- Deployed-live implementations: 9 of 39 unique (rest dead/inactive/uninitialized)
