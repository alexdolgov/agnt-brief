...
import {ERC1155} from '../utils/ERC1155/ERC1155.sol';
import {CTHelpers} from './CTHelpers.sol';

contract ConditionalTokens is ERC1155 {
  /// @dev Emitted upon the successful preparation of a condition.
  /// @param conditionId The condition's ID. This ID may be derived from the other three parameters vi`a ``keccak256(abi.encodePacked(oracle, questionId, outcomeSlotCount))``.
