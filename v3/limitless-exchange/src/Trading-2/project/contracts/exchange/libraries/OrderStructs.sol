...
struct Order {
    ...
    Side side;
    /// @notice Signature type used by the Order: EOA, LIMITLESS_SAFE, POLY_PROXY or ERC1271
...
// 0: ECDSA EIP712 signatures signed by EOAs
{
    ...
    LIMITLESS_SAFE,
    // 3: EIP712 signatures signed by smart contracts according to the ERC1271 standard
    ERC1271
}
