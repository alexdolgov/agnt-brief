...
pragma solidity =0.8.21 >=0.8.0 ^0.8.0 ^0.8.19 ^0.8.20;
...
// src/helper/LoopedHypeDepositor.sol
...
contract LoopedHypeDepositor is Auth {
    ...
    function _deposit(
        ...
        returns (uint256 shares)
    {
        bytes32 depositHash = keccak256(abi.encodePacked(block.chainid, address(this), depositNonce++));
