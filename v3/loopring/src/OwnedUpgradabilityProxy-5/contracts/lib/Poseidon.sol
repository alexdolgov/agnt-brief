...
library Poseidon {
    ...
    function mix(HashInputs4 memory i, uint q) internal pure {
        ...
        o.t3 = mulmod(
            i.t0,
            11128168843135959720130031095451763561052380159981718940182755860433840154182,
            q
        );
        o.t3 = addmod(
            o.t3,
            mulmod(
                i.t1,
                2953507793609469112222895633455544691298656192015062835263784675891831794974,
                q
            ),
            q
        );
    ...
    function hash_t5f6p52_internal(
        ...
        assembly {
            function mix(_t0, _t1, _t2, _t3, _t4, _q)
                -> nt0, nt1, nt2, nt3, nt4
            {
                nt0 := mulmod(
                    _t0,
                ...
                nt4 := mulmod(
                    _t0,
                    8336710468787894148066071988103915091676109272951895469087957569358494947747,
                    _q
                )
                nt4 := addmod(
                    nt4,
            ...
            function ark(_t0, _t1, _t2, _t3, _t4, _q, c)
                -> nt0, nt1, nt2, nt3, nt4
            {
                nt0 := addmod(_t0, c, _q)
                nt1 := addmod(_t1, c, _q)
            ...
            function sbox_full(_t0, _t1, _t2, _t3, _t4, _q)
                -> nt0, nt1, nt2, nt3, nt4
            {
