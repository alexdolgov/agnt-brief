...
contract DistributeFees is AutomationCompatibleInterface, Ownable2StepUpgradeable {
    ...
    // whether to check upkeep or not
    ...
    function setBypassUpkeep(bool _bypass) public onlyOwner {
    ...
    function performUpkeep(bytes calldata /*performData*/) external override {
        ...
        if(!bypassUpkeep && block.timestamp - lastCompletedAt <= 3 days && (_getWeekSection(block.timestamp) ==_getWeekSection(lastCompletedAt))) {
            revert("!checkUpkeep");
        }
