...
contract PairAPIV1 is Initializable {
    ...
    function getPairBribe(uint _amounts, uint _offset, address _pair) external pure returns(pairBribeEpoch[] memory _pairEpoch){
