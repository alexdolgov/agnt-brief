...
contract LizardStrategyETHStgV4 is Initializable {
    ...
    function withdraw(uint256 _amountETH) public nonReentrant {
        ...
        IERC20Burnable(lizardETH).burn(msg.sender, _amountETH); // burn after read totalSupply
        ...
        payable(msg.sender).transfer(Math.min(finalAmountETH, address(this).balance));
