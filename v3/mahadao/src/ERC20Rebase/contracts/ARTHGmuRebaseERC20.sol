...
contract ARTHGmuRebaseERC20 is ERC20RebasePermit, Ownable {
    ...
    constructor(
        ...
        address _gmuOracle,
        address _governance
    ) ERC20RebasePermit(_name) {
        symbol = _symbol;
        setGMUOracle(_gmuOracle);
        _transferOwnership(_governance); // transfer ownership to governance
    }
    ...
    function gonsDecimals() public view virtual override returns (uint256) {
     ...
     */
    function setGMUOracle(address _gmuOracle) public onlyOwner {
