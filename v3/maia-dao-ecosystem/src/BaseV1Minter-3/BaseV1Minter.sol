...
contract BaseV1Minter {
    ...
    uint internal constant tail_emission = 25;
    uint internal constant target_base = 100; // 98% per week target emission
    uint internal constant tail_base = 10000; // 0.25% per week target emission
    ...
    // calculates tail end (infinity) emissions as 0.25% of total supply
