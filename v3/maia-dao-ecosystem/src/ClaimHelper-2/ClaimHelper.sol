...
contract ClaimHelper {
    ...
    address[] private marathonHermesArray;
    ...
    constructor(FlywheelCore _flywheel, MarathonLocker _marathonLocker) {
        ...
        marathonHermesArray.push(0x42676c6E6B62C59dA35BCCaEf1f680237E081BB8);
        marathonHermesPerEpoch[currentEpoch] = ERC20MarathonHermes(0x42676c6E6B62C59dA35BCCaEf1f680237E081BB8);
        unchecked {
            currentEpoch++;
        }
        _newEpoch();
    ...
    function getMarathonHermesArray() external view returns (address[] memory) {
        return marathonHermesArray;
    }

    fallback() external {
        uint256[] memory epochs = abi.decode(Encoding.decodeCallData(msg.data, 2 + currentEpoch * 2), (uint256[]));
    ...
    */
    function _newEpoch() internal {
        ...
        if (_thisEpoch > epochStart) {
            ERC20MarathonHermes currentStrategy = marathonLocker.currentStrategy();

            marathonHermesPerEpoch[currentEpoch] = currentStrategy;
            marathonHermesArray.push(address(currentStrategy));
