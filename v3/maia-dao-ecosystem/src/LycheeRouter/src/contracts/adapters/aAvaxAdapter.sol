 ...
 * @notice wAVAX -> sAVAX
 **/
contract SAvaxAdapter is LycheeAdapter {
    using SafeERC20 for IERC20;

    address public constant SAVAX = 0x2b2C81e08f1Af8835a78Bb2A90AE924ACE0eA4bE;
    address public constant WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;

    constructor(uint256 _swapGasEstimate) LycheeAdapter("SAvaxAdapter", _swapGasEstimate) {
        _setAllowances();
    }
    ...
    function _swap(
        ...
        require(shares >= _amountOut, "LycheeAdapter: Amount-out too low");
