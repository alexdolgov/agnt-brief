...
contract MangroveCleanerV2 {
  ...
  constructor(
    ...
    _blastPoints.configurePointsOperator(blastPointsGovernor);
    _blastContract.configureClaimableGas();
    _blastContract.configureGovernor(_taker);
  }
