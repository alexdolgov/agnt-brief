...
- Outside the address book: 37 discovered implementations excluded (0 third-party/infra; 5 standard proxy/library)
- Proxy deployments represented within implementation groups: 14
- Deployed-live implementations: 23 of 60 unique (rest dead/inactive/uninitialized)
