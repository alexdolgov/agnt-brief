...
- Outside the address book: 84 discovered implementations excluded (6 third-party/infra; 2 standard proxy/library)
- Proxy deployments represented within implementation groups: 6
- Deployed-live implementations: 2 of 86 unique (rest dead/inactive/uninitialized)
