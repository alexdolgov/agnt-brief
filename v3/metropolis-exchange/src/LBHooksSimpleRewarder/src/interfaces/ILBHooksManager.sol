...
interface ILBHooksManager {
    ...
    error LBHooksManager__BlacklistedAddress();
    error LBHooksManager__UserNotBlacklisted();
    ...
    event BlacklistUpdated(address[] indexed users, bool isBlacklisted);
    ...
    function claimBlacklistedRewards(address rewarder, address user, uint256[] calldata ids) external;
