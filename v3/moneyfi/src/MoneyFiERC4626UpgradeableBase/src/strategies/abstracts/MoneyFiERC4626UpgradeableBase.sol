...
abstract contract MoneyFiERC4626UpgradeableBase is ERC20Upgradeable, IMoneyFiERC4626UpgradeableBase {
    ...
    function __MoneyFiERC4626UpgradeableBase_init(IERC20 asset_) internal onlyInitializing {
    ...
    function totalLiquidWhitelistPool() public view virtual returns (uint256 tvl) {
        tvl = totalAssets();
    }
        ...
        returns (uint256 shares)
    {
        ...
        afterWithdraw(accruedAssets, shares, externalCallData);
    }
