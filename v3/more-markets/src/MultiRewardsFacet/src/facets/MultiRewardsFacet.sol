...
import {IMultiRewardsFacet} from "../interfaces/facets/IMultiRewardsFacet.sol";
...
contract MultiRewardsFacet is IMultiRewardsFacet, BaseFacetInitializer {
        ...
        returns (bytes32)
    {
        return
            keccak256(
                "MoreVaults.storage.initializable.MultiRewardsFacet"
            );
    }
    ...
    function onFacetRemoval(bool isReplacing) external {
        ...
        MoreVaultsLib.removeFromFacetsForAccounting(
            ds,
            IMultiRewardsFacet.accountingMultiRewardsFacet.selector,
            isReplacing
        );
    ...
    function stake(address staking, uint256 amount) external {
        ...
        ds.lockedTokens[address(stakingToken)] += amount;
    }
