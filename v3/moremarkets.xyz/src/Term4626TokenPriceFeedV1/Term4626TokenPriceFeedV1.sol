...
// File contracts/v1/Term4626TokenPriceFeedV1.sol
...
contract Term4626TokenPriceFeedV1 is AggregatorV3Interface {
        ...
        )
    {
        ...
        uint256 refTokenDecimals = referenceToken4626.decimals();
        address asset = referenceToken4626.asset();
        uint8 assetDecimals = ERC20(asset).decimals();

        int256 price = (assetPrice *
            int256(
                referenceToken4626.convertToAssets(10 ** refTokenDecimals)
