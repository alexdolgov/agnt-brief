...
- Project: Muscadine (`muscadine`)
- Website: [https://muscadine.io](https://muscadine.io)
- Lifecycle: unknown
...
- DeFi Llama TVL: $405,351.14
- On-chain TVL (included contracts): n/a
- TVL by chain: n/a

## Project Description

This brief describes the observed EVM deployment and audit surface for Muscadine. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.

### Architecture

The pinned logic-topography run contains 4 contract row(s) across base. Structural roles: 4 core. No upgradeable pattern was identified in these rows.
...
- Detected standards: erc20 (4), erc20permit (4), erc4626 (4), multicall (4)
- Frameworks: none
