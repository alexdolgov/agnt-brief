...
import "../oracleV3/OracleTypes.sol";
...
interface IPool {
    ...
    event PairSwap(uint256 pairIndex, address tokenIn, uint256 usedAmountIn, address tokenOut, uint256 amountOut);
    ...
    function updateTradingConfig(uint256 _pairIndex, TradingConfig calldata _tradingConfig) external;

    function updateTradingFeeConfig(uint256 _pairIndex, TradingFeeConfig calldata _tradingFeeConfig) external;
}
