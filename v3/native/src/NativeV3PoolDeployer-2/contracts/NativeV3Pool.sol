...
contract NativeV3Pool is INativeV3Pool {
    ...
    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = INativeV3PoolDeployer(msg.sender).parameters();
    ...
    function mint(
        ...
        INativeV3MintCallback(msg.sender).nativeV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            INativeV3SwapCallback(msg.sender).nativeV3SwapCallback(amount0, amount1, data);
    ...
    function setFeeProtocol(uint32 feeProtocol0, uint32 feeProtocol1) external override lock onlyFactoryOwner {
        require(
            (feeProtocol0 == 0 || (feeProtocol0 >= 1000 && feeProtocol0 <= PROTOCOL_FEE_DENOMINATOR)) &&
                (feeProtocol1 == 0 || (feeProtocol1 >= 1000 && feeProtocol1 <= PROTOCOL_FEE_DENOMINATOR))
        );
