...
contract CreditVault is ICreditVault, EIP712, Ownable2Step, ReentrancyGuardTransient {
    ...
    function epochUpdate(
        AccruedFundingFee[] calldata accruedFees
    ) external {
    ...
    function setEpochUpdater(
        address _epochUpdater
    ) external onlyOwner {
    ...
    function setFeeWithdrawer(
        address payable _feeWithdrawer
    ) external onlyOwner {
