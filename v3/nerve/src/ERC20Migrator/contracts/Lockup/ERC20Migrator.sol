...
import "../NerveToken/NerveToken.sol";
...
contract ERC20Migrator {
    ...
    using SafeERC20 for NerveToken;

    /// @dev Address of the old token contract
    IERC20 private _legacyToken;

    /// @dev Address of the new token contract
    NerveToken private _newToken;
     ...
     */
    function beginMigration(NerveToken newToken_) public {
