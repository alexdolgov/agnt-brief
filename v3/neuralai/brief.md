...
This brief describes the observed EVM deployment and audit surface for NeuralAI. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [hacken.io/audits/neuralai](https://hacken.io/audits/neuralai) | Hacken | Audit | 2026-03 | fresh | Direct | n/a | no match | 0 | 0 | 0 | 0 | low |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [3114] hacken.io/audits/neuralai — no match: The page is a listing/overview of audits for NeuralAI, not a detailed audit report. It mentions a single audit with type 'Smart Contract Staking & Marketplace' completed on Jun 6, 2024, but does not list specific contract names or files in scope.
