    ...
    ReverseClaimer
{
    ...
    bytes32 private constant ETH_NODE =
        0xa7475e6ec8a112e8e66186c42ec2ae37848f36e7c4f8c768d0f45b6242a2123a;
    bytes32 private constant ETH_LABELHASH =
        0xd6c66cad06fe14fdb6ce9297d80d32f24d7428996d0045cbf90cc345c677ba16;
     ...
     * @param resolver The resolver address to set on the RNS registry (optional).
     * @param ownerControlledFuses Initial owner-controlled fuses to set
    ...
    /**
     * @notice Sets records for the name in the RNS Registry
    ...
    function _wrapETH2LD(
        ...
        bytes memory name = _addLabel(label, "\x04root\x00");
        names[node] = name;
