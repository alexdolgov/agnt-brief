...
import {IERC20 as bIERC20} from "@balancer-labs/v2-interfaces/contracts/solidity-utils/openzeppelin/IERC20.sol";
...
library ComposablePoolLib {
     ...
     */
    function dropBptFromTokens(bIERC20[] memory registeredTokens) internal pure returns (IERC20[] memory tokens) {
        assembly {
    ...
    //  * the original array variable so it cannot be accessed.
    //  */
    // function dropBpt(bIERC20[] memory registeredTokens, uint256[] memory registeredBalances)
    //     internal
    //     pure
