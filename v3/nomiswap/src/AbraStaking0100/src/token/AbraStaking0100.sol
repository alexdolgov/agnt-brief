...
contract AbraStaking0100 is ERC20VotesUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function stake(
        ...
        uint256 duration,
        address to
    ) external returns (uint lockupId) {
    ...
    /// @param amount ABRA to lockup in the stake
    /// @param duration in seconds for the stake
    function stake(uint256 amount, uint256 duration) external returns (uint lockupId) {
    ...
    function _stake(
        ...
        uint256 duration,
        address to
    ) internal returns (uint lockupId) {
        ...
        emit Stake(to, lockupId, amount, end, points);
    }
