 ...
 * @author Compound
 */
contract ComptrollerEmergencyWithdraw is ComptrollerV7Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getCompAddress() virtual public view returns (address) {
        // return 0xc00e94Cb662C3520282E6f5717214004A7f26888; // COMP (Ethereum)
        // return 0xac485391EB2d7D88253a7F1eF18C37f4242D1A24; // LSK (Lisk)
        return 0xe11F1D5EEE6BE945BeE3fa20dBF46FeBBC9F4A19; // NUSA (BSC)
    }

    event EmergencyWithdraw(address indexed token, address indexed to, uint256 amount);

    /**
     * @notice Emergency withdraw any ERC20 token stuck in the Comptroller proxy
    ...
    function emergencyWithdraw(address token, address to, uint256 amount) external {
        ...
        bool success = EIP20Interface(token).transfer(to, amount);
