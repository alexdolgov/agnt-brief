...
interface BSPTStakingV04Helpers {
    ...
    ReentrancyGuard
{
    ...
    function deposit(address property, uint256 amount) external nonReentrant {
        ...
        uint256 propertyValuation = BSPTStakingV04Helpers(_propertyRegistry)
        ...
        uint256 apy = BSPTStakingV04Helpers(_propertyRegistry).getPropertyAPY(
            property
        );
    ...
    function _withdraw(
        ...
        if (_rewardVesting != address(0)) {
            ...
            require(
                BSPTStakingV04Helpers(_rewardVesting).addVestingInfo(
                    property,
                    user,
                    reward
                ),
        ...
        require(
            _rewardToken.transfer(
                BSPTStakingV04Helpers(_dataProxy).getCPOfProperty(property),
                feeReward
            ),
    ...
    function sellBSPTToOceanPoint(address property) external nonReentrant {
        ...
        require(
            BSPTStakingV04Helpers(_oceanPoint).sellBSPT(
                property,
                user,
                stakedBSPT
            ),
