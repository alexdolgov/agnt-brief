...
contract AssetToken is BasePoolToken {
    ...
    constructor(string memory _url, uint256 _dueDate, string memory _email, address _erc20Token,
        string memory _name, string memory _symbol, uint8 _decimals, uint256 _supplyToMint, bool _fixedSupply, address _owner
...
contract Master {
    ...
    function addAsset(string memory _url, uint256 _dueDate, string memory _email, address _erc20Token,
        string memory _name, string memory _symbol, uint8 _decimals, uint256 _supplyToMint, bool _fixedSupply
    ) public returns (address newAsset) {
        AssetToken _assetToken = new
            AssetToken(_url, _dueDate, _email, _erc20Token, _name, _symbol, _decimals, _supplyToMint, _fixedSupply, msg.sender);
