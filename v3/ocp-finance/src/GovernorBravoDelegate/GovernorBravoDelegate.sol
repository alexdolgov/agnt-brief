...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    function _initiate(address governorAlpha) external {
        ...
        require(timelock.admin() != address(this), "GovernorBravo::_initiate: can only initiate once XXX");
        require(proposalCount == 0, "GovernorBravo::_initiate: can only initiate once XXX");
