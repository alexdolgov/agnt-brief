...
interface IStakingVault is IERC4626 {
    ...
    function getClaimableRequests(
        address account_
    ) external view returns (uint256[] memory requestIds, uint256[] memory assets);
    ...
    function getPendingRequests(
        address account_
    ) external view returns (uint256[] memory requestIds, uint256[] memory assets, uint256[] memory claimableAt);
