...
import './interfaces/IUpheavalV3Pool.sol';
...
import './interfaces/IUpheavalV3PoolDeployer.sol';
import './interfaces/IUpheavalV3Factory.sol';
import './interfaces/IERC20Minimal.sol';
import './interfaces/callback/IUpheavalV3MintCallback.sol';
import './interfaces/callback/IUpheavalV3SwapCallback.sol';
import './interfaces/callback/IUpheavalV3FlashCallback.sol';

import '@upheavalswap/v3-lm-pool/contracts/interfaces/IUpheavalV3LmPool.sol';

contract UpheavalV3Pool is IUpheavalV3Pool {
    ...
    /// @inheritdoc IUpheavalV3PoolImmutables
    ...
    /// @inheritdoc IUpheavalV3PoolState
    ...
    // liquidity mining
    IUpheavalV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IUpheavalV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IUpheavalV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IUpheavalV3PoolDerivedState
    ...
    /// @inheritdoc IUpheavalV3PoolActions
    ...
    function mint(
        ...
        IUpheavalV3MintCallback(msg.sender).pancakeV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IUpheavalV3SwapCallback(msg.sender).pancakeV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IUpheavalV3FlashCallback(msg.sender).pancakeV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IUpheavalV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IUpheavalV3LmPool(_lmPool);
