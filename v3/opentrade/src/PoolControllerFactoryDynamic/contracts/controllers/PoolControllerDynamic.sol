...
contract PoolControllerDynamic is IPoolControllerDynamic, BeaconImplementation {
  ...
  modifier onlyPoolAdminOrBorrower() {
    if (
      ...
      !IServiceConfigurationV5(serviceConfiguration).isBorrower(msg.sender)
    ) {
  ...
  ) public onlyExchangeRateType(IPoolDynamicExchangeRateType.Dynamic) onlyNotPaused onlyPoolAdminOrBorrower {
  ...
  ) public onlyNotPaused onlyPoolAdminOrBorrower onlyExchangeRateType(IPoolDynamicExchangeRateType.Linear) {
    if (_exchangeRate == 0) revert InvalidExchangeRate();
  ...
  function setExchangeRateCompounding(
    ...
    uint256 _interestRate
  ) public onlyNotPaused onlyPoolAdminOrBorrower onlyExchangeRateType(IPoolDynamicExchangeRateType.Compounding) {
    if (_exchangeRate == 0) revert InvalidExchangeRate();
  ...
  function setExchangeRateAtMaturity(
    ...
    uint256 _interestRate
  ) public onlyNotPaused onlyPoolAdminOrBorrower onlyExchangeRateType(IPoolDynamicExchangeRateType.Term) {
    if (_exchangeRate == 0) revert InvalidExchangeRate();
