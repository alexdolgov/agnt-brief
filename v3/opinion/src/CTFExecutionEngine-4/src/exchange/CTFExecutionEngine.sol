    ...
    Trading
{
    ...
    function matchOrders(
        ...
        // If token-specific minFee is set and > 0, use it; otherwise use global default minFee
        // This ensures registered tokens with minFee=0 still apply globalDefaultMinFee
