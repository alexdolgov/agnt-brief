...
- Outside the address book: 60 discovered implementations excluded (0 third-party/infra; 20 standard proxy/library)
- Proxy deployments represented within implementation groups: 28
- Deployed-live implementations: 5 of 65 unique (rest dead/inactive/uninitialized)
