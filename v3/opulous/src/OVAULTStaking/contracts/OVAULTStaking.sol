  ...
  UUPSUpgradeable
{
  ...
  function initialize(
    ...
    LPToken = OVAULT(_lpTokenAddress);
    exchangeRate = 1e18;
   ...
   */
  function StakeUSDC(bytes memory signature, StakeData calldata Data) public virtual nonReentrant {
  ...
  ) public virtual onlyOperationWallet {
   ...
   */
  function SendFundsToDitto(uint256 amount) public virtual onlyOperationWallet {
  ...
  function withdrawFunds(
    uint256 LPAmount
  ) public virtual nonReentrant onlyWithdrawContract returns (uint256 usdcAmount, uint256 rate) {
   ...
   */
  function currentUSDC() public view virtual returns (uint256) {
  ...
  function currentRate() public view returns (uint256) {
    return LPSupply > 0 ? (totalUSDC() * 1e18) / LPSupply : 1e18;
  }
  ...
  function LPToUsdc(uint256 LPNAmount) public view returns (uint256) {
    return (LPNAmount * exchangeRate) / 1e18;
  }
