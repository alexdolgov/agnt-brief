...
- Outside the address book: 56 discovered implementations excluded (27 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 0
- Deployed-live implementations: 9 of 68 unique (rest dead/inactive/uninitialized)
