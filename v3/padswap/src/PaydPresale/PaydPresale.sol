...
contract PaydPresale {
  ...
  constructor () public {
    presaleSize = SafeMath.mul(400000000000, multiplier);
    token = TOKEN(0x641055ec0937aA5e00553e9681C2A16B5cdACE3B);
    ceoAddress = msg.sender;
    buyLimit = SafeMath.mul(400000000000, multiplier); 
    bnbPrice = 1;
    tokenPrice = 1360544218;
  }
