...
import './interfaces/ILuciaDexStateMultiCall.sol';

contract LuciaDexStateMultiCall is ILuciaDexStateMultiCall {
    ...
    function _fillStateWithoutBitmapsAndTicks(
        ...
        ILuciaPool pool = _getPool(factory, tokenIn, tokenOut, fee);
    ...
    function _getPool(
        ...
        pool = ILuciaPool(factory.getPool(tokenIn, tokenOut, fee));
