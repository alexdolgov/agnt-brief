...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    bool public immutable pancakeProfileIsRequested;

    // Pancake Profile points threshold
    uint256 public immutable pancakeProfileThresholdPoints;
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        require(
            !pancakeProfileIsRequested || (active && numberUserPoints >= pancakeProfileThresholdPoints),
            "Deposit: User is not active his profile or get enough user points"
        );
