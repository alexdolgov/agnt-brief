...
contract WBNBOracle is Operator, IOracle {
    ...
    function setChainlinkWbnbUsd(address _chainlinkWbnbUsd) external onlyOperator {
        address oldChainlinkWbnbUsd = chainlinkWbnbUsd;
        chainlinkWbnbUsd = _chainlinkWbnbUsd;
        emit ChainlinkWbnbUsdChanged(oldChainlinkWbnbUsd, _chainlinkWbnbUsd);
    }

    event ChainlinkWbnbUsdChanged(address indexed oldChainlinkWbnbUsd, address indexed newChainlinkWbnbUsd);
}
