...
contract FixedRateNFT is ERC721, ReentrancyGuard, Multicall, BlastManager {
    ...
    /* Events */
    event Mint(address user, uint256 id, address fixedRateContract, uint256 lockedYield, uint256 maturityTimestamp);
    event Burn(address user, uint256 id, uint256 amount, uint256 yieldToUnlock, uint256 yieldToRelease);
