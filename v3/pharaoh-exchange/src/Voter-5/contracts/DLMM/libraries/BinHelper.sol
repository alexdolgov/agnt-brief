...
/// @title Liquidity Bin Bin Helper Library
///
...
library BinHelper {
    ...
    /// @param totalSupply The total supply of the liquidity bin
    ...
    /// @param totalSupply The total supply of the liquidity bin
    /// @return shares The share of the liquidity bin that the user will receive
    /// @return effectiveAmountsIn The encoded effective amounts of tokens that the user will add.
    /// This is the amount of tokens that the user will actually add to the liquidity bin,
    ...
    /// @param binReserves The reserves of the bin
    /// @param parameters The parameters of the liquidity bin
    /// @param binStep The step of the bin
    /// @param amountsIn The amounts of tokens to add
    /// @param totalSupply The total supply of the liquidity bin
    /// @param shares The share of the liquidity bin that the user will receive
