...
- Chains: arbitrum, avalanche, base, bsc, ethereum, fantom, linea, optimism, polygon, zksync-era
...
No contract logic was present for Phemex in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
