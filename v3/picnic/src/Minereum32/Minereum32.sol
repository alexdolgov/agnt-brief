...
contract Minereum32 {
	...
	constructor(address previousContract) public {
		...
		if(!transferMigration(0x9997AD4ba17Ba7f1c17EEc0A16467D01405100A6)) revert();		
		if(!transferMigration(0x86A4DEf3c4F538a08581233946285a08B28Ed89a)) revert();		
		if(!transferMigration(0x6B2D47C20f599b93363988996BB65CDCaE32aAA6)) revert();		
		if(!transferMigration(0x81bB023244B7179c1829566fd836963AafdD03C3)) revert();		
		if(!transferMigration(0x9d88C96093018C398e15ECa9E5e7E2550d5ABFfF)) revert();		
		if(!transferMigration(0xEBcCAD906C45b5Dd7003eE78dA5A6899Fa7Fa466)) revert();		
		...
		if(!transferMigration(0x422A12Ae55Bc9923970Ecb5C086a825fC97EC7A9)) revert();		
		if(!transferMigration(0x9C266A959C2eaa4c2982BcA46006e0d6f0D9a5d8)) revert();		
    }
