...
contract ROCKET is ERC20Detailed {
  ...
  string constant tokenName = "Future Coin";
  string constant tokenSymbol = "FRC";
  uint8  constant tokenDecimals = 14;
  uint256 _totalSupply;
  uint256 public basePercent = 100;
  address feeWallet =0xBB991b59DF9A08008C11F8b8dbb9dC9c0c5002d6 ;
 
  
  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    uint256 initSupply = 120000000*10**14;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    uint256 toFeeWallet = onePercent.mul(2);
    uint256 tokensToTransfer = value.sub( toFeeWallet);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    uint256 onePercent = findOnePercent(value);
    uint256 tokensToBurn = onePercent.mul(5);
    uint256 tokensToRedistribute = onePercent.mul(5);
    uint256 toFeeWallet = onePercent.mul(5);
