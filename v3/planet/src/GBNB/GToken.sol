...
abstract contract GToken is EIP20Interface, ExponentialNoError, TokenErrorReporter, ReentrancyGuard {
    ...
    */
    ...
    function accrueInterest() virtual public returns (uint) {
        ...
        (error, borrowRateMantissa) = interestRateModel.getBorrowRate(cashPrior, borrowsPrior, reservesPrior);
        require(error == 0, "borrowRatePerBlock: interestRateModel.borrowRate failed"); // semi-opaque
