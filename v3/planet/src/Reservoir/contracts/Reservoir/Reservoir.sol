...
contract Reservoir is Ownable {
  ...
  address public foundation = 0x57BfB12c447aa444754F5d1A14a27C1FedAC90eE;     
  address public treasury = 0xb1825a0BB4Bd2ac2C11846C3E8E0f80B90488F1C;       
  address public gammaTroller = 0x1e0C9D09F9995B95Ec4175aaA18b49f49f6165A3;     
  address public farmAddress = 0xB87F7016585510505478D1d160BDf76c1f41b53d; //to be updated
  address public farmV2 = 0x9EBce8B8d535247b2a0dfC0494Bc8aeEd7640cF9; 
  ...
  constructor(IERC20 token_) {
    ...
    gammaTrollerPercentage = 4000;
    farmPercentage = 0;
    farmV2Percentage = 4650;
    maxPercentage = 10000;
    percentageWithoutTreasuryAndFoundation = 8650;
    
    gammaDrippedPerBlock = 0;
  ...
  function drip() public returns (uint) {
    ...
    uint deltaDripFarm_       = farmDripRate * (blockNumber_ - lastDripBlock);


    uint totalDrip = deltaDripFoundation_ + deltaDripTreasury_ + deltaDripGammaTroller_ + deltaDripFarmV2_ + deltaDripFarm_;
    ...
    farmDripped         = farmDripped + deltaDripFarm_;
    ...
    token_.safeTransfer(farmAddress, deltaDripFarm_);
