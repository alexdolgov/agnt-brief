...
- Website: [https://powh.io/](https://powh.io/)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for PoWH3D. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
|---|---|---|---|---:|---|---|---|---|
| Hourglass | unknown | retained_scope_excluded_inventory | address_book_excluded_inventory (excluded) | 0 | ethereum | unit-251775 | `0xb3775fb83f7d12a36e0475abdd1fca35c091efbe` | ⚠️ Unaudited |
