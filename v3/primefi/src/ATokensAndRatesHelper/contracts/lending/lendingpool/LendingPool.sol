...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
	...
	function depositWithAutoDLP(
		...
		looper.flikWETHWithBorrow(looper.wethToFlik(onBehalfOf), onBehalfOf);
	}
	...
	function setLooper(ILooper _looper) external {
		require(msg.sender == owner, "!owner");
		require(address(looper) == address(0), "Looper Already Set");
		looper = _looper;
	}
