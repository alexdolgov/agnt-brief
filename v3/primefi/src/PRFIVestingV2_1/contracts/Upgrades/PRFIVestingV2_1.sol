    ...
    IPRFIVesting
{
    ...
    function getClaimableAmount(
        ...
        claimableAmount = _vestingSchedule(
            schedule.totalAmount - schedule.immediateAmount,
            blockTimestamp,
            schedule.startTime,
            schedule.startTime + schedule.vestingDuration,
            schedule.vestingDuration
        ) - (schedule.claimedAmount - schedule.immediateAmount);
    }
