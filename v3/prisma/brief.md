...
- Project: PrismaLST (`prisma`)
- Website: [https://www.prismafinance.com/](https://www.prismafinance.com/)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for PrismaLST. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.

### Architecture

The pinned logic-topography run contains 6 contract row(s) across ethereum. Structural roles: 3 core, 3 supporting. No upgradeable pattern was identified in these rows.
