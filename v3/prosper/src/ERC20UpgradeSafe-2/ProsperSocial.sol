...
contract ProsperSocial is Ownable, Initializable, ContextUpgradeSafe {
    ...
    function createPool(address token, uint minBet, uint start, uint startPeriod, uint end, uint endPeriod, string memory poolCategory, string memory poolQuestion, string[] memory poolOptions) public {
