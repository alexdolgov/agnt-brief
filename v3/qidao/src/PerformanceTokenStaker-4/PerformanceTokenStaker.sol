...
contract PerformanceTokenStaker is ERC20, ReentrancyGuard {
    ...
    function executeMasterChef() public onlyOwner {
        require(block.timestamp>=(queueTime+minQueue) || !validQueueContract, "must wait queue time.");
     ...
     * - Only the contract owner can call this function.
     */
    function UpgradeChef() public onlyOwner {
     ...
     */
    function ApproveChef() public onlyOwner onlyValid {
     ...
     * - The MasterChef contract address must be set.
     */
    function DisapproveChef() public onlyOwner onlyValid {
     ...
     */
    function DepositChef() public onlyOwner onlyValid {
     ...
     * - The current MasterChef contract address must be set.
     */
    function ExitChef() public onlyOwner onlyValid {
        ISteakingContract currentChef = ISteakingContract(masterchef);
