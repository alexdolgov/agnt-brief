...
// File contracts/token/ERC20/PerformanceTokensV2.sol
...
contract PerformanceTokensV2 is ERC20, ReentrancyGuard {
    ...
    uint256 public perfFee; // basis points
    uint256 public lastInterest;

    uint256 public perfEarned;
    ...
    function withdrawFee() public {
        ...
        _burn(owner, ownerHeld);
        ERC20(token).transfer(owner, what);
        perfEarned=0;
        totalEarned+=what;
    }
