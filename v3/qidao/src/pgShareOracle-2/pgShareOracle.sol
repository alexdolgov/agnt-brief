...
// Shares is performanceToken
	...
	function latestAnswer() public view
        ...
        uint256 sharePrice = underlying.shareToAssetsPrice() * _price / 1e18;  // 1e18 * 1e8 / 1e18
		uint256 newPrice = ( underlying.balanceOf(address(shares))* sharePrice ) / shares.totalSupply() / 1e18; // 1e8 * 1e18 / 1e18
