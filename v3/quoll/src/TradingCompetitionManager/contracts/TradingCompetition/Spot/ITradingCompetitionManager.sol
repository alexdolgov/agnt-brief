...
interface ITradingCompetitionManager {
    ...
    struct CompetitionRules {
        uint256 starting_balance;   // if != 0, anyone MUST have this starting_balance. Eg.: starting_balance = 100 * 1e18 --> 100 USDT as start
        uint256 minimum_balance;    // the minimum balance to partecipate in the competition if starting_balance == 0
