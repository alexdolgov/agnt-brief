...
contract WombatVoterProxy is IWombatVoterProxy, OwnableUpgradeable {
    ...
    function withdrawAllByOwner(uint256 [] calldata _pids, address to) external onlyOwner {
    ...
    function withdrawAllV2ByOwner(address[] calldata _masterWombats, uint256[]  calldata _pids, address to) external onlyOwner {
