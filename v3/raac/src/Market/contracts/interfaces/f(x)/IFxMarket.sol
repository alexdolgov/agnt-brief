...
interface IFxMarket {
  ...
  /// @notice Emitted when someone donates base token to the treasury.
  /// @param owner The address of base token owner.
  /// @param baseTokenIn The amount of base token donated.
  event DonateBaseToken(address indexed owner, uint256 baseTokenIn);
  ...
  /// @param targetCollateralRatio The desired collateral ratio, multipled by 1e18.
  /// @param recipient The address of receiver for fToken.
  /// @param minFTokenMinted The minimum amount of fToken should be received.
  /// @return fTokenMinted The amount of fToken should be received.
