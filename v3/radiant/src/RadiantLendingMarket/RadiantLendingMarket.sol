...
import {
    Authorization,
    IRadiantLendingMarket,
    IRadiantLendingMarketBase,
    IRadiantLendingMarketStaticTyping,
    Id,
    Market,
    MarketParams,
    Position,
    Signature
} from "./interfaces/IRadiantLendingMarket.sol";
...
/// @title Radiant Lending Market
/// @author Radiant Labs
/// @notice The Lending Market contract.
contract RadiantLendingMarket is IRadiantLendingMarketStaticTyping {
    ...
    /// @inheritdoc IRadiantLendingMarketBase
    ...
    /// @inheritdoc IRadiantLendingMarketStaticTyping
        ...
        )
    {
        ...
        (uint256 totalSupplyAssets, uint256 totalSupplyShares, uint256 totalBorrowAssets, uint256 totalBorrowShares) =
            LendingMarketBalancesLib.expectedMarketBalances(IRadiantLendingMarket(address(this)), marketParams);
    ...
    /// @dev Returns whether the position of 'borrower' in the given market `marketParams.ltv' is healthy
