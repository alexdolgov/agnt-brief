...
library UrmStructs {
  ...
  struct FortressConfig {
    ...
    uint32 twap; // TWAP interval for peg defense triggers in seconds (60–3600; default 120)
    uint256 slippage; // max slippage on swaps in BPS (0–2500; default 500)
    uint256 abovePegThreshold; // URM price in USDC (6 dec) that triggers above-peg defense (≥1_001_000; default 1_002_500)
