...
library RouteExecutor {
    ...
    address private constant _UNISWAP_V3_QUOTER = 0x61fFE014bA17989E743c5F6cB21bF9697530B21e;

    /// @dev Address of the permit2 contract.
    IPermit2 private constant _PERMIT2 = IPermit2(0x000000000022D473030F116dDEE9F6B43aC78BA3);

    /// @dev Address of the universal router contract.
    IUniversalRouter private constant _UNIVERSAL_ROUTER = IUniversalRouter(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD);
    ...
    function _executeV2Swap(uint256 assets, uint256 slippageBps, bytes memory path) private returns (bool) {
        ...
        bytes memory commands = abi.encodePacked(Commands.V2_SWAP_EXACT_IN);
    ...
    function _executeV3Swap(uint256 assets, uint256 slippageBps, bytes memory path) private returns (bool) {
        ...
        bytes memory input = abi.encode(address(this), assets, amountOutMin, path, true);
