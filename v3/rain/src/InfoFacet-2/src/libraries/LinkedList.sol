...
library LinkedListLogic {
     ...
     */
    function append(
        LinkedListStorage.LinkedList storage list,
        LinkedListStorage.Order memory order
    ) internal returns (int256 idx) {
    ...
    function getData(
        LinkedListStorage.LinkedList storage list,
        int256 idx
    ) internal view returns (LinkedListStorage.Order memory) {
