...
import { ENSInterface } from "@chainlink/contracts/src/v0.8/operatorforwarder/interfaces/ENSInterface.sol";
import { LinkTokenInterface } from "@chainlink/contracts/src/v0.8/shared/interfaces/LinkTokenInterface.sol";
import { ChainlinkRequestInterface } from "@chainlink/contracts/src/v0.8/operatorforwarder/interfaces/ChainlinkRequestInterface.sol";
import { OperatorInterface } from "@chainlink/contracts/src/v0.8/operatorforwarder/interfaces/OperatorInterface.sol";
import { PointerInterface } from "@chainlink/contracts/src/v0.8/operatorforwarder/interfaces/PointerInterface.sol";
import { ENSResolver as ENSResolver_Chainlink } from "@chainlink/contracts/src/v0.8/vendor/ENSResolver.sol";

/**
 * @title ChainlinkClientUpgradeable
...
abstract contract ChainlinkClientUpgradeable is Initializable {
    ...
    OperatorInterface internal s_oracle;
    ...
    event ChainlinkOracleUpdated(address indexed oracle);
    event ChainlinkTokenUpdated(address indexed token);

    function __ChainlinkClient_init(address oracle) internal onlyInitializing {
        __ChainlinkClient_init_unchained(oracle);
    }

    function __ChainlinkClient_init_unchained(address oracle) internal onlyInitializing {
        s_oracle = OperatorInterface(oracle);
    }
    ...
    function _setChainlinkOracle(address oracleAddress) internal {
        ...
        emit ChainlinkOracleUpdated(oracleAddress);
    }
    ...
    function _setChainlinkToken(address linkAddress) internal {
        ...
        emit ChainlinkTokenUpdated(linkAddress);
    }
     ...
     */
    function _validateChainlinkCallback(bytes32 requestId) internal recordChainlinkFulfillment(requestId) {}
