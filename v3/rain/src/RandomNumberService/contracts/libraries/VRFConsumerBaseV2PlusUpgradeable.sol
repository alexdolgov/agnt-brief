 ...
 */
abstract contract VRFConsumerBaseV2PlusUpgradeable is IVRFMigratableConsumerV2Plus {
    error OnlyCoordinatorCanFulfill(address have, address want);
    error OnlyOwnerOrCoordinator(address have, address owner, address coordinator);
    error ZeroAddress();

    // vrfCoordinator should be used by consumers to make requests to vrfCoordinator
