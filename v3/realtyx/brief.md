...
- Project: RealtyX (`realtyx`)
- Website: [https://realtyx.co/](https://realtyx.co/)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for RealtyX. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
- UnnamedContract (`0x5b1e769e74fd7e532a48261ab42ee906f0090556`, chain 8453)
...
|---|---|---|---|---:|---|---|---|---|
| UnnamedContract | token | project_anchor | own_supporting | 0 | base | unit-391314 | `0x5b1e769e74fd7e532a48261ab42ee906f0090556` | ⚠️ Unaudited |
