...
contract EthereumPriceFeedFgnxpEodWithoutRoundsV1 is PriceFeedWithoutRoundsForMultiFeedAdapter {
  function description() public view virtual override returns (string memory) {
    return "RedStone Price Feed for FGNXP_EOD";
  }

  function getDataFeedId() public view virtual override returns (bytes32) {
    return bytes32("FGNXP_EOD");
  }
