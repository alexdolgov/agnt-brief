...
contract BnbPriceFeedSolvbtcBbnbtcWithoutRoundsV1 is PriceFeedWithoutRoundsForMultiFeedAdapter {
  function description() public view virtual override returns (string memory) {
    return "RedStone Price Feed for SolvBTC.BBN/BTC";
  }

  function getDataFeedId() public view virtual override returns (bytes32) {
    return bytes32("SolvBTC.BBN/BTC");
  }
