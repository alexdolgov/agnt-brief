...
contract BnbPriceFeedSolvbtcFundamentalusdWithoutRoundsV1 is PriceFeedWithoutRoundsForMultiFeedAdapter {
  function description() public view virtual override returns (string memory) {
    return "RedStone Price Feed for SolvBTC_FUNDAMENTAL/USD";
  }

  function getDataFeedId() public view virtual override returns (bytes32) {
    return bytes32("SolvBTC_FUNDAMENTAL/USD");
  }
