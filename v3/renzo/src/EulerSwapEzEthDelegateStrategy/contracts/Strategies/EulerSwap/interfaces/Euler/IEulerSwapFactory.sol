...
interface IEulerSwapFactory {
    ...
    /// @notice Returns the implementation address of the EulerSwap contract
    /// @dev Returns the address of the implementation contract for the EulerSwap contract
    /// @return The address of the implementation contract for the EulerSwap contract
