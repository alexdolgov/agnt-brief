...
interface IRoleManager {
    ...
    /**
     * @notice Checks if an address has the ORDER_ADMIN role
     * @param potentialAddress The address to check
     * @return bool True if the address has the ORDER_ADMIN role, false otherwise
     */
     ...
     * @param potentialAddress The address to check
     * @return bool True if the address has the MINTER role, false otherwise
     */
