...
/// @title AssetRegistry
/// @notice Manages a registry of asset addresses with metadata including adapter, chain, type, and symbol
...
contract AssetRegistry {
    ...
    /// @notice Types of assets supported
    enum AssetType {
        ERC20,
        ERC721,
        ERC1155,
    ...
    function setAsset(
        ...
        emit AssetUpdated(_asset, _adapter, _chain, _assetType, _symbol, isUpdate);
    }
    ...
    function _batchSetAssets(AssetInfo[] memory _assets) private {
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            emit AssetUpdated(info.asset, info.adapter, info.chain, info.assetType, info.symbol, isUpdate);
        }
