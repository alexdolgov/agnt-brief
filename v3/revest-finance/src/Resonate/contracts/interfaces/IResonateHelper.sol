...
interface IResonateHelper {
    ...
    function sandwichSnapshot(bytes32 poolId, uint256 amount, bool isWithdrawal) external;
    ...
    function calculateInterest(uint256 fnftId) external view returns (uint256 interest, uint256 interestAfterFee);
}
