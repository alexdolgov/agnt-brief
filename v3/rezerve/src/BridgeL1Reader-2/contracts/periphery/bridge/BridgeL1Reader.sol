...
contract BridgeL1Reader is OAppRead, OAppOptionsType3 {
     ...
     */
    function readSum(uint256 _a, uint256 _b, bytes calldata _extraOptions)
        external
        payable
     ...
     */
    function quoteReadFee(uint256 _a, uint256 _b, bytes calldata _extraOptions)
        external
        view
    ...
    function _lzReceive(
        ...
        bytes memory data = abi.decode(_message, (bytes));
