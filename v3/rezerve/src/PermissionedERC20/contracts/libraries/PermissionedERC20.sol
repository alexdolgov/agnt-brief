...
contract PermissionedERC20 is AppAccessControlled, ERC20, IPermissionedERC20 {
    ...
    constructor(address _authority, string memory _name, string memory _symbol) ERC20(_name, _symbol) {
