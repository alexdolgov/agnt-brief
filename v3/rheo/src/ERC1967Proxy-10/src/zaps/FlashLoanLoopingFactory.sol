    ...
    IFlashLoanLoopingFactory
{
    ...
    function deploy(address onBehalfOf, bytes32 extraSalt) public returns (FlashLoanLooping flashLoanLooping) {
    ...
    function deploy(bytes32 extraSalt) external returns (FlashLoanLooping flashLoanLooping) {
