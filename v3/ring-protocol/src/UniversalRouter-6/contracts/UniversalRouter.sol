...
contract UniversalRouter is IUniversalRouter, Dispatcher {
    constructor(RouterParameters memory params)
        UniswapImmutables(
            UniswapParameters(params.uniswapV2Factory, params.ringSwapV2Factory, params.uniswapV3Factory, params.uniswapV2PairInitCodeHash, params.ringSwapV2PairInitCodeHash, params.uniswapV3PoolInitCodeHash, params.fwrng)
        )
        V4SwapRouter(params.v4PoolManager)
        PaymentsImmutables(PaymentsParameters(params.permit2, params.weth9, params.fewFactory))
