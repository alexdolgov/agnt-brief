...
import {BlastManager} from './modules/BlastManager.sol';

contract UniversalRouter is IUniversalRouter, Dispatcher, RewardsCollector, BlastManager{
    ...
    constructor(RouterParameters memory params)
        UniswapImmutables(
            UniswapParameters(params.v2Factory, params.ringV2Factory, params.fwrng, params.v3Factory, params.pairInitCodeHash, params.ringPairInitCodeHash, params.poolInitCodeHash)
        )
