...
library Commands {
    ...
    uint256 constant FEW_V2_SWAP_EXACT_IN = 0x23;
    uint256 constant FEW_V2_SWAP_EXACT_OUT = 0x24;
    uint256 constant RING_V2_SWAP_EXACT_IN = 0x25;
    uint256 constant RING_V2_SWAP_EXACT_OUT = 0x26;

    // COMMAND_PLACEHOLDER for 0x27 to 0x3f (all unused)
}
