...
contract RcktLocker is Ownable{
    ...
    IERC20 public RcktToken = IERC20(0x6653dD4B92a0e5Bf8ae570A98906d9D6fD2eEc09);
    ...
    function lockTokensByRckt(IERC20 _token, address _withdrawer, uint256 _amount, uint256 _unlockTimestamp) external returns (uint256 _id) {
        ...
        require(RcktToken.balanceOf(msg.sender) >= lockFee, "Need to pay lock fee!");
        ...
        RcktToken.transferFrom(msg.sender, marketingAddress, lockFee);
    ...
    function setRcktToken(IERC20 _token) external onlyOwner {
        RcktToken = _token;
    }
}