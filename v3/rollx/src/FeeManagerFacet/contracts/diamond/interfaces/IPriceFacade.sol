...
interface IPriceFacade {
    ...
    function requestPriceCallbackPyth(bytes32 requestId, bytes32 priceId, bytes calldata updateData) external;

    function batchRequestPriceCallback(PriceCallbackParam[] calldata params) external;

    function batchRequestPriceCallbackPyth(PriceCallbackParamPyth[] calldata params) external;
