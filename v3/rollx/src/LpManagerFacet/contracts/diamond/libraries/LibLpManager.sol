...
library LibLpManager {
    ...
    function _calculateLpAmount(LibVault.AvailableToken memory at, uint256 amount) private returns (uint256 lpAmount) {
        ...
        (int256 lpUnPnlUsd, int256 lpTokenUnPnlUsd) = ITradingCore(address(this)).lpUnrealizedPnlUsdToken(at.tokenAddress);
        ...
        require(amountUsd > 0, "LibLpManager: amountUsd should > 0");
        ...
        require(lpAmount > 0, "LibLpManager: lpAmount should > 0");
