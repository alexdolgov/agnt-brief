...
interface ITradingCore {
    ...
    function lpUnrealizedPnlTotalUsd() external view returns (int256 unrealizedPnlUsd);
    
    function lpUnrealizedPnlUsd() external view returns (int256 totalUsd, LpMarginTokenUnPnl[] memory);

    function lpUnrealizedPnlUsdToken(address targetToken) external view returns (int256 totalUsd, int256 tokenUsd);
