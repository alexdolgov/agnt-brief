...
import {AdminControlledVesting} from "./AdminControlledVesting.sol";
import {ReentrancyGuard} from "@openzeppelin/contracts/utils/ReentrancyGuard.sol";
import {IStreamable} from "./interfaces/IStreamable.sol";

/**
 * @title BebraVesting
 * @notice Stores ERC20 tokens, adding streaming capabilities.
 ...
 * Modifications:
 * - Sablier "pulls" the funds from the creator of the stream at creation. In the Rubicon case, we already have the funds.
 * - Anybody can create streams on Sablier. Here, only the funds admin can.
 ...
 * @notice Original AAVE code: https://github.com/aave/aave-v3-periphery/blob/803c3e7d6d1c6da8d91411f4d085494f7189ea0b/contracts/treasury/AaveEcosystemReserveV2.sol
 * @author BGD Labs
 **/
contract BebraVesting is
    AdminControlledVesting,
    ReentrancyGuard,
    IStreamable
{
