...
//   File:     contracts/ClearingV2.sol  (Clearing v2.0.0)
// Rubicon CLMM adaptation:
//   - None required. ClearingV2 reads IHypervisor (which exposes the RubiconV3 pool
//     via `pool()`), and uses pure Uniswap libraries (FullMath, TickMath) that are
