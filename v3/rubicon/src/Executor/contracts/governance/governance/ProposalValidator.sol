...
import {IRubiconGovernance} from "../interfaces/IRubiconGovernance.sol";
import {IProposalValidator} from "../interfaces/IProposalValidator.sol";
import {SafeMath} from "../dependencies/open-zeppelin/SafeMath.sol";

/**
 * @title Proposal Validator Contract, inherited by Rubicon Governance Executors
...
contract ProposalValidator is IProposalValidator {
     ...
     * Needs the creator to have lost proposition power threashold
     * @param governance Governance Contract
     * @param user Address of the proposal creator
     * @param blockNumber Block Number against which to make the test (e.g proposal creation block -1).
    ...
    /**
     * @dev Returns the minimum Proposition Power needed to create a proposal.
     * @param governance Governance Contract
    ...
    function isQuorumValid(
        ...
        IRubiconGovernance.ProposalWithoutVotes memory proposal = governance
