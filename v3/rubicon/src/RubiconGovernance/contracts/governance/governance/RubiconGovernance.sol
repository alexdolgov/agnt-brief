 ...
 * @dev Main point of interaction with Rubicon protocol's governance
 * - Create a Proposal
 * - Cancel a Proposal
 * - Queue a Proposal
 * - Execute a Proposal
 ...
 * @author Aave
 **/
contract RubiconGovernance is Ownable, IRubiconGovernance {
    ...
    string public constant NAME = "Rubicon Governance";
