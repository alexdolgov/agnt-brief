...
/// @dev Changed Owned to Ownable here.
...
/// @dev Curve's https://github.com/curvefi/multi-rewards/blob/master/contracts/MultiRewards.sol
contract StakingMultiRewards is ReentrancyGuard, Pausable {
    using SafeMath for uint256;
