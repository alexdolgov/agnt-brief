...
//   File:     contracts/UniProxy.sol  (UniProxy v1.2.3)
// Rubicon CLMM adaptation:
//   - None. UniProxy only interacts with IHypervisor and the local IClearing.
// -----------------------------------------------------------------------------
...
/// @title UniProxy v1.2.3 — Rubicon CLMM fork (unchanged from upstream)
