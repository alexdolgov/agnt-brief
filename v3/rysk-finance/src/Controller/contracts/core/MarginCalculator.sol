...
contract MarginCalculator is Ownable {
    ...
    /**
     * @notice return the collateral payout per oToken after expiry, scaled by collateral asset decimals.
     ...
     *   calls: max(underlyingPrice - strikePrice, 0) converted to collateral and capped at peg-equivalent value.
     *   puts: max(strikePrice - underlyingPrice, 0) converted to collateral.
     *
     ...
     *          by the peg-equivalent cap. the redeemer pays the strike asset and receives this amount
