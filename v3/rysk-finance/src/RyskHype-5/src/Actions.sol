...
library Actions {
    ...
    function _constructFlashLoanRedeemActionArgs(bytes calldata packedEncodedArgs, address rysk) internal returns (ActionArgs memory, address, bytes memory, uint256) {
