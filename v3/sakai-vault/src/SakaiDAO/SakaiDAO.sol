...
contract SakaiDAO is ITokenVote, ERC20, Ownable, ReentrancyGuard {
    ...
    event ReceiveRewardReferrer(address account, uint256 amount, uint256 epoch);
    ...
    function _claimRewardReferrer(address account) internal {
        ...
        _calculateReward(amountAfterTax);
        emit ReceiveRewardReferrer(account, amountAfterTax, currentEpoch);
    }
