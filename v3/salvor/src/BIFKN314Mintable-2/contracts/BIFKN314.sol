 ...
 * The contract allows users to add and remove liquidity, and swap tokens.
...
contract BIFKN314 is BIFKNERC20, ReentrancyGuard, IERC314Errors, IERC314Events {
     ...
     * Unlike the transfer function, this function does not perform auto-swaps
     * when transferring to the contract address, maintaining standard ERC20 behavior.
     * Still enforces maximum wallet limits for recipients.
     *
     ...
     * for the purpose of adding liquidity or swapping.
