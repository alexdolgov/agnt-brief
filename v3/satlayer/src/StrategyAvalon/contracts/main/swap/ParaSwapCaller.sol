...
contract ParaSwapCaller {
    ...
    function executeSwap(
        ...
        if (_srcToken != address(0) && _srcToken != 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE) {
        ...
        (success_, resp_) = PARASWAP_AUGUSTUS_PROXY_V6.call{value: _srcToken == address(0) ? _amount : 0}(_swapData);
