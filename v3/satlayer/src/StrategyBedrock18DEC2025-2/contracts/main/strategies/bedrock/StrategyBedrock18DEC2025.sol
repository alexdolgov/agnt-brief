...
contract StrategyBedrock18DEC2025 is StrategyBase {
    ...
    address internal constant EQB_PENDLE_LP = 0x058394Ff6565529CeA3E67EfDeaCccFf558C4586;

    address internal constant EQB_DEPOSIT = 0x4D32C8Ff2fACC771eC7Efc70d6A8468bC30C26bF;

    address internal constant EQB_POOL = 0x981517ECFff254608789e2dfF4EfBe0c47c7ec5E;

    address internal constant EQB_ZAP = 0x4f1cDF43f5E407abD569878976960d4d0A3d3452;

    uint256 internal constant EQB_PID = 203;
