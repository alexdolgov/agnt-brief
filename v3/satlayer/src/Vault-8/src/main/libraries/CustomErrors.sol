...
library CustomErrors {
    ...
    error InsufficientSrUSDe(); // 0xbf4b46d8
    error InsufficientYT(); // 0xbe934939
    error InvalidAccount(); // 0x6d187b28
    error InvalidAdapter(); // 0xfbf66df1
    error InvalidAdmin(); // 0xb5eba9f0
    error InvalidAsset(); // 0xc891add2
    error InvalidCallbackType(); // 0x07143fee
    error InvalidCallData(); // 0x1c49f4d1
    ...
    error SlippageTooHigh(uint256 tokenGet, uint256 minGet); // 0x76baadda
