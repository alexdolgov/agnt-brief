...
library Errors {
    ...
    error ExceededExchangePriceRate(); // 0xc8d1ba3d
    error ExceededMaxDeposit(); // 0x3bc9ae09
    error ExceededRedeemInstantLimit(); // 0x1cdb58a6
    ...
    error MFONERedeemPending(); // 0xd4206c4a
    error MFONEMintPending(); // 0x22f00e7a
    error NotSupportedYet(); // 0xfb89ba2a
    error PriceBelowZero(); // 0xc94c652c
