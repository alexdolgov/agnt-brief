    ...
    Mutex
{
    ...
    /// @notice Calculate the ratio of a user's weight to the total weight.
    ...
    /// @return collateralWeightRatio user collateral weight in BPS.
    function _getCollateralWeightRatio(
        ...
        return
            totalCollateralWeight == 0
                ? 0
                : userCollateralWeight * BPS / totalCollateralWeight;
    }
    ...
    function _getSvyEarnRate(
        ...
        return collateralWeightRatio_ * emissionRatio / BPS;
    }
