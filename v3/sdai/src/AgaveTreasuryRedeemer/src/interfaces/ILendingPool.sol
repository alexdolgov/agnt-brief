...
interface ILendingPool {
    ...
    event SetReserveLimits(
        address indexed asset, uint256 depositLimit, uint256 borrowLimit, uint256 collateralUsageLimit
    );
     ...
     *
     */
    function repayUsingAgToken(address asset, uint256 amount, uint256 rateMode, address onBehalfOf)
        external
        returns (uint256);
