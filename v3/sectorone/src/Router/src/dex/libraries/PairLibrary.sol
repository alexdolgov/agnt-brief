...
library PairLibrary {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'07dfaef371a973f003dc4c74454e25c843913358a827acc444fa92626e886a4a' // new
                        // hex"049f32ebc831c324153e0852a313f2be077e76367383aa39f9e12ad395265ab2" // init code hash for tests (hardhat)
                    )
                )
            )
        );
    ...
    {
        (address token0, ) = sortTokens(tokenA, tokenB);
        IPair pair = IPair(pairFor(factory, tokenA, tokenB));
