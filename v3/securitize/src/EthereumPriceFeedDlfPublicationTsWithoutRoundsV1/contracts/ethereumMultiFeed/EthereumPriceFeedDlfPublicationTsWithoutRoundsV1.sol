...
contract EthereumPriceFeedDlfPublicationTsWithoutRoundsV1 is PriceFeedWithoutRoundsForMultiFeedAdapter {
  function description() public view virtual override returns (string memory) {
    return "RedStone Price Feed for DLF_PUBLICATION_TS";
  }

  function getDataFeedId() public view virtual override returns (bytes32) {
    return bytes32("DLF_PUBLICATION_TS");
  }
