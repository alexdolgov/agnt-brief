...
import "../../v1/gacha/OracleClient.sol";
...
contract VendingMachineV2 is OwnableUpgradeable, OracleClient {
    /****************************************************
    // ******************  Events ***********************
    // **************************************************/
    event CreatePack(
    ...
    function setAdditionalPrivilegeBonus(uint256 privilegeLevel, uint256 min, uint256 max) external onlyOwner {
    ...
    function getPrivilegeLevel() internal view returns (uint256 level){
        ...
        uint256 planted = farmer.stakeAmount.div(1e18);
