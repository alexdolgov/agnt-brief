...
contract GovernorAlpha {
    ...
    string public constant name = "Segment Governor Alpha";
    ...
    /// @notice The address of the Segment Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Segment governance token
    SEFInterface public sef;
    ...
    constructor(address timelock_, address sef_, address guardian_) public {
        timelock = TimelockInterface(timelock_);
        sef = SEFInterface(sef_);
        guardian = guardian_;
    }
    ...
    function propose(
        ...
        require(
            sef.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold(),
    ...
    function cancel(uint proposalId) public {
        ...
        require(
            msg.sender == guardian ||
                sef.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold(),
    ...
    function _castVote(address voter, uint proposalId, bool support) internal {
        ...
        uint96 votes = sef.getPriorVotes(voter, proposal.startBlock);
