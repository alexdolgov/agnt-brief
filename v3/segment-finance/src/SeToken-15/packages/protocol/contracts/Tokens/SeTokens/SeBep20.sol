...
/**
 * @title Segment's SeBep20 Contract
 * @notice seTokens which wrap an EIP-20 underlying
 * @author Segment
 */
contract SeBep20 is SeToken, SeBep20Interface {
    /*** User Interface ***/
     ...
     * @dev Accrues interest whether or not the operation succeeds, unless reverted
     * @param receiver The account which is receiving the seTokens
     * @param mintAmount The amount of the underlying asset to supply
     * @return uint Returns 0 on success, otherwise returns a failure code (see ErrorReporter.sol for details).
     */
    // @custom:event Emits Transfer event
    ...
    function liquidateBorrow(
        ...
        (uint err, ) = liquidateBorrowInternal(borrower, repayAmount, seTokenCollateral);
        return err;
    }
    ...
    function initialize(
        ...
        // SeToken initialize does the bulk of the work
