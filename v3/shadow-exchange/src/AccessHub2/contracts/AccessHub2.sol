...
contract AccessHub2 is IAccessHub {
    ...
    function notifyEmissions(address[] calldata pools, uint256[] calldata emissions) external useExpansionPack {}

    /// @notice rescues token from Access Hub
    function rescue(address token) external useExpansionPack {}
    ...
    function amountForSeed(address pool) external view viewExpansionPack returns (uint256 amount0, uint256 amount1) {}
    ...
    /// @notice function for rescuing rewards from the wrong feeDistributor
    function clawbackRewards(address feeDistributor, address token, address destination) external useExpansionPack {}
    ...
    function voterProxyAdmin() external view viewExpansionPack returns (address) {}

    /// @notice the minter proxy admin address
    function minterProxyAdmin() external view viewExpansionPack returns (address) {}
    ...
    function rescueFromX33(address _token, uint256 _amount) external useExpansionPack {}

    /// @notice rescues token from x33 adapater
    function rescueFromX33Adapter(address _token) external useExpansionPack {}

    /// @notice transfers the x33 Adapter operator address
    function transferOperatorInX33Adapter(address _newOperator) external useExpansionPack {}
    ...
    function upgradeVoterImplementation(address _newVoterImplementation, bytes memory data) external useExpansionPack {}

    /// @notice upgrade minter implementation
    function upgradeMinterImplementation(address _newMinterImplementation, bytes memory data)
        external
        useExpansionPack
    {}

    /// @notice Sets implementation for all GaugeV3s
    function upgradeGaugeV3Implementation(address _newGaugeV3Implementation) external useExpansionPack {}
    ...
    ) external useExpansionPack {}

    /// @notice sets new treasury in access hub
    function setTreasury(address _newTreasury) external useExpansionPack {}

    /// @notice sets x33Utils in access hub
    function setX33Utils(address _x33Utils) external useExpansionPack {}

    /// @notice transfers x33's operator to x33Utils
    function preX33UtilsHook() external useExpansionPack {}

    /// @notice transfers x33's operator to x33Adapter
    function postX33UtilsHook() external useExpansionPack {}
