    ...
    IERC721Enumerable
{
    ...
    /// @notice The last time an NFP was updated
    function lastUpdated(uint256 tokenId) external view returns (uint256);

    /// @notice The last liquidity an NFP was updated with
    function lastLiquidity(uint256 tokenId) external view returns (uint256);
}
