...
interface IAccessHub0 {
    ...
    function clawbackRewards(address feeDistributor, address token, address destination) external;

    /// @notice function for rescuing rewards from the wrong feeDistributor
    function clawbackRewards(address feeDistributor, address[] calldata tokens, address destination) external;
...
interface IAccessHub1 {
    ...
    function setX33Utils(address _x33Utils) external;
