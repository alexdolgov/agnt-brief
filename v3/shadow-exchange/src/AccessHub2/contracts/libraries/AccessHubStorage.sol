...
import {Ix33Adapter} from "contracts/interfaces/Ix33Adapter.sol";
import {IX33Utils} from "contracts/interfaces/IX33Utils.sol";
...
library AccessHubStorage {
    ...
    //     IShadowV3Factory shadowV3PoolFactory = $.shadowV3PoolFactory;
