...
import './interfaces/IShibaswapPair.sol';
...
contract V2Migrator is IV2Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IShibaswapPair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IShibaswapPair(params.pair).burn(address(this));
