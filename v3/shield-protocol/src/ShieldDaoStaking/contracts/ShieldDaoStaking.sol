...
library WethUtils {
    ...
    IWETH public constant weth = IWETH(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //WETH
    IERC20 public constant SHIELD = IERC20(0xbDEea520aB347101461133bCD5C678bbB1f30e96); //SHIELD token
...
// File contracts/farms/ShieldDaoStaking.sol

pragma solidity 0.8.4; 

// Based on EPS's & Geist's MultiFeeDistribution
contract ShieldDaoStaking is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public  lockDuration; // 1 day
    ...
    function getBalanceInfo(address _user) external view returns(Balances memory) {
