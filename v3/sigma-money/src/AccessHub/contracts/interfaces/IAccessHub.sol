...
interface IAccessHub {
    ...
    event Reinitialized(InitParams params);
    ...
    /// @notice upgrades a UUPS upgradeable contract to a new implementation
    /// @param _proxy the proxy address of the contract to upgrade
    /// @param _newImplementation the new implementation address
    /// @param _data optional calldata for post-upgrade initialization (pass empty bytes if none)
    function upgradeContract(address _proxy, address _newImplementation, bytes calldata _data) external;
