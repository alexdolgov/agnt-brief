...
/**
 * @title GaugeV2
 * @notice Upgradeable version of the Gauge contract using UUPS proxy pattern
 * @dev Implements Requirements 4.1, 4.2, 4.3, 4.4
 * 
 * Storage Layout:
 ...
 */
contract GaugeV2 is IGauge, Initializable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;

    // ============ Storage Variables (Order Preserved from Original Gauge.sol) ============
    // Requirements 4.2, 4.3, 4.4: Storage layout must be preserved exactly
    ...
    // Requirement 4.2: Constructor logic moved to initialize function

    /**
     * @notice Initializes the GaugeV2 contract
