...
/**
 * @title VoterV2
 * @notice Upgradeable version of the Voter contract using UUPS proxy pattern
 * @dev Implements Requirements 2.1, 2.2, 2.3, 2.4, 2.5, 17.1, 17.2, 17.3, 17.4
 * 
 * Storage Layout:
 ...
 */
contract VoterV2 is IVoter, Initializable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;

    // ============ Storage Variables (Order Preserved from Original Voter.sol) ============
    // Requirements 17.1, 17.2, 17.3: Storage layout must be preserved exactly
    ...
    // Requirement 2.2: Constructor logic moved to initialize function

    /**
     * @notice Initializes the VoterV2 contract (interface-compatible version)
     * @dev Can only be called once due to initializer modifier
     * @dev This function matches the IVoter interface signature
     * @dev For upgradeable deployment, use initializeV2 which includes _accessHub parameter
    ...
    function initialize(
        ...
        // Note: accessHub must be set via initializeV2 for fresh deployments
        // For upgrades from existing Voter, accessHub is already set in storage
        shadow = _shadow;
    ...
    /**
     * @notice Initializes the VoterV2 contract with accessHub parameter
