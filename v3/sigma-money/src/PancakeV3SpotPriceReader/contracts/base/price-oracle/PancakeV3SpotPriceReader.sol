...
contract PancakeV3SpotPriceReader is ISpotPriceOracle {
  ...
  /// @param _encoding The encoding of the price source.
  /// @return spotPrice The spot price with 18 decimal places.
  function getSpotPrice(uint256 _encoding) external view returns (uint256 spotPrice) {
    uint256 encoding = _encoding;
