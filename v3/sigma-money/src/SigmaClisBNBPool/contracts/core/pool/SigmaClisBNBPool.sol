...
contract SigmaClisBNBPool is BasePool, IAaveFundingPool {
  ...
  constructor(address _poolManager) BasePool(_poolManager) {}
  ...
  function initialize(
    ...
    _updateInterestRate(0, 100000000000000000); // 10% interest rate
  }
  ...
  function _getAverageInterestRate(
    ...
    newBorrowIndex = snapshot.borrowIndex;
