...
abstract contract BasePool is TickLogic, PositionLogic {
  ...
  function updateDebtRatioRange(uint256 minRatio, uint256 maxRatio) external onlyRole(OPERATOR_ROLE) {
  ...
  function updateMaxRedeemRatioPerTick(uint256 ratio) external onlyRole(OPERATOR_ROLE) {
  ...
  function updateRebalanceRatios(uint256 debtRatio, uint256 bonusRatio) external onlyRole(OPERATOR_ROLE) {
  ...
  function updateLiquidateRatios(uint256 debtRatio, uint256 bonusRatio) external onlyRole(OPERATOR_ROLE) {
  ...
  function updateCounterparty(address newCounterparty) external onlyRole(OPERATOR_ROLE) {
