...
contract SigmaSPAdapter is IStandardizedYieldAdapter {
    ...
    address public constant CURVE_POOL =
        0xe5F111F2594749c1Dd4815Ef512230BF9b240CBd;
    ...
    function convertToRedeem(
        ...
        uint256 minOut = (amountPivotToken *
            (SLIPPAGE_PRESISION - CURVE_POOL_EXCHANGE_SLIPPAGE)) /
            SLIPPAGE_PRESISION;
        IERC20(SP).forceApprove(CURVE_POOL, amountPivotToken);
        amountOut = ICurveStableSwapNG(CURVE_POOL).exchange(
            1,
            0,
            amountPivotToken,
            minOut,
    ...
    function getAdapterTokensDeposit()
        external
        pure
        override
    ...
    function getAdapterTokensRedeem()
        external
        pure
        override
        returns (address[] memory tokens)
