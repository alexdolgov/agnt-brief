    ...
    AccessControlEnumerableUpgradeable
{
    ...
    /// @notice sigma vesting contract
    ISigmaVesting public sigmaVesting;
    ...
    function addVestingSchedule(
        ...
        sigmaVesting.addVestingSchedule(_beneficiary, _tokenAddress, _category, _entries);
    }

    /// @inheritdoc IAccessHub
    function removeVestingSchedule(address _beneficiary, address _tokenAddress) external onlyRole(PROTOCOL_OPERATOR) {
        sigmaVesting.removeVestingSchedule(_beneficiary, _tokenAddress);
    }

    /// @inheritdoc IAccessHub
    function release() external onlyRole(PROTOCOL_OPERATOR) {
        sigmaVesting.release();
    }
    ...
    function createVeFunderGauge(
        ...
        voter.createVeFunderGauge(_receiver, _maxEmission, _pool);
    }
