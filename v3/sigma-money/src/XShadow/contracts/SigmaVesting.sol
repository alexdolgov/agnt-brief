 ...
 *
 */
contract SigmaVesting is ISigmaVesting, ReentrancyGuard {
    ...
    /**
     * @notice Allows a beneficiary to release all their available tokens (both sigma and xSigma).
     * @dev The beneficiary can only release their own tokens.
     */
