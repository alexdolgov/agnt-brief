...
library TokenizedStrategyLib {
	...
	function setName(address token0, address token1, int24 tickLower, int24 tickUpper, int24 tickSpacing) external view returns (string memory) {
	 ...
	 * @param tickSpacing The tickSpacing of the pool
	 */
	function setSymbol(address token0, address token1, int24 tickLower, int24 tickUpper, int24 tickSpacing) external view returns (string memory) {
