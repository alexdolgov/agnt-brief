...
- Outside the address book: 67 discovered implementations excluded (3 third-party/infra; 1 standard proxy/library)
- Proxy deployments represented within implementation groups: 3
- Deployed-live implementations: 8 of 78 unique (rest dead/inactive/uninitialized)
