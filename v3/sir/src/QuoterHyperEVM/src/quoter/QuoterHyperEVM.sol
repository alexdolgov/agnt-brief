...
import {IUniswapV3Pool} from "v3-core-sol-7/interfaces/IUniswapV3Pool.sol";
import {SwapMath} from "v3-core-sol-7/libraries/SwapMath.sol";
import {FullMath} from "v3-core-sol-7/libraries/FullMath.sol";
import {TickMath} from "v3-core-sol-7/libraries/TickMath.sol";
import "v3-core-sol-7/libraries/LowGasSafeMath.sol";
import "v3-core-sol-7/libraries/SafeCast.sol";
import "v3-periphery-sol-7/libraries/Path.sol";
import {SqrtPriceMath} from "v3-core-sol-7/libraries/SqrtPriceMath.sol";
import {LiquidityMath} from "v3-core-sol-7/libraries/LiquidityMath.sol";
import {PoolTickBitmap} from "./libraries/PoolTickBitmap.sol";
import {IQuoterHyperEVM} from "./interfaces/IQuoterHyperEVM.sol";
import {PoolAddressHyperEVM} from "./libraries/PoolAddressHyperEVM.sol";
import {QuoterMath} from "./libraries/QuoterMath.sol";

/// @title Quoter for HyperEVM
/// @notice Modified version of Uniswap V3 Quoter for HyperEVM networks
contract QuoterHyperEVM is IQuoterHyperEVM {
    ...
    function getPool(address tokenA, address tokenB, uint24 fee) private view returns (address pool) {
        pool = PoolAddressHyperEVM.computeAddress(factory, PoolAddressHyperEVM.getPoolKey(tokenA, tokenB, fee));
    }

    /// @inheritdoc IQuoterHyperEVM
