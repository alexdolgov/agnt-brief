...
import {IRangeLiquiChargedFactory} from "./interfaces/IRangeLiquiChargedFactory.sol";
import {FactoryErrors} from "./errors/FactoryErrors.sol";

/**
 * @dev Mars@RangeProtocol
 * @notice RangeLiquiChargedFactory deploys and upgrades proxies for Range Protocol vault contracts.
 * Owner can deploy and upgrade vault contracts.
 */
contract RangeLiquiChargedFactory is IRangeLiquiChargedFactory, Ownable {
