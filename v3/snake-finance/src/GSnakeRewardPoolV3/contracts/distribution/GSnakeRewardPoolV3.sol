...
contract GSnakeRewardPoolV3 is ReentrancyGuard {
    ...
    uint256 public pegStabilityModuleFee = 300; // 15%
    ...
    constructor(
        ...
        add(0.000578010052004059 ether, 0, IERC20(0x287c6882dE298665977787e268f3dba052A6e251), false, 0); // SNAKE-S
        add(0.000358399923896499 ether, 0, IERC20(0xb901D7316447C84f4417b8a8268E2822095051E6), false, 0); // GSNAKE-S

        add(0.000002893518518519 ether, 0, IERC20(0xF19748a0E269c6965a84f8C98ca8C47A064D4dd0), false, 0); // SHADOW-S
        add(0.000000868055555556 ether, 0, IERC20(0xDE87419F0774eef80b0EbD134Ff54ece0d4927C9), false, 0); // MCLB-S
        add(0.000000578703703704 ether, 0, IERC20(0x880ADDfEB13bb647a2dc5fC01f5ADCbB6Baa401F), false, 0); // SHADOW-SHEDEW
        add(0.000002314814814815 ether, 0, IERC20(0xAE8E9B2222031c464342dBFab7433B64eB5C15cF), false, 0); // THC-S
        add(0.000000578703703704 ether, 0, IERC20(0xbd0313C1986F7Ef59C8Ea58cc85714ae2aa5b89D), false, 0); // GOGLZ-S
        add(0.000002893518518519 ether, 0, IERC20(0x268D86627E193dc731Bb06109d69175d56d54c98), false, 0); // FA-S
    }
