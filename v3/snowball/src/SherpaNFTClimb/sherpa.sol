...
contract SherpaNFTClimb is ERC721, Ownable{
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    uint public constant TOKEN_LIMIT = 300;
    ...
    constructor() ERC721("Sherpa NFT Climb To The Top", "SHERPANFTCLIMB") {
        _feeReceiver = payable(_feeAddress);
        setBaseURI("https://api.snowball.network/nft/sherpa_climb/");
    }
