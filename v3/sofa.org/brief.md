...
The pinned logic-topography run contains 95 contract row(s) across arbitrum, bsc, ethereum, polygon. Structural roles: 70 unclassified, 19 core, 5 supporting, 1 infra. 14 row(s) use upgradeable patterns.
...
- Indexed contracts: 95; live-surface contracts included: 95 (78 live, 17 unknown).
...
- All verified address-book-owned implementations audited (incl. non-live): 2/39
...
|---|---|---:|---:|---|
| yAudit | Tier 2 | 2 | 5.1% | 2025-01 |
| Code4rena | Tier 1 | 1 | 2.6% | 2025-01 |
...
|---|---|---|---|---:|---|---|---|---|
| Automator | unknown | project_anchor | own_supporting | 1 | arbitrum | unit-392777 | `0x4c2414...073cdb` | ✅ Audited |
...
| CrvUSDSmartTrendVault | unknown | project_anchor | own_supporting | 4 | ethereum | unit-392774 (4 proxies) | 4 deployments: ethereum `0x9832e7...8f6cfa`; ethereum `0x995954...034aa1`; ethereum `0xf421b0...324487`; ethereum `0xf5bf8a...408d9f` | ⚠️ Unaudited |
| DNTVault | unknown | project_anchor | own_supporting | 2 | ethereum | unit-392771 (2 proxies) | 2 deployments: ethereum `0x3a2538...5d68b2`; ethereum `0xd9cff1...71370a` | ⚠️ Unaudited |
| DNTVault | unknown | project_anchor | own_supporting | 3 | ethereum | unit-392773 (3 proxies) | 3 deployments: ethereum `0xbefb3a...5b2b86`; ethereum `0xbfd58c...8416fe`; ethereum `0xf1485c...c72ffc` | ⚠️ Unaudited |
| DNTVault | core_logic | project_anchor | own_supporting | 1 | arbitrum | unit-392780 | `0xdfeb34...c26c42` | ⚠️ Unaudited |
...
| LeverageDNTVault | unknown | project_anchor | own_supporting | 2 | ethereum | unit-392767 (2 proxies) | 2 deployments: ethereum `0x507525...74e746`; ethereum `0xf4a602...d27d02` | ⚠️ Unaudited |
| LeverageDNTVault | unknown | project_anchor | own_supporting | 2 | arbitrum | unit-392779 (2 proxies) | 2 deployments: arbitrum `0x1d2faa...067873`; arbitrum `0xa8fcc1...fe04ab` | ⚠️ Unaudited |
| LeverageSmartTrendVault | unknown | project_anchor | own_supporting | 4 | ethereum | unit-392761 (4 proxies) | 4 deployments: ethereum `0x071e0c...e1feed`; ethereum `0x3abc70...2eca80`; ethereum `0x8ea963...5f5211`; ethereum `0x8f9259...ed0706` | ⚠️ Unaudited |
| LeverageSmartTrendVault | unknown | project_anchor | own_supporting | 1 | bsc | unit-392782 | `0xab08ff...4a4c97` | ⚠️ Unaudited |
| LeverageSmartTrendVault | unknown | project_anchor | own_supporting | 2 | arbitrum | unit-392776 (2 proxies) | 2 deployments: arbitrum `0x7e11ce...e81cde`; arbitrum `0xf7be09...134eac` | ⚠️ Unaudited |
| RCHAutomatorFactory | registry | project_anchor | own_supporting | 0 | ethereum | unit-392708 | `0x307999...47dc1a` | ⚠️ Unaudited |
| RCHDNTVault | unknown | project_anchor | own_supporting | 2 | ethereum | unit-392770 (2 proxies) | 2 deployments: ethereum `0x53ee67...0387a3`; ethereum `0xe51777...94499d` | ⚠️ Unaudited |
| RCHSmartTrendVault | unknown | project_anchor | own_supporting | 4 | ethereum | unit-392775 (4 proxies) | 4 deployments: ethereum `0x13ef70...dd6cfa`; ethereum `0x4cfc3a...173123`; ethereum `0xc0baa3...791f38`; ethereum `0xf07d6b...9d77a7` | ⚠️ Unaudited |
| SmartTrendVault | unknown | project_anchor | own_supporting | 4 | ethereum | unit-392758 (4 proxies) | 4 deployments: ethereum `0x08c57a...da7ed8`; ethereum `0x4a5b40...da67d1`; ethereum `0x94fe82...fd7830`; ethereum `0xfa49f8...0e7770` | ⚠️ Unaudited |
...
| StETHDNTVault | unknown | project_anchor | own_supporting | 2 | ethereum | unit-392759 (2 proxies) | 2 deployments: ethereum `0x141b89...72bc65`; ethereum `0xc0f6d3...a780c1` | ⚠️ Unaudited |
| StETHLeverageDNTVault | unknown | project_anchor | own_supporting | 2 | ethereum | unit-392769 (2 proxies) | 2 deployments: ethereum `0x601478...463f06`; ethereum `0xd94a2b...cdec71` | ⚠️ Unaudited |
| StETHLeverageSmartTrendVault | unknown | project_anchor | own_supporting | 4 | ethereum | unit-392768 (4 proxies) | 4 deployments: ethereum `0x1361fa...db4366`; ethereum `0x36ac03...8e0629`; ethereum `0x858af7...353f2c`; ethereum `0xb8610f...e1a0a5` | ⚠️ Unaudited |
| StETHSmartTrendVault | unknown | project_anchor | own_supporting | 4 | ethereum | unit-392772 (4 proxies) | 4 deployments: ethereum `0x22d620...35ae69`; ethereum `0x4f8abb...95b793`; ethereum `0x5bbeb8...be2368`; ethereum `0xbeb059...da4540` | ⚠️ Unaudited |
...
| arbitrum | `0xdfeb34...c26c42` | DNTVault | core_logic | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
| bsc | `0xab08ff...4a4c97` | LeverageSmartTrendVault | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | `0x7e11ce...e81cde` | LeverageSmartTrendVault | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
