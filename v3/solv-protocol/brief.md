...
- Chains: arbitrum, avalanche, base, bob, bsc, ethereum, linea, mantle, merlin, scroll
...
- Outside the address book: 93 discovered implementations excluded (0 third-party/infra; 4 standard proxy/library)
- Proxy deployments represented within implementation groups: 23
- Deployed-live implementations: 34 of 127 unique (rest dead/inactive/uninitialized)
...
|---|---|---:|---:|---|
| OpenZeppelin | Tier 1 | 1 | 50.0% | 2024-12 |
