...
- Outside the address book: 192 discovered implementations excluded (0 third-party/infra; 5 standard proxy/library)
- Proxy deployments represented within implementation groups: 10
- Deployed-live implementations: 4 of 196 unique (rest dead/inactive/uninitialized)
