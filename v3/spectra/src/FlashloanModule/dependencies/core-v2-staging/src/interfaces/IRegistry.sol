...
interface IRegistry {
    ...
    /**
     * @notice Get the value of limit order fee
     * @return The value of limit order fee
     */
    ...
    /**
     * @notice set the limit order fee
     * @param _limitOrderFee The value of limit order fee
     */
