...
interface IAmphor {
    ...
    function epochs(uint256 epochId) external view returns (uint256 totalSupplySnapshot, uint256 totalAssetsSnapshot);
    ...
    function requestDeposit(uint256 assets, address receiver, address owner, bytes calldata data) external;
    ...
    function requestRedeem(uint256 shares, address receiver, address owner, bytes calldata data) external;
    ...
    function convertToShares(uint256 assets, uint256 epochOrRequestId) external view returns (uint256 shares);
    function convertToAssets(uint256 shares, uint256 epochOrRequestId) external view returns (uint256 assets);
    ...
    function getEpochSnapshots(uint256 epochId)
        external
        view
        returns (uint256 totalSupplySnapshot, uint256 totalAssetsSnapshot);
