...
interface IMetavaultsRegistry {
     ...
     */
    event BridgePathAllowed(address indexed tokenIn, address tokenOut, uint32 indexed dstChainId, address indexed bridge);

    /**
     * @notice Emitted when a bridge path is removed
     */
    event BridgePathRemoved(address indexed tokenIn, address tokenOut, uint32 indexed dstChainId, address indexed bridge);
    ...
    error BridgePathAlreadyAllowed(address tokenIn, address tokenOut,uint32 dstChainId, address bridge);

    error BridgePathNotAllowed(address tokenIn, address tokenOut, uint32 dstChainId, address bridge);
     ...
     * @param bridgePaths Mapping of keccak256(abi.encode(token, dstChainId)) to a set of allowed bridge addresses
     */
     ...
     */
    function allowBridgePath(address metavault, address tokenIn, address tokenOut, uint32 dstChainId, address bridge) external;
     ...
     * @param bridge Address of the bridge contract
     */
    function removeBridgePath(address metavault, address tokenIn, address tokenOut, uint32 dstChainId, address bridge) external;
