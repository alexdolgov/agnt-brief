...
interface IMetavaultsRegistry {
     ...
     */
    event BridgePathAllowed(address indexed metavault, address indexed tokenIn, address tokenOut, uint32 indexed dstChainId, address bridge);

    /**
     * @notice Emitted when a bridge path is removed
     */
    event BridgePathRemoved(address indexed metavault, address indexed tokenIn, address tokenOut, uint32 indexed dstChainId, address bridge);
