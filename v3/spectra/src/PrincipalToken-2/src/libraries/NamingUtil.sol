...
library NamingUtil {
    ...
    function genYTSymbol(
        ...
        return
            concatenate(
                concatenate(
                    concatenate("YT-", _ibtSymbol),
                    concatenate("(", concatenate(_underlyingSymbol, ")-"))
                ),
                date
            );
    }
    ...
    function genYTName(
        ...
        return
            concatenate(
                concatenate(
                    "Yield Token: ",
                    concatenate(_ibtSymbol, concatenate("(", concatenate(_underlyingSymbol, ") ")))
                ),
                date
            );
    }
