...
abstract contract Factory is ProtocolContext {
    ...
    /// @param _accountant Address of the accountant contract
    ...
    /// @param _rewardReceiverMigrationModule Address of the reward receiver migration module
    /// @param _rewardRouter Address of the reward router
