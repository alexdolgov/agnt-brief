...
import "src/votemarket-infra/interfaces/ILaPoste.sol";
import "src/votemarket-infra/interfaces/IRemote.sol";
import "src/votemarket-infra/interfaces/ITokenFactory.sol";
...
contract IncentiveGaugeHook {
    ...
    /// @param {laPoste} LaPoste contract address
    /// @param from Starting index
    /// @param to Ending index
    ...
    function _get_addresses(IVotemarket votemarket) internal view returns (address, address) {
