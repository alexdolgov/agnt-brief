...
// src/common/fee/vlCVXRecipient.sol

/// @title vlCVX recipient - Contract to receive vlCVX rewards (from Votemarket)
contract vlCVXRecipient is Recipient {
    constructor(address _governance) Recipient(_governance) {}

    function name() external pure returns (string memory) {
        return "Votemarket vlCVX Rewards Recipient";
    }
}