...
import {IStrategy, IAllocator} from "@interfaces/stake-dao/IStrategyV2.sol";
...
abstract contract Strategy is IStrategy, ProtocolContext {
    ...
    /// @notice Initializes the strategy with registry, protocol ID, accountant, locker and gateway
    ...
    constructor(address _registry, bytes4 _protocolId, address _accountant, address _locker, address _gateway)
        ProtocolContext(_protocolId, _registry, _accountant, _locker, _gateway)
    {}
