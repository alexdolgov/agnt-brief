...
contract MorphoMarketFactory {
    ...
    constructor() {
        if (block.chainid == 1) {
            ...
            oracleFactory = IMorphoOracleFactory(0x3A7bB36Ee3f3eE32A60e9f2b33c1e5f2E83ad766);
            irm = address(0x870aC11D48B15DB9a138Cf899d20F13F79Ba00BC);
        } else if (block.chainid == 8453) {
            morpho = IMorpho(0xBBBBBbbBBb9cC5e90e3b3Af64bdAF62C37EEFFCb);
            oracleFactory = IMorphoOracleFactory(0x2DC205F24BCb6B311E5cdf0745B0741648Aebd3d);
    ...
    function _createMorphoChainlinkOracle(
        ...
        if (baseVaultConversionSample != 0 || _isERC4626(collateralAsset)) {
        ...
        if (quoteVaultConversionSample != 0 || _isERC4626(loanAsset)) {
