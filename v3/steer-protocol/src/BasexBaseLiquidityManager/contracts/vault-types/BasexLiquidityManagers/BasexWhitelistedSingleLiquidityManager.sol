...
import { BasexBaseLiquidityManager } from "./BasexBaseLiquidityManager.sol";
...
import { BasexSinglePositionLiquidityManager } from "./BasexSinglePositionLiquidityManager.sol";

// SinglePositionLiquidityManager with whitelist-gated deposits
contract BasexWhitelistedSingleLiquidityManager is BasexSinglePositionLiquidityManager {
    // Storage
    ...
    ) public virtual override(BasexBaseLiquidityManager) {
