...
import { CamelotBaseLiquidityManager } from "./CamelotBaseLiquidityManager.sol";
import { IBareWhitelistRegistry } from "contracts/interfaces/IBareWhitelistRegistry.sol";
import { CamelotSinglePositionLiquidityManager } from "./CamelotSinglePositionLiquidityManager.sol";
...
contract CamelotWhitelistedSingleLiquidityManager is
    CamelotSinglePositionLiquidityManager
{
    // Storage
    ...
    ) public virtual override(CamelotBaseLiquidityManager) {
