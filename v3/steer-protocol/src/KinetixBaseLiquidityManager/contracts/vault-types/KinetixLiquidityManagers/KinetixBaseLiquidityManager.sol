...
abstract contract KinetixBaseLiquidityManager is
    Initializable,
    ERC20Upgradeable,
    PausableUpgradeable,
    ...
    IUniswapV3SwapCallback
{
    ...
    uint256 public constant TOTAL_FEE = 10_00;
    /// @dev Total fraction of fees going towards Steer (as opposed to going towards strategist)
    uint256 public constant STEER_FRACTION_OF_FEE = 50_00;
    ...
    IUniswapV3Factory internal constant FACTORY =
        IUniswapV3Factory(0xdDF5a3259a88Ab79D5530eB3eB14c1C92CD97FCf);
