...
// File contracts/Bridges/Moonbeam/CrossChainBridgeBacker_MNBM_Nomad.sol
...
contract CrossChainBridgeBacker_MNBM_Nomad is CrossChainBridgeBacker {
    ...
    function setRecipient(string memory _recipient_string) external onlyByOwnGov {
        recipient = bytes32(bytes(_recipient_string));
    }
