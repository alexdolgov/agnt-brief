...
abstract contract BaseLeverage is IFlashLoanReceiver, IFlashLoanRecipient, ReentrancyGuard {
  ...
  function zapDeposit(
    ...
    uint256 suppliedAmount = _swapTo(_zappingAsset, _collateralAsset, _principal, _zapPaths, _zapPathLength, true);
    // deposit collateral
    _supply(_collateralAsset, _silo, suppliedAmount, msg.sender);
  }
