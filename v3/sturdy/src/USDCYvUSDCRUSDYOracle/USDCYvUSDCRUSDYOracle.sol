...
/// @title USDCYvUSDCRUSDYOracle
/// @author Jason (Sturdy) https://github.com/iris112
/// @notice  An oracle for USDC/YvUSDCrUSDY
contract USDCYvUSDCRUSDYOracle {
    ...
    function getPrices() external view returns (bool _isBadData, uint256 _priceLow, uint256 _priceHigh) {
        ...
        uint256 curveLPTokenPriceInUSD = (ICurvePool(CURVE_USDC_RUSDY_POOL).get_virtual_price() * minStable) / 1e18;
        uint256 yvLPTokenPriceInUSD = curveLPTokenPriceInUSD * IYearnVault(YEARN_USDC_RUSDY_VAULT).pricePerShare() / 1e18;

        // usdcPriceInUSD, yvLPTokenPriceInUSD is 8 decimals, - USDC decimals + yvLPToken decimals + oracle decimals -6+18+18=30
        uint256 rate = usdcPriceInUSD * 1e30 / yvLPTokenPriceInUSD;  // USDC/yvUSDCrUSDY
