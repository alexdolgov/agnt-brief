...
interface IRemoteVault is ICrosschainVault {
    ...
    /**
     * @notice Get idle asset balance
     * @return Amount of idle asset tokens in the vault
     */
     ...
     * @return amountOut Amount of tokens received
     */
    function swapCurve(bool isUsdtToAsset, uint256 amount, uint256 minAmountOut) external returns (uint256 amountOut);
     ...
     */
    function emergencyWithdrawFromYearn(uint256 maxLoss) external;
     ...
     */
    function emergencyCooldownVaultRedeem() external returns (uint256 requestId);
