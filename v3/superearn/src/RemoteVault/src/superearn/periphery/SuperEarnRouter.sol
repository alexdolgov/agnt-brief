...
contract SuperEarnRouter is Initializable, ISuperEarnRouter, MulticallUpgradeable, OwnableUpgradeable {
    ...
    // NOTE: redeemWithPermit is not provided because the Vyper Vault doesn't support standard EIP-2612.
    // Vyper vault uses Bytes[65] signature format, not the standard (v, r, s) components.
     ...
     *
     * Storage usage: 3 slots (registry, remoteVault, whitelistedVaults)
     * Gap = 50 - 3 = 47
     */
