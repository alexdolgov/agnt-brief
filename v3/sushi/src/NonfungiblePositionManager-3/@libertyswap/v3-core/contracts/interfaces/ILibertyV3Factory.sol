...
/// @title The interface for the LibertySwap V3 Factory
/// @notice The LibertySwap V3 Factory facilitates creation of LibertySwap V3 pools and control over the protocol fees
interface ILibertyV3Factory {
    struct TickSpacingExtraInfo {
        bool whitelistRequested;
        bool enabled;
    }

    struct FeeProtocolDistributionInfo {
    ...
    event FeeProtocolDistributionInfoUpdated(
    ...
    function feeProtocolDistributionInfo()
        external
        view
        returns (
            address treasureAddress,
    ...
    function setFeeProtocolDistributionInfo(
        address treasureAddress,
        address buybackAddress,
        uint16 treasuryShareBps,
        uint16 buybackShareBps
