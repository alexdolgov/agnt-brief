...
/// @title The interface for the Bulba V3 Factory
/// @notice The Bulba V3 Factory facilitates creation of Bulba V3 pools and control over the protocol fees
...
// File uniswap/v3-core/contracts/NoDelegateCall.sol
...
interface IUniswapV3FlashCallback {
    ...
    /// The caller of this method must be checked to be a UniswapV3Pool deployed by the canonical BulbaV3Factory.
...
/// @title Minimal ERC20 interface for Bulba
/// @notice Contains a subset of the full ERC20 interface that is used in Bulba V3
...
/// @title The interface for a Bulba V3 Pool
/// @notice A Bulba pool facilitates swapping and automated market making between any two assets that strictly conform
...
/// @title An interface for a contract that is capable of deploying Bulba V3 Pools
...
// File uniswap/v3-core/contracts/UniswapV3Pool.sol
...
// File uniswap/v3-core/contracts/UniswapV3PoolDeployer.sol
...
contract UniswapV3PoolDeployer is IUniswapV3PoolDeployer {
    ...
    /// @param factory The contract address of the Bulba V3 factory
    /// @param token0 The first token of the pool by address sort order
    /// @param token1 The second token of the pool by address sort order
    /// @param fee The fee collected upon every swap in the pool, denominated in hundredths of a bip
    /// @param tickSpacing The spacing between usable ticks
...
// File uniswap/v3-core/contracts/BulbaV3Factory.sol

// Original license: SPDX_License_Identifier: BUSL-1.1
pragma solidity =0.7.6;


/// @title Canonical Bulba V3 factory
/// @notice Deploys Bulba V3 pools and manages ownership and control over pool protocol fees
contract BulbaV3Factory is IUniswapV3Factory, UniswapV3PoolDeployer, NoDelegateCall {
