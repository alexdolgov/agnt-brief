...
contract BasePositionManager is IBasePositionManager, ReentrancyGuard, Governable {
    ...
    event SetProtocolFeeCollector(address _protocolFeeCollector);
    ...
    function setProtocolFeeCollector(address _protocolFeeCollector) external onlyAdmin {
        protocolFeeCollector = _protocolFeeCollector;
        emit SetProtocolFeeCollector(_protocolFeeCollector);
    }

    function withdrawFees(address _token, address _receiver) public {
        require(_receiver == protocolFeeCollector, "BasePositionManager: Unknown protocolFeeCollector");
    ...
    function claimFees(address _token) external {
        withdrawFees(_token, protocolFeeCollector);
    }
