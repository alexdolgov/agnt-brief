...
contract SwapBlastToken is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the SBF ERC-20 contract.
     */
    constructor() public ERC20("SwapBlast Finance Token", "SBF") {
    ...
    /**
     * @notice Operator mints SBF to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of SBF to mint to
