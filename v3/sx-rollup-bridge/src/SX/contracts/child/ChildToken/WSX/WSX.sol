...
contract WSX is Initializable, UUPSUpgradeable, OwnableUpgradeable, ERC20PresetMinterPauserUpgradeable, NativeMetaTransaction, ContextMixin {
    ...
    function initialize() initializer public {
        ERC20PresetMinterPauserUpgradeable.initialize("Wrapped SX", "WSX");
        __Ownable_init();
