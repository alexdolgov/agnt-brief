...
interface IDepository {
    event DepositLocked(
        ...
        DepositoryTypes.BlockchainState state
    );
    ...
    function depositID(
        ...
        DepositoryTypes.BlockchainState calldata state
...
interface IDepositUnlocker {
    ...
    function unlock(
        ...
        DepositoryTypes.BlockchainState calldata  state, // Blockchain state when deposit was locked.
