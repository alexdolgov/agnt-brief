...
interface ISymmio is
  ...
  IDiamondLoupe
{
  event BalanceChangePartyA(address indexed partyA, uint256 amount, SharedEvents.BalanceChangeType _type);

  event BalanceChangePartyB(address indexed partyB, address indexed partyA, uint256 amount, SharedEvents.BalanceChangeType _type);
}
