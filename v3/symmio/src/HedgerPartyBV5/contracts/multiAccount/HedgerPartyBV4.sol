...
contract HedgerPartyBV4 is HedgerPartyBV3 {
  ...
  function isContractWhitelisted(address _addr) private view returns (bool) {
    PartyBStorageV4 storage sv4 = storeV4();
  ...
  function isAddressWhitelisted(address _addr) private view returns (bool) {
    PartyBStorageV4 storage sv4 = storeV4();
  ...
  function isRebalancerWhitelisted(address _addr) private view returns (bool) {
    PartyBStorageV4 storage sv4 = storeV4();
  ...
  function _isElementInArray(address[] memory array, address item) private pure returns (bool) {
