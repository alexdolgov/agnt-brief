 ...
 *         authorization and automatic fee collection from the FeeCollector.
 *
 * @dev    Upgrade-safe, Access-controlled, Reentrancy-guarded.
 *         Integrates with Symmio, MultiAccount, RFL NFTs, and FeeCollector contracts.
 */
...
contract Rakeback is AccessControlEnumerableUpgradeable, ReentrancyGuardUpgradeable {
	...
	/// @notice FeeCollector contract for claiming protocol fees.
	...
	/**
	 * @dev Collect fees from FeeCollector if contract balance is insufficient.
	 */
