...
contract ZenithSymmioPartyB is Initializable, PausableUpgradeable, AccessControlUpgradeable {
	...
	constructor(address[] memory admins, address withdrawalAddress_, address ledgerWithdrawalAddress_, address symmioAddress_) {
		initialize(admins, withdrawalAddress_, ledgerWithdrawalAddress_, symmioAddress_);
		_disableInitializers();
	}
