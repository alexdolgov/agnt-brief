...
// File: contracts/ZenithSymmioPartyB.sol
...
contract ZenithSymmioPartyB is UUPSUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, PausableUpgradeable {

    address public symmioAddress;
    address private withdrawalAddress;
	address private ledgerWithdrawalAddress;
	 ...
	 */
	function initialize(address[] memory admins, address withdrawalAddress_, address ledgerWithdrawalAddress_, address symmioAddress_) public initializer {
		...
		ledgerWithdrawalAddress = ledgerWithdrawalAddress_;
	...
	function withdrawERC20(address targetAddress, address token, uint256 amount) external onlyRole(MANAGER_ROLE) {
        require(targetAddress == withdrawalAddress || targetAddress == ledgerWithdrawalAddress, "Invalid target withdrawal Address!");
