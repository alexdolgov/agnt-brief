...
contract CoreRouter {
    ...
    constructor() {
        ...
        selectors[3] = 0xb49a3f9d;
        selectors[4] = 0x7d8a4140;
    ...
    address private constant _ACCOUNT_MODULE = 0x3B078D6C1B6D114815C495C99B177200A4872649;
    address private constant _ASSOCIATE_DEBT_MODULE = 0x2436703aBb814DFF0f5b394FD28eb5DD1E7dA400;
    ...
    address private constant _COLLATERAL_MODULE = 0x5C4909b982a106F9f59BD8D6b44c4D38B18E064E;
    ...
    address private constant _ISSUE_USDMODULE = 0x058Dc95F4628DCF7CBFe702fCE0Ec433C6D094F7;
    address private constant _LIQUIDATION_MODULE = 0x4cb44De9e943347E701E9A1D3d80004eE1e9159e;
    ...
    address private constant _REWARDS_MANAGER_MODULE = 0x7CeA62f6191e7990c55A218D1874e40629feEc27;
    address private constant _UTILS_MODULE = 0x750714EC1357042e2102BC25E20e5359C27168d3;
    address private constant _VAULT_MODULE = 0x255fD9cDF297fFe30f62bcC39fD2f1Cd71414e7d;
            ...
            function findImplementation(sig) -> result {
                ...
                if lt(sig,0xc2b0cf41) {
                    ...
                    if lt(sig,0xb7746b59) {
                        ...
                        case 0xb49a3f9d { result := _LIQUIDATION_MODULE } // LiquidationModule.liquidateToTreasury()
                        leave
                    }
                    switch sig
