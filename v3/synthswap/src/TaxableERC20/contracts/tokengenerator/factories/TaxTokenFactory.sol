...
import {ISynthswapTokenFactory} from "../interfaces/ISynthswapTokenFactory.sol";
...
contract TaxTokenFactory is ISynthswapTokenFactory {
    ...
    function deploy(
        ...
        address developmentWallet = additionalData.length > 0
            ? abi.decode(additionalData, (address))
            : address(0);
...
contract TaxableERC20 is Ownable, ERC20, ERC20Permit {
    ...
    function setDevelopmentWallet(address _newWallet) external {
        require(
            msg.sender == developmentWallet || msg.sender == owner(),
            "Unauthorized"
        );
    ...
    function _swapBack() internal {
        ...
        uint256 liquidityTokens = (contractBalance * feesToLiquidity) / 2e18;
        ...
        uint256 ethBalance = ((address(this).balance - initialETHBalance) *
            1e18) / (feesToLiquidity / 2 + feesToDevelopment);
