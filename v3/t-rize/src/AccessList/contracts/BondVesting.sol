...
contract BondVesting {
    ...
    event VestingUpdated(uint256 indexed nftId, uint256 amount, uint64 cliff, uint64 vesting, uint64 start);
    ...
    function _startVesting(
        ...
        emit VestingUpdated(id, schedule.amount, schedule.cliff, schedule.vesting, schedule.start);
    }
