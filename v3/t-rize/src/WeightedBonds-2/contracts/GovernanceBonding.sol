...
import {WeightedBonds, Pool, VestingSchedule} from "./WeightedBonds.sol";
...
contract GovernanceBonding is WeightedBonds, AccessRestricted {
    ...
    /**
     * @notice Updates the vesting schedule. 
     * Vesting can only be decreased.
     * Requires caller to be committee.
     * @param tokenId the bond id
    ...
    function updateVestingSchedule(
        ...
        _updateVesting(tokenId, schedule);
    }
