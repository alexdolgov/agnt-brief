...
contract SingleTokenLiquidityProvider is MulticallUpgradeable, OwnableUpgradeable {
    ...
    function addLiquidity(
        ...
        IERC20Upgradeable(_token).safeTransferFrom(msg.sender, address(_pair), _amount);
        _pair.swap(_zeroForOne ? 0 : _amountOut, _zeroForOne ? _amountOut : 0, address(_pair), "");
