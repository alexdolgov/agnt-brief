...
contract USDRTreasury is AddressAccessor, ITreasury, IERC721Receiver {
        ...
        returns (ITreasury.TreasuryValue memory value)
    {
            ...
            );
        {
            ...
            value.rwaVaults = cValue.vaultsUsdValue * underlyingMultiplier;
    ...
    function updateTrackerFtnft(
        ...
        ITreasuryTracker(tracker).ftnftTreasuryPlaced(ftnft, tokenId, placed);
        ...
        placed
            ? ITreasuryTracker(tracker).addValueAfterPurchase(currency, value)
