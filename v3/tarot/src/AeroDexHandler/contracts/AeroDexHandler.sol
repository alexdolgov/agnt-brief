...
contract AeroDexHandler is IDexHandler {
    constructor() {}
    ...
    function getAmountOut(
        ...
        pair = IBaseV1Factory(_dex).getPool(_tokenIn, _tokenOut, false);
        amountOut = getPairAmountOut(pair, _tokenIn, _amountIn);

        address stablePair = IBaseV1Factory(_dex).getPool(_tokenIn, _tokenOut, true);
