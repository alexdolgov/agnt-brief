...
import "./interfaces/ISoliSnekPairFactory.sol";
import "./interfaces/IVeloGauge.sol";
import "./interfaces/IVeloRouter.sol";
import "./interfaces/IBaseV1Pair.sol";
import "./interfaces/ISoliSnekVaultToken.sol";
...
contract SoliSnekVaultToken is ISoliSnekVaultToken, PoolToken {
    ...
    function _optimalDepositA(
        ...
        uint256 swapFee = ISoliSnekPairFactory(pairFactory).getPairFee(underlying, false);
