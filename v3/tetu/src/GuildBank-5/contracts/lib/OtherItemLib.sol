...
library OtherItemLib {
  ...
  function useOtherItem(
    ...
    if (kind == IItemController.OtherSubtypeKind.REDUCE_FRAGILITY_1) {
      ...
      inSandbox = ItemLib._checkOwnerItems(cc, v.item, otherItem, msgSender)[1];
      ...
      inSandbox = ItemLib.onlyItemOwner(cc, otherItem, v.hero, v.heroId, msgSender, ItemLib._getSandboxMode(cc, v.hero, v.heroId), true);
