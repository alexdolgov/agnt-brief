...
contract TokenManagerERC20 is OwnableUpgradeable, UUPSUpgradeable, PausableUpgradeable {
        ...
        returns (uint256 arenaAmountSentToLP, uint256 tokenAmountSentToLP, uint256 liquidity)
    {
        ...
        (arenaAmountSentToLP, tokenAmountSentToLP, liquidity) = uniswapV2Router02.addLiquidity(ARENA_ADDRESS, tokenAddress, arenaAmount, tokenAmount, 1, 1, LP_TOKEN_VAULT, block.timestamp);
