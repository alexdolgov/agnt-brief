...
contract ICHIVault is IICHIVault, ICLSwapCallback, ERC20, ManualReentrancyGuard, Ownable, IERC721Receiver {
    ...
    */
    ...
    function deposit(
        ...
        require(allowToken0 || deposit0 == 0, "7");
        require(allowToken1 || deposit1 == 0, "8");
        require(deposit0 > 0 || deposit1 > 0, "9");
        require(deposit0 <= deposit0Max && deposit1 <= deposit1Max, "10");
        require(to != address(0) && to != address(this), "11");
    ...
    */
    function _withdrawFromPosition(
        ...
        require(tokensOwed0 == 0 && tokensOwed1 == 0, "12");
    ...
    function withdraw(
        ...
        _preAction(_lastActiveGauge);
        require(shares > 0, "13");
        require(to != address(0), "14");

        uint256 _totalSupply = totalSupply();
        require(shares == _totalSupply || _totalSupply >= shares.add(MIN_SHARES), "15");
    ...
    function rebalance(
        ...
        require(_baseLower != _limitLower || _baseUpper != _limitUpper, "18");
    ...
    function setBaseFeeOverride(uint256 _baseFee) external override {
        ...
        if (_baseFee != type(uint256).max) {
            require(_baseFee <= PRECISION, "20");
            uint256 currentAmmFee = IICHIVaultFactory(ichiVaultFactory).ammFee();
            require(_baseFee.add(currentAmmFee) <= PRECISION, "21");
        }
