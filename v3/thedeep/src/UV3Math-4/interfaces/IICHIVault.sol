...
interface IICHIVault {
    ...
    function lastActiveGauge() external view returns (address);
    ...
    function getEffectiveBaseFee() external view returns (uint256);
    ...
    function setBaseFeeOverride(uint256 _baseFee) external;
