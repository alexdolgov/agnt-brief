...
contract ICHIVault is IICHIVault, IUniswapV3MintCallback, IUniswapV3SwapCallback, ERC20, ReentrancyGuard, Ownable {
    ...
    */
    ...
    function validateDepositAndSyncFees(
        ...
        // Check if current tick is too close to extreme bounds to prevent overvaluation
        int24 tick = currentTick();
        require(tick >= -887272 + 1000, "IV.deposit: tick too low");
        require(tick <= 887272 - 1000, "IV.deposit: tick too high");
