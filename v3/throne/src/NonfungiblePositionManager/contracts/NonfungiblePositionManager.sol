...
/// @title NFT positions
/// @notice Wraps Throne V3 positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    constructor(
        ...
        ERC721Permit('Throne V3 Positions NFT-V1', 'THRONE-V3-POS', '1')
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IThroneV3Pool pool = IThroneV3Pool(PoolAddress.computeAddress(deployer, poolKey));
