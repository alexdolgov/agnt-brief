...
contract AtmwSale is Ownable, Pausable {
    ...
    uint256 public minDepositWad = 25 ether;
    uint256 public maxDepositWad = type(uint256).max;
    uint256 public hardcap = 30000 ether;
    uint256 public totalDeposits;

    uint256 public startEpoch = 1683032400;
    uint256 public endEpoch = 1685624400;
        ...
        whenNotPaused
    {
        ...
        uint256 wad = CZUSD.balanceOf(address(this));
        ...
        wad = CZUSD.balanceOf(address(this)) - wad;
