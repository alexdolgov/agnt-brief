# Agentic Audit Brief: Titano Swych
...
This brief describes the observed EVM deployment and audit surface for Titano Swych. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [DL audit link](https://skynet.certik.com/projects/titano) | CertiK | Audit | 2023-07 | stale | Direct | address | matched | 1 | 0 | 0 | 0 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [18436] DL audit link — matched: Only one contract file (Titano.sol) is explicitly listed in the audited files section. The report is for Titano Finance v2.
