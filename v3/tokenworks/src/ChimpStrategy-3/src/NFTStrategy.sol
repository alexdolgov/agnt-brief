...
contract NFTStrategy is Initializable, UUPSUpgradeable, Ownable, ReentrancyGuard, ERC20 {
    ...
    function syncOrderStatus(uint256[] calldata tokenIds) external virtual nonReentrant {
        uint256 totalReward;
    ...
    function _createSeaportListing(uint256 tokenId, uint256 price) internal virtual {
    ...
    function _cancelSeaportListingIfExists(uint256 tokenId) internal virtual {
        bytes32 orderHash = tokenIdToOrderHash[tokenId];
