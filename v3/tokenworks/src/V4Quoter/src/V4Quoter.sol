...
contract V4Quoter is IV4Quoter, BaseV4Quoter {
    ...
    address public constant TOKEN_WORKS = 0x019817aD02a31B990433542097bE29D97613E8Cb;
    ...
    /// @dev The V4Quoter does NOT have a msgSender() function for some reason, so need to add it ourselves to simulate swaps
