...
library NFTSVG {
    ...
    function generateArt() private pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                ...
                '<g id="topaz" transform="translate(400 369) scale(0.4) translate(-300 -307)">',
    ...
    function generateWordmark() private pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                '<g id="wordmark" transform="translate(400 512) scale(0.26) translate(-240 -83.5)">',
