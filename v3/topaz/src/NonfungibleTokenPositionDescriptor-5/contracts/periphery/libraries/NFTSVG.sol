...
library NFTSVG {
    ...
    function generateArt() private pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                '<circle fill="#0F1629" r="165.837" cy="399.837" cx="400" id="circle"/>',
                '<g id="topaz" transform="translate(400 399.837) scale(0.85) translate(-256 -270)">',
                '<polygon points="150,150 220,150 190,205 110,205" fill="#F4B400"/>',
                '<polygon points="235,150 277,150 302,205 210,205" fill="#FFD54A"/>',
                '<polygon points="292,150 362,150 402,205 322,205" fill="#F7C600"/>',
                '<polygon points="110,220 190,220 245,390" fill="#E2A100"/>',
                '<polygon points="210,220 302,220 256,390" fill="#F4B400"/>',
                '<polygon points="322,220 402,220 267,390" fill="#F7C600"/>',
                "</g>"
            )
        );
    }
