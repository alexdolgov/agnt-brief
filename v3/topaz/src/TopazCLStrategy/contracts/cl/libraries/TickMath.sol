...
/// @notice Computes sqrt(1.0001^tick) as a Q64.96. Canonical Uniswap v3 TickMath
///         (only the tick → sqrtRatio direction; the pool supplies the current
///         tick via slot0, so the reverse direction is unused).
library TickMath {
