# Agentic Audit Brief: Tori Finance
...
- Project: Tori Finance (`tori-finance`)
- Website: [https://tori.finance/](https://tori.finance/)
- Lifecycle: unknown
...
- DeFi Llama TVL: $49,847,693.58
- On-chain TVL (included contracts): n/a
- TVL by chain: n/a

## Project Description

No contract logic was present for Tori Finance in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
