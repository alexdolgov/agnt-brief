...
contract Smols is
    UtilitiesV3Upgradeable,
    ERC721Upgradeable
{
    bytes32 internal constant PRIVILIGED_MINTER_ROLE = keccak256("PRIVILIGED_MINTER");
    ...
    function initialize() public initializer {
        ...
        //The first version of this used v2, it now uses v3
    ...
    function privilegedMint(address _to, uint256 _tokenId) external requiresEitherRole(OWNER_ROLE, SMOLS_PRIVILIGED_MINTER_ROLE){
    ...
    function setSmolsAddressRegistry(address _smolsAddressRegistry) external requiresRole(OWNER_ROLE) {
