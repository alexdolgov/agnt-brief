...
// File: contracts/trebleswap/contracts/core/TREB.sol
...
contract TREB is ERC20, ERC20Burnable, ERC20Capped, Ownable {
    ...
    modifier hasMinterRole() {
        require(
            isMinter[msg.sender],
            "TREB: You don't have the minting permission!"
        );
        _;
    }
    ...
    constructor(
        ...
        uint256 cap
    ) ERC20("TREB", "TREB") Ownable(initialOwner) ERC20Capped(cap) {}
    ...
    function assignMinterRole(address _account) public onlyOwner {
        ...
        emit MinterRoleAssigned(msg.sender, _account);
    }

    function revokeMinterRole(address _account) public onlyOwner {
        isMinter[_account] = false;

        emit MinterRoleRevoked(msg.sender, _account);
    }
}