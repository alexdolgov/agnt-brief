...
contract RepricingOracle is IRepricingOracle, Initializable {
  ...
  error AdminNoInvalidSnapshotMetaTimestamp(
    uint256 requiredInvalidBlockTimestampReprice_slot8650592,
    uint256 currentBlockTimestampReprice_slot8650592
  );

  event AdminCorrectedSnapshotMetaTimestamp(
    uint256 invalidBlockTimestampReprice_slot8650592,
    uint256 correctedBlockTimestampReprice_slot8650592
  );

  function adminCorrectSnapshotMetaTimestamp()
    external
    checkRole(SwellLib.PLATFORM_ADMIN)
  {
    uint256 invalidBlockTimestampReprice_slot8650592 = 115792089237316195423570985008687907853269984665640564039457584007850994043136;
    uint256 correctedBlockTimestampReprice_slot8650592 = 1710412247;

    if (
      _lastRepriceSnapshot.meta.timestamp !=
      invalidBlockTimestampReprice_slot8650592
    ) {
      // The invalid value is not present
      revert AdminNoInvalidSnapshotMetaTimestamp(
        invalidBlockTimestampReprice_slot8650592,
        _lastRepriceSnapshot.meta.timestamp
      );
    }

    _lastRepriceSnapshot
      .meta
      .timestamp = correctedBlockTimestampReprice_slot8650592;

    emit AdminCorrectedSnapshotMetaTimestamp(
      invalidBlockTimestampReprice_slot8650592,
      correctedBlockTimestampReprice_slot8650592
    );
  }
}
