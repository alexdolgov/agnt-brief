...
// File: contracts/feeds/PriceFeedsConstants.sol
...
// File: contracts/feeds/InternalOracle..sol
...
contract InternalOracle is IPriceFeedsExt, Ownable {
    ...
    function latestAnswer() external view returns (uint256 _price) {
        IStdReference.ReferenceData memory data =
            ref.getReferenceData("Sample", "USD");
        _price = data.rate;
    }
    ...
    function setRefOracleAddress(IStdReference _ref) public onlyOwner {
        ref = _ref;
    }
}