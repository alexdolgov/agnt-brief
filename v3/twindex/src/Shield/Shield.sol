...
// File: mainnet/IFairLaunchV1.sol
...
interface IFairLaunchV1 {
  ...
  function dopplePerBlock() external view returns (uint256);
...
contract Shield is Ownable {
  ...
  /// @dev Maunally mint DOPPLE warchest portion.
