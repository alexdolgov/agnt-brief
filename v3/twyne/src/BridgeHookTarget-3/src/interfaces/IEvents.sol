...
interface IEvents {
    ...
    event T_SetMaxLiqLTV(address indexed collateralAddress, uint16 ltv, uint32 rampDuration);
    event T_SetExternalLiqBuffer(address indexed collateralAddress, uint16 liqBuffer, uint32 rampDuration);
