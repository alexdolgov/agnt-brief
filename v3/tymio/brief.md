...
This brief describes the observed EVM deployment and audit surface for TYMIO. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
- Frameworks: openzeppelin (2), uniswap-v3 (2)
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [TYMIO Security Analysis by Pessimistic.pdf](https://github.com/pessimistic-io/audits/blob/f2c817cecb35ecd831f5cc73aa99c58b484c0d13/TYMIO%20Security%20Analysis%20by%20Pessimistic.pdf) | unknown | Audit | 2024-03 | stale | Direct | contract_name | matched | 1 | 0 | 0 | 0 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [14053] TYMIO Security Analysis by Pessimistic.pdf — matched: Only one contract, PayerV3, was explicitly listed in scope. The report date is March 13, 2024.
