...
- Project: Umee (`umee`)
- Website: [https://www.umee.cc/](https://www.umee.cc/)
- Lifecycle: unknown
...
No contract logic was present for Umee in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
...
| UnnamedContract | unknown | retained_scope_excluded_inventory | address_book_excluded_inventory (excluded) | 0 | ethereum | n/a | `0x7d2768de32b0b80b7a3454c06bdac94a69ddc7a9` | ❓ Unverified |
