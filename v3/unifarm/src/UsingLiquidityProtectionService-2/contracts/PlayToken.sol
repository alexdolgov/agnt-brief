...
ERC20,
Ownable,
UsingLiquidityProtectionService(0xa14278eB49C0d622493E3bA302A4D8A44ebA4bD3) {
    ...
    function mint(address _address,uint256 amount) external onlyMinter(){
        ...
        require(totalSupply().add(amount) <= maximumSupply,"PlayToken: totalSupply must be less than maximumSupply");
    ...
    function protectionChecker() internal view override returns(bool) {
         return ProtectionSwitch_timestamp(1647348449); // Switch off protection automatically on Tuesday, February 15, 2022 11:59:59 PM GMT.
