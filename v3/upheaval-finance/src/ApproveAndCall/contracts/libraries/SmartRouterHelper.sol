...
import '@upheavalswap/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
library SmartRouterHelper {
    ...
    // bytes32 internal constant V2_INIT_CODE_HASH = 0x322cd15b147cc34c1fa71f2d45d01c29d0e86ba8e7e4a307ee98a4383b8e8016; // BSC TESTNET
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x322cd15b147cc34c1fa71f2d45d01c29d0e86ba8e7e4a307ee98a4383b8e8016;
    ...
    /// @param deployer The UpheavalSwap V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (IUpheavalV3Pool) {
        return IUpheavalV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid UpheavalSwap V3 Pool
    /// @param deployer The contract address of the UpheavalSwap V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IUpheavalV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (IUpheavalV3Pool pool)
    {
        pool = IUpheavalV3Pool(computeAddress(deployer, poolKey));
