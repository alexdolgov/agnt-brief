...
import '@upheavalswap/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@upheavalswap/v3-core/contracts/libraries/SafeCast.sol';
import '@upheavalswap/v3-core/contracts/libraries/TickMath.sol';
import '@upheavalswap/v3-core/contracts/libraries/TickBitmap.sol';
import '@upheavalswap/v3-core/contracts/interfaces/IUpheavalV3Pool.sol';
import '@upheavalswap/v3-core/contracts/interfaces/callback/IUpheavalV3SwapCallback.sol';
import '@upheavalswap/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IUpheavalV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IUpheavalV3Pool;
    ...
    */
    ...
    /// @inheritdoc IUpheavalV3SwapCallback
    function pancakeV3SwapCallback(
        ...
        IUpheavalV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IUpheavalV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
