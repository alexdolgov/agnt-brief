...
interface IPancakeV3Factory {
    ...
    /// @notice Emitted when the pairFeesV3 of the factory is changed
    /// @param oldPairFeesV3 The pairFeesV3 before the pairFeesV3 was changed
    /// @param newPairFeesV3 The pairFeesV3 after the pairFeesV3 was changed
    event PairFeesV3Changed(address indexed oldPairFeesV3, address indexed newPairFeesV3);
    ...
    /// @notice Returns the current owner of the factory
    /// @dev Can be changed by the current owner via setOwner
    /// @return The address of the factory pairFeesV3
    function pairFeesV3() external view returns (address);
    ...
    /// @notice Updates the owner of the factory
    /// @dev Must be called by the current owner
    /// @param _pairFeesV3 The new owner of the factory
    function setPairFeesV3(address _pairFeesV3) external;
