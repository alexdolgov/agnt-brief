...
// GemJoin5
// For tokens with decimals < 18 (e.g. WBTC with 8 decimals).
// Normalises token amount to 18-decimal WAD when interacting with the Vat.
...
contract GemJoin5 {
    ...
    modifier auth { require(wards[msg.sender] == 1, "GemJoin5/not-authorized"); _; }
    ...
    // amt: token amount in native decimals (e.g. 1e8 for 1 WBTC)
    // wad: normalised amount in 18 decimals written to the Vat
