...
// src/interfaces/dss/UsddJoinAbstract.sol
...
// src/urns/RwaUrnCloseHelper.sol
...
interface RwaUrnLike {
    ...
    function usddJoin() external view returns (UsddJoinAbstract);
...
contract RwaUrnCloseHelper {
     ...
     * @dev It requires that enough Usdd to repay the debt is already deposited into the `urn`.
     * @dev Any remaining Usdd balance is sent back to the output conduit when possible.
    ...
    /**
     * @notice Estimates the amount of Usdd required to fully repay a loan at `when` given time.
     ...
     * @return wad The amount of Usdd required to make a full repayment.
     */
