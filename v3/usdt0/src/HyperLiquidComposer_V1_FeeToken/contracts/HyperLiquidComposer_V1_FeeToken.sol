...
/**
 * @title HyperLiquidComposer_V1_FeeToken
 ...
 */
contract HyperLiquidComposer_V1_FeeToken is FeeToken, RecoverableComposer {
    /**
    ...
    ) HyperLiquidComposer(_oft, _hlIndexId, _assetDecimalDiff) FeeToken() RecoverableComposer(_recoveryAddress) {}

    function _getFinalCoreAmount(
        address _to,
        uint64 _coreAmount
    ) internal view override(FeeToken, HyperLiquidComposer) returns (uint64) {
