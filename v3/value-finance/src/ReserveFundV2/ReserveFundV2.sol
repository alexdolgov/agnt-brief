...
contract ReserveFundV2 {
    ...
    function exitFromPool(address _pool, uint256 _pid) external onlyStrategist {
    ...
    function _pancakeSwapToken(
        ...
        IUniswapV2Router(pancakeRouter).swapExactTokensForTokens(_amount, 1, _path, msg.sender, block.timestamp.add(60));
    }
    ...
    function _pancakeAddLiquidity(
        ...
        IUniswapV2Router(pancakeRouter).addLiquidity(_tokenA, _tokenB, _amountADesired, _amountBDesired, 1, 1, msg.sender, block.timestamp.add(60));
    ...
    function _pancakeRemoveLiquidity(address _pair, uint256 _liquidity) internal {
        ...
        IUniswapV2Router(pancakeRouter).removeLiquidity(_tokenA, _tokenB, _liquidity, 1, 1, msg.sender, block.timestamp.add(60));
    }
