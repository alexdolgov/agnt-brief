...
contract DebtToken is IDebtToken, ERC20Permit, Ownable {
    string private constant _NAME = "Vaultedge Debt Token";
    string private constant _SYMBOL = "USDVE";
    ...
    function _requireCallerIsBOorVM() internal view {
        require(
            msg.sender == borrowerOperationsAddress || msg.sender == vesselManagerAddress,
            "DebtToken: Caller is neither BorrowerOperations nor VesselManager"
        );
    }
