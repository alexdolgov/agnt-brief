...
import "./ISharedProtocolBase.sol";
import "./IVesselManager.sol";

interface IVesselManagerOperations is ISharedProtocolBase {
    // Events -----------------------------------------------------------------------------------------------------------
    ...
    function getRedemptionHints(
        ...
        external
        returns (address firstRedemptionHint, uint256 partialRedemptionHintNICR, uint256 truncatedDebtTokenAmount);
