...
/**
 * @title VeilETHQueue v2.0.0
 * @author Veil Cash
 * @dev Fixes minimum deposit check to validate shielded amount after fee deduction
 */
/// @custom:oz-upgrades-from VeilETHQueue
contract VeilETHQueueV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    /// @notice Events
