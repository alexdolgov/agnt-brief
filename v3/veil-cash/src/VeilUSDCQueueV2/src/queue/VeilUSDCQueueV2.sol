...
/**
 * @title VeilUSDCQueue v2.0.0
 * @author Veil Cash
 * @dev Queue contract for USDC deposits with screening support
 */
/// @custom:oz-upgrades-from VeilUSDCQueue
contract VeilUSDCQueueV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    /// @notice Events
