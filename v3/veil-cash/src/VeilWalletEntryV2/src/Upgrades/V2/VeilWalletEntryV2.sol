...
/**
 * @title VeilWalletEntry v2.0.0
 * @author Veil Cash
 * @dev Veil Wallet - Entry point for depositing ETH into the Veil pools
 */
/// @custom:oz-upgrades-from VeilWalletEntry
contract VeilWalletEntryV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    /// @dev Events
