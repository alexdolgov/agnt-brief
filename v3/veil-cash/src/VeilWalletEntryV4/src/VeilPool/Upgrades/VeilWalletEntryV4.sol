...
/**
 * @title VeilWalletEntry v4.0.0
 * @author Veil Cash
 * @dev Veil Wallet - Entry point for depositing ETH into the Veil pools with seperate queue contract
 */
/// @custom:oz-upgrades-from VeilWalletEntryV3
contract VeilWalletEntryV4 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
