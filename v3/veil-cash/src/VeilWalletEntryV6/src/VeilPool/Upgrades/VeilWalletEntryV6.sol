...
/**
 * @title VeilWalletEntry v6.0.0
 * @author Veil Cash
 * @dev Veil Wallet - Entry point for depositing ETH into the Veil pools with seperate queue contract
 */
/// @custom:oz-upgrades-from VeilWalletEntryV5
contract VeilWalletEntryV6 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
