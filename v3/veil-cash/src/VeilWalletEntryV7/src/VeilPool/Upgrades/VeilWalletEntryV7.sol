...
/**
 * @title VeilWalletEntry v7.0.0
 * @author Veil Cash
 * @dev Veil Wallet - Entry point for depositing ETH into the Veil pools with seperate queue contract
 */
/// @custom:oz-upgrades-from VeilWalletEntryV6
contract VeilWalletEntryV7 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
