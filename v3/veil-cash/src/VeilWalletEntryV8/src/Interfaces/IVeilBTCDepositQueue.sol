...
/// @title IVeilBTCDepositQueue
/// @notice Interface for VeilBTCDepositQueue contract
interface IVeilBTCDepositQueue {
    /// @notice Queue a BTC deposit with a deposit key
