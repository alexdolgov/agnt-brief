...
/**
 * @title VeilWalletEntry v9.0.0
 * @author Veil Cash
 * @dev Veil Wallet - Entry point for depositing ETH into the Veil pools with seperate queue contract
 */
/// @custom:oz-upgrades-from VeilWalletEntryV8
contract VeilWalletEntryV9 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
