...
contract WavesTracker is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    error OnlyValidator();
     ...
     */
    function claim(uint256 wave) external nonReentrant {
        /// to do in contract upgrade
    }
