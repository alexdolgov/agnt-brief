...
interface ITokenFarm {
    ...
    function claimableV2(address _account) external view returns (uint256);
    ...
    function getStakedAmount(address _stakeToken, address _account) external view returns (uint256, uint256);

    function getTotalVested(address _account) external view returns (uint256);

    function getTotalVestingAmount(address _account) external view returns (uint256);
