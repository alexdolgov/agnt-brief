...
contract VelaBoost is Ownable {
    event BoostRequested(address indexed sender, uint256 amount);
    ...
    constructor(address _velaTokenAddress) {
        ...
        transferOwnership(0xD21628dB849bC5e310bC3D9b590FB2650038Fe6b);
    }
    ...
    function boost() public {
        ...
        emit BoostRequested(msg.sender, boostAmount);
    }
