...
- Token (`0xf486ad...f6fd46`, chain 56)
...
|---|---|---|---|---:|---|---|---|---|
| Token | token | project_anchor | own_supporting | 0 | bsc | unit-395632 | `0xf486ad...f6fd46` | ⚠️ Unaudited |
...
|---|---|---|---|---:|---|
| bsc | `0xf486ad...f6fd46` | Token | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
