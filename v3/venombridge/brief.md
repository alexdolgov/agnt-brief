...
No contract logic was present for VenomBridge in the closed normalized topography run; this brief does not infer a protocol purpose from missing code.
...
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [skynet.certik.com/projects/venom-bridge](https://skynet.certik.com/projects/venom-bridge) | CertiK | Audit | 2022-11 | stale | Direct | contract_name | no match | 0 | 0 | 0 | 2 | medium |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [3237] skynet.certik.com/projects/venom-bridge — no match: Extracted from audited files list; only two contract names explicitly mentioned. Audit date from 'Last Audit was delivered on 11/3/2022'.
...
|---|---|---|---|---|---|
| skynet.certik.com/projects/venom-bridge | TransferUtils | unmatched — not counted | — | listed in audited files | no |
| skynet.certik.com/projects/venom-bridge | Receiver | unmatched — not counted | — | listed in audited files | no |
