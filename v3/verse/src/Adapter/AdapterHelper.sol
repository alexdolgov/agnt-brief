...
abstract contract AdapterHelper is AdapterDeclarations {
    ...
    */
    ...
    uint256 private constant DEPOSITED_IN_LIQUID_NFTS = 280 * 1E18;
    uint256 private constant DEPOSITED_IN_WISE_LENDING = 110 * 1E18;
    ...
    */
    ...
    {
        if (PAUSE_GROW == true) {
            return DEPOSITED_IN_LIQUID_NFTS;
        }
    ...
    */
    ...
    {
        if (PAUSE_GROW == true) {
            return DEPOSITED_IN_WISE_LENDING;
        }
