...
contract VerusStorage {
    ...
    mapping (bytes32 => mapping(address => uint256)) public refunds; // Failed transaction refunds
    ...
    mapping (address => uint) successfulVoteHashes; // Used hashes of contract upgrades
