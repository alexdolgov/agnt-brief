...
interface IDevSrcBridge {
    ...
    event WithdrawedSolana(address indexed account, address token, uint256 amount, bytes32 indexed recipient, bytes32 indexed requestHash);
