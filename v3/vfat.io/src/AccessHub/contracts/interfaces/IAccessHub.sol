...
interface IAccessHub {
    ...
    function createCLGaugeOveridden(address tokenA, address tokenB, int24 tickSpacing) external;
    function resetVotesOnBehalfOf(address _user) external;
    function resetGauge(address _user, address _pool, int24 _tickspaceTo) external;
