...
} from "contracts/connectors/aerodrome/AerodromeGaugeConnector.sol";
import {
...
import {
    ICLPoolFactory
} from "contracts/interfaces/external/aerodrome/ICLPoolFactory.sol";
import {
    IV2PoolFactory
} from "contracts/interfaces/external/aerodrome/IV2PoolFactory.sol";
...
contract AerodromeGaugeRegistry is ICustomConnectorRegistry {
    ...
    ICLPoolFactory public immutable ignitionPoolFactory;
    ICLPoolFactory public immutable aerodromeClPoolFactory;
    ...
    constructor(
        ...
        ICLPoolFactory ignitionPoolFactory_,
        ICLPoolFactory aerodromeClPoolFactory_,
        ...
        ignitionPoolFactory = ignitionPoolFactory_;
        aerodromeClPoolFactory = aerodromeClPoolFactory_;
    ...
    function connectorOf(
        ...
        if (voter.isGauge(target)) {
            ...
            if (
                slipstreamPoolFactory.isPool(pair)
                    || ignitionPoolFactory.isPool(pair)
                    || aerodromeClPoolFactory.isPool(pair)
            ) {
