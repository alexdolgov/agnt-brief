...
/// @dev Minimal interface for Algebra pools (used for direct pool swaps)
...
/// @dev Minimal interface for Uniswap V3-style pools (direct swaps)
...
interface IUniversalRouterPermit2 {
...
contract MultiSwapRouter {
    ...
    // Selectors
    bytes4 internal constant SELECTOR_SWAP_EXACT_TOKENS_FOR_TOKENS_SOLIDLY = 0xf41766d8;
    bytes4 internal constant SELECTOR_SWAP_EXACT_TOKENS_FOR_TOKENS_BLACKHOLE = 0x204b5c0a;
    bytes4 internal constant SELECTOR_EXACT_INPUT_SINGLE_V3_ROUTER02 = 0x04e45aaf;
    bytes4 internal constant SELECTOR_EXACT_INPUT_SINGLE_V3_ROUTER = 0x414bf389;
    bytes4 internal constant SELECTOR_EXACT_INPUT_SINGLE_SLIPSTREAM = 0xa026383e;
    bytes4 internal constant SELECTOR_EXACT_INPUT_SINGLE_ALGEBRA = 0xbc651188;
    bytes4 internal constant SELECTOR_EXACT_INPUT_SINGLE_ALGEBRA_INTEGRAL = 0x1679c792;
    ...
    /// @dev Full V4 PoolKey for ABI encoding with currencies
    struct V4PoolKeyFull {
        address currency0;
        address currency1;
        uint24 fee;
        int24 tickSpacing;
    ...
    /// @dev ExactInputSingle params for V4 ABI encoding
    struct V4ExactInputSingleParams {
        V4PoolKeyFull poolKey;
        bool zeroForOne;
        uint128 amountIn;
    ...
    function _swapUniswapV4(
        ...
        if (poolKey.hooks != address(0)) {
            allowlist.requireAllowedHook(poolKey.hooks);
        }
    ...
    function _buildV4Input(
        ...
        V4ExactInputSingleParams memory swapParams = V4ExactInputSingleParams({
            poolKey: V4PoolKeyFull({
                currency0: currency0,
                currency1: currency1,
                fee: poolKey.fee,
    ...
    function _encodeExactInputSingleRouter02(
        ...
        return abi.encodeWithSelector(
            SELECTOR_EXACT_INPUT_SINGLE_V3_ROUTER02,
            tokenIn,
            tokenOut,
            fee,
            address(this),
    ...
    function _encodeExactInputSingleRouter(
        ...
        return abi.encodeWithSelector(
            SELECTOR_EXACT_INPUT_SINGLE_V3_ROUTER,
            tokenIn,
            tokenOut,
            fee,
            address(this),
    ...
    function _encodeSolidlySwap(
        SolidlyRoute[] memory routes,
        uint256 amountIn
    ) internal view returns (bytes memory) {
        return abi.encodeWithSelector(
            SELECTOR_SWAP_EXACT_TOKENS_FOR_TOKENS_SOLIDLY,
            amountIn,
            0,
            routes,
            address(this),
    ...
    function _encodeAlgebraIntegralSwap(
        ...
        return abi.encodeWithSelector(
            SELECTOR_EXACT_INPUT_SINGLE_ALGEBRA_INTEGRAL,
            step.tokenIn,
            step.tokenOut,
            deployer,
            address(this),
    ...
    function _encodeAlgebraSwap(
        ...
        return abi.encodeWithSelector(
            SELECTOR_EXACT_INPUT_SINGLE_ALGEBRA,
            step.tokenIn,
            step.tokenOut,
            address(this),
            block.timestamp,
    ...
    function _encodeSlipstreamSwap(
        ...
        return abi.encodeWithSelector(
            SELECTOR_EXACT_INPUT_SINGLE_SLIPSTREAM,
            step.tokenIn,
            step.tokenOut,
            tickSpacing,
            address(this),
    ...
    function _encodeBlackholeSwap(
        ...
        return abi.encodeWithSelector(
            SELECTOR_SWAP_EXACT_TOKENS_FOR_TOKENS_BLACKHOLE,
            amountIn,
            0,
            routes,
            address(this),
    ...
    function _validateV3PoolAndDirection(
        ...
        IUniswapV3PoolMinimal v3pool = IUniswapV3PoolMinimal(pool);
    ...
    function _readFeeAndTickSpacing(address pool) internal view returns (uint24 fee, int24 tickSpacing) {
        (bool ok, bytes memory data) = pool.staticcall(
            abi.encodeWithSelector(IUniswapV3PoolMinimal.fee.selector)
        );
        ...
        (ok, data) = pool.staticcall(
            abi.encodeWithSelector(IUniswapV3PoolMinimal.tickSpacing.selector)
        );
        if (ok && data.length >= 32) {
    ...
    function uniswapV3SwapCallback(
        ...
        IUniswapV3PoolMinimal v3pool = IUniswapV3PoolMinimal(msg.sender);
        address token0 = v3pool.token0();
        address token1 = v3pool.token1();
        address factory = v3pool.factory();
