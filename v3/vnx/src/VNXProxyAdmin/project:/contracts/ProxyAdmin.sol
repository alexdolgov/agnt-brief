/**
 * VNX Proxy Admin Smart Contract
 * Updated:   17.07.2025
...
contract VNXProxyAdmin is ProxyAdmin {
     ...
     */
    function upgrade(ITransparentUpgradeableProxy proxy, address implementation) public override virtual onlyUpgradeAdmin {
    ...
    function upgradeAndCall(
        ...
        bytes memory data
    ) public override payable virtual onlyUpgradeAdmin {
