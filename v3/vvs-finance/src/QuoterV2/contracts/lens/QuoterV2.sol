...
import '@cronos-labs/vvs-v3-core/contracts/libraries/TickMath.sol';
import '@cronos-labs/vvs-v3-core/contracts/libraries/TickBitmap.sol';
import '@cronos-labs/vvs-v3-core/contracts/interfaces/IVVSV3Pool.sol';
import '@cronos-labs/vvs-v3-core/contracts/interfaces/callback/IVVSV3SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IVVSV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IVVSV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IVVSV3Pool) {
        return IVVSV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IVVSV3SwapCallback
    function vvsV3SwapCallback(
        ...
        IVVSV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IVVSV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
