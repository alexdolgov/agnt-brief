...
contract WardenMdexRouter is IWardenTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    ISwapMining public constant swapMining = ISwapMining(0x782395303692aBeD877d2737Aa7982345eB44c11);
    address public feeGetter = 0xC146A672c85b408a9A7BC00F74AD567b7684134C;
    IERC20 public mdx = IERC20(0x9C65AB58d8d978DB963e63f2bfB7121627e3a739);
    ...
    function updateFeeGetter (address _feeGetter)
        external
        onlyWhitelistAdmin
    {
    ...
    function claim () external {
        ...
        mdx.safeTransfer(feeGetter, mdx.balanceOf(address(this)));
    }
}