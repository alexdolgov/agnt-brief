...
// File contracts/interfaces/IBNBVaultAdapterV2WithIndirection.sol

pragma solidity ^0.6.12;

/// Interface for all Vault Adapter implementations.
interface IBNBVaultAdapterV2WithIndirection {
...
// File contracts/libraries/alchemist/BNBVaultV2WithIndirection.sol
...
/// @title BNBVaultV2WithIndirection
///
/// @dev A library which provides the Vault data struct and associated functions.
library BNBVaultV2WithIndirection {
  using BNBVaultV2WithIndirection for Data;
  using BNBVaultV2WithIndirection for List;
  using SafeMath for uint256;

  struct Data {
    IBNBVaultAdapterV2WithIndirection adapter;
...
// File contracts/MigratableBNBTransmuterV2.sol
 ...
 */
contract MigratableBNBTransmuterV2 is Context {
    using SafeMath for uint256;
    using SafeERC20 for IERC20Burnable;
    using Address for address;
    using BNBVaultV2WithIndirection for BNBVaultV2WithIndirection.Data;
    using BNBVaultV2WithIndirection for BNBVaultV2WithIndirection.List;
    ...
    uint256 public plantableThreshold = 5000000000000000000000; // 5k
    ...
    /// deposits and withdraws. BNBVaultV2WithIndirection before the last element are considered inactive and are expected to be cleared.
    BNBVaultV2WithIndirection.List private _vaults;
    ...
    event ActiveVaultUpdated(
        IBNBVaultAdapterV2WithIndirection indexed adapter
    );
    ...
    constructor(address _waToken, address _token, address _governance) public {
        require(_governance != ZERO_ADDRESS, "MigratableBNBTransmuterV2: 0 gov");
    ...
    modifier onlyWhitelisted() {
        require(whiteList[msg.sender], "MigratableBNBTransmuterV2: !whitelisted");
        _;
    }
    ...
    ///
    modifier onlyGov() {
        require(msg.sender == governance, "MigratableBNBTransmuterV2: !governance");
        _;
    }
    ...
    function claim() public {
        ...
        require(realisedTokens[sender] > 0, "MigratableBNBTransmuterV2: no realisedToken balance for sender");
    ...
    function unstake(uint256 amount) public updateAccount(msg.sender) {
        ...
        address sender = msg.sender;
        require(depositedWaTokens[sender] >= amount, "MigratableBNBTransmuterV2: unstake amount exceeds deposited amount");
    ...
    function stake(uint256 amount)
        ...
        checkIfNewUser()
    {
        require(!pause, "MigratableBNBTransmuterV2: emergency pause enabled");
    ...
    function transmute() public runPhasedDistribution() updateAccount(msg.sender) {
        ...
        require(pendingz > 0, "MigratableBNBTransmuterV2: need to have pending in bucket");
        ...
        checkIfNewUser()
    {
        ...
        require(
            ...
            "MigratableBNBTransmuterV2: !overflow"
        );
    ...
    function setPendingGovernance(address _pendingGovernance) external onlyGov() {
        require(_pendingGovernance != ZERO_ADDRESS, "MigratableBNBTransmuterV2: 0 gov");
    ...
    function acceptGovernance() external  {
        require(msg.sender == pendingGovernance, "MigratableBNBTransmuterV2: !pendingGovernance");
    ...
    function setActiveVault(IBNBVaultAdapterV2WithIndirection _adapter) external onlyGov() {
        require(_adapter != IBNBVaultAdapterV2WithIndirection(ZERO_ADDRESS), "MigratableBNBTransmuterV2: active vault address cannot be 0x0.");
        require(address(_adapter.token()) == token, "MigratableBNBTransmuterV2.vault: token mismatch.");

        _vaults.push(BNBVaultV2WithIndirection.Data({
            adapter: _adapter,
            totalDeposited: 0
        }));
    ...
    function recallAllFundsFromVault(uint256 _vaultId) external {
        require(pause && (msg.sender == governance || msg.sender == sentinel), "MigratableBNBTransmuterV2: not paused, or not governance or sentinel");
    ...
    function _recallAllFundsFromVault(uint256 _vaultId) internal {
        BNBVaultV2WithIndirection.Data storage _vault = _vaults.get(_vaultId);
    ...
    function _plantOrRecallExcessFunds() internal {
        ...
        if (bal > plantableThreshold.add(marginVal)) {
            ...
            BNBVaultV2WithIndirection.Data storage _activeVault = _vaults.last();
    ...
    function setSentinel(address _sentinel) external onlyGov() {
        require(_sentinel != ZERO_ADDRESS, "MigratableBNBTransmuterV2: sentinel address cannot be 0x0.");
        sentinel = _sentinel;
    ...
    function setPause(bool _pause) external {
        require(msg.sender == governance || msg.sender == sentinel, "MigratableBNBTransmuterV2: !(gov || sentinel)");
        pause = _pause;
    ...
    function setRewards(address _rewards) external onlyGov() {
        ...
        require(_rewards != ZERO_ADDRESS, "MigratableBNBTransmuterV2: rewards address cannot be 0x0.");
    ...
    function migrateFunds(address migrateTo) external onlyGov() {
        require(migrateTo != address(0), "MigratableBNBTransmuterV2: cannot migrate to 0x0");
        require(pause, "MigratableBNBTransmuterV2: set pause first");
    ...
    function getVaultAdapter(uint256 _vaultId) external view returns (IBNBVaultAdapterV2WithIndirection) {
        BNBVaultV2WithIndirection.Data storage _vault = _vaults.get(_vaultId);
