 ...
 */
contract PoolAdapter is BasePoolAdapter {
     ...
     */
    constructor(address addressBook_, uint8 n_) BasePoolAdapter(addressBook_) {
    ...
    function swap(
        ...
        SafeERC20.safeIncreaseAllowance(erc20Impl, pool, amountIn);
        amountOut = poolImpl.exchange(uint256(i), uint256(j), amountIn, minAmountOut, to);
    }
    ...
    function removeLiquidity(
        ...
        amountOut = poolImpl.remove_liquidity_one_coin(amountIn, uint256(j), minAmountOut, to);
    }
}
