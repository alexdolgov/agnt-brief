...
/**
 * @title VestingWallet
 * @dev Based on @openzeppelin/finance/VestingWallet.sol
 *
...
abstract contract VestingWallet is Context {
     ...
     * @dev Set beneficiary.
     */
    function _setBeneficiary(address beneficiary_) internal virtual {
        require(beneficiary_ != address(0), "VestingWallet: zero address");
