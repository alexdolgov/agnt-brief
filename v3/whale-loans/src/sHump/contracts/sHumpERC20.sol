...
contract sHump is IsHUMP, ERC20Permit {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor() ERC20("Staked Humpback Token", "sHUMP", 9) ERC20Permit("Staked Humpback Token") {
    ...
    // this function is called by the treasury, and informs sHUMP of changes to debt.
    // note that addresses with debt balances cannot transfer collateralized sHUMP
    ...
    function changeDebt(
        ...
        require(debtBalances[debtor] <= balanceOf(debtor), "sHUMP: insufficient balance");
    }
