    ...
    SendValueHelper
{
    ...
    uint256 internal MIN_BORROW_SHARE_PRICE = 5 * PRECISION_FACTOR_E18
        / 10;
    ...
    uint256 internal GHOST_AMOUNT = 1E3;
    ...
    mapping(address => uint256) internal maxDepositValueToken;
    ...
    uint256 internal THREE_HOURS = 3 hours;
    uint256 internal PRECISION_FACTOR_YEAR = PRECISION_FACTOR_E18 * ONE_YEAR;
    ...
    // LASA CONSTANTS -------------------------
    uint256 internal THRESHOLD_SWITCH_DIRECTION = 90 * PRECISION_FACTOR_E16;
    uint256 internal THRESHOLD_RESET_RESONANCE_FACTOR = 75 * PRECISION_FACTOR_E16;

    // MORE THRESHHOLD VALUES

    uint256 internal MAX_COLLATERAL_FACTOR = 85 * PRECISION_FACTOR_E16;
    uint256 internal MAX_TOTAL_TOKEN_NUMBER = 8;

    // APR RESTRICTIONS
    uint256 internal RESTRICTION_FACTOR = 10
