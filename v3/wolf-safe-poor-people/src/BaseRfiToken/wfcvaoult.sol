...
// File: contracts/farms/olive/WfcVault.sol


pragma solidity 0.8.4;


contract WfcVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 cakeAtLastUserAction; // keeps track of Wfc deposited at the last user action
        uint256 lastUserActionTime; // keeps track of the last user action time
    }

    IERC20 public immutable token; // Wfc token
    ...
    /**
     * @notice Constructor
     * @param _token: Wfc token contract
    ...
    /**
     * @notice Deposits funds into the Wfc Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in OLIVE)
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Wfc Vault
     */
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingWfc(poolId, address(this));
    ...
    /**
     * @notice Withdraws from funds from the Wfc Vault
