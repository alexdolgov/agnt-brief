...
contract StrategyAave is BaseStrategy {
    ...
    constructor(
        ...
        aavePool = address(0xA238Dd80C259a72e81d7e4664a9801593F98d1c5); // Aave: Pool V3
        incentivesController = address(0xf9cc4F0D883F1a1eb2c253bdb46c254Ca51E1F44); // Aave: Incentives V3
        dataProvider = address(0x2d8A3C5677189723C4cB8873CfC9C8976FDF38Ac); // Aave: Pool Data Provider V3
