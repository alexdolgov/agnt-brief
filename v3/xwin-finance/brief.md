...
The pinned logic-topography run contains 7 contract row(s) across bsc. Structural roles: 3 unclassified, 2 core, 2 infra. 3 row(s) use upgradeable patterns.
...
- Indexed contracts: 7; live-surface contracts included: 7 (4 live, 3 unknown).
...
|---|---|---|---|---:|---|---|---|---|
| xWinBuddyChef | unknown | project_anchor | own_supporting | 1 | bsc | unit-397355 | `0x4b87a6...c2e903` | ✅ Audited |

### ⚠️ Verified + Unaudited (3)

| Contract Name | Role | Address-Book Class | Surface | Proxy Deployments | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---:|---|---|---|---|
| xWinLockedStake | unknown | project_anchor | own_supporting | 1 | bsc | unit-397354 | `0xa4ae0d...25a9fc` | ⚠️ Unaudited |
| xWinMasterChef | unknown | project_anchor | own_supporting | 1 | bsc | unit-397353 | `0xd09774...900a60` | ⚠️ Unaudited |
...
| bsc | `0xd09774...900a60` | xWinMasterChef | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
