...
- Outside the address book: 61 discovered implementations excluded (1 third-party/infra; 0 standard proxy/library)
- Proxy deployments represented within implementation groups: 0
- Deployed-live implementations: 14 of 75 unique (rest dead/inactive/uninitialized)
