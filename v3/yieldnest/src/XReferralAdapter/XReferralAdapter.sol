...
// src/utils/XReferralAdapter.sol
...
contract XReferralAdapter is ReentrancyGuardUpgradeable {
        ...
        returns (uint256 shares)
    {
        ...
        SafeERC20.safeTransferFrom(IERC20_0(asset), msg.sender, address(this), assets);

        // approve vault
        SafeERC20.forceApprove(IERC20_0(asset), _vault, assets);
