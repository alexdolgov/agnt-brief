...
import '@zf/v3-core/contracts/interfaces/callback/IZFV3SwapCallback.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IZFV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function zfV3SwapCallback(
        ...
        IZFV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IZFV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
    ...
    {
        (uint256 reserveIn, uint256 reserveOut, uint16 swapFee) = SmartRouterHelper.getReserves(factoryV2, params.tokenIn, params.tokenOut);
        amountOut = SmartRouterHelper.getAmountOut(params.amountIn, reserveIn, reserveOut, swapFee);
    }
