...
import {IZFV3Pool} from '../../interfaces/IZFV3Pool.sol';
import {IZFV3SwapCallback} from '../../interfaces/callback/IZFV3SwapCallback.sol';
...
/// @title Router for ZF v3 Trades
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, IZFV3SwapCallback {
    ...
    function zfV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
        ...
        if (UniversalRouterHelper.computePoolAddress(ZF_V3_DEPLOYER, ZF_V3_POOL_INIT_CODE_HASH, tokenIn, tokenOut, fee) != msg.sender) revert V3InvalidCaller();
    ...
    /// @notice Performs a ZF v3 exact input swap
    ...
    /// @notice Performs a ZF v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IZFV3Pool(UniversalRouterHelper.computePoolAddress(ZF_V3_DEPLOYER, ZF_V3_POOL_INIT_CODE_HASH, tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
