...
contract ZFV3Factory is IZFV3Factory {
    ...
    constructor(address _poolDeployer) {
        ...
        feeAmountTickSpacing[1000] = 10;
        feeAmountTickSpacingExtraInfo[1000] = TickSpacingExtraInfo({whitelistRequested: false, enabled: true});
        emit FeeAmountEnabled(1000, 10);
        emit FeeAmountExtraInfoUpdated(1000, false, true);
        ...
        feeAmountTickSpacing[5000] = 50;
        feeAmountTickSpacingExtraInfo[5000] = TickSpacingExtraInfo({whitelistRequested: false, enabled: true});
        emit FeeAmountEnabled(5000, 50);
        ...
        feeAmountTickSpacing[20000] = 200;
        feeAmountTickSpacingExtraInfo[20000] = TickSpacingExtraInfo({whitelistRequested: false, enabled: true});
        emit FeeAmountEnabled(20000, 200);
        emit FeeAmountExtraInfoUpdated(20000, false, true);

        feeAmountTickSpacing[30000] = 300;
        feeAmountTickSpacingExtraInfo[30000] = TickSpacingExtraInfo({whitelistRequested: false, enabled: true});
        emit FeeAmountEnabled(30000, 300);
        emit FeeAmountExtraInfoUpdated(30000, false, true);
    }
