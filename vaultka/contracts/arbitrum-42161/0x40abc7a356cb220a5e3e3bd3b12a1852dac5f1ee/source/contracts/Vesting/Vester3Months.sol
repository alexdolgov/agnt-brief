...
contract Vester3Months is IERC20, ReentrancyGuard, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, address _esToken, address _claimableToken) {
    ...
    function _updateVesting(address _account) private {
        ...
        //
        ERC20Burnable(esToken).burn(amount * 2);
        ERC20Burnable(claimableToken).burn(amount * 2);
    }
    ...
    function transferVKAtoVester12Months(uint256 _amount) external onlyOwner {
        ...
        IERC20(claimableToken).safeTransfer(vester12Months, _amount);
    }
}
