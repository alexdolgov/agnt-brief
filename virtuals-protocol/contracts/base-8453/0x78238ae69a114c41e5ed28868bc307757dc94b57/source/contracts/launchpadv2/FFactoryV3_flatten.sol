...
// contracts/launchpadv2/IFPairV2.sol
...
// contracts/launchpadv2/FPairV2.sol
...
// contracts/launchpadv2/FFactoryV3.sol
 ...
 */
contract FFactoryV3 is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _createPair(address tokenA, address tokenB, uint256 startTime, uint256 startTimeDelay)
        internal
        returns (address)
    {
        ...
        FPairV2 pair_ = new FPairV2(router, tokenA, tokenB, startTime, startTimeDelay);
    ...
    function createPair(address tokenA, address tokenB, uint256 startTime, uint256 startTimeDelay)
        external
