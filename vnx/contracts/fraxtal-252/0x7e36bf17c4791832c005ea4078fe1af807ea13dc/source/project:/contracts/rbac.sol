/**
 * VNXC RBAC Manger Smart Contract
...
contract VNXManager is IRBAC, Ownable {
   ...
   * @return The role id.
   */
  function addRootRole(string memory roleDescription) onlyOwner
    public override
    returns(uint256)
  {
   ...
   * @return The role id.
   */
  function addRole(string memory roleDescription, uint256 admin) onlyOwner
    public override
    returns(uint256)
  {
