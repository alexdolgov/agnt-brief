...
- Generated: 2026-05-25T13:17:30.407Z
...
- Contract surface: 153 unique implementations (376 raw deployments)
- DeFi Llama TVL: $25,128,699.68
- On-chain TVL (included contracts): $1,776,212.53
- TVL by chain: Ethereum $1,771,615.06 | Base $3,871.21 | Avalanche $676.35 | Moonbeam $49.92

## Project Description

Wan Bridge is a cross-chain bridge protocol that enables asset transfers and liquidity provision across multiple blockchains. It supports token bridging, staking, farming, and liquidity pools, with governance and oracle infrastructure to manage cross-chain operations.
...
- ASD (verified + unaudited TVL): $1,776,212.53
...
| ERC20Vinu | token | ethereum | [`0xafcdd4...f652c9`](./contracts/ethereum-1/0xafcdd4f666c84fed1d8bd825aa762e3714f652c9/) | ⚠️ Unaudited |
| DegaToken | token | ethereum | [`0x97aee0...225f17`](./contracts/ethereum-1/0x97aee01ed2aabad9f54692f94461ae761d225f17/) | ⚠️ Unaudited |
...
| AutoFarmV2_CrossChain | unknown | moonbeam | 5 deployments: polygon `0x89d065...eb0b76`; moonbeam [`0x77286f...8573a6`](./contracts/moonbeam-1284/0x77286f5257e090b1bedbc6df6726d53cbf8573a6/); moonriver `0xfada8c...d4680e`; celo `0xdd11b6...12303f`; avalanche `0x864a0b...23f213` | ⚠️ Unaudited |
...
|---|---|---|---|---:|---|
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $303,596.51 | Verified native implementation with $303,596.51 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0xafcdd4...f652c9`](./contracts/ethereum-1/0xafcdd4f666c84fed1d8bd825aa762e3714f652c9/) | ERC20Vinu | token | $153,388.19 | Verified native implementation with $153,388.19 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| ethereum | [`0x97aee0...225f17`](./contracts/ethereum-1/0x97aee01ed2aabad9f54692f94461ae761d225f17/) | DegaToken | token | $107,161.17 | Verified native implementation with $107,161.17 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0x0b9818...5d3895`](./contracts/ethereum-1/0x0b98183f06ce5694736880ed644c74606e5d3895/) | CrossDelegate | unknown | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
| polygon | [`0xa39ee0...3fa01d`](./contracts/polygon-137/0xa39ee04e8208c3309026f34007f036cbb03fa01d/) | NFTHelper | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
| polygon | [`0xd8dde3...54a480`](./contracts/polygon-137/0xd8dde3abe038519cb46afd36bf8777fdc754a480/) | NFTHelperERC721T | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
...
| polygon | [`0x990825...984e07`](./contracts/polygon-137/0x990825c5d894385f1c5bd36b6427c5336d984e07/) | WrappedERC1155T1 | token | n/a | Verified native implementation with no TVL datapoint and no extraction_exact/inherited_name_remap audit coverage |
