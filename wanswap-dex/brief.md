# Agentic Audit Brief: WanSwap Dex

⚠️ Lifecycle status: DECLINING - TVL changed 1.3% over 90 days
...
- Generated: 2026-05-25T06:55:31.152Z
...
- DeFi Llama TVL: $1,076,147.29
- On-chain TVL (included contracts): $1,854,784.23
- TVL by chain: Ethereum $1,694,294.04 | Arbitrum $160,489.50 | Bsc $0.70

## Project Description

WanSwap Dex is a multi-chain decentralized exchange and yield farming protocol that enables users to swap tokens, provide liquidity, and earn rewards through staking and farming pools.

### Architecture

The protocol's single product family integrates liquidity pools (e.g., UniswapV2Pair, PancakePair) with yield farming controllers (FarmV2Controller, FarmV3Controller) and staking contracts (BOGStaking, NyanRewards) to distribute rewards. Core vaults like bVault and CavePool manage user deposits, while tokens such as StakedBPT and ArcxTokenV2 represent staked positions, and proxies like ArcProxy provide upgradeability.

## Audit Coverage Summary

- Verified implementations audited: 2/185 (1.1%)
...
- ASD (verified + unaudited TVL): $1,854,784.23
- Latest audit: 2021-04 (stale)
- Staleness: 0 fresh, 0 aging, 1 stale, 0 unknown
- Tier 1 coverage: No Tier 1 coverage
- Note: This protocol is classified as [declining]. ASD of $1,854,784.23 represents exposure in a protocol with declining activity.

### Auditor Coverage

| Auditor | Tier | Contracts Covered | Coverage % | Latest Audit |
|---|---|---:|---:|---|
| HAECHI | Tier 2 | 2 | 1.1% | 2021-04 |
...
|---|---|---|---|---|
| Multicall | periphery | aurora | [`0xd26ddb...4e0a23`](./contracts/aurora-1313161554/0xd26ddb60efb6267db68f18801491c2292c4e0a23/) | ✅ Audited |
| UniswapV2Pair | unknown | ethereum | 2 deployments: ethereum [`0x570242...6507e5`](./contracts/ethereum-1/0x57024267e8272618f9c5037d373043a8646507e5/); ethereum `0x9f624b...980808` | ✅ Audited |
...
|---|---|---|---|---|---|---|---|---|
| [Haechi Audit](https://github.com/wanswap/wanswap-contracts/blob/master/%5BHAECHI%20AUDIT%5D%20WanSwap%20Smart%20Contract%20Audit%20Report%20ver%202.0.pdf) | HAECHI | Audit | 2021-04 | stale | Direct | contract_name | 3 | high |
...
| ethereum | [`0x2c2327...568ea6`](./contracts/ethereum-1/0x2c23276107b45e64c8c59482f4a24f4f2e568ea6/) | bVault | core_logic | $301,715.08 | Verified native implementation with $301,715.08 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| arbitrum | [`0x303f12...b86a3e`](./contracts/arbitrum-42161/0x303f12da29fa6346361a9e4feb5db073c5b86a3e/) | ArbisETHLPFarmStrategy | core_logic | $51,855.90 | Verified native implementation with $51,855.90 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
...
| ethereum | [`0xa3063c...63095e`](./contracts/ethereum-1/0xa3063cf3a934068cbe8f55212577a1ffbe63095e/) | StrategyArpa | core_logic | $4,952.64 | Verified native implementation with $4,952.64 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
| arbitrum | [`0x1c3e7f...da1a56`](./contracts/arbitrum-42161/0x1c3e7f51a9d24e813fa7c2614713b727a4da1a56/) | SwaprLPFarmStrategy | core_logic | $4,587.27 | Verified native implementation with $4,587.27 on-chain TVL and no extraction_exact/inherited_name_remap audit coverage |
