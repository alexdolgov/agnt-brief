...
- Generated: 2026-06-19T06:14:53.827Z
- Pipeline run: v2-pipeline-2026-06-19-32b207-c216
- Chains: base, berachain, blast, ethereum
- Contract surface: 60 unique implementations (277 raw deployments)
...
- Indexed contracts: 441; live-surface contracts included: 277 (277 live, 0 unknown).
- Excluded by liveness: 95 inactive, 69 singleton, 0 uninitialized.
...
|---|---|---:|---:|---|
| Zellic | Tier 2 | 16 | 32.7% | 2024-10 |
| Sherlock | Tier 1 | 12 | 24.5% | 2024-11 |
| Foobar | Tier 2 | 3 | 6.1% | 2023-12 |
...
| PerpManager | governance | ethereum | unit-38658 | [`0xc0b01a...010e7d`](./contracts/ethereum-1/0xc0b01a4f4a4459d5a7e13c2e8566cde93a010e7d/) | ✅ Audited |
| PerpManager | governance | base | unit-38686 | [`0xec3e4e...f7d70e`](./contracts/base-8453/0xec3e4e0fdb50411f4c5ee9f75436d8b20cf7d70e/) | ✅ Audited |
| PerpManager | governance | berachain | unit-38698 | [`0x5c285d...b6dd81`](./contracts/berachain-80094/0x5c285dd01440fb1175ae31934a5d1b3b90b6dd81/) | ✅ Audited |
| PerpManager | governance | blast | unit-38715 | [`0xff2cdb...7cc268`](./contracts/blast-81457/0xff2cdb9cdb79a60a31188fe37bdc6774107cc268/) | ✅ Audited |
| WasabiLongPool | core_logic | ethereum | n/a | 10 deployments: ethereum [`0x023afc...6a6078`](./contracts/ethereum-1/0x023afc8b575ef583ef5596d3834d82b7116a6078/); ethereum `0x095c34...5599d3`; ethereum `0x17d163...db5c3d`; ethereum `0x7041ce...7f3e95`; ethereum `0x8e19c0...2ddc04`; ethereum `0x94cf96...b10c51`; ethereum `0x97eea3...ab40f7`; ethereum `0xab1644...5df9cb`; ethereum `0xd2439d...165ffe`; ethereum `0xd4a321...ae430d` | ✅ Audited |
| WasabiRouter | adapter | ethereum | n/a | 5 deployments: ethereum [`0x08aad5...72ae33`](./contracts/ethereum-1/0x08aad56f494d705eaee20185e02996d5be72ae33/); ethereum `0x0b38cb...5f437e`; ethereum `0x96b10b...a63f23`; ethereum `0xe5312d...a564f9`; berachain `0x760d9c...b52d64` | ✅ Audited |
| WasabiRouter | adapter | ethereum | unit-38660 | [`0xee5c45...aac03b`](./contracts/ethereum-1/0xee5c45dcb0064f9b097edbc5d8adfce23baac03b/) | ✅ Audited |
| WasabiRouter | adapter | base | unit-38690 | [`0xfae69f...d8558f`](./contracts/base-8453/0xfae69f2c82747f878f74c1e57a1aed945ed8558f/) | ✅ Audited |
| WasabiRouter | adapter | berachain | unit-38700 | [`0x7864d8...a4b237`](./contracts/berachain-80094/0x7864d8c34bfcdbd83fda2da917aa6175a4a4b237/) | ✅ Audited |
| WasabiShortPool | core_logic | ethereum | n/a | 11 deployments: ethereum [`0x1536f7...a3662b`](./contracts/ethereum-1/0x1536f738d1dd76a90d3667dca58e85867ea3662b/); ethereum `0x1888f9...d46176`; ethereum `0x41247b...f78fad`; ethereum `0x44ba62...96559e`; ethereum `0x62d254...9bf842`; ethereum `0x8826d2...3cbc96`; ethereum `0x96ce21...137f78`; ethereum `0xc905de...b7dca5`; ethereum `0xcb8d3c...e8a2bb`; ethereum `0xd5a09a...33ae95`; ethereum `0xfc55a2...28006b` | ✅ Audited |
...
| Contract Name | Role | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---|---|
| WasabiVaultRecoveryV1 | core_logic | base | unit-38663 (8 proxies) | 8 deployments: base [`0x078b93...ac94fc`](./contracts/base-8453/0x078b931f7759ec09d74dd31316c610e09aac94fc/); base `0x197d5c...7e4a18`; base `0x1c4a80...048b24`; base `0x833fd9...2766b6`; base `0x95c81f...97fe95`; base `0xb152e9...1ad8c9`; base `0xb8da93...7239a0`; base `0xe6c109...9962a2` | ⚠️ Unaudited |
| WasabiVaultRecoveryV1 | core_logic | ethereum | unit-38650 (8 proxies) | 8 deployments: ethereum [`0x10432b...7bfe71`](./contracts/ethereum-1/0x10432bc30396e70f792b538d7e810c83dd7bfe71/); ethereum `0x127d36...74820a`; ethereum `0x630ed8...d61397`; ethereum `0x7d7bb4...389e8f`; ethereum `0x8d48b8...61e153`; ethereum `0xb533c6...0289f0`; ethereum `0xb86510...ceaba8`; ethereum `0xd2502e...f1c1b4` | ⚠️ Unaudited |
| WasabiVaultRecoveryV1 | core_logic | blast | unit-38711 (2 proxies) | 2 deployments: blast [`0x4bed2a...f24855`](./contracts/blast-81457/0x4bed2a922654cacc2be974689619768fabf24855/); blast `0x8e2b50...961e40` | ⚠️ Unaudited |
| WasabiVaultRecoveryV1 | core_logic | berachain | unit-38706 (2 proxies) | 2 deployments: berachain [`0xc95ab9...8afa1b`](./contracts/berachain-80094/0xc95ab9eff8fb48760703c74416764b8f898afa1b/); berachain `0xd94821...9c40fe` | ⚠️ Unaudited |
| BeraLongPool | core_logic | berachain | unit-38693 | [`0x0da575...6bb12b`](./contracts/berachain-80094/0x0da575d3edd4e3ee1d904936f94ec043c06bb12b/) | ⚠️ Unaudited |
| AaveStrategy | operational_periphery | ethereum | unit-38652 (3 proxies) | 3 deployments: ethereum [`0x1c1efa...fcd548`](./contracts/ethereum-1/0x1c1efa17081cde0c8ee816075369741d89fcd548/); ethereum `0x997904...448f67`; ethereum `0xc3f7e6...1543d2` | ⚠️ Unaudited |
| AaveStrategy | operational_periphery | base | unit-38662 | [`0x023d35...537fcf`](./contracts/base-8453/0x023d357d04f2d024993f6c002837ed3195537fcf/) | ⚠️ Unaudited |
...
| ERC1155CreatorImplementation | token | ethereum | unit-38653 | [`0x2d850f...54d165`](./contracts/ethereum-1/0x2d850f76c671aa2e1c1892a0644c115eb254d165/) | ⚠️ Unaudited |
| ERC1967Proxy | proxy | ethereum | unit-38656 | [`0x8e0edf...d5afc0`](./contracts/ethereum-1/0x8e0edfd6d15f858adbb41677b82ab64797d5afc0/) | ⚠️ Unaudited |
| ERC1967Proxy | proxy | base | unit-38680 | [`0xa456c7...7da37c`](./contracts/base-8453/0xa456c77d358c9c89f4dfb294fa2a47470b7da37c/) | ⚠️ Unaudited |
| ERC1967Proxy | proxy | base | unit-38681 | [`0xbdae5d...b248aa`](./contracts/base-8453/0xbdae5df498a45c5f058e3a09afe9ba4da7b248aa/) | ⚠️ Unaudited |
| ERC1967Proxy | proxy | base | unit-38691 | [`0xfc81df...3369fe`](./contracts/base-8453/0xfc81dfde25083a286723b7c9dd7213f8723369fe/) | ⚠️ Unaudited |
...
| ExactOutSwapperV2 | adapter | base | unit-38687 | [`0xf016fe...e38ad9`](./contracts/base-8453/0xf016fe66103c2a9f3d156fef32d2da8db8e38ad9/) | ⚠️ Unaudited |
...
| PartnerFeeManager | governance | ethereum | unit-38659 | [`0xcac101...934d33`](./contracts/ethereum-1/0xcac10196ae000184107916898f10a9045c934d33/) | ⚠️ Unaudited |
| PartnerFeeManager | governance | base | unit-38688 | [`0xf0714a...bfe1be`](./contracts/base-8453/0xf0714a3e2f4d78ffc1b400bfdacb7b8869bfe1be/) | ⚠️ Unaudited |
...
| VaultBoostManager | core_logic | ethereum | unit-38654 | [`0x382a45...cbfbd0`](./contracts/ethereum-1/0x382a45ab979b69f94346f3c004033ef7c9cbfbd0/) | ⚠️ Unaudited |
...
|---|---|---|---|---|---|---|---|---|
| [DL audit link](https://dkoda-public.s3.amazonaws.com/Narya.ai_Wasabi_Smart_Contract_Audit.pdf) | unknown | Audit | 2023-04 | stale | Direct | contract_name | 0 | n/a |
| [DL audit link](https://dkoda-public.s3.amazonaws.com/Zellic_Wasabi_Smart_Contract_Audit.pdf) | Zellic | Audit | 2023-04 | stale | Direct | contract_name | 0 | n/a |
| [Foobar Report](https://wasabi-public.s3.amazonaws.com/audits/v1/0xfoobar_Wasabi_Smart_Contract_Audit.pdf) | Foobar | Audit | 2023-05 | stale | Direct | contract_name | 0 | n/a |
| [WasabiPerps+Security+Assessment-1+(2).pdf](https://wasabi-public.s3.amazonaws.com/audits/v1/WasabiPerps+Security+Assessment-1+(2).pdf) | Foobar | Audit | 2023-12 | stale | Direct | contract_name | 22 | high |
| [Zellic Report](https://wasabi-public.s3.amazonaws.com/audits/v1/Wasabi+Perps+-+Zellic+Audit+Report.pdf) | Zellic | Audit | 2024-01 | stale | Direct | contract_name | 167 | high |
| [Zellic Report (2)](https://wasabi-public.s3.us-east-1.amazonaws.com/audits/v1/Wasabi+Perps+-+Zellic+Audit+Report+2.pdf) | Zellic | Audit | 2024-10 | aging | Direct | contract_name | 205 | high |
| [Sherlock EVM Report](https://wasabi-public.s3.us-east-1.amazonaws.com/audits/v1/Wasabi_Perps_EVM_Audit_Sherlock.pdf) | Sherlock | Contest | 2024-11 | aging | Direct | contract_name | 198 | high |
| [Sherlock SVM Report](https://wasabi-public.s3.us-east-1.amazonaws.com/audits/v1/Wasabi_Perps_Solana_Audit_Sherlock.pdf) | Sherlock | Contest | 2024-11 | aging | Direct | contract_name | 0 | n/a |
