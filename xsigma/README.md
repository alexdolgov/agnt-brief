...
- Website: [http://xsigma.fi/](http://xsigma.fi/)
- Lifecycle: unknown
...
This brief describes the observed EVM deployment and audit surface for xSigma. It intentionally limits the description to receipted repository and on-chain evidence instead of inferring a business model.
...
| Contract Name | Role | Address-Book Class | Surface | Proxy Deployments | Chain | Deployment Unit | Deployments | Audit Status |
|---|---|---|---|---:|---|---|---|---|
| UnnamedContract | unknown | non_address_book | non_address_book_inventory (excluded) | 0 | ethereum | n/a | `0x79ef38d19ea4167703ccd7c41fb1ece2b2521a02` | ❓ Unverified |
...
|---|---|---|---|---|---|---|---|
| unverified unclassified | UnnamedContract<br>`0x79ef38d19ea4167703ccd7c41fb1ece2b2521a02` | non_address_book | unknown | unknown | unverified | n/a | `0x2a7d2665955c1cdb7f41aea9c3f4cce74b835b0a` |

## Audit Inventory

| Audit | Auditor | Audit Type | Date | Freshness | Inheritance | Scope Format | Scope Result | Own Matches | Proxy Refs | Excluded/Context | Unresolved | Extraction Confidence |
|---|---|---|---|---|---|---|---|---:|---:|---:|---:|---|
| [15022021_xSigma_Audit.pdf](http://web.archive.org/web/20220626121344/https://xsigma.fi/15022021_xSigma_Audit.pdf) | Hacken | Audit | 2021-02 | stale | Direct | contract_name | no match | 0 | 0 | 0 | 5 | high |

### Scope Outcome Records

These are completed scope-analysis outcomes, not missing matcher runs. Explicit-zero results retain their unresolved/context references below.

- [21484] 15022021_xSigma_Audit.pdf — no match: Scope section lists 5 files: DAO/Governor.sol, DAO/TimeLock.sol, SigMasterChef.sol, SigThreePoolProxy.sol, SigToken.sol. Audit date is February 9th, 2021.
...
|---|---|---|---|---|---|
| 15022021_xSigma_Audit.pdf | Governor | unmatched — not counted | — | listed in scope | no |
| 15022021_xSigma_Audit.pdf | TimeLock | unmatched — not counted | — | listed in scope | no |
| 15022021_xSigma_Audit.pdf | SigMasterChef | unmatched — not counted | — | listed in scope | no |
| 15022021_xSigma_Audit.pdf | SigThreePoolProxy | unmatched — not counted | — | listed in scope | no |
| 15022021_xSigma_Audit.pdf | SigToken | unmatched — not counted | — | listed in scope | no |
...
- [21484] 15022021_xSigma_Audit.pdf
