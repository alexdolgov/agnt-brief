...
contract ExerciseHelperBMX is Ownable2Step {
        ...
        )
    {
        ...
        uint256 wethNeeded = router.quoteMintAmountBLT(
            address(weth),
            paymentTokenNeeded
        );
        ...
        uint256 expectedProfit = (wethNeeded *
            (DISCOUNT_DENOMINATOR - discount)) / discount;
    ...
    function exercise(
        ...
        // swap any leftover wBLT to WETH
     ...
     * @param _wBLTNeeded The amount of wBLT needed.
    ...
    function _borrowPaymentToken(
        ...
        uint256 wethNeeded = router.quoteMintAmountBLT(_weth, _wBLTNeeded);
        ...
        amounts[0] = wethNeeded;

        bytes memory userData = abi.encode(wethNeeded, _slippageAllowed);
