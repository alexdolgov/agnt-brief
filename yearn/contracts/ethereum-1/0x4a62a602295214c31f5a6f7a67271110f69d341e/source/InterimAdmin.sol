...
contract InterimAdmin is Ownable {
    ...
    event ProposalCreated(address indexed account, Action[] payload);
     ...
     */
    function createNewProposal(address account, Action[] calldata payload) external onlyOwner {
        ...
        emit ProposalCreated(account, payload);
    }
