...
// ============================================================
// FILE: contracts/BasicTradeFactory.sol
// ============================================================
...
contract BasicTradeFactory {
    ...
    address internal constant swapper =
        0xd0002c648CCa8DeE2f2b8D70D542Ccde8ad6EC03;

    // strategy address => token to swap to want
    mapping(address => address) public strategyToken;

    constructor() {}

    function enable(address _from, address _to) external {
        strategyToken[msg.sender] = _from;
    }

    function pullToSwap(address _strategy) external {
        require(msg.sender == swapper, "!swapper");
        IERC20 swapToken = IERC20(strategyToken[_strategy]);
