...
contract LyvePublicSale is Ownable, ReentrancyGuard {
   ...
   function addWhiteList(address[] memory addressList) external onlyOwner {
    ...
    function start() external onlyOwner {
        ...
        started = true;
        LYVE.safeTransferFrom(msg.sender, address(this), lyveTotalSaleAmount + lyveTotalSaleAmount*5/100);
    }
    ...
    function claim() external nonReentrant returns (uint256, uint256) {
        ...
        uint256 receiveEsLyveAmount = tokensToReceive*5/100;
    ...
    function finish() external onlyOwner {
        ...
        if (ethersToRaise > totalCommitments) {
            ...
            uint256 esLyveToBurn = tokensToBurn*5/100;
