...
contract PairFactory is IPairFactory,Ownable {
    ...
    uint256 public MAX_REFERRAL_FEE = 5000; // 50%
    ...
    constructor(address _permissionsRegistry) {
        pauser = msg.sender;
        isPaused = false;
    ...
    function setFee(bool _stable, uint256 _fee) external {
     ...
     function setCustomFee(address pair, uint256 fee) external  {
        ...
        if (!isPair[pair]) revert InvalidPool();
      ...
      function getFee(address pair, bool _stable) public view returns(uint256) {
        ...
        return  fee != 0 ? fee : _stable ? stableFee : volatileFee;
    }
