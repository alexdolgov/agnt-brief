...
import '@zf/v3-core/contracts/libraries/BitMath.sol';
import 'base64-sol/base64.sol';

/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a zkSwap Finance NFT
library NFTSVG {
    ...
    function generateSVG(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        msg: "Forged in SVG for zkSwap Finance in 2021 by 0xe8ab59d3bcde16a29912de83a90eb39628cfc163",
