...
import {Pausable} from '@openzeppelin-v4/contracts/security/Pausable.sol';
...
contract UniversalRouter is RouterImmutables, IUniversalRouter, Dispatcher, RewardsCollector, Pausable {
    ...
    StableSwapRouter(params.stableFactory, params.stableTwoPoolInfo, params.stableThreePoolInfo)
