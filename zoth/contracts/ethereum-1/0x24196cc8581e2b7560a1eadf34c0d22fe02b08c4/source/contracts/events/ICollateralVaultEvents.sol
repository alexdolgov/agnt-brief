...
interface ICollateralVaultEvents {
    ...
    /// @notice Emitted when a deposit record is permanently removed from storage
    /// @dev This event differs from DepositDeactivated as it indicates permanent removal rather than deactivation
    /// @param user The address of the user whose deposit was removed
    /// @param depositId The unique identifier of the removed deposit
    /// @param asset The address of the deposited asset/token
    /// @param amount The original amount of the asset that was deposited
    /// @param zeusdMinted The amount of ZeUSD that was minted against this deposit
    /// @param subVault The address of the subvault that handled this deposit
